declare namespace Ext.chart.axis.layout {
	/** 
	 * [Ext.chart.axis.layout.CombineDuplicate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.layout.CombineDuplicate.html)
	...
	class CombineDuplicate extends Ext.chart.axis.layout.Discrete {
		 ...
		 * @returns {any}            
		 */
		calculateLayout? (context: object): any;
		/** 
		 ...
		 * @returns {void}           
		 */
		calculateMajorTicks? (context: object): void;
		/** 
		 ...
		 * @returns {void}           
		 */
		calculateMinorTicks? (context: object): void;
		/** 
		 * Returns the value of [axis](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.layout.Layout.html#cfg-axis).
		 * @method
		 * @public (method)
		...
		processData? (): void;
		/** 
		 * Sets the value of [axis](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.layout.Layout.html#cfg-axis).
		 * @method
		 * @public (method)
		 * @param   {Ext.chart.axis.Axis} axis The new value.
		 * @returns {void}                     
		 */
		 ...
		 * @returns {void}               
		 */
		snapEnds? (context: object, min: number, max: number, estStepSize: number): void;
		/** 
		 ...
		 * @returns {void}           
		 */
		trimByRange? (context: object, out: object, trimMin: number, trimMax: number): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} value
		 ...
		 * @returns {void}         
		 */
		getCoordFor? (value: object, field: object, idx: object, items: object): void;
	}
	/** 
	 * [Ext.chart.axis.layout.Continuous](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.layout.Continuous.html)
	...
	class Continuous extends Ext.chart.axis.layout.Layout {
		...
		calculateMinorTicks? (context: object): void;
		/** 
		 * Returns the value of [adjustMaximumByMajorUnit](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.layout.Continuous.html#cfg-adjustMaximumByMajorUnit).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [adjustMinimumByMajorUnit](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.layout.Continuous.html#cfg-adjustMinimumByMajorUnit).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Sets the value of [adjustMaximumByMajorUnit](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.layout.Continuous.html#cfg-adjustMaximumByMajorUnit).
		 * @method
		 * @public (method)
		 * @param   {boolean} adjustMaximumByMajorUnit The new value.
		 * @returns {void}                             
		 */
		setAdjustMaximumByMajorUnit? (adjustMaximumByMajorUnit: boolean): void;
		/** 
		 * Sets the value of [adjustMinimumByMajorUnit](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.layout.Continuous.html#cfg-adjustMinimumByMajorUnit).
		 * @method
		 * @public (method)
		 * @param   {boolean} adjustMinimumByMajorUnit The new value.
		 * @returns {void}                             
		 */
	...
	/** 
	 * [Ext.chart.axis.layout.Discrete](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.layout.Discrete.html)
	...
	/** 
	 * [Ext.chart.axis.layout.Layout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.layout.Layout.html)
...
declare namespace Ext.chart.axis.segmenter {
	/** 
	 * [Ext.chart.axis.segmenter.Names](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Names.html)
	...
	class Names extends Ext.chart.axis.segmenter.Segmenter {
		 ...
		 * @returns {void}         
		 */
		add? (value: object, step: object, unit: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.chart.axis.segmenter.Segmenter.add](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Segmenter.html#method-add).
		 * Add `step` `unit`s to the value.
		 * @method
		 * @public (method)
		 ...
		 * @param   {object} step
		 * @param   {object} unit
		 * @returns {any}          Aligned value.
		 */
		align? (value: object, step: object, unit: object): any;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.chart.axis.segmenter.Segmenter.align](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Segmenter.html#method-align).
		 * Align value with step of units.
		 * For example, for the date segmenter, if the unit is "Month" and step is 3, the value will be aligned by
		 * seasons.
		 * @method
		 * @public (method)
		 * @param   {any}    value The value to be aligned.
		 ...
		 * @method
		 * @public (method)
		 * @param   {any} value The value to convert from
		 * @returns {any}       The converted value.
		 */
		from? (value: any): any;
		/** 
		 * Returns the value of [axis](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Segmenter.html#cfg-axis).
		 * @method
		 * @public (method)
		 * @returns {Ext.chart.axis.Axis}  
		 */
		 ...
		 * @public (method)
		 * @param   {object} min
		 * @param   {object} estStepSize
		 * @param   {object} minIdx
		 * @param   {object} data
		 * @returns {object}             Return the step size by an object of step x unit.
		 */
		preferredStep? (min: object, estStepSize: object, minIdx: object, data: object): object;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.chart.axis.segmenter.Segmenter.preferredStep](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Segmenter.html#method-preferredStep).
		 * Given a start point and estimated step size of a range, determine the preferred step size.
		 * @method
		 * @public (method)
		 * @param   {any}    start       The start point of range.
		 * @param   {any}    estStepSize The estimated step size.
		 * @returns {object}             Return the step size by an object of step x unit.
		 */
		preferredStep? (start: any, estStepSize: any): object;
		/** 
		 * Sets the value of [axis](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Segmenter.html#cfg-axis).
		 * @method
		 * @public (method)
		 * @param   {Ext.chart.axis.Axis} axis The new value.
		 * @returns {void}                     
	...
	/** 
	 * [Ext.chart.axis.segmenter.Numeric](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Numeric.html)
	 * Numeric data type.
	 */
	class Numeric extends Ext.chart.axis.segmenter.Segmenter {
		 ...
		 * @method
		 * @public (method)
		 * @param   {any}    min         The start point of range.
		 * @param   {any}    estStepSize The estimated step size.
		 * @returns {object}             Return the step size by an object of step x unit.
		 */
		exactStep? (min: any, estStepSize: any): object;
		/** 
		 * Convert from any data into the target type.
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.chart.axis.segmenter.Segmenter](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Segmenter.html)
	 * Interface for a segmenter in an Axis. A segmenter defines the operations you can do to a specific
	 * data type.
	 * 
	 * See [Ext.chart.axis.Axis](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.Axis.html).
	 */
	class Segmenter extends Ext.Base {
		 ...
		 * @method
		 * @public (method)
		 * @param   {any}    min  The smaller value.
		 * @param   {any}    max  The larger value.
		 * @param   {any}    unit The unit scale. Unit can be any type.
		 * @returns {number}      The number of `unit`s between min and max. It is the minimum n that min + n * unit >= max.
		 */
		 ...
		 * @returns {string}         
		 */
		renderer? (value: any, context: object): string;
		/** 
		 * Sets the value of [axis](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Segmenter.html#cfg-axis).
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.chart.axis.segmenter.Time](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Time.html)
	 * Time data type.
	 */
	class Time extends Ext.chart.axis.segmenter.Segmenter {
		 ...
		 * @returns {any}         Aligned value.
		 */
		align? (date: object, step: object, unit: object): any;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.chart.axis.segmenter.Segmenter.align](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Segmenter.html#method-align).
		 * Align value with step of units.
		 * For example, for the date segmenter, if the unit is "Month" and step is 3, the value will be aligned by
		...
		getAxis? (): Ext.chart.axis.Axis;
		/** 
		 * Returns the value of [step](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Time.html#cfg-step).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		setAxis? (axis: Ext.chart.axis.Axis): void;
		/** 
		 * Sets the value of [step](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Time.html#cfg-step).
		 * @method
		 * @public (method)
		 * @param   {object} step The new value.
		 * @returns {void}        
		 */
		setStep? (step: object): void;
	}
}
declare namespace Ext.chart.axis.sprite {
	 ...
	 * @private (class)
	 */
	class Axis extends Ext.draw.sprite.Sprite {}
	/** 
	 * The [3D axis](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.Axis3D.html) sprite.
	 * Only 3D cartesian axes are rendered with this sprite.
	 * @private (class)
	 */
	class Axis3D extends Ext.chart.axis.sprite.Axis {}
}
declare namespace Ext.chart.axis.layout.CombineDuplicate {
	/** 
	 * @definitions
	 ...
	 * Discrete processor that combines duplicate data points.
	 */
	interface Def extends Ext.chart.axis.layout.CombineDuplicate {
		/** 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.chart.axis.layout.CombineDuplicate.Cfg}
		 */
		config?: Ext.chart.axis.layout.CombineDuplicate.Cfg;
		/** 
...
declare namespace Ext.chart.axis.layout.Continuous {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.chart.axis.layout.Continuous](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.layout.Continuous.html)
	 * Processor for axis data that can be interpolated.
	 */
	interface Def extends Ext.chart.axis.layout.Continuous {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.chart.axis.layout.Continuous.Cfg}
		 */
		config?: Ext.chart.axis.layout.Continuous.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.chart.axis.layout.Discrete {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.chart.axis.layout.Discrete](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.layout.Discrete.html)
	 * Simple processor for data that cannot be interpolated.
	 */
	interface Def extends Ext.chart.axis.layout.Discrete {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.chart.axis.layout.Discrete.Cfg}
		 */
		config?: Ext.chart.axis.layout.Discrete.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.chart.axis.layout.Layout {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.chart.axis.layout.Layout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.layout.Layout.html)
	 * Interface used by Axis to process its data into a meaningful layout.
	 */
	interface Def extends Ext.chart.axis.layout.Layout {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.chart.axis.layout.Layout.Cfg}
		 */
		config?: Ext.chart.axis.layout.Layout.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.chart.axis.segmenter.Names {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.chart.axis.segmenter.Names](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Names.html)
	 ...
	 * The `preferredStep` always return `{ unit: 1, step: 1 }` to indicate "show every item".
	 */
	interface Def extends Ext.chart.axis.segmenter.Names {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.chart.axis.segmenter.Names.Cfg}
		 */
		config?: Ext.chart.axis.segmenter.Names.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.chart.axis.segmenter.Numeric {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.chart.axis.segmenter.Numeric](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Numeric.html)
	 * Numeric data type.
	 */
	interface Def extends Ext.chart.axis.segmenter.Numeric {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.chart.axis.segmenter.Numeric.Cfg}
		 */
		config?: Ext.chart.axis.segmenter.Numeric.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.chart.axis.segmenter.Segmenter {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.chart.axis.segmenter.Segmenter](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Segmenter.html)
	 ...
	 * See [Ext.chart.axis.Axis](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.Axis.html).
	 */
	interface Def extends Ext.chart.axis.segmenter.Segmenter {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.chart.axis.segmenter.Segmenter.Cfg}
		 */
		config?: Ext.chart.axis.segmenter.Segmenter.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.chart.axis.segmenter.Time {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.chart.axis.segmenter.Time](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Time.html)
	 * Time data type.
	 */
	interface Def extends Ext.chart.axis.segmenter.Time {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.chart.axis.segmenter.Time.Cfg}
		 */
		config?: Ext.chart.axis.segmenter.Time.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.chart.axis.sprite.Axis {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.chart.axis.sprite.Axis](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.sprite.Axis.html)
	 * The axis sprite. Currently all types of the axis will be rendered with this sprite.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * @private (property)
		 * @static
		 * @default {processors: {grid: 'bool', axisLine: 'bool', minorTicks: 'bool', minorTickSize: 'number', majorTicks: 'bool', majorTickSize: 'number', length: 'number', startGap: 'number', endGap: 'number', dataMin: 'number', dataMax: 'number', visibleMin: 'number', visibleMax: 'number', position: 'enums(left,right,top,bottom,angular,radial,gauge)', minStepSize: 'number', estStepSize: 'number', titleOffset: 'number', textPadding: 'number', min: 'number', max: 'number', centerX: 'number', centerY: 'number', radius: 'number', totalAngle: 'number', baseRotation: 'number', data: 'default', enlargeEstStepSizeByText: 'bool'}, defaults: {grid: false, axisLine: true, minorTicks: false, minorTickSize: 3, majorTicks: true, majorTickSize: 5, length: 0, startGap: 0, endGap: 0, visibleMin: 0, visibleMax: 1, dataMin: 0, dataMax: 1, position: '', minStepSize: 0, estStepSize: 20, min: 0, max: 1, centerX: 0, centerY: 0, radius: 1, baseRotation: 0, data: null, titleOffset: 0, textPadding: 0, scalingCenterY: 0, scalingCenterX: 0, strokeStyle: 'black', enlargeEstStepSizeByText: false}, triggers: {minorTickSize: 'bbox', majorTickSize: 'bbox', position: 'bbox,layout', axisLine: 'bbox,layout', min: 'layout', max: 'layout', length: 'layout', minStepSize: 'layout', estStepSize: 'layout', data: 'layout', dataMin: 'layout', dataMax: 'layout', visibleMin: 'layout', visibleMax: 'layout', enlargeEstStepSizeByText: 'layout'}, updaters: {layout: 'layoutUpdater'}}
		 * @type {object}
		 */
		def?: object;
	}
}
declare namespace Ext.chart.axis.sprite.Axis3D {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.chart.axis.sprite.Axis3D](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.sprite.Axis3D.html)
	 * The [3D axis](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.Axis3D.html) sprite.
	 * Only 3D cartesian axes are rendered with this sprite.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * @private (property)
		 * @static
		 * @default {processors: {depth: 'number'}, defaults: {depth: 0}, triggers: {depth: 'layout'}}
		 * @type {object}
		 */
		def?: object;
	}
...
declare namespace Ext.chart.axis.segmenter.Time {
	...
	interface Cfg extends Ext.base.Configs {
		...
		axis?: Ext.chart.axis.Axis;
		/** 
		 * If specified, the will override the result of [preferredStep](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.axis.segmenter.Time.html#method-preferredStep).
		 * @configuration
		 * @optional
		 * @type {object}
		 */
...
declare namespace Ext.chart.axis.sprite.Axis {
	...
	interface Cfg extends Ext.base.Configs {
		...
		dirty?: boolean;
		/** 
		 * Axis end determined by the chart inset padding.
		 * @configuration
		 * @optional
		 * @default 'number'
		 * @type {number}
		...
		/** 
		 * Axis start determined by the chart inset padding.
		 * @configuration
		 * @optional
		 * @default 'number'
		 * @type {number}
		 ...
		 * This default is defined in the [axis](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.theme.Base.html#cfg-axis) config
		 * of the [Base](https://docs.sencha.com/extjs/6.0.1/classic/Ext.chart.theme.Base.html) theme.
		 ...
		 * @chainable
		 * @param   {object}                             config
		 * @returns {Ext.chart.axis.sprite.Axis.Statics}        this
		 */
		initConfig? (config: object): Ext.chart.axis.sprite.Axis.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.chart.axis.sprite.Axis.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.chart.axis.sprite.Axis.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.chart.axis.sprite.Axis.Statics}  
		 */
		statics? (): Ext.chart.axis.sprite.Axis.Statics;
	}
}
declare namespace Ext.chart.axis.sprite.Axis3D {
	/** 
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                               config
		 * @returns {Ext.chart.axis.sprite.Axis3D.Statics}        this
		 */
		initConfig? (config: object): Ext.chart.axis.sprite.Axis3D.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.chart.axis.sprite.Axis3D.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.chart.axis.sprite.Axis3D.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.chart.axis.sprite.Axis3D.Statics}  
		 */
		statics? (): Ext.chart.axis.sprite.Axis3D.Statics;
	}
}

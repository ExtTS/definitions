declare namespace Ext.draw.engine {
	/** 
	 * [Ext.draw.engine.Canvas](https://docs.sencha.com/extjs/6.0.1/classic/Ext.draw.engine.Canvas.html)
	...
	class Canvas extends Ext.draw.Surface {
		 ...
		 * @property
		 * @private (property)
		 * @default {reference: 'element', style: {position: 'absolute'}, children: [{reference: 'innerElement', style: {width: '100%', height: '100%', position: 'relative'}}]}
		 * @type {object}
		 */
		element?: object;
		/** 
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.draw.Surface.flatten](https://docs.sencha.com/extjs/6.0.1/classic/Ext.draw.Surface.html#method-flatten).
		 * Flattens the given drawing surfaces into a single image
		 * and returns an object containing the data (in the DataURL format)
		 * and the type (e.g. 'png' or 'svg') of that image.
		 * @method
		...
		/** 
		 * Returns the value of [highPrecision](https://docs.sencha.com/extjs/6.0.1/classic/Ext.draw.engine.Canvas.html#cfg-highPrecision).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Sets the value of [highPrecision](https://docs.sencha.com/extjs/6.0.1/classic/Ext.draw.engine.Canvas.html#cfg-highPrecision).
		 * @method
		 * @public (method)
	...
	/** 
	 * @define [Ext.draw.engine.excanvas](https://docs.sencha.com/extjs/6.0.1/classic/Ext.draw.engine.excanvas.html)
	 * @private (class)
	 */
	class excanvas {}
	/** 
	 * [Ext.draw.engine.Svg](https://docs.sencha.com/extjs/6.0.1/classic/Ext.draw.engine.Svg.html)
	 * SVG engine.
	 */
	class Svg extends Ext.draw.Surface {
		...
		getFlipRtlText? (): boolean;
		/** 
		 * Returns the value of [highPrecision](https://docs.sencha.com/extjs/6.0.1/classic/Ext.draw.engine.Svg.html#cfg-highPrecision).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.draw.Surface.remove](https://docs.sencha.com/extjs/6.0.1/classic/Ext.draw.Surface.html#method-remove).
		 * Remove a given sprite from the surface,
		 * optionally destroying the sprite in the process.
		 * You can also call the sprite's own `remove` method.
		 * 
		...
		setFlipRtlText? (flipRtlText: boolean): void;
		/** 
		 * Sets the value of [highPrecision](https://docs.sencha.com/extjs/6.0.1/classic/Ext.draw.engine.Svg.html#cfg-highPrecision).
		 * @method
		 * @public (method)
		 * @param   {boolean} highPrecision The new value.
		 * @returns {void}                  
	...
	/** 
	 * [Ext.draw.engine.SvgContext](https://docs.sencha.com/extjs/6.0.1/classic/Ext.draw.engine.SvgContext.html)
...
declare namespace Ext.draw.engine.Svg {
	...
	interface Def extends Ext.draw.engine.Svg {
		 ...
		 * @protected (method+configuration)
		 * @returns {Ext.Widget.Statics|Ext.Evented.Statics|Ext.Base.Statics}  
		 * @type {Ext.draw.engine.Svg.Statics}
		 */
		statics?: (() => Ext.Widget.Statics | Ext.Evented.Statics | Ext.Base.Statics) | Ext.draw.engine.Svg.Statics | any;
	}
}
declare namespace Ext.draw.engine.SvgContext {
	/** 
...
declare namespace Ext.draw.engine.SvgContext.Gradient {
	 ...
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.draw.engine.SvgContext.Gradient](https://docs.sencha.com/extjs/6.0.1/classic/Ext.draw.engine.SvgContext.Gradient.html)
	 */
	interface Def extends Ext.draw.engine.SvgContext.Gradient {
		 ...
		 * @protected (method+configuration)
		 * @returns {Ext.Base.Statics}  
		 * @type {Ext.draw.engine.SvgContext.Gradient.Statics}
		 */
		statics?: (() => Ext.Base.Statics) | Ext.draw.engine.SvgContext.Gradient.Statics | any;
	}
}
declare namespace Ext.draw.engine.Canvas {
	/** 
...
declare namespace Ext.draw.engine.Canvas.methodReturns {
	 ...
	 * [Ext.draw.engine.Canvas.getBBox](https://docs.sencha.com/extjs/6.0.1/classic/Ext.draw.engine.Canvas.html#method-getBBox)
	 */
...
declare namespace Ext.draw.engine.Svg.methodReturns {
	 ...
	 * @returns
	 * Method return interface: 
	 * [Ext.draw.engine.Svg.getBBox](https://docs.sencha.com/extjs/6.0.1/classic/Ext.draw.engine.Svg.html#method-getBBox)
	 */
	interface getBBox extends Ext.base.Returns {
	}
}
...
declare namespace Ext.draw.engine.Svg {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                      config
		 * @returns {Ext.draw.engine.Svg.Statics}        this
		 */
		initConfig? (config: object): Ext.draw.engine.Svg.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.draw.engine.Svg.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.draw.engine.Svg.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.draw.engine.Svg.Statics}  
		 */
		statics? (): Ext.draw.engine.Svg.Statics;
	}
}

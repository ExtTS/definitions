declare namespace Ext.app.domain {
	 ...
	 * [Ext.Component](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html) are included in this domain. The matching criteria uses
	 * [Ext.ComponentQuery](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ComponentQuery.html).
	 * @private (class)
	 ...
	 * [Ext.app.Controller](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.Controller.html) are included in this domain. The selectors are simply id,
	 ...
	 * [Ext.direct.Provider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Provider.html) are included in this domain. The selectors are simply provider
	 ...
	 * [Ext.GlobalEvents](https://docs.sencha.com/extjs/6.0.1/classic/Ext.GlobalEvents.html) Observable instance. No selectors are supported for this domain.
	 * @private (class)
	 * @singleton (definition)
	 */
	 ...
	 * [Ext.data.AbstractStore](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.AbstractStore.html) are included in this domain. The selectors are simply
	...
	class View extends Ext.app.EventDomain {
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.app.EventDomain.constructor](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.EventDomain.html#method-constructor).
		 * @method
		 * @public (method)
		 */
		constructor ();
		 ...
		 * [idProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.domain.View.html#cfg-idProperty), or when selector is '*' wildcard to match any
		 * target.
		 * @method
		 * @protected (method)
		 * @param   {object}  target
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.app.EventDomain.match](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.EventDomain.html#method-match).
		 * This method matches the firer of the event (the `target`) to the given `selector`.
		 * Default matching is very simple: a match is true when selector equals target's
...
declare namespace Ext.app.route {
	/** 
	 * A Queue is a queue of [Ext.app.route.Route](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Route.html) instances managed by the
	 * [Ext.app.route.Router](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Router.html) singleton if queueActions is set to `true`.
	 * 
	 * A developer shouldn't need to use this class as [Ext.app.route.Router](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Router.html) should
	 * manage this class. When a [Ext.app.route.Route](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Route.html) is executed,it will automatically
	...
	/** 
	 * The Router is an ordered set of [Ext.app.route.Route](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Route.html) definitions that decode a
	 ...
	 * [Ext.util.History](https://docs.sencha.com/extjs/6.0.1/classic/Ext.util.History.html) singleton to find out when the browser's url has changed.
	 * 
	 * Routes are almost always defined inside a [Controller](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.Controller.html), as
	 ...
	 * [Controller documentation](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.Controller.html) for more information on specifying
	 * routes.
	 * @private (class)
	 * @singleton (definition)
	 */
...
declare namespace Ext.app.domain.View {
	 ...
	 * [Ext.app.domain.View](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.domain.View.html)
	 */
...
declare namespace Ext.app.domain.Component {
	 ...
	 * [Ext.app.domain.Component](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.domain.Component.html)
	 * This class implements the component event domain. All classes extending from
	 * [Ext.Component](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html) are included in this domain. The matching criteria uses
	 * [Ext.ComponentQuery](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ComponentQuery.html).
	 */
...
declare namespace Ext.app.domain.Controller {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.app.domain.Controller](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.domain.Controller.html)
	 * This class implements the controller event domain. All classes extending from
	 * [Ext.app.Controller](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.Controller.html) are included in this domain. The selectors are simply id,
	 * alias, or the wildcard "*" to match any controller.
	 */
...
declare namespace Ext.app.domain.Direct {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.app.domain.Direct](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.domain.Direct.html)
	 * This class implements the Ext Direct event domain. All classes extending from
	 * [Ext.direct.Provider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Provider.html) are included in this domain. The selectors are simply provider
	 * id's or the wildcard "*" to match any provider.
	 */
...
declare namespace Ext.app.domain.Global {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.app.domain.Global](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.domain.Global.html)
	 * This class implements the global event domain. This domain represents event fired from
	 * [Ext.GlobalEvents](https://docs.sencha.com/extjs/6.0.1/classic/Ext.GlobalEvents.html) Observable instance. No selectors are supported for this domain.
	 */
	interface Statics extends Ext.base.Statics {
...
declare namespace Ext.app.domain.Store {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.app.domain.Store](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.domain.Store.html)
	 * This class implements the data store event domain. All classes extending from
	 * [Ext.data.AbstractStore](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.AbstractStore.html) are included in this domain. The selectors are simply
	 * store id, alias or the wildcard "*" to match any store.
	 */
...
declare namespace Ext.app.route.Queue {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.app.route.Queue](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Queue.html)
	 * A Queue is a queue of [Ext.app.route.Route](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Route.html) instances managed by the
	 * [Ext.app.route.Router](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Router.html) singleton if queueActions is set to `true`.
	 * 
	 * A developer shouldn't need to use this class as [Ext.app.route.Router](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Router.html) should
...
declare namespace Ext.app.route.Route {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.app.route.Route](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Route.html)
	 * Represents a mapping between a url and a controller/action pair. May also contain
	 * additional params.
	 * 
	 * This is a private internal class that should not need to be used by end-developer code.
...
declare namespace Ext.app.route.Router {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.app.route.Router](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Router.html)
	 * The Router is an ordered set of [Ext.app.route.Route](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Route.html) definitions that decode a
	 * url into a controller function to execute. Each `route` defines a type of url to match,
	 * along with the controller function to call if it is matched. The Router uses the
	 * [Ext.util.History](https://docs.sencha.com/extjs/6.0.1/classic/Ext.util.History.html) singleton to find out when the browser's url has changed.
...
declare namespace Ext.app.route.Route {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * [controller](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Route.html#cfg-controller) if this route is matched.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		...
		/** 
		 * An optional function used to intercept [action](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Route.html#cfg-action)
		 ...
		 * send an [Ext.Ajax](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Ajax.html) request to a server or some arbitrary code.
		 * 
		 * This function MUST be executed by passing in a Boolean
		 * value to allow execution of the configured action on [Ext.app.route.Route](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Route.html).
		 * 
		 * Defaults to `null`
		 * @configuration
		 * @optional
		...
		conditions?: object;
		/** 
		 * The name of the Controller whose [action](https://docs.sencha.com/extjs/6.0.1/classic/Ext.app.route.Route.html#cfg-action) will be

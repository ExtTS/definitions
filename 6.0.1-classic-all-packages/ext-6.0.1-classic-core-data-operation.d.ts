declare namespace Ext.data.operation {
	/** 
	 * [Ext.data.operation.Create](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Create.html)
	 * Enacpsulates a create operation as performed by a [proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Proxy.html).
	 * 
	 * This class is instantiated by [stores](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Store.html) and [records](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html) and should
	...
	class Create extends Ext.data.operation.Operation {
		...
		/** 
		 * This number is used by [`Ext.data.Batch.sort`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Batch.html#method-sort) to order operations. Order of
		 ...
		 * @returns {Ext.data.operation.Create|Ext.data.operation.Operation|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.data.operation.Create;
		static addInheritableStatics? (members: object): typeof Ext.data.operation.Operation;
		...
		/** 
		 * Aborts the processing of this operation on the [proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-proxy).
		...
		destroy? (): void;
		/** 
		 * Returns the value of [batch](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-batch).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [callback](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-callback).
		 * @method
		 * @public (method)
		 * @returns {Function}  
		 */
		...
		/** 
		 * Returns the error string or object that was set using [setException](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#method-setException)
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [id](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-id).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the value of [params](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-params).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getParams? (): object;
		/** 
		 * Returns the value of [proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-proxy).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [recordCreator](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Create.html#cfg-recordCreator).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the [record](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html)s associated with this operation. For read
		 * operations the records as set by the [Proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Proxy.html) will be
		...
		/** 
		 * Returns the value of [request](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-request).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [resultSet](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-resultSet).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [scope](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-scope).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getScope? (): object;
		/** 
		 * Returns the value of [synchronous](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-synchronous).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [url](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-url).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		getUrl? (): string;
		/** 
		 * Returns true if this Operation encountered an exception (see also [getError](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#method-getError))
		 * @method
		 * @public (method)
		 ...
		 * [isRunning](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#method-isRunning) to test if the Operation is currently running.
		 * @method
		 * @public (method)
		...
		isStarted? (): boolean;
		/** 
		 * Sets the value of [batch](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-batch).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [callback](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-callback).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [id](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-id).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [params](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-params).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-proxy).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [recordCreator](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Create.html#cfg-recordCreator).
		 * @method
		 * @public (method)
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.operation.Operation.setRecordCreator](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#method-setRecordCreator).
		 * Sets the value of [recordCreator](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-recordCreator).
		 * @method
		 * @private (method)
		...
		/** 
		 * Sets the value of [records](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-records).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [request](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-request).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [resultSet](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-resultSet).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [scope](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-scope).
		 * @method
		 * @public (method)
		 ...
		 * as being complete See [setCompleted](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#method-setCompleted).
		 * @returns {void}               
		 */
		setSuccessful? (complete?: boolean): void;
		/** 
		 * Sets the value of [synchronous](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-synchronous).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [url](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-url).
		 * @method
		 * @public (method)
		...
		doExecute? (): void;
		/** 
		 * Executes the operation on the configured [proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-proxy).
		 * @method
		 * @private (method)
		...
		/** 
		 * Returns the value of [internalCallback](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-internalCallback).
		 * @method
		 * @private (method)
		 * @returns {Function}  
		 */
		...
		/** 
		 * Returns the value of [internalScope](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-internalScope).
		 * @method
		 * @private (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the value of [response](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-response).
		 * @method
		 * @private (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Sets the value of [internalCallback](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-internalCallback).
		 * @method
		 * @private (method)
		...
		/** 
		 * Sets the value of [internalScope](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-internalScope).
		 * @method
		 * @private (method)
		...
		/** 
		 * Sets the value of [response](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-response).
		 * @method
		 * @private (method)
	...
	/** 
	 * [Ext.data.operation.Destroy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Destroy.html)
	 * Enacapsulates a destroy operation as performed by a [proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Proxy.html).
	 * 
	 * This class is instantiated by [stores](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Store.html) and [records](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html) and should
	 * not need to be instantiated in user code.
	 */
	class Destroy extends Ext.data.operation.Operation {
		...
		/** 
		 * This number is used by [`Ext.data.Batch.sort`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Batch.html#method-sort) to order operations of the
		 ...
		 * operation. Only [`Ext.data.operation.Destroy`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Destroy.html) overrides this value.
		 * @property
		 * @private (property)
		 * @type {number}
		 */
		 ...
		 * @returns {Ext.data.operation.Destroy|Ext.data.operation.Operation|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.data.operation.Destroy;
		static addInheritableStatics? (members: object): typeof Ext.data.operation.Operation;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		...
		wasSuccessful? (): boolean;
		/** 
		 * Returns the value of [recordCreator](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-recordCreator).
		 * @method
		 * @private (method)
		 * @returns {Function}  
		 */
	...
	/** 
	 * [Ext.data.operation.Operation](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html)
	 * Represents a read or write operation performed by a [Proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Proxy.html).
	 ...
	 * 
	 * Several Operations can be batched together in a [batch](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Batch.html).
	 */
	class Operation extends Ext.Base {
		...
		/** 
		 * The completion status of this Operation. Use [isComplete](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#method-isComplete).
		 * @property
		 * @private (property)
		 * @readonly
		 * @default false
		...
		/** 
		 * The error object passed when [setException](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#method-setException) was called. This could be any object or primitive.
		 * @property
		 * @private (property)
		 * @type {string|object}
		 */
		error?: string | object;
		/** 
		 * The exception status of this Operation. Use [hasException](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#method-hasException) and see [getError](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#method-getError).
		 * @property
		 * @private (property)
		 * @readonly
		 * @default false
		...
		/** 
		 * The run status of this Operation. Use [isRunning](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#method-isRunning).
		 * @property
		 * @private (property)
		 * @readonly
		 * @default false
		...
		/** 
		 * The start status of this Operation. Use [isStarted](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#method-isStarted).
		 * @property
		 * @private (property)
		 * @readonly
		 * @default false
		 ...
		 * or false by the Proxy that is executing the Operation. It is also set to false by [setException](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#method-setException). Use
		 * [wasSuccessful](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#method-wasSuccessful) to query success status.
		 * @property
		 * @private (property)
		 * @readonly
		 * @type {boolean}
	...
	/** 
	 * [Ext.data.operation.Read](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Read.html)
	 * Enacpsulates a read operation as performed by a [proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Proxy.html).
	 * 
	 * This class is instantiated by [stores](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Store.html) and [records](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html) and should
	 * not need to be instantiated in user code.
	 */
	class Read extends Ext.data.operation.Operation {
		 ...
		 * @returns {Ext.data.operation.Read|Ext.data.operation.Operation|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.data.operation.Read;
		static addInheritableStatics? (members: object): typeof Ext.data.operation.Operation;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		...
		getError? (): string | object;
		/** 
		 * Returns the value of [filters](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Read.html#cfg-filters).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [grouper](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Read.html#cfg-grouper).
		 * @method
		 * @public (method)
		...
		getInitialConfig? (name?: string): object | any;
		/** 
		 * Returns the value of [limit](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Read.html#cfg-limit).
		 * @method
		 * @public (method)
		 * @returns {number}  
		 */
		getLimit? (): number;
		/** 
		 * Returns the value of [page](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Read.html#cfg-page).
		 * @method
		 * @public (method)
		 * @returns {number}  
		 */
		...
		getScope? (): object;
		/** 
		 * Returns the value of [sorters](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Read.html#cfg-sorters).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [start](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Read.html#cfg-start).
		 * @method
		 * @public (method)
		 * @returns {number}  
		 */
		...
		setException? (error?: string | object): void;
		/** 
		 * Sets the value of [filters](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Read.html#cfg-filters).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [grouper](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Read.html#cfg-grouper).
		 * @method
		 * @public (method)
		...
		setId? (id: object): void;
		/** 
		 * Sets the value of [limit](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Read.html#cfg-limit).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [page](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Read.html#cfg-page).
		 * @method
		 * @public (method)
		...
		setScope? (scope: object): void;
		/** 
		 * Sets the value of [sorters](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Read.html#cfg-sorters).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [start](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Read.html#cfg-start).
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.data.operation.Update](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Update.html)
	 * Enacpsulates a update operation as performed by a [proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Proxy.html).
	 * 
	 * This class is instantiated by [stores](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Store.html) and [records](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html) and should
	 * not need to be instantiated in user code.
	 */
	class Update extends Ext.data.operation.Operation {
		 ...
		 * @returns {Ext.data.operation.Update|Ext.data.operation.Operation|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.data.operation.Update;
		static addInheritableStatics? (members: object): typeof Ext.data.operation.Operation;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		...
		getProxy? (): Ext.data.proxy.Proxy;
		/** 
		 * Returns the value of [recordCreator](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Update.html#cfg-recordCreator).
		 * @method
		 * @public (method)
		 * @returns {object|Function}  
		 */
		...
		setProxy? (proxy: Ext.data.proxy.Proxy): void;
		/** 
		 * Sets the value of [recordCreator](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Update.html#cfg-recordCreator).
		 * @method
		 * @public (method)
		 * @param   {object} recordCreator The new value.
		 * @returns {void}                 
...
declare namespace Ext.data.operation.Create {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.data.operation.Create|Ext.data.operation.Operation|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.data.operation.Create;
		addInheritableStatics? (members: object): typeof Ext.data.operation.Operation;
...
declare namespace Ext.data.operation.Destroy {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.data.operation.Destroy|Ext.data.operation.Operation|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.data.operation.Destroy;
		addInheritableStatics? (members: object): typeof Ext.data.operation.Operation;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.data.operation.Read {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.data.operation.Read|Ext.data.operation.Operation|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.data.operation.Read;
		addInheritableStatics? (members: object): typeof Ext.data.operation.Operation;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.data.operation.Update {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.data.operation.Update|Ext.data.operation.Operation|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.data.operation.Update;
		addInheritableStatics? (members: object): typeof Ext.data.operation.Operation;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.data.operation.Create {
	...
	interface Cfg extends Ext.base.Configs {
		...
		id?: object;
		/** 
		 * A callback to run before the [callback](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-callback).
		 * @configuration
		 * @optional
		 */
		internalCallback?: ExtGlobalFunction;
		/** 
		 * Scope to run the [internalCallback](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-internalCallback)
		 * @configuration
		 * @optional
		 * @type {object}
		 */
		...
		/** 
		 * Passed to the reader, see [Ext.data.reader.Reader.read](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-read)
		 * @configuration
		 * @optional
		 */
		 ...
		 * `null` until data is returned from the [Ext.data.proxy.Proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Proxy.html).
		 * @configuration
		 * @optional
		 * @type {Ext.data.Model[]}
		 */
		...
		/** 
		 * Scope for the [callback](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.operation.Operation.html#cfg-callback) function.
		 * @configuration
		 * @optional
		 * @type {object}
		 */
		 ...
		 * [Batch](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Batch.html) to see if a series of Operations can be executed in parallel or not.
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}

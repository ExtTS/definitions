...
declare namespace Ext.data.request {
	/** 
	 * [Ext.data.request.Ajax](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.request.Ajax.html)
	 * This class manages a pending Ajax request. Instances of this type are created by the
	 * [`Ext.data.Connection.request`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Connection.html#method-request) method.
	 */
	class Ajax extends Ext.data.request.Base {
		 ...
		 * @returns {Ext.data.request.Ajax|Ext.data.request.Base|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.data.request.Ajax;
		static addInheritableStatics? (members: object): typeof Ext.data.request.Base;
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.request.Base.abort](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.request.Base.html#method-abort).
		 * @method
		 * @private (method)
		 * @returns {void}  
		 */
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.request.Base.start](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.request.Base.html#method-start).
		 * Start the request.
		 * @method
		 * @public (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.data.request.Base](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.request.Base.html)
	 * This class manages a pending Ajax request. Instances of this type are created by the
	 * [`Ext.data.Connection.request`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Connection.html#method-request) method.
	 */
	...
	/** 
	 * [Ext.data.request.Form](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.request.Form.html)
	...
	class Form extends Ext.data.request.Base {
		 ...
		 * @returns {Ext.data.request.Form|Ext.data.request.Base|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.data.request.Form;
		static addInheritableStatics? (members: object): typeof Ext.data.request.Base;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.data.session {
	/** 
	 * [Ext.data.session.BatchVisitor](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.session.BatchVisitor.html)
	 * This class is used internally by [`Ext.data.Session.getSaveBatch`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Session.html#method-getSaveBatch) and is
	 * not intended for direct use. It can be studied as an example of implementing a visitor
	 * to pass to [`Ext.data.Session.visitData`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Session.html#method-visitData).
	 */
	class BatchVisitor extends Ext.Base {
		 ...
		 * @returns {Ext.data.session.BatchVisitor|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.data.session.BatchVisitor;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
	...
	/** 
	 * [Ext.data.session.ChangesVisitor](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.session.ChangesVisitor.html)
	 * This class is used internally by [`Ext.data.Session.getChanges`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Session.html#method-getChanges) to build
	 * up an object describing changes in the session. It is not intended for public use but
	 * can be used as an example of the visitor [`Ext.data.Session.visitData`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Session.html#method-visitData)
	 * requires.
	 */
	class ChangesVisitor extends Ext.Base {
		 ...
		 * @returns {Ext.data.session.ChangesVisitor|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.data.session.ChangesVisitor;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
	...
	/** 
	 * [Ext.data.session.ChildChangesVisitor](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.session.ChildChangesVisitor.html)
	...
	class ChildChangesVisitor extends Ext.data.session.ChangesVisitor {
		 ...
		 * @returns {Ext.data.session.ChildChangesVisitor|Ext.data.session.ChangesVisitor|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.data.session.ChildChangesVisitor;
		static addInheritableStatics? (members: object): typeof Ext.data.session.ChangesVisitor;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.data.flash.BinaryXhr {
	 ...
	 * [Ext.data.flash.BinaryXhr](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.flash.BinaryXhr.html)
	 * Simulates an XMLHttpRequest object's methods and properties as returned
	 * form the flash polyfill plugin. Used in submitting binary data in browsers that do
	 * not support doing so from JavaScript.
	 * NOTE: By default this will look for the flash object in the ext directory. When packaging and deploying the app, copy the <tt>ext/plugins</tt> directory and its contents to your root directory. For custom deployments where just the <tt>FlashPlugin.swf</tt> file gets copied (e.g. to <tt>/resources/FlashPlugin.swf</tt>), make sure to notify the framework of the location of the plugin before making the first attempt to post binary data, e.g. in the <tt>launch</tt> method of your app do:
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.data.flash.BinaryXhr|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.data.flash.BinaryXhr;
...
declare namespace Ext.data.matrix.Matrix {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.data.matrix.Matrix](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.matrix.Matrix.html)
	 * This class manages a many-to-many matrix for a `Session`.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * @returns {Ext.data.matrix.Matrix|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.data.matrix.Matrix;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.data.matrix.Side {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.data.matrix.Side](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.matrix.Side.html)
	 * This class manages one side of a `Matrix`.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * @returns {Ext.data.matrix.Side|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.data.matrix.Side;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.data.matrix.Slice {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.data.matrix.Slice](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.matrix.Slice.html)
	 * This class manages one side of a `Matrix`.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * @returns {Ext.data.matrix.Slice|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.data.matrix.Slice;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.data.request.Ajax {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.data.request.Ajax|Ext.data.request.Base|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.data.request.Ajax;
		addInheritableStatics? (members: object): typeof Ext.data.request.Base;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.data.request.Form {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.data.request.Form|Ext.data.request.Base|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.data.request.Form;
		addInheritableStatics? (members: object): typeof Ext.data.request.Base;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.data.session.BatchVisitor {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.data.session.BatchVisitor|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.data.session.BatchVisitor;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.data.session.ChangesVisitor {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.data.session.ChangesVisitor|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.data.session.ChangesVisitor;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.data.session.ChildChangesVisitor {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.data.session.ChildChangesVisitor|Ext.data.session.ChangesVisitor|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.data.session.ChildChangesVisitor;
		addInheritableStatics? (members: object): typeof Ext.data.session.ChangesVisitor;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method

declare namespace Ext.data.reader {
	 ...
	 * Data reader class to create an Array of [Ext.data.Model](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html) objects from an Array.
	...
	class Array extends Ext.data.reader.Json {
		...
		/** 
		 * Returns the value of [implicitIncludes](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-implicitIncludes).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [keepRawData](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-keepRawData).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [messageProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-messageProperty).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Returns the value of [metaProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-metaProperty).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Returns the value of [model](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-model).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [preserveRawData](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-preserveRawData).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [readRecordsOnFailure](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-readRecordsOnFailure).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [record](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-record).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		getRecord? (): string;
		/** 
		 * Takes a raw response object (as passed to the [read](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#method-read) method) and returns the useful data
		...
		/** 
		 * Returns the value of [rootProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-rootProperty).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [successProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Array.html#cfg-successProperty).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [totalProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Array.html#cfg-totalProperty).
		 * @method
		 * @public (method)
		 * @returns {object|string}  
		 */
		...
		/** 
		 * Returns the value of [transform](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-transform).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [typeProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-typeProperty).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Returns the value of [useSimpleAccessors](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-useSimpleAccessors).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		 ...
		 * @param   {object}             [readOptions] See [read](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#method-read) for details.
		...
		/** 
		 * Sets the value of [implicitIncludes](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-implicitIncludes).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [keepRawData](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-keepRawData).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [messageProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-messageProperty).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [metaProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-metaProperty).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [model](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-model).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [preserveRawData](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-preserveRawData).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [readRecordsOnFailure](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-readRecordsOnFailure).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [record](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-record).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [rootProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-rootProperty).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [successProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Array.html#cfg-successProperty).
		 * @method
		 * @public (method)
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.reader.Reader.setSuccessProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-setSuccessProperty).
		 * Sets the value of [successProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-successProperty).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [totalProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Array.html#cfg-totalProperty).
		 * @method
		 * @public (method)
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.reader.Reader.setTotalProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-setTotalProperty).
		 * Sets the value of [totalProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-totalProperty).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [transform](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-transform).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [typeProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-typeProperty).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [useSimpleAccessors](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-useSimpleAccessors).
		 * @method
		 * @public (method)
		 ...
		 * See [XmlReader](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html) for an example.
		 * @method
		 * @protected (method)
		 * @template
		 ...
		 * - 'values[0]'
		 * 
		 * This is used by [buildExtractors](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#method-buildExtractors) to create optimized extractor functions for properties that are looked
		 * up directly on the source object (e.g. [successProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-successProperty), [messageProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-messageProperty), etc.).
		 * @method
		 * @private (method)
		 * @returns {void}  
		 */
		 ...
		 * - 'values[0]'
		 * 
		 * This is used by [buildExtractors](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Array.html#method-buildExtractors) to create optimized extractor expressions when converting raw
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.reader.Reader.createFieldAccessor](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-createFieldAccessor).
		 * @method
		 * @private (method)
		 * @returns {void}  
		 */
		...
		/** 
		 * We're just preparing the data for the superclass by pulling out the record objects we want. If a [record](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-record)
		...
		/** 
		 * Returns the value of [proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-proxy).
		 * @method
		 * @private (method)
		 ...
		 * @param   {object}         readOptions See [read](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-read).
		 * @returns {void}                       
		 */
		...
		/** 
		 * Sets the value of [proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-proxy).
		 * @method
		 * @private (method)
	 ...
	 *    });
	 * 
	 * The example above creates a 'User' model. Models are explained in the [Model](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html) docs if you're
	 * not already familiar with them.
	 * 
	 * We created the simplest type of JSON Reader possible by simply telling our [Store](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Store.html)'s
	 * [Proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Proxy.html) that we want a JSON Reader. The Store automatically passes the configured model to the
	 ...
	 * [rootProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-rootProperty) configuration to parse data that comes back like this:
	 * 
	 *    {
	 *        "users": [
	 *           {
	 ...
	 *    }
	 * 
	 * To parse this we just pass in a [rootProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-rootProperty) configuration that matches the 'users' above:
	 * 
	 *    reader: {
	 *        type: 'json',
	 *        rootProperty: 'users'
	 ...
	 * JSON above we need to specify the [record](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-record) configuration like this:
	 * 
	 *    reader: {
	 *        type  : 'json',
	 *        rootProperty  : 'users',
	 ...
	 * 
	 * - [rootProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-rootProperty): the property name of the root response node containing the record data
	 * - [totalProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-totalProperty): property name for the total number of records in the data
	 * - [successProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-successProperty): property name for the success status of the response
	 * - [messageProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#cfg-messageProperty): property name for an optional response message
	 * - [fields](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html#cfg-fields): Config used to reconfigure the Model's fields before converting the
	 ...
	 * but will be accessible via the Reader's [metaData](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#property-metaData) property (which is also passed to listeners via the Proxy's
	 * [metachange](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Proxy.html#event-metachange) event (also relayed by the store). Application code can then
	 ...
	 * could simply pass a standard grid [column](https://docs.sencha.com/extjs/6.0.1/classic/Ext.panel.Table.html#cfg-columns) config object as part of the `metaData` attribute
	...
	class Json extends Ext.data.reader.Reader {
		...
		getRootProperty? (): ExtGlobalFunction | string;
		/** 
		 * Returns the value of [successProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-successProperty).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		getSuccessProperty? (): string;
		/** 
		 * Returns the value of [totalProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-totalProperty).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		 ...
		 * - 'values[0]'
		 * 
		 * This is used by [buildExtractors](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#method-buildExtractors) to create optimized extractor expressions when converting raw
		 * data into model instances. This method is used at the field level to dynamically map values to model fields.
		 * @method
		 * @private (method)
		 * @param   {object} field
	...
	/** 
	 * [Ext.data.reader.Reader](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html)
	 * Readers are used to interpret data to be loaded into a [Model](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html) instance or a [Store](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Store.html) - often in response to an AJAX request. In general there is usually no need to create
	 * a Reader instance directly, since a Reader is almost always used together with a [Proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Proxy.html),
	 * and is configured using the Proxy's [reader](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Proxy.html#cfg-reader) configuration property:
	 * 
	 ...
	 * # Loading Nested Data
	 * 
	 * Readers have the ability to automatically load deeply-nested data objects based on the [associations](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Association.html)
	...
	class Reader extends Ext.Base {
		 ...
		 * Reader config options like [totalProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-totalProperty), etc. that get
		 ...
		 * [metachange](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Proxy.html#event-metachange) event which passes this exact same meta
		...
		/** 
		 * The raw data object that was last passed to [readRecords](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-readRecords). rawData is populated
		 * based on the results of [Ext.data.proxy.Server.processResponse](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Server.html#method-processResponse). rawData will
		 ...
		 * 
		 * Since Ext JS 5.1.1 you can use the [keepRawData](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-keepRawData) config option to
		...
		getReadRecordsOnFailure? (): boolean;
		/** 
		 * Takes a raw response object (as passed to the [read](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-read) method) and returns the useful data
		 * segment from it. This must be implemented by each subclass.
		 * @method
		 * @public (method)
		 ...
		 * If it's an XMLHttpRequest object, hand off to the subclass' [getResponseData](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-getResponseData) method.
		 * Else, hand off the reading of records to the [readRecords](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-readRecords) method.
		 * @method
		 * @public (method)
		 ...
		 * before running its own logic and returning the [Ext.data.ResultSet](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.ResultSet.html) instance. For most Readers additional
		 * processing should not be needed.
		 * @method
		 * @public (method)
		 * @param   {object}             data          The raw data object
		 * @param   {object}             [readOptions] See [read](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-read) for details.
	 ...
	 *    });
	 * 
	 * The example above creates a 'User' model. Models are explained in the [Model](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html) docs if you're not
	 * already familiar with them.
	 * 
	 * We created the simplest type of XML Reader possible by simply telling our [Store](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Store.html)'s [Proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Proxy.html) that we want a XML Reader. The Store automatically passes the configured model to the
	 * Store, so it is as if we passed this instead:
	 * 
	 *    reader: {
	 *        type : 'xml',
	 ...
	 *    &lt;/users&gt;
	 * 
	 * First off there's [rootProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#cfg-rootProperty) option to define the root node `&lt;users&gt;` (there should be only one in a well-formed
	 * XML document). Then the XML Reader uses the configured [record](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#cfg-record) option to pull out the data for each record -
	 * in this case we set record to 'user', so each `&lt;user&gt;` above will be converted into a User model.
	 * 
	 * Note that XmlReader doesn't care whether your [rootProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#cfg-rootProperty) and [record](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#cfg-record) elements are nested deep inside a
	 ...
	 *    &lt;/deeply&gt;
	 * 
	 * If this Reader is being used by a [TreeStore](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.TreeStore.html) to read tree-structured data in which records
	 * are nested as descendant nodes of other records, then this lenient behaviour must be overridden by using a more specific
	 * child node selector as your [record](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#cfg-record) selector which will not select all descendants, such as:
	 * 
	 *    record: '>user'
	 * 
	 * # Response metadata
	 * 
	 * The server can return additional data in its response, such as the [total number of records](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#cfg-totalProperty) and
	 * the [success status of the response](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#cfg-successProperty). These are typically included in the XML response like
	 * this:
	 * 
	 *    &lt;?xml version="1.0" encoding="UTF-8"?&gt;
	 *    &lt;users&gt;
	...
	class Xml extends Ext.data.reader.Reader {
		/** 
		 * Copy of [rawData](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#property-rawData).
		 * @property
		 * @public (property)
		 * @deprecated Since version 5.1.1.
		 *             Removed in Ext JS 5.0. Use [rawData](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#property-rawData) instead.
		 * @type {object}
		 */
		xmlData?: object;
		/** 
		...
		getModel? (): string | Ext.data.Model;
		/** 
		 * Returns the value of [namespace](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#cfg-namespace).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		getReadRecordsOnFailure? (): boolean;
		/** 
		 * Returns the value of [record](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#cfg-record).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		getRecord? (): string;
		/** 
		 * Takes a raw response object (as passed to the [read](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#method-read) method) and returns the useful data
		 * segment from it. This must be implemented by each subclass.
		 * @method
		 * @public (method)
		 * @param   {object} response
		...
		setModel? (model: string | Ext.data.Model): void;
		/** 
		 * Sets the value of [namespace](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#cfg-namespace).
		 * @method
		 * @public (method)
		...
		setReadRecordsOnFailure? (readRecordsOnFailure: boolean): void;
		/** 
		 * Sets the value of [record](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#cfg-record).
		 * @method
		 * @public (method)
		 * @param   {string} record The new value.
		 * @returns {void}          
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.reader.Reader.createAccessor](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-createAccessor).
		 * @method
		 * @private (method)
...
declare namespace Ext.data.reader.Array.methodParams.addListener {
	 ...
	 * [Ext.data.reader.Array.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Array.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.data.reader.Array.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.data.reader.Array.on](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Array.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.data.reader.Array.methodParams.read {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.data.reader.Array.read](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Array.html#method-read)
...
declare namespace Ext.data.reader.Json.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.data.reader.Json.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.data.reader.Json.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.data.reader.Json.on](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.data.reader.Json.methodParams.read {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.data.reader.Json.read](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#method-read)
	 * Various options that instruct the reader on how to read the data
	 */
	interface ReadOptions extends Ext.base.Params {
		/** 
...
declare namespace Ext.data.reader.Reader.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.data.reader.Reader.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.data.reader.Reader.methodParams.extractData {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.data.reader.Reader.extractData](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-extractData)
...
declare namespace Ext.data.reader.Reader.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.data.reader.Reader.on](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.data.reader.Reader.methodParams.read {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.data.reader.Reader.read](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-read)
	 * Various options that instruct the reader on how to read the data
	 */
	interface ReadOptions extends Ext.base.Params {
		/** 
...
declare namespace Ext.data.reader.Xml.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.data.reader.Xml.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.data.reader.Xml.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.data.reader.Xml.on](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.data.reader.Xml.methodParams.read {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.data.reader.Xml.read](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#method-read)
	 * Various options that instruct the reader on how to read the data
	 */
	interface ReadOptions extends Ext.base.Params {
		/** 
...
declare namespace Ext.data.reader.Array {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * [Ext.data.reader.Reader](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html) intro docs for full explanation.
		 * @configuration
		 * @optional
		 * @default true
		 * @type {boolean}
		 ...
		 * received from the server in the [rawData](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#property-rawData) property.
		 * 
		 ...
		 * it is recommended to use [transform](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-transform) function for that purpose.
		 * 
		 ...
		 *    }
		 * 
		 * You can retrieve this error message in a callback when loading a [Store](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Store.html) or [Model](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html) like:
		 * 
		 ...
		 *    });
		 * 
		 * In this example, the callback will execute with `success` being `false` and will therefore show the [Ext.Msg.alert](https://docs.sencha.com/extjs/6.0.1/classic/Ext.MessageBox.html#method-alert) with
		...
		/** 
		 * Name of the property from which to retrieve the `metaData` attribute. See [metaData](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#property-metaData).
		 * @configuration
		 * @optional
		 * @default 'metaData'
		 * @type {string}
		...
		/** 
		 * True to extract the records from a data packet even if the [successProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#cfg-successProperty) returns false.
		 * @configuration
		 * @optional
		 * @default true
		 * @type {boolean}
		 ...
		 * [Ext.data.proxy.Server](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Server.html).[exception](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Server.html#event-exception) for additional information.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		...
		/** 
		 * If a transform function is set, it will be invoked just before [readRecords](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Reader.html#method-readRecords) executes.
...
declare namespace Ext.data.reader.Json {
	...
	interface Cfg extends Ext.base.Configs {
		...
		model?: string | Ext.data.Model;
		/** 
		 * The reader will keep a copy of the most recent request in the [rawData](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Json.html#property-rawData) property. For performance reasons,
...
declare namespace Ext.data.reader.Xml {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * below the [rootProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.reader.Xml.html#cfg-rootProperty)
		 * 
		 * If this Reader is being used by a [TreeStore](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.TreeStore.html) to read tree-structured data,

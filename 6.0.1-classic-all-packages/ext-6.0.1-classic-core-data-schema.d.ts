declare namespace Ext.data.schema {
	/** 
	 * [Ext.data.schema.Association](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Association.html)
	 * This class and its derivatives describe how two entities are related to each other.
	 * Associations have the following forms:
	 * 
	 * - _[many-to-one](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.ManyToOne.html)_
	 * - _[many-to-many](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.ManyToMany.html)_
	 * - _[one-to-one](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.OneToOne.html)_
	 * 
	 * Associations are first-class objects in a [`schema`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html) but
	 * are not created directly. They are created based on [Ext.data.field.Field.reference](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.field.Field.html#cfg-reference)
	 * properties but also on [Ext.data.schema.ManyToMany](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.ManyToMany.html) declarations.
	 * 
	 * Associations have unique names within the `schema` as do [entities](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html).
	 ...
	 * replaced by implementing a custom [`Ext.data.schema.Schema`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html) class.
	 * 
	 * # Life Cycle
	 * 
	 ...
	 * deleted. This is the case in a [many-to-many](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.ManyToMany.html)
	 ...
	 * other "right".
	 * 
	 * The reason for this choice derives from [many-to-many](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.ManyToMany.html)
	 ...
	 * entity that contains the [Ext.data.Field.reference](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.field.Field.html#cfg-reference) (or foreign key).
	 * 
	 * # Example
	 * 
	 ...
	 * To summarize:
	 * 
	 * - Users are _[many-to-one](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.ManyToOne.html)_ to Organizations
	 * - Users are _[many-to-one](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.ManyToOne.html)_ to Levels
	 * - Users are _[many-to-many](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.ManyToMany.html)_ to Groups
	 */
	...
	/** 
	 * [Ext.data.schema.ManyToMany](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.ManyToMany.html)
	...
	/** 
	 * [Ext.data.schema.ManyToOne](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.ManyToOne.html)
	 ...
	 * known as "Primary Key" or, more specifically, as the [Ext.data.Model.idProperty](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html#cfg-idProperty)
	 * field) of the related entity. These fields have a [Ext.data.field.Field.reference](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.field.Field.html#cfg-reference)
	...
	/** 
	 * [Ext.data.schema.Namer](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Namer.html)
	...
	/** 
	 * [Ext.data.schema.OneToOne](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.OneToOne.html)
	 * This type of association is similar to [many-to-one](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.ManyToOne.html),
	 * except that the [reference](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.field.Field.html#cfg-reference) field also has set
	 * [unique](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.field.Field.html#cfg-unique) to `true`.
	 * 
	...
	/** 
	 * [Ext.data.schema.Schema](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html)
	 * A Schema is a collection of related [entities](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html) and their respective
	 * [associations](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Association.html).
	 * 
	 * # Schema Instances
	 * 
	 * By default a single instance of this class is created which serves as the schema for all
	 * entities that do not have an explicit [`schema`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html#cfg-schema) config
	 * either specified or inherited. This is sufficient in most cases.
	 * 
	 * When an entity does specify a [`schema`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html#cfg-schema), however, that
	 ...
	 * all of your entities and use the [`schema`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html#cfg-schema) config like
	 * this:
	 * 
	 ...
	 *     });
	 * 
	 * For details see the documentation for [Namer](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Namer.html).
	 */
	class Schema extends Ext.Base {
		/** 
		 * The number of [associations](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Association.html)
		 * in this `schema`.
		 * @property
		 * @public (property)
		 * @readonly
		...
		/** 
		 * The number of [entities](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html) in this
		 * `schema`.
		 * @property
		 * @public (property)
		 * @readonly
		...
		getConfig? (name?: string, peek?: boolean): object;
		/** 
		 * Returns the value of [defaultIdentifier](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html#cfg-defaultIdentifier).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Get the entity name taking into account the [namespace](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html#cfg-namespace).
		 * @method
		 * @public (method)
		...
		getInitialConfig? (name?: string): object | any;
		/** 
		 * Returns the value of [namer](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html#cfg-namer).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [namespace](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html#cfg-namespace).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		getNamespace? (): string;
		/** 
		 * Returns the value of [proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html#cfg-proxy).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [urlPrefix](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html#cfg-urlPrefix).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Sets the value of [defaultIdentifier](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html#cfg-defaultIdentifier).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [namer](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html#cfg-namer).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [namespace](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html#cfg-namespace).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [proxy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html#cfg-proxy).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [urlPrefix](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html#cfg-urlPrefix).
		 * @method
		 * @public (method)
		...
		/** 
		 * Adds an entry from a [matrix config](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.ManyToMany.html) declared by an
		 * entity.
		 * 
		 ...
		 * @method
		 * @protected (method)
		 * @param   {Ext.Class}                                                  entityType A class derived from [`Ext.data.Model`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html).
		...
		/** 
		 * Adds a [reference](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.field.Field.html#cfg-reference) field association for an entity
		 * to this `schema`.
		 * 
		 * This is the ideal method to override in a derived class if the standard, default
		 * naming conventions need to be adjusted. In the override, apply whatever logic is
		 ...
		 * [entityName](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html#property-entityName) of the `entityType`
		 * ([singularized](https://docs.sencha.com/extjs/6.0.1/classic/Ext.util.Inflector.html#method-singularize) or
		 * [pluralized](https://docs.sencha.com/extjs/6.0.1/classic/Ext.util.Inflector.html#method-pluralize) based on `referenceField.unique`).
		 * @param   {string}               type
		 * The [entityName](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html#property-entityName) of the target
		 * of the reference.
		 * @param   {object}               [descr]
...
declare namespace Ext.data.schema.Role {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.data.schema.Role](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Role.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
...
declare namespace Ext.data.schema.Schema.methodParams.addMatrix {
	 ...
	 * [Ext.data.schema.Schema.addMatrix](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html#method-addMatrix)
	...
	interface Left extends Ext.base.Params {
		 ...
		 * [singularized](https://docs.sencha.com/extjs/6.0.1/classic/Ext.util.Inflector.html#method-singularize) and uncapitalized followed by
		 ...
		 * [pluralized](https://docs.sencha.com/extjs/6.0.1/classic/Ext.util.Inflector.html#method-pluralize) and uncapitalized. For example,
...
declare namespace Ext.data.schema.Schema.staticMethodParams.get {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.data.schema.Schema.get](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html#static-method-get)
	...
	interface Config extends Ext.base.Params {
		 ...
		 * match the "alias" of some class derived from [`Ext.data.schema.Schema`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.schema.Schema.html).
		 * @configuration
		 * @optional
		 * @type {string}
		 */
...
declare namespace Ext.data.schema.Schema {
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * This config is used to initialize the [`Ext.data.Model.identifier`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html#cfg-identifier) config
		...
		namespace?: string;
		/** 
		 * This is a template used to produce [`Ext.data.proxy.Proxy`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.proxy.Proxy.html) configurations for
		 * Models that do not define an explicit [`proxy`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html#cfg-proxy).
		 * 
		 ...
		 * - `entityName` - The [name](https://docs.sencha.com/extjs/6.0.1/classic/Ext.data.Model.html#property-entityName) of the Model
		 *   (for example, "User").

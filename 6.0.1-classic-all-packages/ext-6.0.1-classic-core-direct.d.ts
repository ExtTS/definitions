declare namespace Ext.direct {
	/** 
	 * [Ext.direct.Event](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Event.html)
	...
	class Event extends Ext.Base {
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.direct.Event.Statics}
		 */
		self?: Ext.direct.Event.Statics | Ext.Base.Statics;
		/** 
		 * @property
		 * @private (property)
		 * @default true
		 ...
		 * @returns {Ext.direct.Event|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Event;
		 ...
		 * @returns {Ext.direct.Event|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.direct.Event;
		 ...
		 * @returns {Ext.direct.Event|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.direct.Event;
		 ...
		 * @returns {Ext.direct.Event|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.direct.Event;
		 ...
		 * @returns {Ext.direct.Event|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.direct.Event;
		 ...
		 * @method
		 * @public (method)
		 * @returns {any}  The data from the event
		 */
		getData? (): any;
		/** 
		 ...
		 * @returns {Ext.direct.Event|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.direct.Event;
		 ...
		 * @returns {Ext.direct.Event|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.direct.Event;
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.direct.Event.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.direct.Event.Statics;
		 ...
		 * @returns {Ext.direct.Event|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.direct.Event;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * [Ext.direct.ExceptionEvent](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.ExceptionEvent.html)
	 * An event that is fired when an exception is received from a [Ext.direct.RemotingProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingProvider.html)
	 */
	class ExceptionEvent extends Ext.direct.RemotingEvent {
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.direct.ExceptionEvent.Statics}
		 */
		self?: Ext.direct.ExceptionEvent.Statics | Ext.direct.RemotingEvent.Statics | Ext.direct.Event.Statics | Ext.Base.Statics;
		/** 
		 * @property
		 * @private (property)
		 * @default false
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.direct.ExceptionEvent|Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.ExceptionEvent;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.RemotingEvent;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Event;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                                                       members
		 * @returns {Ext.direct.ExceptionEvent|Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.direct.ExceptionEvent;
		static addStatics? (members: object): typeof Ext.direct.RemotingEvent;
		static addStatics? (members: object): typeof Ext.direct.Event;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.direct.ExceptionEvent|Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.direct.ExceptionEvent;
		static addInheritableStatics? (members: object): typeof Ext.direct.RemotingEvent;
		static addInheritableStatics? (members: object): typeof Ext.direct.Event;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 ...
		 * @returns {Ext.direct.ExceptionEvent|Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.direct.ExceptionEvent;
		static addMember? (name: object, member: object): typeof Ext.direct.RemotingEvent;
		static addMember? (name: object, member: object): typeof Ext.direct.Event;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.direct.ExceptionEvent|Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.direct.ExceptionEvent;
		static onExtended? (fn: object, scope: object): typeof Ext.direct.RemotingEvent;
		static onExtended? (fn: object, scope: object): typeof Ext.direct.Event;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 ...
		 * @returns {Ext.direct.ExceptionEvent|Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.direct.ExceptionEvent;
		setConfig? (name: string | object, value?: object): Ext.direct.RemotingEvent;
		setConfig? (name: string | object, value?: object): Ext.direct.Event;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Call the original method that was previously overridden with [override](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Base.html#static-method-override)
		 ...
		 * @returns {Ext.direct.ExceptionEvent|Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.direct.ExceptionEvent;
		initConfig? (config: object): Ext.direct.RemotingEvent;
		initConfig? (config: object): Ext.direct.Event;
		initConfig? (config: object): Ext.Base;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Base.html#property-self),
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.direct.ExceptionEvent.Statics|Ext.direct.RemotingEvent.Statics|Ext.direct.Event.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.direct.ExceptionEvent.Statics;
		statics? (): Ext.direct.RemotingEvent.Statics;
		statics? (): Ext.direct.Event.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 * This method applies a versioned, deprecation declaration to this class. This
		 ...
		 * @returns {Ext.direct.ExceptionEvent|Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.direct.ExceptionEvent;
		unlink? (names: string[]): Ext.direct.RemotingEvent;
		unlink? (names: string[]): Ext.direct.Event;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * [Ext.direct.JsonProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.JsonProvider.html)
	...
	class JsonProvider extends Ext.direct.Provider {
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.direct.JsonProvider.Statics}
		 */
		self?: Ext.direct.JsonProvider.Statics | Ext.direct.Provider.Statics | Ext.Base.Statics;
		/** 
		 * Add methods / properties to the prototype of this class.
		 * 
		 *    Ext.define('My.awesome.Cat', {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.JsonProvider;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Provider;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @chainable
		 * @param   {object}                                               members
		 * @returns {Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.direct.JsonProvider;
		static addStatics? (members: object): typeof Ext.direct.Provider;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 ...
		 */
		static checkConfig? (config: object): boolean;
		/** 
		 * Create a new instance of this Class.
		 * 
		 *    Ext.define('My.cool.Class', {
		 ...
		 * @returns {Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.direct.JsonProvider;
		static addInheritableStatics? (members: object): typeof Ext.direct.Provider;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.direct.JsonProvider;
		static addMember? (name: object, member: object): typeof Ext.direct.Provider;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.direct.JsonProvider;
		static onExtended? (fn: object, scope: object): typeof Ext.direct.Provider;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.direct.Event[]}          An array of [Ext.direct.Event](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Event.html)
		 */
		 ...
		 * @returns {Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.direct.JsonProvider;
		setConfig? (name: string | object, value?: object): Ext.direct.Provider;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.direct.JsonProvider;
		initConfig? (config: object): Ext.direct.Provider;
		initConfig? (config: object): Ext.Base;
		/** 
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.direct.JsonProvider.Statics|Ext.direct.Provider.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.direct.JsonProvider.Statics;
		statics? (): Ext.direct.Provider.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 ...
		 * @returns {object}          The data in the response.
		 */
		 ...
		 * @returns {Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.direct.JsonProvider;
		unlink? (names: string[]): Ext.direct.Provider;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * [Ext.direct.Manager](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html)
	 ...
	 * 
	 * - [JsonProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.JsonProvider.html) for simple JSON operations
	 * - [PollingProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.PollingProvider.html) for repeated requests
	 * - [RemotingProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingProvider.html) exposes server side to the client.
	 * 
	 * A provider does not need to be invoked directly, providers are added via
	 * [#addProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html). RemotingProviders' API declarations
	 * can also be loaded with [#loadProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html), with
	...
	interface Manager extends Ext.Base {
		 ...
		 * @property
		 * @public (property)
		 * @default {TRANSPORT: 'xhr', PARSE: 'parse', DATA: 'data', LOGIN: 'login', SERVER: 'exception'}
		 * @type {object}
		 */
		exceptions?: object;
		/** 
		 ...
		 * The scope (`this` reference) in which the handler function is
		 * executed. **If omitted, defaults to the object which fired the event.**
		 * @param   {object|Ext.direct.Manager.methodParams.addListener.Options} [options]
		 ...
		 * 
		 */
		addListener? (eventName: string | object, fn?: ExtGlobalFunction | string, scope?: object, options?: object | Ext.direct.Manager.methodParams.addListener.Options, order?: string): object;
		/** 
		 * The addManagedListener method is used when some object (call it "A") is listening
		 * to an event on another observable object ("B") and you want to remove that listener
		 * from "B" when "A" is destroyed. This is not an issue when "B" is destroyed because
		 ...
		 * @returns {void}                         
		 */
		addProvider? (provider: Ext.direct.Provider): void;
		/** 
		 * Adds an Ext Direct Provider and creates the proxy or stub methods to execute
		 * server-side methods for RemotingProviders. If the provider is not already connected,
		 * it will auto-connect.
		...
		fireEventedAction? (eventName: string, args: any[], fn: ExtGlobalFunction | string, scope?: object, fnArgs?: any[] | boolean): void;
		/** 
		 * Retrieves a [provider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Provider.html) by the id specified when the
		 * provider is added.
		 * @method
		 * @public (method)
		 ...
		 * @returns {void}                          
		 */
		getProvider? (id: string | Ext.direct.Provider): void;
		/** 
		 * Returns the value of [varName](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html#cfg-varName).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		 ...
		 * [addProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html#method-addProvider).
		 * 
		 ...
		 * @method
		 * @public (method)
		 * @param   {object|Ext.direct.Manager.methodParams.loadProvider.Config} config     Remoting API configuration.
		 * @param   {Function}                                                   [callback]
		 * Optional callback to execute when
		 * Provider is created, or when an error has occured.
		 * @param   {object}                                                     [scope]
		 * Optional scope to execute callback function in.
		 * 
		 * For additional information see the [Ext Direct specification][1].
		 * @returns {void}                                                                  
		 */
		loadProvider? (config: object | Ext.direct.Manager.methodParams.loadProvider.Config, callback?: ExtGlobalFunction, scope?: object): void;
		/** 
		 * Shorthand for [addManagedListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.mixin.Observable.html#method-addManagedListener).
		 * @method
		 * @public (method)
		 ...
		 * The scope (`this` reference) in which the handler function is
		 * executed. **If omitted, defaults to the object which fired the event.**
		 * @param   {object|Ext.direct.Manager.methodParams.on.Options} [options]
		 * An object containing handler configuration.
		 * 
		 * **Note:** The options object will also be passed as the last argument to every
		 * event handler.
		 ...
		 * 
		 */
		on? (eventName: string | object, fn?: ExtGlobalFunction | string, scope?: object, options?: object | Ext.direct.Manager.methodParams.on.Options, order?: string): object;
		/** 
		 * Appends an after-event handler.
		 * 
		 * Same as [addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.util.Observable.html#method-addListener) with `order` set
		 ...
		 * @method
		 * @public (method)
		 * @param   {Function|string} fn The direct function
		 * @returns {Function}           The function to use in the direct call. Null if not found
		 */
		parseMethod? (fn: ExtGlobalFunction | string): ExtGlobalFunction;
		/** 
		 * Relays selected events from the specified Observable as if the events were fired by `this`.
		 * 
		 * For example if you are extending Grid, you might decide to forward some events from store.
		 ...
		 */
		removeProvider? (provider: string | Ext.direct.Provider): Ext.direct.Provider;
		/** 
		 * Resumes firing of the named event(s).
		 * 
		 * After calling this method to resume events, the events will fire when requested to fire.
		...
		setListeners? (listeners: object): void;
		/** 
		 * Sets the value of [varName](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html#cfg-varName).
		 * @method
		 * @public (method)
		 * @param   {string} varName The new value.
		 * @returns {void}           
		 */
	...
	/** 
	 * [Ext.direct.PollingProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.PollingProvider.html)
	 * Provides for repetitive polling of the server at distinct [intervals](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.PollingProvider.html#cfg-interval).
	...
	class PollingProvider extends Ext.direct.JsonProvider {
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.direct.PollingProvider.Statics}
		 */
		self?: Ext.direct.PollingProvider.Statics | Ext.direct.JsonProvider.Statics | Ext.direct.Provider.Statics | Ext.Base.Statics;
		/** 
		 * Add methods / properties to the prototype of this class.
		 * 
		 *    Ext.define('My.awesome.Cat', {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.direct.PollingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.PollingProvider;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.JsonProvider;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Provider;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 ...
		 * @chainable
		 * @param   {object}                                                                          members
		 * @returns {Ext.direct.PollingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.direct.PollingProvider;
		static addStatics? (members: object): typeof Ext.direct.JsonProvider;
		static addStatics? (members: object): typeof Ext.direct.Provider;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 ...
		 */
		static checkConfig? (config: object): void;
		static checkConfig? (config: object): boolean;
		/** 
		 * @method
		 * @protected (method)
		 ...
		 * @returns {Ext.direct.PollingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.direct.PollingProvider;
		static addInheritableStatics? (members: object): typeof Ext.direct.JsonProvider;
		static addInheritableStatics? (members: object): typeof Ext.direct.Provider;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.PollingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.direct.PollingProvider;
		static addMember? (name: object, member: object): typeof Ext.direct.JsonProvider;
		static addMember? (name: object, member: object): typeof Ext.direct.Provider;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.PollingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.direct.PollingProvider;
		static onExtended? (fn: object, scope: object): typeof Ext.direct.JsonProvider;
		static onExtended? (fn: object, scope: object): typeof Ext.direct.Provider;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.PollingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.direct.PollingProvider;
		setConfig? (name: string | object, value?: object): Ext.direct.JsonProvider;
		setConfig? (name: string | object, value?: object): Ext.direct.Provider;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.PollingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.direct.PollingProvider;
		initConfig? (config: object): Ext.direct.JsonProvider;
		initConfig? (config: object): Ext.direct.Provider;
		initConfig? (config: object): Ext.Base;
		/** 
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.direct.PollingProvider.Statics|Ext.direct.JsonProvider.Statics|Ext.direct.Provider.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.direct.PollingProvider.Statics;
		statics? (): Ext.direct.JsonProvider.Statics;
		statics? (): Ext.direct.Provider.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 ...
		 * @returns {Ext.direct.PollingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.direct.PollingProvider;
		unlink? (names: string[]): Ext.direct.JsonProvider;
		unlink? (names: string[]): Ext.direct.Provider;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * [Ext.direct.Provider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Provider.html)
	 * [Ext.direct.Provider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Provider.html) is an abstract class meant to be extended.
	 * 
	...
	class Provider extends Ext.Base {
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.direct.Provider.Statics}
		 */
		self?: Ext.direct.Provider.Statics | Ext.Base.Statics;
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.direct.Provider|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Provider;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 ...
		 * @chainable
		 * @param   {object}                       members
		 * @returns {Ext.direct.Provider|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.direct.Provider;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 ...
		 * The scope (`this` reference) in which the handler function is
		 * executed. **If omitted, defaults to the object which fired the event.**
		 * @param   {object|Ext.direct.Provider.methodParams.addListener.Options} [options]
		 * An object containing handler configuration.
		 * 
		 * **Note:** The options object will also be passed as the last argument to every
		 * event handler.
		 ...
		 * 
		 */
		addListener? (eventName: string | object, fn?: ExtGlobalFunction | string, scope?: object, options?: object | Ext.direct.Provider.methodParams.addListener.Options, order?: string): object;
		/** 
		 * The addManagedListener method is used when some object (call it "A") is listening
		 * to an event on another observable object ("B") and you want to remove that listener
		 * from "B" when "A" is destroyed. This is not an issue when "B" is destroyed because
		 ...
		 * The scope (`this` reference) in which the handler function is
		 * executed. **If omitted, defaults to the object which fired the event.**
		 * @param   {object|Ext.direct.Provider.methodParams.on.Options} [options]
		 * An object containing handler configuration.
		 * 
		 * **Note:** The options object will also be passed as the last argument to every
		 * event handler.
		 ...
		 * 
		 */
		on? (eventName: string | object, fn?: ExtGlobalFunction | string, scope?: object, options?: object | Ext.direct.Provider.methodParams.on.Options, order?: string): object;
		/** 
		 * Appends an after-event handler.
		 * 
		 * Same as [addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.util.Observable.html#method-addListener) with `order` set
	...
	/** 
	 * [Ext.direct.RemotingEvent](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingEvent.html)
	 * An event that is fired when data is received from a
	 * [Ext.direct.RemotingProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingProvider.html). Contains a method to the
	 * related transaction for the direct request, see [getTransaction](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingEvent.html#method-getTransaction)
	 */
	class RemotingEvent extends Ext.direct.Event {
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.direct.RemotingEvent.Statics}
		 */
		self?: Ext.direct.RemotingEvent.Statics | Ext.direct.Event.Statics | Ext.Base.Statics;
		/** 
		 * Add methods / properties to the prototype of this class.
		 * 
		 *    Ext.define('My.awesome.Cat', {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.RemotingEvent;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Event;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		 ...
		 * @chainable
		 * @param   {object}                                             members
		 * @returns {Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.direct.RemotingEvent;
		static addStatics? (members: object): typeof Ext.direct.Event;
		static addStatics? (members: object): typeof Ext.Base;
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.direct.RemotingEvent.Statics|Ext.direct.Event.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.direct.RemotingEvent.Statics;
		statics? (): Ext.direct.Event.Statics;
		statics? (): Ext.Base.Statics;
	...
	/** 
	 * [Ext.direct.RemotingProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingProvider.html)
	 * The [RemotingProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingProvider.html) exposes access to
	...
	class RemotingProvider extends Ext.direct.JsonProvider {
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.direct.RemotingProvider.Statics}
		 */
		self?: Ext.direct.RemotingProvider.Statics | Ext.direct.JsonProvider.Statics | Ext.direct.Provider.Statics | Ext.Base.Statics;
		/** 
		 * Add methods / properties to the prototype of this class.
		 * 
		 *    Ext.define('My.awesome.Cat', {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.direct.RemotingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.RemotingProvider;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.JsonProvider;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Provider;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 ...
		 * @chainable
		 * @param   {object}                                                                           members
		 * @returns {Ext.direct.RemotingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.direct.RemotingProvider;
		static addStatics? (members: object): typeof Ext.direct.JsonProvider;
		static addStatics? (members: object): typeof Ext.direct.Provider;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.RemotingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.direct.RemotingProvider;
		static addInheritableStatics? (members: object): typeof Ext.direct.JsonProvider;
		static addInheritableStatics? (members: object): typeof Ext.direct.Provider;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.RemotingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.direct.RemotingProvider;
		static addMember? (name: object, member: object): typeof Ext.direct.JsonProvider;
		static addMember? (name: object, member: object): typeof Ext.direct.Provider;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.RemotingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.direct.RemotingProvider;
		static onExtended? (fn: object, scope: object): typeof Ext.direct.JsonProvider;
		static onExtended? (fn: object, scope: object): typeof Ext.direct.Provider;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.RemotingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.direct.RemotingProvider;
		setConfig? (name: string | object, value?: object): Ext.direct.JsonProvider;
		setConfig? (name: string | object, value?: object): Ext.direct.Provider;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.RemotingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.direct.RemotingProvider;
		initConfig? (config: object): Ext.direct.JsonProvider;
		initConfig? (config: object): Ext.direct.Provider;
		initConfig? (config: object): Ext.Base;
		/** 
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.direct.RemotingProvider.Statics|Ext.direct.JsonProvider.Statics|Ext.direct.Provider.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.direct.RemotingProvider.Statics;
		statics? (): Ext.direct.JsonProvider.Statics;
		statics? (): Ext.direct.Provider.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 ...
		 * @returns {Ext.direct.RemotingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.direct.RemotingProvider;
		unlink? (names: string[]): Ext.direct.JsonProvider;
		unlink? (names: string[]): Ext.direct.Provider;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * [Ext.direct.Transaction](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Transaction.html)
	...
	class Transaction extends Ext.Base {
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.direct.Transaction.Statics}
		 */
		self?: Ext.direct.Transaction.Statics | Ext.Base.Statics;
		/** 
		 * Add methods / properties to the prototype of this class.
		 * 
		 *    Ext.define('My.awesome.Cat', {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.direct.Transaction|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Transaction;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @chainable
		 * @param   {object}                          members
		 * @returns {Ext.direct.Transaction|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.direct.Transaction;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.direct.Transaction|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.direct.Transaction;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.direct.Transaction|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.direct.Transaction;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.direct.Transaction|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.direct.Transaction;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.direct.Transaction|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.direct.Transaction;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Call the original method that was previously overridden with [override](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Base.html#static-method-override)
		 * 
		 ...
		 * @returns {Ext.direct.Transaction|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.direct.Transaction;
		initConfig? (config: object): Ext.Base;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.direct.Transaction.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.direct.Transaction.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 * This method applies a versioned, deprecation declaration to this class. This
		 * is typically called by the `deprecated` config.
		 ...
		 * @returns {Ext.direct.Transaction|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.direct.Transaction;
		unlink? (names: string[]): Ext.Base;
	}
}
declare namespace Ext {
	class direct {
		 ...
		 * @singleton (instance)
		 */
		static readonly Manager?: Ext.direct.Manager;
	}
	interface Direct extends Ext.direct.Manager {}
}
declare namespace Ext.direct.Event {
	/** 
	 * @definitions
	 ...
	 * to hold a Direct response.
	 */
	interface Def extends Ext.direct.Event {
		/** 
		 ...
		 * @type {Ext.direct.Event.Statics}
		 */
		statics?: (() => Ext.direct.Event.Statics | Ext.Base.Statics) | Ext.direct.Event.Statics | any;
	}
}
declare namespace Ext.direct.ExceptionEvent {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.direct.ExceptionEvent](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.ExceptionEvent.html)
	 * An event that is fired when an exception is received from a [Ext.direct.RemotingProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingProvider.html)
	 */
	interface Def extends Ext.direct.ExceptionEvent {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @type {Ext.direct.ExceptionEvent.Statics}
		 */
		statics?: (() => Ext.direct.ExceptionEvent.Statics | Ext.direct.RemotingEvent.Statics | Ext.direct.Event.Statics | Ext.Base.Statics) | Ext.direct.ExceptionEvent.Statics | any;
	}
}
declare namespace Ext.direct.JsonProvider {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.direct.JsonProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.JsonProvider.html)
	 ...
	 * and should not be instanced directly.
	 */
	interface Def extends Ext.direct.JsonProvider {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.direct.JsonProvider.Cfg}
		 */
		config?: Ext.direct.JsonProvider.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * @type {Ext.direct.JsonProvider.Statics}
		 */
		statics?: (() => Ext.direct.JsonProvider.Statics | Ext.direct.Provider.Statics | Ext.Base.Statics) | Ext.direct.JsonProvider.Statics | any;
	}
}
declare namespace Ext.direct.PollingProvider {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.direct.PollingProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.PollingProvider.html)
	 ...
	 * 
	 */
	interface Def extends Ext.direct.PollingProvider {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.direct.PollingProvider.Cfg}
		 */
		config?: Ext.direct.PollingProvider.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * @type {Ext.direct.PollingProvider.Statics}
		 */
		statics?: (() => Ext.direct.PollingProvider.Statics | Ext.direct.JsonProvider.Statics | Ext.direct.Provider.Statics | Ext.Base.Statics) | Ext.direct.PollingProvider.Statics | any;
	}
}
declare namespace Ext.direct.Provider {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.direct.Provider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Provider.html)
	 ...
	 * 
	 */
	interface Def extends Ext.direct.Provider {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.direct.Provider.Cfg}
		 */
		config?: Ext.direct.Provider.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * @type {Ext.direct.Provider.Statics}
		 */
		statics?: (() => Ext.direct.Provider.Statics | Ext.Base.Statics) | Ext.direct.Provider.Statics | any;
	}
}
declare namespace Ext.direct.RemotingEvent {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.direct.RemotingEvent](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingEvent.html)
	 ...
	 * related transaction for the direct request, see [getTransaction](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingEvent.html#method-getTransaction)
	 */
	interface Def extends Ext.direct.RemotingEvent {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @type {Ext.direct.RemotingEvent.Statics}
		 */
		statics?: (() => Ext.direct.RemotingEvent.Statics | Ext.direct.Event.Statics | Ext.Base.Statics) | Ext.direct.RemotingEvent.Statics | any;
	}
}
declare namespace Ext.direct.RemotingProvider {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.direct.RemotingProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingProvider.html)
	 ...
	 * outputted by the server-side Ext Direct stack when the API description is built.
	 */
	interface Def extends Ext.direct.RemotingProvider {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.direct.RemotingProvider.Cfg}
		 */
		config?: Ext.direct.RemotingProvider.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * @type {Ext.direct.RemotingProvider.Statics}
		 */
		statics?: (() => Ext.direct.RemotingProvider.Statics | Ext.direct.JsonProvider.Statics | Ext.direct.Provider.Statics | Ext.Base.Statics) | Ext.direct.RemotingProvider.Statics | any;
	}
}
declare namespace Ext.direct.Transaction {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.direct.Transaction](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Transaction.html)
	 * Supporting Class for Ext Direct (not intended to be used directly).
	 */
	interface Def extends Ext.direct.Transaction {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.direct.Transaction.Cfg}
		 */
		config?: Ext.direct.Transaction.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * @type {Ext.direct.Transaction.Statics}
		 */
		statics?: (() => Ext.direct.Transaction.Statics | Ext.Base.Statics) | Ext.direct.Transaction.Statics | any;
	}
}
declare namespace Ext.direct.Event {
	/** 
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.direct.Event|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Event;
		 ...
		 * @returns {Ext.direct.Event|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.direct.Event;
		 ...
		 * @returns {Ext.direct.Event|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.direct.Event;
		 ...
		 * @returns {Ext.direct.Event|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.direct.Event;
		 ...
		 * @returns {Ext.direct.Event|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.direct.Event;
...
declare namespace Ext.direct.ExceptionEvent {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.direct.ExceptionEvent|Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.ExceptionEvent;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.RemotingEvent;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Event;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @returns {Ext.direct.ExceptionEvent|Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.direct.ExceptionEvent;
		addStatics? (members: object): typeof Ext.direct.RemotingEvent;
		addStatics? (members: object): typeof Ext.direct.Event;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.direct.ExceptionEvent|Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.direct.ExceptionEvent;
		addInheritableStatics? (members: object): typeof Ext.direct.RemotingEvent;
		addInheritableStatics? (members: object): typeof Ext.direct.Event;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 ...
		 * @returns {Ext.direct.ExceptionEvent|Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.direct.ExceptionEvent;
		addMember? (name: object, member: object): typeof Ext.direct.RemotingEvent;
		addMember? (name: object, member: object): typeof Ext.direct.Event;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.direct.ExceptionEvent|Ext.direct.RemotingEvent|Ext.direct.Event|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.direct.ExceptionEvent;
		onExtended? (fn: object, scope: object): typeof Ext.direct.RemotingEvent;
		onExtended? (fn: object, scope: object): typeof Ext.direct.Event;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.direct.JsonProvider {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.JsonProvider;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Provider;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @returns {Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.direct.JsonProvider;
		addStatics? (members: object): typeof Ext.direct.Provider;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Check if the passed configuration object contains enough
		 * information to construct a Provider.
		 ...
		 * @returns {boolean}        `true` if config is sufficient, `false` otherwise.
		 */
		checkConfig? (config: object): boolean;
		/** 
		 * Create a new instance of this Class.
		 * 
		 *    Ext.define('My.cool.Class', {
		 ...
		 * @returns {Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.direct.JsonProvider;
		addInheritableStatics? (members: object): typeof Ext.direct.Provider;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.direct.JsonProvider;
		addMember? (name: object, member: object): typeof Ext.direct.Provider;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.direct.JsonProvider;
		onExtended? (fn: object, scope: object): typeof Ext.direct.Provider;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.direct.Manager {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.direct.Manager](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html)
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.direct.Manager|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Manager;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @chainable
		 * @param   {object}                      members
		 * @returns {Ext.direct.Manager|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.direct.Manager;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.direct.Manager|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.direct.Manager;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.direct.Manager|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.direct.Manager;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.direct.Manager|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.direct.Manager;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.direct.PollingProvider {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.direct.PollingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.PollingProvider;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.JsonProvider;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Provider;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.PollingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.direct.PollingProvider;
		addStatics? (members: object): typeof Ext.direct.JsonProvider;
		addStatics? (members: object): typeof Ext.direct.Provider;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {void|boolean}        
		 */
		checkConfig? (config: object): void;
		checkConfig? (config: object): boolean;
		/** 
		 * @method
		 * @protected (method)
		 ...
		 * @returns {Ext.direct.PollingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.direct.PollingProvider;
		addInheritableStatics? (members: object): typeof Ext.direct.JsonProvider;
		addInheritableStatics? (members: object): typeof Ext.direct.Provider;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.PollingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.direct.PollingProvider;
		addMember? (name: object, member: object): typeof Ext.direct.JsonProvider;
		addMember? (name: object, member: object): typeof Ext.direct.Provider;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.PollingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.direct.PollingProvider;
		onExtended? (fn: object, scope: object): typeof Ext.direct.JsonProvider;
		onExtended? (fn: object, scope: object): typeof Ext.direct.Provider;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
...
declare namespace Ext.direct.RemotingMethod {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.direct.RemotingMethod](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingMethod.html)
	 * Small utility class used internally to represent a Direct method.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.direct.RemotingMethod|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.RemotingMethod;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @chainable
		 * @param   {object}                             members
		 * @returns {Ext.direct.RemotingMethod|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.direct.RemotingMethod;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.direct.RemotingMethod|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.direct.RemotingMethod;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.direct.RemotingMethod|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.direct.RemotingMethod;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.direct.RemotingMethod|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.direct.RemotingMethod;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.direct.RemotingProvider {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.direct.RemotingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.RemotingProvider;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.JsonProvider;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Provider;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.RemotingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.direct.RemotingProvider;
		addStatics? (members: object): typeof Ext.direct.JsonProvider;
		addStatics? (members: object): typeof Ext.direct.Provider;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.RemotingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.direct.RemotingProvider;
		addInheritableStatics? (members: object): typeof Ext.direct.JsonProvider;
		addInheritableStatics? (members: object): typeof Ext.direct.Provider;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.RemotingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.direct.RemotingProvider;
		addMember? (name: object, member: object): typeof Ext.direct.JsonProvider;
		addMember? (name: object, member: object): typeof Ext.direct.Provider;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.direct.RemotingProvider|Ext.direct.JsonProvider|Ext.direct.Provider|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.direct.RemotingProvider;
		onExtended? (fn: object, scope: object): typeof Ext.direct.JsonProvider;
		onExtended? (fn: object, scope: object): typeof Ext.direct.Provider;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
...
declare namespace Ext.direct.Transaction {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.direct.Transaction|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.direct.Transaction;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @returns {Ext.direct.Transaction|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.direct.Transaction;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.direct.Transaction|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.direct.Transaction;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.direct.Transaction|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.direct.Transaction;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.direct.Transaction|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.direct.Transaction;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.direct.JsonProvider.methodParams.addListener {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.JsonProvider.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.JsonProvider.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.JsonProvider.methodParams.on {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.JsonProvider.on](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.JsonProvider.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.Manager.methodParams.addListener {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.Manager.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.Manager.methodParams.loadProvider {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.Manager.loadProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html#method-loadProvider)
	 * Remoting API configuration.
	 */
...
declare namespace Ext.direct.Manager.methodParams.on {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.Manager.on](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.PollingProvider.methodParams.addListener {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.PollingProvider.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.PollingProvider.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.PollingProvider.methodParams.on {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.PollingProvider.on](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.PollingProvider.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.Provider.methodParams.addListener {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.Provider.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Provider.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.Provider.methodParams.on {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.Provider.on](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Provider.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.RemotingProvider.methodParams.addListener {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.RemotingProvider.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingProvider.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.RemotingProvider.methodParams.on {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.RemotingProvider.on](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingProvider.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.JsonProvider {
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * The unique id of the provider (defaults to an [auto-assigned id](https://docs.sencha.com/extjs/6.0.1/classic/Ext.html#method-id)).
		...
		listeners?: object;
		/** 
		 * List of Provider events that should be relayed by [Ext.direct.Manager](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html).
		 ...
		 * @chainable
		 * @param   {object}                          config
		 * @returns {Ext.direct.JsonProvider.Statics}        this
		 */
		initConfig? (config: object): Ext.direct.JsonProvider.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.direct.JsonProvider.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.direct.JsonProvider.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.direct.JsonProvider.Statics}  
		 */
		statics? (): Ext.direct.JsonProvider.Statics;
	}
}
declare namespace Ext.direct.Manager {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                     config
		 * @returns {Ext.direct.Manager.Statics}        this
		 */
		initConfig? (config: object): Ext.direct.Manager.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.direct.Manager.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.direct.Manager.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.direct.Manager.Statics}  
		 */
		statics? (): Ext.direct.Manager.Statics;
	}
}
declare namespace Ext.direct.PollingProvider {
	/** 
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * polling request. Note that if baseParams are set and [url](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.PollingProvider.html#cfg-url) parameter
		 ...
		 * is connected.
		 * 
		 * The method should accept named arguments and will be passed [baseParams](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.PollingProvider.html#cfg-baseParams)
		 * if set.
		 * @configuration
		 * @optional
		 * @type {ExtGlobalFunction|string}
		 */
		pollFn?: ExtGlobalFunction | string;
		/** 
		 * List of Provider events that should be relayed by [Ext.direct.Manager](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html).
		 * 'data' event is always relayed.
		 * @configuration
		 ...
		 * 
		 * _Note_ that using string `url` is deprecated, use [pollFn](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.PollingProvider.html#cfg-pollFn) instead.
		 * @configuration
		 * @optional
		 * @type {ExtGlobalFunction|string}
		 */
		 ...
		 * @chainable
		 * @param   {object}                             config
		 * @returns {Ext.direct.PollingProvider.Statics}        this
		 */
		initConfig? (config: object): Ext.direct.PollingProvider.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.direct.PollingProvider.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.direct.PollingProvider.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.direct.PollingProvider.Statics}  
		 */
		statics? (): Ext.direct.PollingProvider.Statics;
	}
}
declare namespace Ext.direct.Provider {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                      config
		 * @returns {Ext.direct.Provider.Statics}        this
		 */
		initConfig? (config: object): Ext.direct.Provider.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.direct.Provider.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.direct.Provider.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.direct.Provider.Statics}  
		 */
		statics? (): Ext.direct.Provider.Statics;
	}
}
declare namespace Ext.direct.RemotingProvider {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * If you wish to reverse to previous behavior, set [disableNestedActions](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingProvider.html#cfg-disableNestedActions)
		 * to `true`.
		 * 
		 * In the following example a _client side_ handler is used to call the
		 ...
		 * dispatching a request to the server, even if [enableBuffer](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingProvider.html#cfg-enableBuffer) timeout
		 * has not yet expired.
		 * 
		 * Note that this option does nothing if [enableBuffer](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingProvider.html#cfg-enableBuffer) is set to `false`.
		 * @configuration
		 * @optional
		 * @type {number}
		 */
		 ...
		 * because it generated flat [namespace](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.RemotingProvider.html#cfg-namespace) object with dotted property names.
		 ...
		 * [namespace](https://docs.sencha.com/extjs/6.0.1/classic/Ext.html#method-namespace) created implicitly.
		 * @configuration
		 * @optional
		 * @type {string|object}
		 */
		...
		timeout?: number;
		/** 
		 * **Required**. The url to connect to the [Ext.direct.Manager](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html) server-side router.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		 ...
		 * @chainable
		 * @param   {object}                              config
		 * @returns {Ext.direct.RemotingProvider.Statics}        this
		 */
		initConfig? (config: object): Ext.direct.RemotingProvider.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.direct.RemotingProvider.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.direct.RemotingProvider.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.direct.RemotingProvider.Statics}  
		 */
		statics? (): Ext.direct.RemotingProvider.Statics;
	}
}
declare namespace Ext.direct.Transaction {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                         config
		 * @returns {Ext.direct.Transaction.Statics}        this
		 */
		initConfig? (config: object): Ext.direct.Transaction.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.direct.Transaction.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.direct.Transaction.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.direct.Transaction.Statics}  
		 */
		statics? (): Ext.direct.Transaction.Statics;
	}
}
declare namespace Ext.direct.JsonProvider {
	...
	interface Events extends Ext.base.Events {
		 ...
		 * @event
		 * @param   {Ext.direct.Provider} provider The [Provider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Provider.html).
		 ...
		 * @returns {void}                
		 */
		connect? (provider: Ext.direct.Provider, eOpts: object): void;
		/** 
		 * Fires when the Provider receives data from the server-side
		 * @event
		 * @param   {Ext.direct.Provider} provider The [Provider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Provider.html).
		 * @param   {Ext.direct.Event}    e        The [Ext.direct.Event](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Event.html) type that occurred.
		 * @param   {object}              eOpts    The options object passed to [Ext.util.Observable.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.util.Observable.html#method-addListener).
		 * @returns {void}                
		 */
		data? (provider: Ext.direct.Provider, e: Ext.direct.Event, eOpts: object): void;
		/** 
		 ...
		 * @returns {void}                
		 */
		disconnect? (provider: Ext.direct.Provider, eOpts: object): void;
		/** 
...
declare namespace Ext.direct.Manager {
	...
	interface Events extends Ext.base.Events {
		 ...
		 * @event
		 * @param   {Ext.direct.Event}    event    The [Event](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Event.html) that occurred.
		 * @param   {Ext.direct.Provider} provider
		 * The [Provider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Provider.html)
		 * that provided the event.
		 * @param   {object}              eOpts    The options object passed to [Ext.util.Observable.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.util.Observable.html#method-addListener).
		 * @returns {void}                
		 */
		event? (event: Ext.direct.Event, provider: Ext.direct.Provider, eOpts: object): void;
		/** 
		 ...
		 * @returns {void}                
		 */
		exception? (event: Ext.direct.Event, provider: Ext.direct.Provider, eOpts: object): void;
		/** 
		 * Fired by [loadProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html#method-loadProvider) after successfully loading RemotingProvider API
		 ...
		 * @returns {void}                
		 */
		providerload? (url: string, provider: Ext.direct.Provider, eOpts: object): void;
		/** 
		 * Fired by [loadProvider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Manager.html#method-loadProvider) when remoting API could not be loaded, or
		 ...
		 * @returns {void}   
		 */
		providerloaderror? (url: string, error: string, eOpts: object): void;
	}
}
declare namespace Ext.direct.PollingProvider {
	/** 
	...
	interface Events extends Ext.base.Events {
		 ...
		 * @event
		 * @param   {Ext.direct.PollingProvider} _this
		 * @param   {object}                     eOpts The options object passed to [Ext.util.Observable.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.util.Observable.html#method-addListener).
		 * @returns {void}                       
		 */
		beforepoll? (_this: Ext.direct.PollingProvider, eOpts: object): void;
		/** 
		 * Fires when the Provider connects to the server-side
		 * @event
		 * @param   {Ext.direct.Provider} provider The [Provider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Provider.html).
		 ...
		 * @returns {void}                       
		 */
		poll? (_this: Ext.direct.PollingProvider, eOpts: object): void;
	}
}
declare namespace Ext.direct.Provider {
	/** 
...
declare namespace Ext.direct.RemotingProvider {
	...
	interface Events extends Ext.base.Events {
		 ...
		 * @returns {void}                        
		 */
		beforecall? (provider: Ext.direct.RemotingProvider, transaction: Ext.direct.Transaction, meta: object, eOpts: object): void;
		/** 
		 ...
		 * @returns {void}                        
		 */
		beforecallback? (provider: Ext.direct.RemotingProvider, event: Ext.direct.Event, transaction: Ext.direct.Transaction, eOpts: object): void;
		/** 
		 ...
		 * @returns {void}                        
		 */
		call? (provider: Ext.direct.RemotingProvider, transaction: Ext.direct.Transaction, meta: object, eOpts: object): void;
		/** 
		 * Fires when the Provider connects to the server-side
		 * @event
		 * @param   {Ext.direct.Provider} provider The [Provider](https://docs.sencha.com/extjs/6.0.1/classic/Ext.direct.Provider.html).

declare namespace Ext.flash {
	/** 
	 * [Ext.flash.Component](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html)
	 ...
	 * important is the required [url](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html#cfg-url) which points to the location of the Flash movie to load. Other
	 * configurations include:
	 * 
	 * - [backgroundColor](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html#cfg-backgroundColor)
	 * - [wmode](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html#cfg-wmode)
	 * - [flashVars](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html#cfg-flashVars)
	 * - [flashParams](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html#cfg-flashParams)
	 * - [flashAttributes](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html#cfg-flashAttributes)
	 * 
	 * ## Example usage:
	 * 
	...
	class Component extends Ext.Component {
		 ...
		 * @returns {Ext.flash.Component|Ext.Component|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.flash.Component;
		 ...
		 * template method [beforeDestroy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#method-beforeDestroy) or [onDestroy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#method-onDestroy). And do not forget to
		 ...
		 */
		stopAnimation? (): Ext.flash.Component;
		 ...
		 * respective Container, firing a [removed](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#event-removed) event. References are properly
		 ...
		 * should override this for use by [focus](https://docs.sencha.com/extjs/6.0.1/classic/Ext.util.Focusable.html#method-focus)
		 * method.
		 * @method
		 * @protected (method)
		 * @returns {Ext.Element}  
		 ...
		 * 
		 * Setting the [_isLayoutRoot](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#property-_isLayoutRoot) property to `true` causes this method to always
...
declare namespace Ext.flash.Component {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.flash.Component|Ext.Component|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.flash.Component;
...
declare namespace Ext.flash.Component.methodParams.addListener {
	 ...
	 * [Ext.flash.Component.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html#method-addListener)
...
declare namespace Ext.flash.Component.methodParams.forceComponentLayout {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.flash.Component.forceComponentLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html#method-forceComponentLayout)
...
declare namespace Ext.flash.Component.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.flash.Component.on](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.flash.Component.methodParams.onFocusEnter {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.flash.Component.onFocusEnter](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html#method-onFocusEnter)
	 */
...
declare namespace Ext.flash.Component.methodParams.onFocusLeave {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.flash.Component.onFocusLeave](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html#method-onFocusLeave)
	 */
...
declare namespace Ext.flash.Component.methodParams.updateLayout {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.flash.Component.updateLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html#method-updateLayout)
	 * An object with layout options.
	 */
	interface Options extends Ext.base.Params {
		/** 
...
declare namespace Ext.flash.Component {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * [Ext.FlashComponent.EXPRESS_INSTALL_URL](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html#static-property-EXPRESS_INSTALL_URL), which should be set to the local resource.
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
		...
		/** 
		 * A value to control how Components are laid out in a [Border](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.container.Border.html) layout or as docked items.
		 * 
		 * In a Border layout, this can control how the regions (not the center) region lay out if the west or east take full height
		 * or if the north or south region take full width. Also look at the [Ext.layout.container.Border.regionWeights](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.container.Border.html#cfg-regionWeights) on the Border layout. An example to show how you can
		 ...
		 *    });
		 * 
		 * If docked items, the weight will order how the items are laid out. Here is an example to put a [Ext.toolbar.Toolbar](https://docs.sencha.com/extjs/6.0.1/classic/Ext.toolbar.Toolbar.html) above
		 * a [Ext.panel.Panel](https://docs.sencha.com/extjs/6.0.1/classic/Ext.panel.Panel.html)'s header:
		 * 
		 ...
		 * Set to 'transparent' to ignore the [backgroundColor](https://docs.sencha.com/extjs/6.0.1/classic/Ext.flash.Component.html#cfg-backgroundColor) and make the background of the Flash
		 * movie transparent.
		 * @configuration
		 * @optional
		 * @default "opaque"

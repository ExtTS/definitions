declare namespace Ext.fx {
	/** 
	 * [Ext.fx.Anim](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html)
	 * This class manages animation for a specific [target](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#cfg-target). The animation allows
	 * animation of various properties on the target, such as size, position, color and others.
	 * 
	 * ## Starting Conditions
	 * 
	 * The starting conditions for the animation are provided by the [from](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#cfg-from) configuration.
	 * Any/all of the properties in the [from](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#cfg-from) configuration can be specified. If a particular
	 * property is not defined, the starting value for that property will be read directly from the target.
	 * 
	 * ## End Conditions
	 * 
	 * The ending conditions for the animation are provided by the [to](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#cfg-to) configuration. These mark
	 * the final values once the animations has finished. The values in the [from](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#cfg-from) can mirror
	 * those in the [to](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#cfg-to) configuration to provide a starting point.
	 * 
	 * ## Other Options
	 * 
	 * - [duration](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#cfg-duration): Specifies the time period of the animation.
	 * - [easing](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#cfg-easing): Specifies the easing of the animation.
	 * - [iterations](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#cfg-iterations): Allows the animation to repeat a number of times.
	 * - [alternate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#cfg-alternate): Used in conjunction with [iterations](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#cfg-iterations), reverses the direction every second iteration.
	 * 
	 * ## Example Code
	 * 
	...
	class Anim extends Ext.Base {
		 ...
		 * keep the Anim instance around to be un-paused later; otherwise call [end](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#method-end).
		 * @property
		 * @public (property)
		 * @default false
		 * @type {boolean}
		 ...
		 * @returns {Ext.fx.Anim|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.fx.Anim;
	...
	/** 
	 * This class is a factory class that will create and return an animation class based on the [type](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Animation.html#cfg-type) configuration.
	 * @private (class)
	 */
	class Animation extends Ext.Base {}
	/** 
	 * [Ext.fx.Animator](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Animator.html)
	 ...
	 * ## Using Keyframes
	 * 
	 * The [keyframes](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Animator.html#cfg-keyframes) option is the most important part of specifying an animation when using this
	 ...
	 * you _must_ specify the values at 0% and 100%, the start and ending values. There is also a [keyframe](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Animator.html#event-keyframe)
	...
	class Animator extends Ext.Base {
		...
		/** 
		 * Flag to determine if the animation is paused. Only set this to true if you need to
		 * keep the Anim instance around to be unpaused later; otherwise call [end](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Animator.html#method-end).
		 * @property
		 * @public (property)
		 * @default false
		 * @type {boolean}
		 ...
		 * @returns {Ext.fx.Animator|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.fx.Animator;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
	...
	/** 
	 * [Ext.fx.Easing](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Easing.html)
...
declare namespace Ext.fx.Anim {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.fx.Anim|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.fx.Anim;
...
declare namespace Ext.fx.Animation {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.fx.Animation](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Animation.html)
	 * This class is a factory class that will create and return an animation class based on the [type](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Animation.html#cfg-type) configuration.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
...
declare namespace Ext.fx.Animator {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.fx.Animator|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.fx.Animator;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.fx.CubicBezier {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.fx.CubicBezier](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.CubicBezier.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
		 ...
		 * @returns {Ext.fx.CubicBezier|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.fx.CubicBezier;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.fx.DrawPath {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.fx.DrawPath](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.DrawPath.html)
	 * Provides SVG Paths handling functions. Copied from Ext.draw.Draw in ExtJs 4.2 in order
	 * to break the dependencies on parsePathString() and interpolatePaths() in PropertyHandler.js
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.fx.DrawPath|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.fx.DrawPath;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.fx.Easing {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.fx.Easing|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.fx.Easing;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.fx.Manager {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.fx.Manager](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Manager.html)
	 * Animation Manager which keeps track of all current animations and manages them on a frame by frame basis.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * @returns {Ext.fx.Manager|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.fx.Manager;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.fx.PropertyHandler {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.fx.PropertyHandler](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.PropertyHandler.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
		 ...
		 * @returns {Ext.fx.PropertyHandler|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.fx.PropertyHandler;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.fx.Queue {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.fx.Queue](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Queue.html)
	 * Animation Queue mixin to handle chaining and queueing by target.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * @returns {Ext.fx.Queue|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.fx.Queue;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.fx.Runner {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.fx.Runner](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Runner.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
		 ...
		 * @returns {Ext.fx.Runner|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.fx.Runner;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.fx.State {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.fx.State](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.State.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
		 ...
		 * @returns {Ext.fx.State|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.fx.State;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.fx.Anim.methodParams.addListener {
	 ...
	 * [Ext.fx.Anim.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.fx.Anim.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.fx.Anim.on](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.fx.Animator.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.fx.Animator.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Animator.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.fx.Animator.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.fx.Animator.on](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Animator.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.fx.Anim {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * animation dynamically. Also see the [jumpToEnd](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#method-jumpToEnd) method.
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
		...
		delay?: number;
		/** 
		 * Time in milliseconds for a single animation to last. If the [iterations](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#cfg-iterations) property is
		...
		reverse?: boolean;
		/** 
		 * The scope that the [callback](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html#cfg-callback) function will be called with
		 * @configuration
		 * @optional
		 * @type {object}
		 */
		scope?: object;
		/** 
		 * The [Ext.fx.target.Target](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.target.Target.html) to apply the animation to.  This should only be specified when creating an [Ext.fx.Anim](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.Anim.html) directly.
		 * The target does not need to be a [Ext.fx.target.Target](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.target.Target.html) instance, it can be the underlying object. For example, you can
		 * pass a Component, Element or Sprite as the target and the Anim will create the appropriate [Ext.fx.target.Target](https://docs.sencha.com/extjs/6.0.1/classic/Ext.fx.target.Target.html) object
		 * automatically.
		 * @configuration
		 * @optional
		 * @type {string|object}

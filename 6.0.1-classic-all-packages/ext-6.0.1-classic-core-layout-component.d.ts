declare namespace Ext.layout.component {
	/** 
	 * [Ext.layout.component.Auto](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.component.Auto.html)
	 * The class is the default component layout for [Ext.Component](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html) when no explicit
	 * [`componentLayout`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#cfg-componentLayout) is configured.
	 * 
	 ...
	 * [size model](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#method-getSizeModel).
	 * 
	 * ## configured / calculated
	 * 
	 * In either of these size models, the dimension of the outer element is of a known size.
	 * The size is found in the `ownerContext` (the [Ext.layout.ContextItem](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html) for the owner
	 ...
	 * 
	 * - [`Ext.layout.component.Component.measureContentWidth`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.component.Component.html#method-measureContentWidth)
	 * - `publishOwnerWidth`
	 *   <ul>
	 ...
	 * 
	 * - [`Ext.layout.component.Component.measureOwnerWidth`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.component.Component.html#method-measureOwnerWidth)
	 * - `publishInnerWidth`
	 */
	class Auto extends Ext.layout.component.Component {
		 ...
		 * @returns {Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.layout.component.Auto;
		static addInheritableStatics? (members: object): typeof Ext.layout.component.Component;
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.layout.Layout.beginLayoutCycle](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-beginLayoutCycle).
		 * Called before any calculation cycles to reset DOM values and prepare for calculation.
		 * 
		 * This is a write phase and DOM reads should be strictly avoided when overridding
		 * this method.
		 ...
		 * least once and may be called repeatedly if the [done](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.component.Auto.html#property-done) property is cleared
		 * before return to indicate that this layout is not yet done. The [done](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.component.Auto.html#property-done) property
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.layout.Layout.calculate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-calculate).
		 * Called to perform the calculations for this layout. This method will be called at
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.layout.Layout.finishedLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-finishedLayout).
		 * This method is called after all layouts are complete and their calculations flushed
		 * to the DOM. No further layouts will be run and this method is only called once per
		 * layout run. The base component layout caches `lastComponentSize`.
		 * 
		 ...
		 * called once per layout run. It is the bookend to [beginLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.component.Component.html#method-beginLayout).
		 * 
		 * This is a write phase and DOM reads should be avoided if possible when overridding
		 ...
		 * a read is necessary, consider implementing a [finalizeLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.component.Component.html#method-finalizeLayout) method to do the
		 * required reads.
		 * 
		 * This method need not be implemented by derived classes and, in fact, should only be
		 * implemented when needed.
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.layout.Layout.notifyOwner](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-notifyOwner).
		 * This method (if implemented) is called after all layouts are finished, and all have
		 * a `lastComponentSize` cached. No further layouts will be run and this method is only
	...
	/** 
	 * Component layout for [Ext.view.BoundList](https://docs.sencha.com/extjs/6.0.1/classic/Ext.view.BoundList.html).
	 * @private (class)
	 */
	class BoundList extends Ext.layout.component.Auto {}
	/** 
	 * This class is intended to be extended or created via the [layout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#cfg-componentLayout)
	 * configuration property.  See [Ext.Component.componentLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#cfg-componentLayout) for additional details.
	 * @private (class)
	 */
	...
	/** 
	 * Component layout for [Ext.form.FieldSet](https://docs.sencha.com/extjs/6.0.1/classic/Ext.form.FieldSet.html) components
	 * @private (class)
	 */
...
declare namespace Ext.layout.component.Auto {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.layout.component.Auto;
		addInheritableStatics? (members: object): typeof Ext.layout.component.Component;
...
declare namespace Ext.layout.component.Body {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.component.Body](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.component.Body.html)
	 * Component layout for components which maintain an inner body element which must be resized to synchronize with the
	 * Component size.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.layout.component.Body|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.layout.component.Body;
		addInheritableStatics? (members: object): typeof Ext.layout.component.Auto;
		addInheritableStatics? (members: object): typeof Ext.layout.component.Component;
		addInheritableStatics? (members: object): typeof Ext.layout.Layout;
		addInheritableStatics? (members: object): typeof Ext.Base;
...
declare namespace Ext.layout.component.BoundList {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.component.BoundList](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.component.BoundList.html)
	 * Component layout for [Ext.view.BoundList](https://docs.sencha.com/extjs/6.0.1/classic/Ext.view.BoundList.html).
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * @returns {Ext.layout.component.BoundList|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.layout.component.BoundList;
		addInheritableStatics? (members: object): typeof Ext.layout.component.Auto;
		addInheritableStatics? (members: object): typeof Ext.layout.component.Component;
		addInheritableStatics? (members: object): typeof Ext.layout.Layout;
		addInheritableStatics? (members: object): typeof Ext.Base;
...
declare namespace Ext.layout.component.Component {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.component.Component](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.component.Component.html)
	 * This class is intended to be extended or created via the [layout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#cfg-componentLayout)
	 * configuration property.  See [Ext.Component.componentLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#cfg-componentLayout) for additional details.
	 */
	interface Statics extends Ext.base.Statics {
...
declare namespace Ext.layout.component.Dock {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.component.Dock](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.component.Dock.html)
	 * This ComponentLayout handles docking for Panels. It takes care of panels that are
	 * part of a ContainerLayout that sets this Panel's size and Panels that are part of
	 * an AutoContainerLayout in which this panel get his height based of the CSS or
	 * its content.
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.layout.component.Dock|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.layout.component.Dock;
		addInheritableStatics? (members: object): typeof Ext.layout.component.Component;
		addInheritableStatics? (members: object): typeof Ext.layout.Layout;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
...
declare namespace Ext.layout.component.FieldSet {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.component.FieldSet](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.component.FieldSet.html)
	 * Component layout for [Ext.form.FieldSet](https://docs.sencha.com/extjs/6.0.1/classic/Ext.form.FieldSet.html) components
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * @returns {Ext.layout.component.FieldSet|Ext.layout.component.Body|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.layout.component.FieldSet;
		addInheritableStatics? (members: object): typeof Ext.layout.component.Body;
		addInheritableStatics? (members: object): typeof Ext.layout.component.Auto;
		addInheritableStatics? (members: object): typeof Ext.layout.component.Component;
		addInheritableStatics? (members: object): typeof Ext.layout.Layout;
...
declare namespace Ext.layout.component.ProgressBar {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.component.ProgressBar](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.component.ProgressBar.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
		 ...
		 * @returns {Ext.layout.component.ProgressBar|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.layout.component.ProgressBar;
		addInheritableStatics? (members: object): typeof Ext.layout.component.Auto;
		addInheritableStatics? (members: object): typeof Ext.layout.component.Component;
		addInheritableStatics? (members: object): typeof Ext.layout.Layout;
		addInheritableStatics? (members: object): typeof Ext.Base;

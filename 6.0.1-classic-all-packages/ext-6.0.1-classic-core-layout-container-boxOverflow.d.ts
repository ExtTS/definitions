...
declare namespace Ext.layout.boxOverflow {
	class Menu extends Ext.layout.container.boxOverflow.Menu {}
	class None extends Ext.layout.container.boxOverflow.None {}
	class Scroller extends Ext.layout.container.boxOverflow.Scroller {}
}
declare namespace Ext.layout.container.boxOverflow.Menu {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.container.boxOverflow.Menu](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.container.boxOverflow.Menu.html)
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.layout.container.boxOverflow.Menu|Ext.layout.container.boxOverflow.None|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.container.boxOverflow.Menu;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.container.boxOverflow.None;
		 ...
		 * @returns {Ext.layout.container.boxOverflow.Menu|Ext.layout.container.boxOverflow.None|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.layout.container.boxOverflow.Menu;
		addStatics? (members: object): typeof Ext.layout.container.boxOverflow.None;
		 ...
		 * @returns {Ext.layout.container.boxOverflow.Menu|Ext.layout.container.boxOverflow.None|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.layout.container.boxOverflow.Menu;
		addInheritableStatics? (members: object): typeof Ext.layout.container.boxOverflow.None;
		 ...
		 * @returns {Ext.layout.container.boxOverflow.Menu|Ext.layout.container.boxOverflow.None|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.layout.container.boxOverflow.Menu;
		addMember? (name: object, member: object): typeof Ext.layout.container.boxOverflow.None;
		 ...
		 * @returns {Ext.layout.container.boxOverflow.Menu|Ext.layout.container.boxOverflow.None|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.layout.container.boxOverflow.Menu;
		onExtended? (fn: object, scope: object): typeof Ext.layout.container.boxOverflow.None;
...
declare namespace Ext.layout.container.boxOverflow.None {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.container.boxOverflow.None](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.container.boxOverflow.None.html)
	 * Base class for Box Layout overflow handlers. These specialized classes are invoked when a Box Layout
	 * (either an HBox or a VBox) has child items that are either too wide (for HBox) or too tall (for VBox)
	 * for its container.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.layout.container.boxOverflow.None|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.container.boxOverflow.None;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 ...
		 * @chainable
		 * @param   {object}                                         members
		 * @returns {Ext.layout.container.boxOverflow.None|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.layout.container.boxOverflow.None;
		addStatics? (members: object): typeof Ext.Base;
		/** 
...
declare namespace Ext.layout.container.boxOverflow.Scroller {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.container.boxOverflow.Scroller](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.container.boxOverflow.Scroller.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.layout.container.boxOverflow.Scroller|Ext.layout.container.boxOverflow.None|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.container.boxOverflow.Scroller;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.container.boxOverflow.None;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                                                                   members
		 * @returns {Ext.layout.container.boxOverflow.Scroller|Ext.layout.container.boxOverflow.None|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.layout.container.boxOverflow.Scroller;
		addStatics? (members: object): typeof Ext.layout.container.boxOverflow.None;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.layout.container.boxOverflow.Scroller|Ext.layout.container.boxOverflow.None|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.layout.container.boxOverflow.Scroller;
		addInheritableStatics? (members: object): typeof Ext.layout.container.boxOverflow.None;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 ...
		 * @returns {Ext.layout.container.boxOverflow.Scroller|Ext.layout.container.boxOverflow.None|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.layout.container.boxOverflow.Scroller;
		addMember? (name: object, member: object): typeof Ext.layout.container.boxOverflow.None;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.layout.container.boxOverflow.Scroller|Ext.layout.container.boxOverflow.None|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.layout.container.boxOverflow.Scroller;
		onExtended? (fn: object, scope: object): typeof Ext.layout.container.boxOverflow.None;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.layout.container.boxOverflow.Scroller.methodParams.addListener {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.layout.container.boxOverflow.Scroller.addListener](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.container.boxOverflow.Scroller.html#method-addListener)
...
declare namespace Ext.layout.container.boxOverflow.Scroller.methodParams.on {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.layout.container.boxOverflow.Scroller.on](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.container.boxOverflow.Scroller.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.layout.container.boxOverflow.Scroller {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                                            config
		 * @returns {Ext.layout.container.boxOverflow.Scroller.Statics}        this
		 */
		initConfig? (config: object): Ext.layout.container.boxOverflow.Scroller.Statics;
		/** 
		 ...
		 * @returns {Ext.layout.container.boxOverflow.Scroller.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.layout.container.boxOverflow.Scroller.Statics;
		/** 
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.layout.container.boxOverflow.Scroller.Statics}  
		 */
		statics? (): Ext.layout.container.boxOverflow.Scroller.Statics;
	}
}

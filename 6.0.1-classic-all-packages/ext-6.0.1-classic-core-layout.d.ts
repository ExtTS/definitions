declare namespace Ext.layout {
	 ...
	 * [Layout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html) are called during a read phase:
	 * [calculate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-calculate),
	 * [completeLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-completeLayout) and
	 * [finalizeLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-finalizeLayout). The exceptions to this are
	 * [beginLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-beginLayout),
	 * [beginLayoutCycle](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-beginLayoutCycle) and
	 * [finishedLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-finishedLayout) which are called during
	 * a write phase. While [finishedLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-finishedLayout) is called
	 ...
	 * [ContextItem](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html) where possible since that provides a cache
	 ...
	 * like [getStyle](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-getStyle) will still read the DOM unless the
	 ...
	 * the [calculate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-calculate) method on all layouts in the
	 * [layoutQueue](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Context.html#property-layoutQueue). These calls are part of a "read phase" and writes to the DOM should
	 * be strictly avoided.
	 * 
	 * # Considerations
	 * 
	 * **RULE 1**: Respect the read/write cycles. Always use the [getProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-getProp)
	 * or [getDomProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-getDomProp) methods to get calculated values;
	 * only use the [getStyle](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-getStyle) method to read styles; use
	 * [setProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-setProp) to set DOM values. Some reads will, of
	 * course, still go directly to the DOM, but if there is a method in
	 * [ContextItem](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html) to do a certain job, it should be used instead
	 * of a lower-level equivalent.
	 * 
	 * The basic logic flow in [calculate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-calculate) consists of gathering
	 * values by calling [getProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-getProp) or
	 * [getDomProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-getDomProp), calculating results and publishing
	 * them by calling [setProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-setProp). It is important to realize
	 * that [getProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-getProp) will return `undefined` if the value
	 ...
	 * 
	 * **RULE 2**: Avoid calling [getProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-getProp) unless the value
	 ...
	 * [getDomProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-getDomProp) and the test-only methods
	 * [hasProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-hasProp) and [hasDomProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-hasDomProp).
	 * 
	 * Because [getProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-getProp) can return `undefined`, it is often
	 ...
	 * and NaN are ignored by [Ext.layout.ContextItem.setProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-setProp), so it is often not necessary
	 ...
	 * must set [done](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#property-done) to `false` before returning from
	 * [calculate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-calculate). This value is always `true` on entry because
	 ...
	 * values and some layouts may even incorrectly flag themselves as [done](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#property-done)
	 ...
	 * call to [Ext.layout.Layout.calculate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-calculate) to avoid unnecessary cycles and poor performance. It is
	 ...
	 * is best to use [block](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-block) or
	 * [domBlock](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-domBlock) and thereby avoid processing the layout
	 * until the needed value is available.
	 * 
	 * **RULE 7**: Use [block](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-block) or
	 * [domBlock](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-domBlock) when values are required to make progress.
	 ...
	 * Notes:
	 * 
	 * **A.** This is a call from the [run](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Context.html#method-run) method to the [run](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Context.html#method-run) method.
	 * Each layout in the queue will have its [calculate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-calculate)
	 * method called.
	 * 
	 * **B.** After each [calculate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-calculate) method is called the
	 * [done](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#property-done) flag is checked to see if the Layout has completed.
	 * If it has completed and that layout object implements a
	 * [completeLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-completeLayout) method, this layout is queued to
	 * receive its call. Otherwise, the layout will be queued again unless there are blocks or
	 * triggers that govern its requeueing.
	 * 
	 * **C.** The call to [getProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-getProp) is made to the Item
	 ...
	 * [setProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-setProp) will place a value in the item and not
	 ...
	 * the context) and if the [layoutQueue](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Context.html#property-layoutQueue) is not empty, the next cycle is run. If no
	 * progress was made or no layouts are ready to run, all buffered values are written to
	 * the DOM (a flush).
	 * 
	 * **F.** After flushing, any layouts that were marked as [done](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#property-done)
	 * that also have a [completeLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-completeLayout) method are called.
	 * This can cause them to become no longer done (see [invalidate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Context.html#method-invalidate)). As with
	 * [calculate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-calculate), this is considered a "read phase" and
	 * direct DOM writes should be avoided.
	 * 
	 * **G.** Flushing and calling any pending [completeLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-completeLayout)
	 * methods will likely trigger layouts that called [getDomProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-getDomProp)
	 * and unblock layouts that have called [domBlock](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-domBlock).
	 ...
	 * 
	 * **H.** Call [calculate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-calculate) on any layouts in the queue
	 ...
	 * in the [done](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#property-done) state. This is the value on entry to
	 * [calculate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-calculate) and must be cleared in that call if the
	 * layout has more work to do.
	 * 
	 * **J.** Now that all layouts are done, flush any DOM values and
	 * [completeLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-completeLayout) calls. This can again cause
	 * layouts to become not done, and so we will be back on another cycle if that happens.
	 * 
	 * **K.** After all layouts are done, call the [finalizeLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-finalizeLayout)
	 * method on any layouts that have one. As with [completeLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-completeLayout),
	 * this can cause layouts to become no longer done. This is less desirable than using
	 * [completeLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-completeLayout) because it will cause all
	 * [finalizeLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-finalizeLayout) methods to be called again
	 * when we think things are all wrapped up.
	 * 
	 * **L.** After finishing the last iteration, layouts that have a
	 * [finishedLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-finishedLayout) method will be called. This
	 ...
	 * [notifyOwner](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-notifyOwner) method will be called. This
	 * call will only happen once per run and cannot cause layouts to be run further.
	 * 
	 ...
	 * each components' [size model](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#method-getSizeModel).
	 * 
	 * To facilitate this collaboration, the following pairs of properties are published to the
	 * component's [ContextItem](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html):
	 * 
	 * - width/height: These hold the final size of the component. The layout indicated by the
	 *   [size model](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#method-getSizeModel) is responsible for setting these.
	 ...
	 *   is [shrink-wrapped](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#cfg-shrinkWrap). They are also used to
	 ...
	 * # Triggers
	 * 
	 * Whenever any call to [getProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-getProp), [getDomProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-getDomProp), [hasProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-hasProp) or
	 * [hasDomProp](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-hasDomProp) is made, the current layout is automatically registered as being
	 * dependent on that property in the appropriate state. Any changes to the property will
	 * trigger the layout and it will be queued in the [Ext.layout.Context](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Context.html).
	 * 
	...
	/** 
	 * [Ext.layout.Layout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html)
	...
	class Layout extends Ext.Base {
		 ...
		 * [calculate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-calculate) and should be set to false if this layout has more work to do.
		 * @property
		 * @public (property)
		 * @type {boolean}
		 */
		 ...
		 * items if [Ext.layout.container.Container.activeItemCount](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.container.Container.html#property-activeItemCount) is `0`, which will be the case if all child items
		 * use "liquid" CSS layout, e.g. form fields.  (See [Ext.Component.liquidLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#cfg-liquidLayout))
		 * @property
		 * @private (property)
		 * @default true
		 * @type {boolean}
		 ...
		 * @returns {Ext.layout.Layout|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.layout.Layout;
		 ...
		 * least once and may be called repeatedly if the [done](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#property-done) property is cleared
		 * before return to indicate that this layout is not yet done. The [done](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#property-done) property
		 ...
		 * Instead, DOM writes need to be written to [Ext.layout.ContextItem](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html) objects to
		 ...
		 * completes (by not setting [done](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#property-done) to `false` in [calculate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-calculate)). It is
		 * possible for the layout to complete and yet become invalid before the end of the cycle,
		 * in which case, this method will not be called. It is also possible for this method to
		 * be called and then later the layout becomes invalidated. This will result in
		 * [calculate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-calculate) being called again, followed by another call to this method.
		 * 
		 * This is a read phase and DOM writes should be strictly avoided in derived classes.
		 * Instead, DOM writes need to be written to [Ext.layout.ContextItem](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html) objects to
		 * be flushed at the next opportunity.
		 ...
		 * ways this is similar to [completeLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-completeLayout). This call can cause this (or any
		 * layout) to be become invalid (see [Ext.layout.Context.invalidate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Context.html#method-invalidate)), but this
		 ...
		 * called once per layout run. It is the bookend to [beginLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-beginLayout).
		 * 
		 * This is a write phase and DOM reads should be avoided if possible when overridding
		 ...
		 * a read is necessary, consider implementing a [finalizeLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-finalizeLayout) method to do the
		 * required reads.
		 * 
		 * This method need not be implemented by derived classes and, in fact, should only be
		 * implemented when needed.
		 ...
		 * [Ext.Component.updateLayout](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Component.html#method-updateLayout) on this layout's owner.
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.layout.SizePolicy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.SizePolicy.html)
...
declare namespace Ext.layout.Context {
	 ...
	 * [Ext.layout.Context](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Context.html)
	 * Manages context information during a layout.
	 * 
	 * # Algorithm
	 * 
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.layout.Context|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.layout.Context;
...
declare namespace Ext.layout.ContextItem {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.ContextItem](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html)
	 * This class manages state information for a component or element during a layout.
	 * 
	 * # Blocks
	 * 
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.layout.ContextItem|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.layout.ContextItem;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.layout.Layout {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.layout.Layout|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.layout.Layout;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.layout.SizeModel {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.SizeModel](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.SizeModel.html)
	 * This class describes a size determination strategy or algorithm used by the layout
	 * system. There are special instances of this class stored as static properties to
	 * avoid needless object instantiation. These instances should be treated as readonly.
	 * 
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.layout.SizeModel|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.layout.SizeModel;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.layout.ContextItem.methodParams.invalidate {
	 ...
	 * [Ext.layout.ContextItem.invalidate](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#method-invalidate)
	 * An object describing how to handle the invalidation.
	 */
	interface Options extends Ext.base.Params {
		/** 
		 * An object to [Ext.apply](https://docs.sencha.com/extjs/6.0.1/classic/Ext.html#method-apply) to the [state](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.ContextItem.html#property-state)
		 ...
		 * and before the [Ext.layout.Layout.beginLayoutCycle](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-beginLayoutCycle) methods are called.
		 * @configuration
		 * @optional
		...
		/** 
		 * A function to call after the context data is cleared
		 * and after the [Ext.layout.Layout.beginLayoutCycle](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.Layout.html#method-beginLayoutCycle) methods are called.
		 * @configuration
		 * @optional
...
declare namespace Ext.layout.Layout {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * [accordion](https://docs.sencha.com/extjs/6.0.1/classic/Ext.layout.container.Accordion.html) layout to cause the child panels

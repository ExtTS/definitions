declare namespace Ext.promise {
	 ...
	 * @private (class)
	 */
	class Consequence extends Ext.Base {}
	/** 
	 ...
	 * @private (class)
	 */
	class Deferred extends Ext.Base {}
	/** 
	 * [Ext.promise.Promise](https://docs.sencha.com/extjs/6.0.1/classic/Ext.promise.Promise.html)
	 ...
	 * use `new [Ext.Promise](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Promise.html)()` or `new [Ext.Deferred](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Deferred.html)()` to create and manage
	 * promises. If the browser supports the standard `Promise` constructor, this class will
	 * not be used by [`Ext.Promise`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Promise.html). This class will always be used by [`Ext.Deferred`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Deferred.html) in order
	 * to provide enhanced capabilities beyond standard promises.
	 * 
	 * A Promise's [`then()`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.promise.Promise.html#method-then) method is used to specify onFulfilled and onRejected
	 ...
	 * 
	 * See [`Ext.Deferred`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Deferred.html) for an example of using the returned Promise.
	 */
	class Promise extends Ext.Base {
		/** 
		 * The type of `Error` propagated by the [`cancel`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.promise.Promise.html#method-cancel) method. If
		 ...
		 * @type {object}
		 */
		static CancellationError?: object;
		/** 
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.promise.Promise.Statics}
		 */
		self?: Ext.promise.Promise.Statics | Ext.Base.Statics;
		/** 
		 ...
		 * @returns {Ext.promise.Promise|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.promise.Promise;
		 ...
		 * @returns {Ext.promise.Promise|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.promise.Promise;
		 ...
		 * @returns {Ext.promise.Promise|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.promise.Promise;
		 ...
		 * @returns {Ext.promise.Promise|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.promise.Promise;
		 ...
		 * @returns {Ext.promise.Promise|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.promise.Promise;
		 ...
		 * Callback to execute when the Promise is resolved or
		 * rejected.
		 * @param   {object}              scope       Optional scope for the callback.
		 * @returns {Ext.promise.Promise} 
		 * A new "pass-through" Promise that is resolved with
		 * the original value or rejected with the original reason.
		 */
		always? (onCompleted: ExtGlobalFunction, scope: object): Ext.promise.Promise;
		/** 
		 * Cancels this Promise if it is still pending, triggering a rejection with a
		 * [`CancellationError`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.promise.Promise.html#static-property-CancellationError) that will propagate to any Promises originating from
		 * this Promise.
		 * 
		 ...
		 * @returns {void}         
		 */
		cancel? (reason: ExtGlobalError): void;
		/** 
		 ...
		 * An optional identifier to incorporate into the
		 * resulting log entry.
		 * @returns {Ext.promise.Promise} 
		 * A new "pass-through" Promise that is resolved with
		 * the original value or rejected with the original reason.
		 ...
		 * @param   {object}              scope      Optional scope for the callback.
		 * @returns {Ext.promise.Promise}            Promise of the transformed future value.
		 */
		otherwise? (onRejected: ExtGlobalFunction, scope: object): Ext.promise.Promise;
		/** 
		 ...
		 * @returns {Ext.promise.Promise|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.promise.Promise;
		 ...
		 * Optional callback to execute to transform a
		 * fulfillment value.
		 * @param   {Function}            onRejected
		 * Optional callback to execute to transform a rejection
		 * reason.
		 * @param   {Function}            onProgress
		 * Optional callback function to be called with progress
		 * updates.
		 * @param   {object}              scope       Optional scope for the callback(s).
		 * @returns {Ext.promise.Promise} 
		 * Promise that is fulfilled with the callback return
		 * value or rejected with any error thrown by the callback.
		 */
		then? (onFulfilled: ExtGlobalFunction, onRejected: ExtGlobalFunction, onProgress: ExtGlobalFunction, scope: object): Ext.promise.Promise;
		/** 
		 ...
		 * @returns {Ext.promise.Promise|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.promise.Promise;
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.promise.Promise.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.promise.Promise.Statics;
		 ...
		 * @returns {Ext.promise.Promise|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.promise.Promise;
		unlink? (names: string[]): Ext.Base;
	}
}
declare namespace Ext.promise.Promise {
	/** 
	 * @definitions
	 ...
	 * See [`Ext.Deferred`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.Deferred.html) for an example of using the returned Promise.
	 */
	interface Def extends Ext.promise.Promise {
		/** 
		 ...
		 * @type {Ext.promise.Promise.Statics}
		 */
		statics?: (() => Ext.promise.Promise.Statics | Ext.Base.Statics) | Ext.promise.Promise.Statics | any;
	}
}
declare namespace Ext.promise.Consequence {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.promise.Consequence](https://docs.sencha.com/extjs/6.0.1/classic/Ext.promise.Consequence.html)
	 * Consequences are used internally by a Deferred to capture and notify callbacks, and
	 * propagate their transformed results as fulfillment or rejection.
	 * 
	 * Developers never directly interact with a Consequence.
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.promise.Consequence|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.promise.Consequence;
		 ...
		 * @chainable
		 * @param   {object}                           members
		 * @returns {Ext.promise.Consequence|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.promise.Consequence;
		 ...
		 * @returns {Ext.promise.Consequence|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.promise.Consequence;
		 ...
		 * @returns {Ext.promise.Consequence|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.promise.Consequence;
		 ...
		 * @returns {Ext.promise.Consequence|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.promise.Consequence;
...
declare namespace Ext.promise.Deferred {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.promise.Deferred](https://docs.sencha.com/extjs/6.0.1/classic/Ext.promise.Deferred.html)
	 * Deferreds are the mechanism used to create new Promises. A Deferred has a single
	 * associated Promise that can be safely returned to external consumers to ensure they do
	 * not interfere with the resolution or rejection of the deferred operation.
	 * 
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.promise.Deferred|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.promise.Deferred;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @chainable
		 * @param   {object}                        members
		 * @returns {Ext.promise.Deferred|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.promise.Deferred;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.promise.Deferred|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.promise.Deferred;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.promise.Deferred|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.promise.Deferred;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.promise.Deferred|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.promise.Deferred;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.promise.Promise {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.promise.Promise|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.promise.Promise;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @returns {Ext.promise.Promise|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.promise.Promise;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.promise.Promise|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.promise.Promise;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.promise.Promise|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.promise.Promise;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.promise.Promise|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.promise.Promise;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)

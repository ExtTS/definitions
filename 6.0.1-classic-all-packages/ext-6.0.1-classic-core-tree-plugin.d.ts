declare namespace Ext.tree.plugin {
	/** 
	 * [Ext.tree.plugin.TreeViewDragDrop](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html)
	 * This plugin provides drag and drop functionality for a [TreeView](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.View.html).
	 * 
	 * A specialized instance of [DragZone](https://docs.sencha.com/extjs/6.0.1/classic/Ext.dd.DragZone.html) and [DropZone](https://docs.sencha.com/extjs/6.0.1/classic/Ext.dd.DropZone.html) are attached to the tree view.  The DropZone will participate in drops
	 * from DragZones having the same [ddGroup](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#cfg-ddGroup) including drops from within the same
	 * tree.
	 * 
	 ...
	 *   The value of [copy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#cfg-copy).  Or `true` if {@link
	 *   # allowCopy} is true **and** the control key was pressed as the drag operation began.
	 * - **view:** [TreeView](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.View.html)
	 ...
	 * tree view as well as its owning Tree: [`beforedrop`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#event-beforedrop) and [`drop`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#event-drop).
	 * 
	...
	class TreeViewDragDrop extends Ext.plugin.Abstract {
		...
		/** 
		 * An [DropZone](https://docs.sencha.com/extjs/6.0.1/classic/Ext.grid.ViewDropZone.html) which handles mouseover and dropping records in any grid which shares the same [dropGroup](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#cfg-dropGroup).
		 * @property
		 * @public (property)
		 ...
		 * @returns {Ext.tree.plugin.TreeViewDragDrop|Ext.plugin.Abstract|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.tree.plugin.TreeViewDragDrop;
...
declare namespace Ext.tree.plugin.TreeViewDragDrop {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.tree.plugin.TreeViewDragDrop|Ext.plugin.Abstract|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.tree.plugin.TreeViewDragDrop;
...
declare namespace Ext.tree.plugin.TreeViewDragDrop.eventsParams.beforedrop {
	 ...
	 * [Ext.tree.plugin.TreeViewDragDrop.beforedrop](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#event-beforedrop)
	...
	interface Data extends Ext.base.Params {
		/** 
		 * The value of [copy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#cfg-copy).  Or `true` if
		 * [allowCopy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#cfg-allowCopy) is true **and** the control key was pressed as the drag
		 * operation began.
		 * @configuration
		 * @optional
		 * @type {boolean}
...
declare namespace Ext.tree.plugin.TreeViewDragDrop.eventsParams.drop {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.tree.plugin.TreeViewDragDrop.drop](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#event-drop)
	 * The data object gathered at mousedown time by the
	 * cooperating [DragZone](https://docs.sencha.com/extjs/6.0.1/classic/Ext.dd.DragZone.html)'s [getDragData](https://docs.sencha.com/extjs/6.0.1/classic/Ext.dd.DragZone.html#method-getDragData) method.  It contains the following properties:
	 */
	interface Data extends Ext.base.Params {
...
declare namespace Ext.tree.plugin.TreeViewDragDrop {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * unique stores.
		 * 
		 * See [copy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#cfg-copy) to enable the copying of all dragged records.
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
		 ...
		 * unique stores.
		 * 
		 * See [allowCopy](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#cfg-allowCopy) to allow only control-drag operations to copy records.
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
		...
		displayField?: string;
		/** 
		 * The ddGroup to which the [DragZone](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#property-dragZone) will belong.
		 * 
		 ...
		 * 
		 * **NOTE:** The node's [text](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.Panel.html#cfg-displayField) will be shown
		...
		dragText?: string;
		/** 
		 * A config object to apply to the creation of the [DragZone](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#property-dragZone) which handles for drag start gestures.
		 * 
		...
		dragZone?: object;
		/** 
		 * The ddGroup to which the [DropZone](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#property-dropZone) will belong.
		 * 
		 * This defines which other DragZones the DropZone will interact with. Drag/DropZones only interact with other
		 * Drag/DropZones which are members of the same [ddGroup](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#cfg-ddGroup).
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		dropGroup?: string;
		/** 
		 * A config object to apply to the creation of the [DropZone](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#property-dropZone) which handles mouseover and drop gestures.
		 * 
		 ...
		 * The color must be a 6 digit hex value, without a preceding '#'. See also [nodeHighlightOnDrop](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#cfg-nodeHighlightOnDrop) and
		 * [nodeHighlightOnRepair](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#cfg-nodeHighlightOnRepair).
		 * @configuration
		 * @optional
		 * @default c3daf9
		 * @type {string}
		 ...
		 * successfully dropped on their target. Defaults to the value of [`Ext.enableFx`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.html#property-enableFx).
		 * See also [nodeHighlightColor](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#cfg-nodeHighlightColor) and [nodeHighlightOnRepair](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#cfg-nodeHighlightOnRepair).
		 * @configuration
		 * @optional
		 * @type {boolean}
		 */
		...
		/** 
		 * Whether or not to highlight any nodes after they are
		 * repaired from an unsuccessful drag/drop. Defaults to the value of [`Ext.enableFx`](https://docs.sencha.com/extjs/6.0.1/classic/Ext.html#property-enableFx).
		 * See also [nodeHighlightColor](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#cfg-nodeHighlightColor) and [nodeHighlightOnDrop](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.plugin.TreeViewDragDrop.html#cfg-nodeHighlightOnDrop).
		 * @configuration
		 * @optional
		 * @type {boolean}
		 */
	...
	interface Events extends Ext.base.Events {
		/** 
		 * **This event is fired through the [TreeView](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.View.html) and its owning
		 * [Tree](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.Panel.html). You can add listeners to the tree or tree [view config](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.Panel.html#cfg-viewConfig) object**
		 * 
		 ...
		 * The [tree view](https://docs.sencha.com/extjs/6.0.1/classic/Ext.tree.View.html) node **if any** over

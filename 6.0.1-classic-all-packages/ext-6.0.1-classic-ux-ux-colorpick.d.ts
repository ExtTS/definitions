declare namespace Ext.ux.colorpick {
	/** 
	 * [Ext.ux.colorpick.Button](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Button.html)
	 * A simple color swatch that can be clicked to bring up the color selector.
	 * 
	 * The selected color is configurable via [value](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Button.html#cfg-value).
	 * 
	...
	class Button extends Ext.Component {
		...
		mixinId?: string;
		/** 
		 * Returns the value of [format](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Selection.html#cfg-format).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [previousColor](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Selection.html#cfg-previousColor).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the value of [value](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Selection.html#cfg-value).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		getValue? (): string;
		/** 
		 * Sets the value of [format](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Selection.html#cfg-format).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [previousColor](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Selection.html#cfg-previousColor).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [value](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Selection.html#cfg-value).
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.ux.colorpick.ColorPreview](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.ColorPreview.html)
	...
	/** 
	 * [Ext.ux.colorpick.Field](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Field.html)
	 * A field that can be clicked to bring up the color picker.
	 * The selected color is configurable via [value](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Field.html#cfg-value).
	 * 
	 *    Ext.create({
	 *         xtype: 'colorfield',
	 *         renderTo: Ext.getBody(),
	...
	class Field extends Ext.form.field.Picker {
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.form.field.Text.setValue](https://docs.sencha.com/extjs/6.0.1/classic/Ext.form.field.Text.html#method-setValue).
		 * Sets a data value into the field and runs the change detection and validation. Also applies any configured
		 * [emptyText](https://docs.sencha.com/extjs/6.0.1/classic/Ext.form.field.Text.html#cfg-emptyText) for text fields. To set the value directly without these inspections see [setRawValue](https://docs.sencha.com/extjs/6.0.1/classic/Ext.form.field.Text.html#method-setRawValue).
		 * @method
		 * @public (method)
		 * @chainable
		 * @param   {object}                                                              value The value to set
		 * @returns {void|Ext.form.field.Picker|Ext.form.field.Text|Ext.form.field.Field}       this
		 */
		setValue? (value: object): Ext.form.field.Picker;
		setValue? (value: object): Ext.form.field.Text;
	...
	/** 
	 * [Ext.ux.colorpick.Selector](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Selector.html)
	 ...
	 * 
	 * The defaul selected color is configurable via [value](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Selector.html#cfg-value) config. Usually used in
	 * forms via [Ext.ux.colorpick.Button](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Button.html) or [Ext.ux.colorpick.Field](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Field.html).
	 * 
	...
	/** 
	 * [Ext.ux.colorpick.SelectorModel](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.SelectorModel.html)
...
declare namespace Ext.ux.colorpick.Button {
	...
	interface Cfg extends Ext.base.Configs {
		...
		/** 
		 * The initial color to highlight; see [format](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Selection.html#cfg-format) for supported formats.
		 * @configuration
		 * @optional
		 * @default FF0000
		 * @type {string}
...
declare namespace Ext.ux.colorpick.Selection {
	 ...
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.ux.colorpick.Selection](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Selection.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * This config property is used internally by the UI to maintain the full color.
...
declare namespace Ext.ux.colorpick.Selector {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * these are relied upon by the [Ext.ux.colorpick.Button](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Button.html) and the [Ext.ux.colorpick.Field](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Field.html).
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
...
declare namespace Ext.ux.colorpick.Button {
	...
	interface Events extends Ext.base.Events {
		 ...
		 * @param   {string}                    color         The value of the selected color as per specified [format](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Button.html#cfg-format).
...
declare namespace Ext.ux.colorpick.Field {
	...
	interface Events extends Ext.base.Events {
		 ...
		 * @param   {string}                 color         The value of the selected color as per specified [format](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Field.html#cfg-format).
		 * @param   {string}                 previousColor The previous color value.
		 * @param   {object}                 eOpts         The options object passed to Ext.util.Observable.addListener.
		 * @returns {void}                   
		 */
...
declare namespace Ext.ux.colorpick.Selector {
	...
	interface Events extends Ext.base.Events {
		/** 
		 * Fires when Cancel button is clicked (see [showOkCancelButtons](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Selector.html#cfg-showOkCancelButtons)).
		 * @event
		 * @param   {Ext.ux.colorpick.Selector} _this
		 * @param   {object}                    eOpts The options object passed to Ext.util.Observable.addListener.
		 * @returns {void}                      
		 ...
		 * @event
		 * @param   {Ext.ux.colorpick.Selector} _this
		 * @param   {string}                    color         The value of the selected color as per specified [format](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Selector.html#cfg-format).
		 * @param   {string}                    previousColor The previous color value.
		 * @param   {object}                    eOpts         The options object passed to Ext.util.Observable.addListener.
		 * @returns {void}                      
		 */
		change? (_this: Ext.ux.colorpick.Selector, color: string, previousColor: string, eOpts: object): void;
		/** 
		 * Fires when OK button is clicked (see [showOkCancelButtons](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Selector.html#cfg-showOkCancelButtons)).
		 * @event
		 * @param   {Ext.ux.colorpick.Selector} _this
		 * @param   {string}                    color The value of the selected color as per specified [format](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.colorpick.Selector.html#cfg-format).
		 * @param   {object}                    eOpts The options object passed to Ext.util.Observable.addListener.

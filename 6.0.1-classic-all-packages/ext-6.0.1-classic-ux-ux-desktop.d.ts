declare namespace Ext.ux.desktop {
	/** 
	 * [Ext.ux.desktop.App](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.desktop.App.html)
	 * Ext JS Library
	...
	/** 
	 * [Ext.ux.desktop.Desktop](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.desktop.Desktop.html)
	...
	/** 
	 * [Ext.ux.desktop.ShortcutModel](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.desktop.ShortcutModel.html)
	...
	class ShortcutModel extends Ext.data.Model {
		 ...
		 * @property
		 * @private (property)
		 * @default [{name: 'name'}, {name: 'iconCls'}, {name: 'module'}]
		 * @type {any[]}
		 */
		fields?: any[];
	}
	/** 
	 * [Ext.ux.desktop.StartMenu](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.desktop.StartMenu.html)
	 * Ext JS Library
	 * Copyright(c) 2006-2014 Sencha Inc.
	 * licensing@sencha.com
	 * http://www.sencha.com/license
	...
	/** 
	 * [Ext.ux.desktop.TrayClock](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.desktop.TrayClock.html)
	...
	/** 
	 * [Ext.ux.desktop.Video](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.desktop.Video.html)
	 * From code originally written by David Davis
	 * [http://www.sencha.com/blog/html5-video-canvas-and-ext-js](http://www.sencha.com/blog/html5-video-canvas-and-ext-js)
	 * 
	...
	/** 
	 * [Ext.ux.desktop.Wallpaper](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.desktop.Wallpaper.html)
...
declare namespace Ext.ux.desktop.TaskBar {
	 ...
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.desktop.TaskBar](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.desktop.TaskBar.html)
	 */
...
declare namespace Ext.ux.desktop.Desktop {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * If the [shortcutTpl](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.desktop.Desktop.html#cfg-shortcutTpl) is modified, this will probably need to be modified as
		 * well.
		 * @configuration
		 * @optional
		 ...
		 * [shortcutItemSelector](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.desktop.Desktop.html#cfg-shortcutItemSelector) will probably also need to changed.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		 ...
		 * [Shortcut](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.desktop.ShortcutModel.html).
		 * @configuration
		 * @optional

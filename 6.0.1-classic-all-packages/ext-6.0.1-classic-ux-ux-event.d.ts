declare namespace Ext.ux.event {
	/** 
	 * [Ext.ux.event.Driver](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Driver.html)
	 * This is the base class for [Ext.ux.event.Recorder](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Recorder.html) and [Ext.ux.event.Player](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Player.html).
	 */
	...
	/** 
	 * [Ext.ux.event.Maker](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Maker.html)
	 * Event maker.
	 */
	...
	/** 
	 * [Ext.ux.event.Player](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Player.html)
	 * This class manages the playback of an array of "event descriptors". For details on the
	 * contents of an "event descriptor", see [Ext.ux.event.Recorder](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Recorder.html). The events recorded by the
	 * [Ext.ux.event.Recorder](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Recorder.html) class are designed to serve as input for this class.
	 * 
	 * The simplest use of this class is to instantiate it with an [eventQueue](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Player.html#cfg-eventQueue) and call
	 * [start](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Player.html#method-start). Like so:
	 * 
	...
	class Player extends Ext.ux.event.Driver {
		 ...
		 * dequeue the event. Repeated calls return the same object (until [nextEvent](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Player.html#method-nextEvent)
		 * is called).
		 * @method
		 * @public (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.ux.event.Recorder](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Recorder.html)
	 * Event recorder.
	 */
	...
	/** 
	 * [Ext.ux.event.RecorderManager](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.RecorderManager.html)
	 * Recorder manager.
...
declare namespace Ext.ux.event.Player.methodParams.injectKeyEvent {
	 ...
	 * [Ext.ux.event.Player.injectKeyEvent](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Player.html#method-injectKeyEvent)
...
declare namespace Ext.ux.event.Player.methodParams.injectMouseEvent {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.ux.event.Player.injectMouseEvent](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Player.html#method-injectMouseEvent)
	 * Object object containing all of the event injection
	 * options.
	 */
	interface Options extends Ext.base.Params {
...
declare namespace Ext.ux.event.Player.methodParams.injectUIEvent {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.ux.event.Player.injectUIEvent](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Player.html#method-injectUIEvent)
	 */
	interface Options extends Ext.base.Params {
		/** 
		 * The type of event to fire. This can be any one of
...
declare namespace Ext.ux.event.Player {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * the [start](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.event.Player.html#method-start) method is called.
		 * @configuration
		 * @optional
		 * @type {any[]}
		 */

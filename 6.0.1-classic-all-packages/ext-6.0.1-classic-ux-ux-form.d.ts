declare namespace Ext.ux.form {
	/** 
	 * [Ext.ux.form.ItemSelector](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.ItemSelector.html)
	 * A control that allows selection of between two [Ext.ux.form.MultiSelect](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.MultiSelect.html) controls.
	 */
	class ItemSelector extends Ext.ux.form.MultiSelect {
		 ...
		 * 
		 * **Note:** this method does not cause the Field's validate or [isValid](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.MultiSelect.html#method-isValid) methods to return `true`
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.ux.form.MultiSelect.onBindStore](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.MultiSelect.html#method-onBindStore).
		 * @method
		 * @private (method)
		 * @param   {object} store
		 * @returns {void}         
	...
	/** 
	 * [Ext.ux.form.MultiSelect](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.MultiSelect.html)
...
declare namespace Ext.ux.form.ItemSelector {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * to build the button CSS class names, and to look up the button text labels in [buttonsText](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.ItemSelector.html#cfg-buttonsText).
		...
		buttons?: any[];
		/** 
		 * The tooltips for the [buttons](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.ItemSelector.html#cfg-buttons).
		 * Labels for buttons.
		 * @configuration
		 * @optional
		...
		ddReorder?: boolean;
		/** 
		 * The string used to delimit the selected values when [submitting](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.MultiSelect.html#method-getSubmitValue)
		...
		/** 
		 * Validation message displayed when [maxSelections](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.MultiSelect.html#cfg-maxSelections) is not met
		 * The {0} token will be replaced by the value of [maxSelections](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.MultiSelect.html#cfg-maxSelections).
		 * @configuration
		 * @optional
		...
		/** 
		 * Validation message displayed when [minSelections](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.MultiSelect.html#cfg-minSelections) is not met.
		 * The {0} token will be replaced by the value of [minSelections](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.MultiSelect.html#cfg-minSelections).
		 * @configuration
		 * @optional
		 ...
		 *   [value](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.MultiSelect.html#cfg-valueField) and [text](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.MultiSelect.html#cfg-displayField))</div>
		 * - **2-dimensional array** : (e.g., <tt>[['f','Foo'],['b','Bar']]</tt>)<div class="sub-desc">
		 *   For a multi-dimensional array, the value in index 0 of each item will be assumed to be the combo
		 *   [value](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.MultiSelect.html#cfg-valueField), while the value at index 1 is assumed to be the combo [text](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.form.MultiSelect.html#cfg-displayField).
		 *   </div>
		 * 
		 * </div></li></ul></div>
		 * @configuration

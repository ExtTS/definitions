declare namespace Ext.ux.statusbar.StatusBar.methodParams.setStatus.Config {
	 ...
	 * [Ext.ux.statusbar.StatusBar.methodParams.setStatus.Config.setStatus](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.statusbar.StatusBar.methodParams.setStatus.Config.html#method-setStatus)
	...
	interface clear extends Ext.base.Params {
		 ...
		 * (defaults to [autoClear](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.statusbar.StatusBar.html#cfg-autoClear)).
		 * @configuration
		 * @optional
		 * @type {number}
		 */
		 ...
		 * (defaults to true which uses [defaultText](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.statusbar.StatusBar.html#cfg-defaultText) and [defaultIconCls](https://docs.sencha.com/extjs/6.0.1/classic/Ext.ux.statusbar.StatusBar.html#cfg-defaultIconCls)).
		 * @configuration
		 * @optional
		 * @type {boolean}
		 */

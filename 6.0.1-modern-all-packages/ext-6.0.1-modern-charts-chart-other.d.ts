declare namespace Ext.chart.grid {
	/** 
	 * [Ext.chart.grid.CircularGrid](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.grid.CircularGrid.html)
	...
	/** 
	 * [Ext.chart.grid.HorizontalGrid](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.grid.HorizontalGrid.html)
	...
	/** 
	 * [Ext.chart.grid.HorizontalGrid3D](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.grid.HorizontalGrid3D.html)
	...
	/** 
	 * [Ext.chart.grid.RadialGrid](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.grid.RadialGrid.html)
	...
	/** 
	 * [Ext.chart.grid.VerticalGrid](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.grid.VerticalGrid.html)
	...
	/** 
	 * [Ext.chart.grid.VerticalGrid3D](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.grid.VerticalGrid3D.html)
...
declare namespace Ext.chart.label {
	/** 
	 * [Ext.chart.label.Callout](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.label.Callout.html)
	...
	/** 
	 * [Ext.chart.label.Label](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.label.Label.html)
	 * Sprite used to represent labels in series.
	 * 
	 * Important: the actual default values are determined by the theme used.
	 * Please see the `label` config of the [Ext.chart.theme.Base.axis](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-axis).
	 */
	class Label extends Ext.draw.sprite.Text {
		...
		getBBoxCenter? (isWithoutTransform: boolean): any[];
		/** 
		 * Returns the value of [calloutLine](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.label.Label.html#cfg-calloutLine).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [field](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.label.Label.html#cfg-field).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getField? (): object;
		/** 
		 * Returns the value of [fx](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.label.Label.html#cfg-fx).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		setAttributesBypassingNormalization? (changes: object, avoidCopy?: boolean): void;
		/** 
		 * Sets the value of [calloutLine](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.label.Label.html#cfg-calloutLine).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [field](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.label.Label.html#cfg-field).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [fx](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.label.Label.html#cfg-fx).
		 * @method
		 * @public (method)
...
declare namespace Ext.chart.plugin {
	/** 
	 * [Ext.chart.plugin.ItemEvents](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.plugin.ItemEvents.html)
...
declare namespace Ext.chart.theme {
	/** 
	 * [Ext.chart.theme.Base](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html)
	...
	class Base extends Ext.Base {
		...
		constructor (config: object);
		/** 
		 * Returns the value of [axis](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-axis).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getAxis? (): object;
		/** 
		 * Returns the value of [background](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-background).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the value of [baseColor](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-baseColor).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [chart](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-chart).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getChart? (): object;
		/** 
		 * Returns the value of [colors](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-colors).
		 * @method
		 * @public (method)
		 * @returns {any[]}  
		 */
		getColors? (): any[];
		/** 
		 * Returns the value of [gradients](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-gradients).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getGradients? (): object;
		/** 
		 * Returns the value of [markerThemes](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-markerThemes).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the value of [series](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-series).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getSeries? (): object;
		/** 
		 * Returns the value of [sprites](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-sprites).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getSprites? (): object;
		/** 
		 * Returns the value of [useGradients](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-useGradients).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Sets the value of [axis](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-axis).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [background](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-background).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [baseColor](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-baseColor).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [chart](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-chart).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [colors](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-colors).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [gradients](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-gradients).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [markerThemes](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-markerThemes).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [series](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-series).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [sprites](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-sprites).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [useGradients](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-useGradients).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [seriesThemes](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-seriesThemes).
		 * @method
		 * @private (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Sets the value of [seriesThemes](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-seriesThemes).
		 * @method
		 * @private (method)
...
declare namespace Ext.chart.theme.Base {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * is a valid axis [Ext.chart.axis.Axis.position](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.axis.Axis.html#cfg-position), e.g. 'bottom') will be
		 * applied to corresponding [axis](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.axis.Axis.html) configs.
		 * E.g., the axis.defaults.label config will apply to the [Ext.chart.axis.Axis.label](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.axis.Axis.html#cfg-label)
		 * config of all axes, where the axis.left.titleMargin config will only apply to the
		 * [Ext.chart.axis.Axis.titleMargin](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.axis.Axis.html#cfg-titleMargin) config of all axes positioned to the left.
		 * @configuration
		 * @optional
		...
		background?: object;
		/** 
		 * The base color used to generate the [Ext.chart.AbstractChart.colors](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.AbstractChart.html#cfg-colors) of the theme.
		 * @configuration
		 * @optional
		 ...
		 * chart xtype, e.g. '[cartesian](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.CartesianChart.html)' or '[polar](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.PolarChart.html)')
		 * will be applied to corresponding chart configs.
		 * E.g., the chart.defaults.background config will set the [Ext.chart.AbstractChart.background](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.AbstractChart.html#cfg-background)
		 * config of all charts, where the chart.cartesian.flipXY config will only set the
		 * [Ext.chart.CartesianChart.flipXY](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.CartesianChart.html#cfg-flipXY) config of all cartesian charts.
		 * @configuration
		 * @optional
		 ...
		 * Defaults to [colorDefaults](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#property-colorDefaults).
		 * @configuration
		 * @optional
		 * @type {any[]}
		 */
		 ...
		 *    }
		 * 
		 * Please refer to the documentation for the [linear](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.gradient.Linear.html)
		 * and [radial](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.gradient.Radial.html) gradients for all possible options.
		 * The color [stops](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.gradient.Gradient.html#cfg-stops) for the gradients
		 * will be generated by the theme based on the [colors](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Base.html#cfg-colors) config.
		 * @configuration
		 * @optional
		 * @type {object}
		 */
		 ...
		 * is a valid series [Ext.chart.series.Series.type](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.series.Series.html#property-type), e.g. 'line') will be
		 * applied to corresponding series configs.
		 * E.g., the series.defaults.label config will apply to the [Ext.chart.series.Series.label](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.series.Series.html#cfg-label)
		 * config of all series, where the series.line.step config will only apply to the
		 * [Ext.chart.series.Line.step](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.series.Line.html#cfg-step) config of [line](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.series.Line.html) series.
		 * @configuration
		 * @optional
		 ...
		 * specified using the [Ext.draw.Container.sprites](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.Container.html#cfg-sprites) config.
		 * The overrides are specified by sprite type, e.g. sprites.text config
		 * tells to apply given attributes to all [text](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.sprite.Text.html) sprites.
		 * @configuration
		 * @optional
...
declare namespace Ext.chart.theme.Default {
	 ...
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.chart.theme.Default](https://docs.sencha.com/extjs/6.0.1/modern/Ext.chart.theme.Default.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * Theme defaults for the axes.

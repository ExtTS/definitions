declare namespace Ext.draw.engine {
	/** 
	 * [Ext.draw.engine.Canvas](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.engine.Canvas.html)
	...
	class Canvas extends Ext.draw.Surface {
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.draw.Surface.flatten](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.Surface.html#method-flatten).
		 * Flattens the given drawing surfaces into a single image
		 * and returns an object containing the data (in the DataURL format)
		 * and the type (e.g. 'png' or 'svg') of that image.
		 * @method
		...
		/** 
		 * Returns the value of [highPrecision](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.engine.Canvas.html#cfg-highPrecision).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Sets the value of [highPrecision](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.engine.Canvas.html#cfg-highPrecision).
		 * @method
		 * @public (method)
	...
	/** 
	 * @define [Ext.draw.engine.excanvas](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.engine.excanvas.html)
	 * @private (class)
	 */
	class excanvas {}
	/** 
	 * [Ext.draw.engine.Svg](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.engine.Svg.html)
	 * SVG engine.
	 */
	class Svg extends Ext.draw.Surface {
		...
		getFlipRtlText? (): boolean;
		/** 
		 * Returns the value of [highPrecision](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.engine.Svg.html#cfg-highPrecision).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.draw.Surface.remove](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.Surface.html#method-remove).
		 * Remove a given sprite from the surface,
		 * optionally destroying the sprite in the process.
		 * You can also call the sprite's own `remove` method.
		 * 
		...
		setFlipRtlText? (flipRtlText: boolean): void;
		/** 
		 * Sets the value of [highPrecision](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.engine.Svg.html#cfg-highPrecision).
		 * @method
		 * @public (method)
		 * @param   {boolean} highPrecision The new value.
		 * @returns {void}                  
	...
	/** 
	 * [Ext.draw.engine.SvgContext](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.engine.SvgContext.html)
...
declare namespace Ext.draw.engine.SvgContext.Gradient {
	 ...
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.draw.engine.SvgContext.Gradient](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.engine.SvgContext.Gradient.html)
	 */
...
declare namespace Ext.draw.engine.Canvas.methodReturns {
	 ...
	 * [Ext.draw.engine.Canvas.getBBox](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.engine.Canvas.html#method-getBBox)
	 */
...
declare namespace Ext.draw.engine.Svg.methodReturns {
	 ...
	 * @returns
	 * Method return interface: 
	 * [Ext.draw.engine.Svg.getBBox](https://docs.sencha.com/extjs/6.0.1/modern/Ext.draw.engine.Svg.html#method-getBBox)
	 */
	interface getBBox extends Ext.base.Returns {
	}
}

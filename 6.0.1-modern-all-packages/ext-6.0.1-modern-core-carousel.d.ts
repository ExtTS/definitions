declare namespace Ext.carousel {
	/** 
	 * [Ext.carousel.Carousel](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html)
	 ...
	 * 
	 * - [ui](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-ui) defines the style of the carousel
	 * - [direction](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-direction) defines the direction of the carousel
	 * - [indicator](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-indicator) defines if the indicator show be shown
	 * 
	 * ### Useful Methods
	 * 
	 * - [next](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#method-next) moves to the next card
	 * - [previous](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#method-previous) moves to the previous card
	 * - [setActiveItem](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#method-setActiveItem) moves to the passed card
	 */
	class Carousel extends Ext.Container {
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.carousel.Carousel.Statics}
		 */
		self?: Ext.carousel.Carousel.Statics | Ext.Container.Statics | Ext.Component.Statics | Ext.Widget.Statics | Ext.Evented.Statics | Ext.Base.Statics;
		/** 
		 * @property
		 * @private (property)
		 * @type {object}
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.carousel.Carousel;
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.carousel.Carousel;
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.carousel.Carousel;
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.carousel.Carousel;
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.carousel.Carousel;
		...
		/** 
		 * Returns the value of [animation](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-animation).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the value of [baseCls](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-baseCls).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Returns the value of [bufferSize](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-bufferSize).
		 * @method
		 * @public (method)
		 * @returns {number}  
		 */
		...
		getDefaults? (): object;
		/** 
		 * Returns the value of [direction](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-direction).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		getDirection? (): string;
		/** 
		 * Returns the value of [directionLock](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-directionLock).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [indicator](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-indicator).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		getInnerItems? (): any[];
		/** 
		 * Returns the value of [itemConfig](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-itemConfig).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the value of [itemLength](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-itemLength).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the value of [ui](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-ui).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		 ...
		 * @public (method)
		 * @chainable
		 * @returns {Ext.carousel.Carousel}  
		 */
		hide? (): Ext.carousel.Carousel;
		hide? (): Ext.Container;
		/** 
		 * Hides this Component optionally using an animation.
		 * @method
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component}             
		 */
		...
		/** 
		 * Sets the value of [animation](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-animation).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [baseCls](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-baseCls).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [bufferSize](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-bufferSize).
		 * @method
		 * @public (method)
		 * @param   {number} bufferSize The new value.
		 * @returns {void}              
		 */
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.carousel.Carousel;
		...
		/** 
		 * Sets the value of [direction](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-direction).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [directionLock](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-directionLock).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [indicator](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-indicator).
		 * @method
		 * @public (method)
		 * @param   {boolean} indicator The new value.
		 * @returns {void}              
		 */
		setIndicator? (indicator: boolean): void;
		/** 
		 * Sets the value of [itemConfig](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-itemConfig).
		 * @method
		 * @public (method)
		 * @param   {object} itemConfig The new value.
		 * @returns {void}              
		 */
		setItemConfig? (itemConfig: object): void;
		/** 
		 * Sets the value of [itemLength](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-itemLength).
		 * @method
		 * @public (method)
		 * @param   {object} itemLength The new value.
		 * @returns {void}              
		 */
		...
		/** 
		 * Sets the value of [ui](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-ui).
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component|void}           this
		 */
		toggleCls? (className: string, state?: boolean): Ext.carousel.Carousel;
		...
		getDraggable? (): void;
		/** 
		 * Returns the value of [layout](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-layout).
		 * @method
		 * @private (method)
		 * @returns {object|void}  
		 */
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.carousel.Carousel;
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.carousel.Carousel.Statics|Ext.Container.Statics|Ext.Component.Statics|Ext.Widget.Statics|Ext.Evented.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.carousel.Carousel.Statics;
		 ...
		 * @returns {object}  
		 */
		applyActiveItem? (): object;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.Container.applyActiveItem](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Container.html#method-applyActiveItem).
		 * @method
		 * @private (method)
		 ...
		 * @returns {void}             
		 */
		applyAnimation? (animation: object): void;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @param   {object} currentIndicator
		 * @returns {void}                    
		 */
		applyIndicator? (indicator: object, currentIndicator: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} left
		 ...
		 * @returns {object}       
		 */
		getInnerItemAt? (index: object): object;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} item
		 * @returns {number}      
		 */
		getInnerItemIndex? (item: object): number;
		/** 
		 * @method
		 * @private (method)
		 * @chainable
		 * @returns {Ext.carousel.Carousel|Ext.Container}  this
		 */
		getQueryRoot? (): Ext.carousel.Carousel;
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container}                this
		 */
		insertAfter? (item: object, relativeToItem: object): Ext.carousel.Carousel;
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container}                this
		 */
		insertBefore? (item: object, relativeToItem: object): Ext.carousel.Carousel;
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container}       this
		 */
		insertInner? (item: Ext.Component, index: number): Ext.carousel.Carousel;
		 ...
		 * @returns {void}         
		 */
		isIndexDirty? (index: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
		 ...
		 * @returns {void}                
		 */
		onAnimationEnd? (translatable: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} cls
		 ...
		 * @returns {void}             
		 */
		onInnerItemMove? (item: object, toIndex: object, fromIndex: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.Container.onInnerItemMove](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Container.html#method-onInnerItemMove).
		 * @method
		 * @private (method)
		 * @returns {void}  
		 */
		 ...
		 * @returns {void}  
		 */
		refreshInactiveCarouselItems? (): void;
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container}      this
		 */
		removeInner? (item: Ext.Component): Ext.carousel.Carousel;
		 ...
		 * @returns {Ext.carousel.Carousel}        this
		 */
		setOffset? (offset: object): Ext.carousel.Carousel;
		/** 
		 * @method
		 * @private (method)
		 * @chainable
		 ...
		 * @returns {Ext.carousel.Carousel}        this
		 */
		setOffsetAnimated? (offset: object): Ext.carousel.Carousel;
		/** 
		 * @method
		 * @private (method)
		 * @chainable
		 * @param   {object}                                            parent
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component}        this
		 */
		setParent? (parent: object): Ext.carousel.Carousel;
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.carousel.Carousel;
		 ...
		 * @returns {void}        
		 */
		updateBufferSize? (size: object): void;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {void}             
		 */
		updateIndicator? (indicator: object): void;
		/** 
		 * <debug></debug>
		 * @method
		 * @private (method)
	...
	/** 
	 * A private utility class used by [Ext.Carousel](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html) to create indicators.
	 * @private (class)
	 */
	class Indicator extends Ext.Component {}
	/** 
	 * The true infinite implementation of Carousel, private for now until it's stable to be public
	 * @private (class)
	 */
	class Infinite extends Ext.carousel.Carousel {}
	/** 
	 * @private (class)
	 */
	class Item extends Ext.Decorator {}
}
declare namespace Ext {
	class Carousel extends Ext.carousel.Carousel {}
}
declare namespace Ext.carousel.Carousel {
	/** 
	 * @definitions
	 ...
	 * - [setActiveItem](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#method-setActiveItem) moves to the passed card
	 */
	interface Def extends Ext.carousel.Carousel {
		/** 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.carousel.Carousel.Cfg}
		 */
		config?: Ext.carousel.Carousel.Cfg;
		/** 
		 ...
		 * @type {Ext.carousel.Carousel.Statics}
		 */
		statics?: (() => Ext.carousel.Carousel.Statics | Ext.Container.Statics | Ext.Component.Statics | Ext.Widget.Statics | Ext.Evented.Statics | Ext.Base.Statics) | Ext.carousel.Carousel.Statics | any;
	}
	/** 
	 * @statics
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.carousel.Carousel;
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.carousel.Carousel;
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.carousel.Carousel;
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.carousel.Carousel;
		 ...
		 * @returns {Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.carousel.Carousel;
...
declare namespace Ext.carousel.Indicator {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.carousel.Indicator](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Indicator.html)
	 * A private utility class used by [Ext.Carousel](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html) to create indicators.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.carousel.Indicator|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.carousel.Indicator;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Component;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Widget;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Evented;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		 ...
		 * @chainable
		 * @param   {object}                                                               members
		 * @returns {Ext.carousel.Indicator|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.carousel.Indicator;
		addStatics? (members: object): typeof Ext.Component;
		addStatics? (members: object): typeof Ext.Widget;
		addStatics? (members: object): typeof Ext.Evented;
		addStatics? (members: object): typeof Ext.Base;
		 ...
		 * @returns {Ext.carousel.Indicator|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.carousel.Indicator;
		addInheritableStatics? (members: object): typeof Ext.Component;
		addInheritableStatics? (members: object): typeof Ext.Widget;
		addInheritableStatics? (members: object): typeof Ext.Evented;
		addInheritableStatics? (members: object): typeof Ext.Base;
		 ...
		 * @returns {Ext.carousel.Indicator|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.carousel.Indicator;
		addMember? (name: object, member: object): typeof Ext.Component;
		addMember? (name: object, member: object): typeof Ext.Widget;
		addMember? (name: object, member: object): typeof Ext.Evented;
		addMember? (name: object, member: object): typeof Ext.Base;
		 ...
		 * @returns {Ext.carousel.Indicator|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.carousel.Indicator;
		onExtended? (fn: object, scope: object): typeof Ext.Component;
		onExtended? (fn: object, scope: object): typeof Ext.Widget;
		onExtended? (fn: object, scope: object): typeof Ext.Evented;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
...
declare namespace Ext.carousel.Infinite {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.carousel.Infinite](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Infinite.html)
	 * The true infinite implementation of Carousel, private for now until it's stable to be public
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.carousel.Infinite|Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.carousel.Infinite;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.carousel.Carousel;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Container;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Component;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Widget;
		 ...
		 * @chainable
		 * @param   {object}                                                                                                  members
		 * @returns {Ext.carousel.Infinite|Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.carousel.Infinite;
		addStatics? (members: object): typeof Ext.carousel.Carousel;
		addStatics? (members: object): typeof Ext.Container;
		addStatics? (members: object): typeof Ext.Component;
		addStatics? (members: object): typeof Ext.Widget;
		 ...
		 * @returns {Ext.carousel.Infinite|Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.carousel.Infinite;
		addInheritableStatics? (members: object): typeof Ext.carousel.Carousel;
		addInheritableStatics? (members: object): typeof Ext.Container;
		addInheritableStatics? (members: object): typeof Ext.Component;
		addInheritableStatics? (members: object): typeof Ext.Widget;
		 ...
		 * @returns {Ext.carousel.Infinite|Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.carousel.Infinite;
		addMember? (name: object, member: object): typeof Ext.carousel.Carousel;
		addMember? (name: object, member: object): typeof Ext.Container;
		addMember? (name: object, member: object): typeof Ext.Component;
		addMember? (name: object, member: object): typeof Ext.Widget;
		 ...
		 * @returns {Ext.carousel.Infinite|Ext.carousel.Carousel|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.carousel.Infinite;
		onExtended? (fn: object, scope: object): typeof Ext.carousel.Carousel;
		onExtended? (fn: object, scope: object): typeof Ext.Container;
		onExtended? (fn: object, scope: object): typeof Ext.Component;
		onExtended? (fn: object, scope: object): typeof Ext.Widget;
...
declare namespace Ext.carousel.Item {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.carousel.Item](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Item.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.carousel.Item|Ext.Decorator|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.carousel.Item;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Decorator;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Component;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Widget;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Evented;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		 ...
		 * @chainable
		 * @param   {object}                                                                        members
		 * @returns {Ext.carousel.Item|Ext.Decorator|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.carousel.Item;
		addStatics? (members: object): typeof Ext.Decorator;
		addStatics? (members: object): typeof Ext.Component;
		addStatics? (members: object): typeof Ext.Widget;
		addStatics? (members: object): typeof Ext.Evented;
		addStatics? (members: object): typeof Ext.Base;
		 ...
		 * @returns {Ext.carousel.Item|Ext.Decorator|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.carousel.Item;
		addInheritableStatics? (members: object): typeof Ext.Decorator;
		addInheritableStatics? (members: object): typeof Ext.Component;
		addInheritableStatics? (members: object): typeof Ext.Widget;
		addInheritableStatics? (members: object): typeof Ext.Evented;
		addInheritableStatics? (members: object): typeof Ext.Base;
		 ...
		 * @returns {Ext.carousel.Item|Ext.Decorator|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.carousel.Item;
		addMember? (name: object, member: object): typeof Ext.Decorator;
		addMember? (name: object, member: object): typeof Ext.Component;
		addMember? (name: object, member: object): typeof Ext.Widget;
		addMember? (name: object, member: object): typeof Ext.Evented;
		addMember? (name: object, member: object): typeof Ext.Base;
		 ...
		 * @returns {Ext.carousel.Item|Ext.Decorator|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.carousel.Item;
		onExtended? (fn: object, scope: object): typeof Ext.Decorator;
		onExtended? (fn: object, scope: object): typeof Ext.Component;
		onExtended? (fn: object, scope: object): typeof Ext.Widget;
		onExtended? (fn: object, scope: object): typeof Ext.Evented;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
...
declare namespace Ext.carousel.Carousel.methodParams.addListener {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.carousel.Carousel.addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#method-addListener)
...
declare namespace Ext.carousel.Carousel.methodParams.on {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.carousel.Carousel.on](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.carousel.Indicator.methodParams.addListener {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.carousel.Indicator.addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Indicator.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.carousel.Indicator.methodParams.on {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.carousel.Indicator.on](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Indicator.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.carousel.Infinite.methodParams.addListener {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.carousel.Infinite.addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Infinite.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.carousel.Infinite.methodParams.on {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.carousel.Infinite.on](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Infinite.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.carousel.Item.methodParams.addListener {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.carousel.Item.addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Item.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.carousel.Item.methodParams.on {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.carousel.Item.on](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Item.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.carousel.Carousel {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * other elements within this component. To add specific styling for sub-classes, use the [cls](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Carousel.html#cfg-cls) config.
		 * @configuration
		 * @optional
		 * @default 'x-carousel'
		 * @type {string}
		 ...
		 * @chainable
		 * @param   {object}                        config
		 * @returns {Ext.carousel.Carousel.Statics}        this
		 */
		initConfig? (config: object): Ext.carousel.Carousel.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.carousel.Carousel.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.carousel.Carousel.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.carousel.Carousel.Statics}  
		 */
		statics? (): Ext.carousel.Carousel.Statics;
	}
}
declare namespace Ext.carousel.Indicator {
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * The base CSS class to apply to this component's element. This will also be prepended to
		 * other elements within this component. To add specific styling for sub-classes, use the [cls](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Indicator.html#cfg-cls) config.
		 * @configuration
		 * @optional
		 ...
		 * @chainable
		 * @param   {object}                         config
		 * @returns {Ext.carousel.Indicator.Statics}        this
		 */
		initConfig? (config: object): Ext.carousel.Indicator.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.carousel.Indicator.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.carousel.Indicator.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.carousel.Indicator.Statics}  
		 */
		statics? (): Ext.carousel.Indicator.Statics;
	}
}
declare namespace Ext.carousel.Infinite {
	/** 
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                        config
		 * @returns {Ext.carousel.Infinite.Statics}        this
		 */
		initConfig? (config: object): Ext.carousel.Infinite.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.carousel.Infinite.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.carousel.Infinite.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.carousel.Infinite.Statics}  
		 */
		statics? (): Ext.carousel.Infinite.Statics;
	}
}
declare namespace Ext.carousel.Item {
	/** 
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * The base CSS class to apply to this component's element. This will also be prepended to
		 * other elements within this component. To add specific styling for sub-classes, use the [cls](https://docs.sencha.com/extjs/6.0.1/modern/Ext.carousel.Item.html#cfg-cls) config.
		 * @configuration
		 * @optional
		 ...
		 * @chainable
		 * @param   {object}                    config
		 * @returns {Ext.carousel.Item.Statics}        this
		 */
		initConfig? (config: object): Ext.carousel.Item.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.carousel.Item.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.carousel.Item.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.carousel.Item.Statics}  
		 */
		statics? (): Ext.carousel.Item.Statics;
	}
}
declare namespace Ext.carousel.Carousel {
	/** 

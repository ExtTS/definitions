...
declare namespace Ext.data.request {
	/** 
	 * [Ext.data.request.Ajax](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.request.Ajax.html)
	 * This class manages a pending Ajax request. Instances of this type are created by the
	 * [`Ext.data.Connection.request`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.Connection.html#method-request) method.
	 */
	class Ajax extends Ext.data.request.Base {
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.request.Base.abort](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.request.Base.html#method-abort).
		 * @method
		 * @private (method)
		 * @returns {void}  
		 */
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.request.Base.start](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.request.Base.html#method-start).
		 * Start the request.
		 * @method
		 * @public (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.data.request.Base](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.request.Base.html)
	 * This class manages a pending Ajax request. Instances of this type are created by the
	 * [`Ext.data.Connection.request`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.Connection.html#method-request) method.
	 */
	...
	/** 
	 * [Ext.data.request.Form](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.request.Form.html)
...
declare namespace Ext.data.session {
	/** 
	 * [Ext.data.session.BatchVisitor](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.session.BatchVisitor.html)
	 * This class is used internally by [`Ext.data.Session.getSaveBatch`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.Session.html#method-getSaveBatch) and is
	 * not intended for direct use. It can be studied as an example of implementing a visitor
	 * to pass to [`Ext.data.Session.visitData`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.Session.html#method-visitData).
	 */
	...
	/** 
	 * [Ext.data.session.ChangesVisitor](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.session.ChangesVisitor.html)
	 * This class is used internally by [`Ext.data.Session.getChanges`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.Session.html#method-getChanges) to build
	 * up an object describing changes in the session. It is not intended for public use but
	 * can be used as an example of the visitor [`Ext.data.Session.visitData`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.Session.html#method-visitData)
	 * requires.
	 */
	...
	/** 
	 * [Ext.data.session.ChildChangesVisitor](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.session.ChildChangesVisitor.html)
...
declare namespace Ext.data.flash.BinaryXhr {
	 ...
	 * [Ext.data.flash.BinaryXhr](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.flash.BinaryXhr.html)
	 * Simulates an XMLHttpRequest object's methods and properties as returned
	 * form the flash polyfill plugin. Used in submitting binary data in browsers that do
	 * not support doing so from JavaScript.
	 * NOTE: By default this will look for the flash object in the ext directory. When packaging and deploying the app, copy the <tt>ext/plugins</tt> directory and its contents to your root directory. For custom deployments where just the <tt>FlashPlugin.swf</tt> file gets copied (e.g. to <tt>/resources/FlashPlugin.swf</tt>), make sure to notify the framework of the location of the plugin before making the first attempt to post binary data, e.g. in the <tt>launch</tt> method of your app do:
...
declare namespace Ext.data.matrix.Matrix {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.data.matrix.Matrix](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.matrix.Matrix.html)
	 * This class manages a many-to-many matrix for a `Session`.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
...
declare namespace Ext.data.matrix.Side {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.data.matrix.Side](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.matrix.Side.html)
	 * This class manages one side of a `Matrix`.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
...
declare namespace Ext.data.matrix.Slice {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.data.matrix.Slice](https://docs.sencha.com/extjs/6.0.1/modern/Ext.data.matrix.Slice.html)
	 * This class manages one side of a `Matrix`.
	 */
	interface Statics extends Ext.base.Statics {
		/** 

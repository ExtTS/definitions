declare namespace Ext.direct {
	/** 
	 * [Ext.direct.Event](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Event.html)
	...
	/** 
	 * [Ext.direct.ExceptionEvent](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.ExceptionEvent.html)
	 * An event that is fired when an exception is received from a [Ext.direct.RemotingProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.RemotingProvider.html)
	 */
	...
	/** 
	 * [Ext.direct.JsonProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.JsonProvider.html)
	...
	class JsonProvider extends Ext.direct.Provider {
		 ...
		 * @returns {Ext.direct.Event[]}          An array of [Ext.direct.Event](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Event.html)
		 */
	...
	/** 
	 * [Ext.direct.Manager](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Manager.html)
	 ...
	 * 
	 * - [JsonProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.JsonProvider.html) for simple JSON operations
	 * - [PollingProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.PollingProvider.html) for repeated requests
	 * - [RemotingProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.RemotingProvider.html) exposes server side to the client.
	 * 
	 * A provider does not need to be invoked directly, providers are added via
	 * [#addProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Manager.html). RemotingProviders' API declarations
	 * can also be loaded with [#loadProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Manager.html), with
	...
	interface Manager extends Ext.Base {
		...
		fireEventedAction? (eventName: string, args: any[], fn: ExtGlobalFunction | string, scope?: object, fnArgs?: any[] | boolean): void;
		/** 
		 * Retrieves a [provider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Provider.html) by the id specified when the
		 * provider is added.
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [varName](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Manager.html#cfg-varName).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		 ...
		 * [addProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Manager.html#method-addProvider).
		 * 
		...
		setListeners? (listeners: object): void;
		/** 
		 * Sets the value of [varName](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Manager.html#cfg-varName).
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.direct.PollingProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.PollingProvider.html)
	 * Provides for repetitive polling of the server at distinct [intervals](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.PollingProvider.html#cfg-interval).
	...
	/** 
	 * [Ext.direct.Provider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Provider.html)
	 * [Ext.direct.Provider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Provider.html) is an abstract class meant to be extended.
	 * 
	...
	/** 
	 * [Ext.direct.RemotingEvent](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.RemotingEvent.html)
	 * An event that is fired when data is received from a
	 * [Ext.direct.RemotingProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.RemotingProvider.html). Contains a method to the
	 * related transaction for the direct request, see [getTransaction](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.RemotingEvent.html#method-getTransaction)
	 */
	...
	/** 
	 * [Ext.direct.RemotingProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.RemotingProvider.html)
	 * The [RemotingProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.RemotingProvider.html) exposes access to
	...
	/** 
	 * [Ext.direct.Transaction](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Transaction.html)
...
declare namespace Ext.direct.RemotingMethod {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.direct.RemotingMethod](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.RemotingMethod.html)
	 * Small utility class used internally to represent a Direct method.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
...
declare namespace Ext.direct.JsonProvider.methodParams.addListener {
	 ...
	 * [Ext.direct.JsonProvider.addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.JsonProvider.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.JsonProvider.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.JsonProvider.on](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.JsonProvider.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.Manager.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.Manager.addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Manager.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.Manager.methodParams.loadProvider {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.Manager.loadProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Manager.html#method-loadProvider)
...
declare namespace Ext.direct.Manager.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.Manager.on](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Manager.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.PollingProvider.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.PollingProvider.addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.PollingProvider.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.PollingProvider.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.PollingProvider.on](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.PollingProvider.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.Provider.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.Provider.addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Provider.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.Provider.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.Provider.on](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Provider.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.RemotingProvider.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.RemotingProvider.addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.RemotingProvider.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.RemotingProvider.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.direct.RemotingProvider.on](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.RemotingProvider.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.direct.JsonProvider {
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * The unique id of the provider (defaults to an [auto-assigned id](https://docs.sencha.com/extjs/6.0.1/modern/Ext.html#method-id)).
		...
		listeners?: object;
		/** 
		 * List of Provider events that should be relayed by [Ext.direct.Manager](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Manager.html).
...
declare namespace Ext.direct.PollingProvider {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * polling request. Note that if baseParams are set and [url](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.PollingProvider.html#cfg-url) parameter
		 ...
		 * is connected.
		 * 
		 * The method should accept named arguments and will be passed [baseParams](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.PollingProvider.html#cfg-baseParams)
		 * if set.
		 * @configuration
		 * @optional
		 ...
		 * 
		 * _Note_ that using string `url` is deprecated, use [pollFn](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.PollingProvider.html#cfg-pollFn) instead.
		 * @configuration
		 * @optional
		 * @type {ExtGlobalFunction|string}
		 */
...
declare namespace Ext.direct.RemotingProvider {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * If you wish to reverse to previous behavior, set [disableNestedActions](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.RemotingProvider.html#cfg-disableNestedActions)
		 * to `true`.
		 * 
		 ...
		 * dispatching a request to the server, even if [enableBuffer](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.RemotingProvider.html#cfg-enableBuffer) timeout
		 * has not yet expired.
		 * 
		 * Note that this option does nothing if [enableBuffer](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.RemotingProvider.html#cfg-enableBuffer) is set to `false`.
		 * @configuration
		 * @optional
		 * @type {number}
		 */
		 ...
		 * because it generated flat [namespace](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.RemotingProvider.html#cfg-namespace) object with dotted property names.
		 ...
		 * [namespace](https://docs.sencha.com/extjs/6.0.1/modern/Ext.html#method-namespace) created implicitly.
		 * @configuration
		 * @optional
		 * @type {string|object}
		 */
		...
		timeout?: number;
		/** 
		 * **Required**. The url to connect to the [Ext.direct.Manager](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Manager.html) server-side router.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
...
declare namespace Ext.direct.JsonProvider {
	...
	interface Events extends Ext.base.Events {
		 ...
		 * @event
		 * @param   {Ext.direct.Provider} provider The [Provider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Provider.html).
		 ...
		 * @event
		 * @param   {Ext.direct.Provider} provider The [Provider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Provider.html).
		 * @param   {Ext.direct.Event}    e        The [Ext.direct.Event](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Event.html) type that occurred.
		 * @param   {object}              eOpts    The options object passed to [Ext.util.Observable.addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.util.Observable.html#method-addListener).
		 * @returns {void}                
		 */
...
declare namespace Ext.direct.Manager {
	...
	interface Events extends Ext.base.Events {
		 ...
		 * @event
		 * @param   {Ext.direct.Event}    event    The [Event](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Event.html) that occurred.
		 * @param   {Ext.direct.Provider} provider
		 * The [Provider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Provider.html)
		...
		/** 
		 * Fired by [loadProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Manager.html#method-loadProvider) after successfully loading RemotingProvider API
		...
		/** 
		 * Fired by [loadProvider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.direct.Manager.html#method-loadProvider) when remoting API could not be loaded, or

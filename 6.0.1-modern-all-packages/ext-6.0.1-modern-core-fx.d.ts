declare namespace Ext.fx {
	/** 
	 * This class is a factory class that will create and return an animation class based on the [type](https://docs.sencha.com/extjs/6.0.1/modern/Ext.fx.Animation.html#cfg-type) configuration.
	 * @private (class)
	 */
...
declare namespace Ext.fx.Animation {
	 ...
	 * [Ext.fx.Animation](https://docs.sencha.com/extjs/6.0.1/modern/Ext.fx.Animation.html)
	 * This class is a factory class that will create and return an animation class based on the [type](https://docs.sencha.com/extjs/6.0.1/modern/Ext.fx.Animation.html#cfg-type) configuration.
	 */
...
declare namespace Ext.fx.Runner {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.fx.Runner](https://docs.sencha.com/extjs/6.0.1/modern/Ext.fx.Runner.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
...
declare namespace Ext.fx.State {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.fx.State](https://docs.sencha.com/extjs/6.0.1/modern/Ext.fx.State.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.

declare namespace Ext.mixin {
	...
	/** 
	 * A mixin that gives [Ext.Component](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Component.html) and [Ext.Widget](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Widget.html) the ability to process the "delegate"
	 * event option.
	 * @private (class)
	 */
	...
	/** 
	 * [Ext.mixin.Factoryable](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Factoryable.html)
	 * This mixin automates use of [`Ext.Factory`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Factory.html). When mixed in to a class, the `alias` of the
	 * class is retrieved and combined with an optional `factoryConfig` property on that class
	 * to produce the configuration to pass to [`Ext.Factory`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Factory.html).
	 * 
	 * The factory method created by [`Ext.Factory`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Factory.html) is also added as a static method to the
	 * target class.
	 * 
	 ...
	 * 
	 * Alternatively the produced factory is available as a static method of [`Ext.Factory`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Factory.html).
	 */
	class Factoryable extends Ext.Base {
		 ...
		 * @returns {Ext.mixin.Factoryable|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.mixin.Factoryable;
	...
	/** 
	 * [Ext.mixin.Mashup](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Mashup.html)
	 * This mixin allows users to easily require external scripts in their classes. This load
	 * process delays application launch ([`Ext.onReady`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.html#method-onReady)) until all such scripts are loaded
	...
	class Mashup extends Ext.Base {
		 ...
		 * @returns {Ext.mixin.Mashup|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.mixin.Mashup;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
	...
	/** 
	 * [Ext.mixin.Observable](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Observable.html)
	 ...
	 * [initConfig](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Observable.html#method-initConfig), so it does not need to be called a second time.
	 * 
	 * For example:
	 * 
	 *    Ext.define('Employee', {
	...
	class Observable extends Ext.Base {
		 ...
		 * add. See [addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.util.Observable.html#method-addListener).
		 * @returns {void}               
		 */
	...
	/** 
	 * A mixin for providing query related methods for [Ext.ComponentQuery](https://docs.sencha.com/extjs/6.0.1/modern/Ext.ComponentQuery.html) for classes that
	 * implement getRefItems.
	 * @private (class)
	 */
	class Queryable extends Ext.Base {}
	/** 
	 * [Ext.mixin.Responsive](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Responsive.html)
	 ...
	 *     });
	 * 
	 * To use responsiveConfig the class must be defined using the [Ext.mixin.Responsive](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Responsive.html) mixin.
	 * 
	 ...
	 *  In those cases, the viewport plugin inherits from [`Ext.plugin.Responsive`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.plugin.Responsive.html).
	 * 
	...
	class Templatable extends Ext.Mixin {
		 ...
		 * @returns {Ext.mixin.Templatable|Ext.Mixin|Ext.Base}         
		 */
		static addInheritableStatics? (members: object): typeof Ext.mixin.Templatable;
		static addInheritableStatics? (members: object): typeof Ext.Mixin;
		static addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.mixin.Templatable {
	 ...
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.mixin.Templatable](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Templatable.html)
	 */
...
declare namespace Ext.mixin.Accessible {
	 ...
	 * [Ext.mixin.Accessible](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Accessible.html)
	 * This mixin defines certain config options, properties, and APIs to be used
	 * by Components that implement accessible traits according to WAI-ARIA 1.0 specification.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.Accessible|Ext.Mixin|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.mixin.Accessible;
...
declare namespace Ext.mixin.Bindable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Bindable](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Bindable.html)
	 * This class is intended as a mixin for classes that want to provide a "bind" config that
	 * connects to a `ViewModel`.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.Bindable|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.mixin.Bindable;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.mixin.ComponentDelegation {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.ComponentDelegation](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.ComponentDelegation.html)
	 * A mixin that gives [Ext.Component](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Component.html) and [Ext.Widget](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Widget.html) the ability to process the "delegate"
	 * event option.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.ComponentDelegation|Ext.Mixin|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.mixin.ComponentDelegation;
		addInheritableStatics? (members: object): typeof Ext.Mixin;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Container {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Container](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Container.html)
	 * Common methods for both classic &amp; modern containers
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * @returns {Ext.mixin.Container|Ext.Mixin|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.mixin.Container;
		addInheritableStatics? (members: object): typeof Ext.Mixin;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Factoryable {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.Factoryable|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.mixin.Factoryable;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.mixin.Hookable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Hookable](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Hookable.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
		 ...
		 * @returns {Ext.mixin.Hookable|Ext.Mixin|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.mixin.Hookable;
		addInheritableStatics? (members: object): typeof Ext.Mixin;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Identifiable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Identifiable](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Identifiable.html)
	 * An Identifiable mixin.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * @returns {Ext.mixin.Identifiable|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.mixin.Identifiable;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.mixin.Inheritable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Inheritable](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Inheritable.html)
	 * A mixin that provides the functionality for inheritable configs. This allows linking
	 * components and containers via a prototype-chained object for accessing inherited
	 * values.
	 * 
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.Inheritable|Ext.Mixin|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.mixin.Inheritable;
		addInheritableStatics? (members: object): typeof Ext.Mixin;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Mashup {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.Mashup|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.mixin.Mashup;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.mixin.Progressable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Progressable](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Progressable.html)
	 * A Traversable mixin.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * @returns {Ext.mixin.Progressable|Ext.Mixin|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.mixin.Progressable;
		addInheritableStatics? (members: object): typeof Ext.Mixin;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Queryable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Queryable](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Queryable.html)
	 * A mixin for providing query related methods for [Ext.ComponentQuery](https://docs.sencha.com/extjs/6.0.1/modern/Ext.ComponentQuery.html) for classes that
	 * implement getRefItems.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.Queryable|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.mixin.Queryable;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.mixin.Selectable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Selectable](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Selectable.html)
	 * Tracks what records are currently selected in a databound widget. This class is mixed in to
	 * dataview and all subclasses.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.Selectable|Ext.Mixin|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.mixin.Selectable;
		addInheritableStatics? (members: object): typeof Ext.Mixin;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Templatable {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.Templatable|Ext.Mixin|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.mixin.Templatable;
		addInheritableStatics? (members: object): typeof Ext.Mixin;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Traversable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Traversable](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Traversable.html)
	 * A Traversable mixin.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * @returns {Ext.mixin.Traversable|Ext.Mixin|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.mixin.Traversable;
		addInheritableStatics? (members: object): typeof Ext.Mixin;
		addInheritableStatics? (members: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Observable.methodParams.addListener {
	 ...
	 * [Ext.mixin.Observable.addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Observable.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.mixin.Observable.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.mixin.Observable.on](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Observable.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.mixin.Accessible {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * The selector works the same way as [ariaLabelledBy](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Accessible.html#cfg-ariaLabelledBy).
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		 ...
		 * [ariaLabelledBy](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Accessible.html#cfg-ariaLabelledBy) option instead, because screen readers prefer
		 * `aria-labelledby` attribute to `aria-label`. [ariaLabel](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Accessible.html#cfg-ariaLabel) and
		 * [ariaLabelledBy](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Accessible.html#cfg-ariaLabelledBy) config options are mutually exclusive.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		 ...
		 * 
		 * [ariaLabelledBy](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Accessible.html#cfg-ariaLabelledBy) and [ariaLabel](https://docs.sencha.com/extjs/6.0.1/modern/Ext.mixin.Accessible.html#cfg-ariaLabel) config options are

declare namespace Ext.promise {
	...
	/** 
	 * [Ext.promise.Promise](https://docs.sencha.com/extjs/6.0.1/modern/Ext.promise.Promise.html)
	 ...
	 * use `new [Ext.Promise](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Promise.html)()` or `new [Ext.Deferred](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Deferred.html)()` to create and manage
	 * promises. If the browser supports the standard `Promise` constructor, this class will
	 * not be used by [`Ext.Promise`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Promise.html). This class will always be used by [`Ext.Deferred`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Deferred.html) in order
	 * to provide enhanced capabilities beyond standard promises.
	 * 
	 * A Promise's [`then()`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.promise.Promise.html#method-then) method is used to specify onFulfilled and onRejected
	 ...
	 * 
	 * See [`Ext.Deferred`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.Deferred.html) for an example of using the returned Promise.
	 */
	class Promise extends Ext.Base {
		/** 
		 * The type of `Error` propagated by the [`cancel`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.promise.Promise.html#method-cancel) method. If
		 ...
		 * [`CancellationError`](https://docs.sencha.com/extjs/6.0.1/modern/Ext.promise.Promise.html#static-property-CancellationError) that will propagate to any Promises originating from
		 * this Promise.
		 * 
...
declare namespace Ext.promise.Consequence {
	 ...
	 * [Ext.promise.Consequence](https://docs.sencha.com/extjs/6.0.1/modern/Ext.promise.Consequence.html)
	 * Consequences are used internally by a Deferred to capture and notify callbacks, and
	 * propagate their transformed results as fulfillment or rejection.
	 * 
	 * Developers never directly interact with a Consequence.
...
declare namespace Ext.promise.Deferred {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.promise.Deferred](https://docs.sencha.com/extjs/6.0.1/modern/Ext.promise.Deferred.html)
	 * Deferreds are the mechanism used to create new Promises. A Deferred has a single
	 * associated Promise that can be safely returned to external consumers to ensure they do
	 * not interfere with the resolution or rejection of the deferred operation.
	 * 

declare namespace Ext.slider {
	/** 
	 * Utility class used by [Ext.field.Slider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.field.Slider.html).
	 * @private (class)
	 */
	class Slider extends Ext.Container {}
	/** 
	 * Utility class used by [Ext.slider.Slider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Slider.html) - should never need to be used directly.
	 * @private (class)
	 */
...
declare namespace Ext.slider.Slider {
	 ...
	 * [Ext.slider.Slider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Slider.html)
	 * Utility class used by [Ext.field.Slider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.field.Slider.html).
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.slider.Slider|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}            
		 */
		 ...
		 * @returns {Ext.slider.Slider|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         this
		 */
		 ...
		 * @returns {Ext.slider.Slider|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.slider.Slider;
...
declare namespace Ext.slider.Thumb {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.slider.Thumb](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Thumb.html)
	 * Utility class used by [Ext.slider.Slider](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Slider.html) - should never need to be used directly.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * @returns {Ext.slider.Thumb|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.slider.Thumb;
		addInheritableStatics? (members: object): typeof Ext.Component;
		addInheritableStatics? (members: object): typeof Ext.Widget;
		addInheritableStatics? (members: object): typeof Ext.Evented;
		addInheritableStatics? (members: object): typeof Ext.Base;
...
declare namespace Ext.slider.Toggle {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.slider.Toggle](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Toggle.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.slider.Toggle|Ext.slider.Slider|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}            
		 */
		 ...
		 * @chainable
		 * @param   {object}                                                                                          members
		 * @returns {Ext.slider.Toggle|Ext.slider.Slider|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         this
		 */
		 ...
		 * @returns {Ext.slider.Toggle|Ext.slider.Slider|Ext.Container|Ext.Component|Ext.Widget|Ext.Evented|Ext.Base}         
		 */
		addInheritableStatics? (members: object): typeof Ext.slider.Toggle;
		addInheritableStatics? (members: object): typeof Ext.slider.Slider;
		addInheritableStatics? (members: object): typeof Ext.Container;
		addInheritableStatics? (members: object): typeof Ext.Component;
		addInheritableStatics? (members: object): typeof Ext.Widget;
...
declare namespace Ext.slider.Slider.methodParams.addListener {
	 ...
	 * [Ext.slider.Slider.addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Slider.html#method-addListener)
...
declare namespace Ext.slider.Slider.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.slider.Slider.on](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Slider.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.slider.Thumb.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.slider.Thumb.addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Thumb.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.slider.Thumb.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.slider.Thumb.on](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Thumb.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.slider.Toggle.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.slider.Toggle.addListener](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Toggle.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.slider.Toggle.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.slider.Toggle.on](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Toggle.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.slider.Slider {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * Setting this to true guarantees the ability to select every possible value in between [minValue](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Slider.html#cfg-minValue)
		 * and [maxValue](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Slider.html#cfg-maxValue) that satisfies [increment](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Slider.html#cfg-increment)
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
		 ...
		 * other elements within this component. To add specific styling for sub-classes, use the [cls](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Slider.html#cfg-cls) config.
		 * @configuration
		 * @optional
		 * @default 'x-slider'
		 * @type {string}
		...
		/** 
		 * The config object to factory [Ext.slider.Thumb](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Thumb.html) instances
		 * @configuration
		 * @optional
		...
		value?: number | number[];
		/** 
		 * Alias to [value](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Slider.html#cfg-value)
		 * @configuration
		 * @optional
		 * @type {number|number[]}
		 */
...
declare namespace Ext.slider.Thumb {
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * The base CSS class to apply to this component's element. This will also be prepended to
		 * other elements within this component. To add specific styling for sub-classes, use the [cls](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Thumb.html#cfg-cls) config.
		 * @configuration
		 * @optional
...
declare namespace Ext.slider.Toggle {
	...
	interface Cfg extends Ext.base.Configs {
		...
		/** 
		 * The base CSS class to apply to this component's element. This will also be prepended to
		 * other elements within this component. To add specific styling for sub-classes, use the [cls](https://docs.sencha.com/extjs/6.0.1/modern/Ext.slider.Toggle.html#cfg-cls) config.
		 * @configuration
		 * @optional
		 * @default 'x-toggle'
		 * @type {string}

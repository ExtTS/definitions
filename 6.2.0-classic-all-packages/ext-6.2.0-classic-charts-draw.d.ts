declare namespace Ext.draw {
	/** 
	 * [Ext.draw.Animator](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Animator.html)
	...
	/** 
	 * [Ext.draw.Container](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Container.html)
	 * The container that holds and manages instances of the [Ext.draw.Surface](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Surface.html)
	 * in which [sprites](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.sprite.Sprite.html) are rendered.  Draw containers are
	 ...
	 * sprite.  The _type_ of the sprite is [circle](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.sprite.Circle.html), so if you
	 * run this code you'll see a green circle.
	 * 
	 * You can attach sprite event listeners to the draw container with the help of the
	 * [Ext.draw.plugin.SpriteEvents](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.plugin.SpriteEvents.html) plugin.
	 * 
	 * For more information on sprites, the core elements added to a draw container's
	 * surface, refer to the [Ext.draw.sprite.Sprite](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.sprite.Sprite.html) documentation.
	 * 
	 * For more information on surfaces, the interface owned by the draw container used to
	 * manage all sprites, see the [Ext.draw.Surface](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Surface.html) documentation.
	 */
	class Container extends Ext.draw.ContainerBase {
		/** 
		 * The default URL used by [download](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Container.html#method-download).
		 * @property
		 * @public (property)
		 ...
		 * the [preview](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Container.html#method-preview) method instead. This method doesn't work in IE8.
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [resizeHandler](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Container.html#cfg-resizeHandler).
		 * @method
		 * @public (method)
		 * @returns {Function}  
		 */
	...
	/** 
	 * [Ext.draw.Draw](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Draw.html)
	 ...
	 * 
	 * When [get](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.LimitedCache.html#method-get) is called, the container will try to find the object in the list.
	 * If failed it will call the [feeder](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.LimitedCache.html#cfg-feeder) to create that object. If there are too many
	...
	/** 
	 * [Ext.draw.Matrix](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Matrix.html)
	 ...
	 * [sprites](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.sprite.Sprite.html) using a number of convenience transform
	 * methods.
	 * 
	 ...
	 * 
	 * To demonstrate, we'll start with a simple [rect](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.sprite.Rect.html) sprite
	 ...
	 *    });
	 * 
	 * Next, we'll use the [rotate](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Matrix.html#method-rotate) and [translate](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Matrix.html#method-translate) methods from our matrix
	 ...
	 * 
	 * 1. [Ext.draw.Matrix](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Matrix.html) is not read only
	...
	class Matrix extends Ext.Base {
		 ...
		 * Use [getXX](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Matrix.html#method-getXX) instead.
		 * @property
		 * @public (property)
		 * @type {number}
		 */
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.Base.create](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#static-method-create).
	...
	/** 
	 * [Ext.draw.Path](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Path.html)
	 ...
	 * 
	 * **From override Ext.draw.overrides.hittest.Path:** Adds hit testing and path intersection points methods to the [Ext.draw.Path](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Path.html).
	...
	/** 
	 * Singleton that provides methods used by the [Ext.draw.Path](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Path.html)
	 * for hit testing and finding path intersection points.
	 * @private (class)
	 */
	class PathUtil extends Ext.Base {}
	/** 
	 * [Ext.draw.Point](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Point.html)
	 * A helper class to facilitate common operations on points and vectors.
	 */
	class Point extends Ext.Base {
		/** 
		 * Creates a flyweight [Ext.draw.Point](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Point.html) instance.
		 * Takes the same parameters as the [constructor](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Point.html#method-constructor).
	...
	/** 
	 * [Ext.draw.SegmentTree](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.SegmentTree.html)
	...
	class SegmentTree extends Ext.Base {
		...
		/** 
		 * Returns the value of [strategy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.SegmentTree.html#cfg-strategy).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Sets the value of [strategy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.SegmentTree.html#cfg-strategy).
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.draw.Surface](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Surface.html)
	 * A surface is an interface to render [sprites](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.sprite.Sprite.html) inside a
	 * [draw container](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Container.html).  The surface API has methods to render
	 ...
	 * 
	 * One of the more useful methods is the [add](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Surface.html#method-add) method used to add sprites to the
	 * surface:
	 * 
	 ...
	 * 
	 * **From override Ext.draw.overrides.hittest.Surface:** Adds hit testing methods to the [Ext.draw.Surface](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Surface.html).
	...
	/** 
	 * [Ext.draw.TextMeasurer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.TextMeasurer.html)
	...
	/** 
	 * [Ext.draw.TimingFunctions](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.TimingFunctions.html)
...
declare namespace Ext.draw.Container.methodParams.download {
	 ...
	 * [Ext.draw.Container.download](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Container.html#method-download)
...
declare namespace Ext.draw.Surface.methodParams.flatten {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.draw.Surface.flatten](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Surface.html#method-flatten)
...
declare namespace Ext.draw.Surface.methodReturns {
	 ...
	 * [Ext.draw.Surface.getBBox](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Surface.html#method-getBBox)
	 */
...
declare namespace Ext.draw.Container {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * 
		 * **Note:** since resize events trigger [renderFrame](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.Container.html#method-renderFrame) calls automatically,
...
declare namespace Ext.draw.ContainerBase {
	 ...
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.draw.ContainerBase](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.ContainerBase.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * The text to place in the Preview image alt attribute.
...
declare namespace Ext.draw.LimitedCache {
	 ...
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.draw.LimitedCache](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.LimitedCache.html)
	 * Limited cache is a size limited cache container that stores limited number of objects.
	 * 
	 * When [get](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.LimitedCache.html#method-get) is called, the container will try to find the object in the list.
	 * If failed it will call the [feeder](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.LimitedCache.html#cfg-feeder) to create that object. If there are too many
	...
	interface Cfg extends Ext.base.Configs {
		...
		limit?: number;
		/** 
		 * The scope for [feeder](https://docs.sencha.com/extjs/6.2.0/classic/Ext.draw.LimitedCache.html#cfg-feeder)
		 * @configuration
		 * @optional
		 * @type {object}
		 */

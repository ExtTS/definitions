declare namespace Ext.data.field {
	class Boolean extends Ext.data.field.Field {
		 ...
		 * any [sortType](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-sortType). Also see [compare](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-compare).
		 * @method
		 * @public (method)
		 ...
		 * [collate](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-collate).
		 * @method
		 * @public (method)
		 * @param   {object} value1 The first value.
		 * @param   {object} value2 The second value.
		...
		destroy? (): void;
		/** 
		 * Gets allowBlank for this field. See [allowBlank](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-allowBlank).
		 * @method
		 * @public (method)
		...
		/** 
		 * Gets allowNull for this field. See [allowNull](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-allowNull).
		 * @method
		 * @public (method)
		...
		/** 
		 * Gets converter for this field. See [convert](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-convert).
		 * @method
		 * @public (method)
		...
		/** 
		 * Gets the defaultValue for this field. See [defaultValue](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-defaultValue).
		 * @method
		 * @public (method)
		...
		/** 
		 * Gets the depends for this field. See [depends](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-depends).
		 * @method
		 * @public (method)
		...
		/** 
		 * Get the mapping for this field. See [mapping](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-mapping).
		 * @method
		 * @public (method)
		...
		getMapping? (): object;
		/** 
		 * Gets the name for this field. See [name](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-name).
		 * @method
		 * @public (method)
		 * @returns {string}  name
		 */
		getName? (): string;
		/** 
		 * Gets the persist for this field. See [persist](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-persist).
		 * @method
		 * @public (method)
		...
		getSortDir? (): string;
		/** 
		 * Gets the sortType for this field. See [sortType](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-sortType).
		 * @method
		 * @public (method)
		 ...
		 * This uses the [compare](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-compare) method to determine equality, so
		...
		/** 
		 * A function which converts the Model's value for this Field into a form which can be used by whatever [Writer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.writer.Writer.html)
	...
	/** 
	 * [Ext.data.field.Date](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Date.html)
	...
	class Date extends Ext.data.field.Field {
		...
		getConvert? (): ExtGlobalFunction;
		/** 
		 * Gets the dateFormat for this field. See [dateFormat](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Date.html#cfg-dateFormat).
		 * @method
		 * @public (method)
		...
		/** 
		 * Gets the dateReadFormat for this field. See [dateReadFormat](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Date.html#cfg-dateReadFormat).
		 * @method
		 * @public (method)
		...
		/** 
		 * Gets the dateWriteFormat for this field. See [dateWriteFormat](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Date.html#cfg-dateWriteFormat).
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.data.field.Field](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html)
	 * Fields are used to define the members of a Model. They aren't instantiated directly;
	 * instead, when we create a class that extends [Ext.data.Model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html), it automatically
	 * creates Field instances for each field configured in a [Model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html).
	 ...
	 * 
	 * - [auto](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html) (Default, implies no conversion)
	 * - [string](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.String.html)
	 * - [int](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Integer.html)
	 * - [number](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Number.html)
	 * - [boolean](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Boolean.html)
	 * - [date](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Date.html)
	 * 
	 * # Conversion
	 * 
	 ...
	 * [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-convert) method. This method is passed the received value (as
	 * well as the current record instance, but see below) and it returns the value to carry
	 * forward.
	 * 
	 * For `auto` fields there is no [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-convert) method. This is for
	 * efficiency. For other field types, there are often `convert` methods. You can provide
	 * a [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-convert) config when the field is defined like this:
	 * 
	 *     {
	 *         name: 'timestamp',
	 *    
	 ...
	 * `convert` (either to the [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-convert) method or to the
	 * [`convert](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-convert) config)`.
	 * 
	 * ## Calculated Values
	 * 
	 * In some cases fields are the result of a calculation from other fields. Historically
	 * this was a second role for [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-convert) but that has some short
	 * comings. The simpler solution is the [`calculate`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-calculate) config.
	 * 
	 * Values produced by [`calculate`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-calculate) and [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-convert)
	 ...
	 *     }
	 * 
	 * Using [`calculate`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-calculate) is the simplest and safest way to define a
	 ...
	 * [#fields](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html#cfg-fields) of the model.
	 * 
	 * ### Using `convert`
	 * 
	 * Following is the equivalent technique using [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-convert)
	 * 
	 *     {
	 *         name: 'firstName',
	 *    
	 ...
	 *     }
	 * 
	 * When a [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-convert) function accepts a 2nd argument (a reference to
	 * the record), it is considered a calculated field. If a [`depends`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-depends)
	 * config is not provided then this field's dependencies are unknown. In this case, the
	 * [`depends`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-depends) are provided as would be automatically determined with
	 * the [`calculate`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-calculate) config.
	 * 
	 * ### Updating
	 * 
	 * Fields modified with the [set](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html#method-set) method will have their stored
	 ...
	 * [`Ext.data.Model.convertOnSet`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html#cfg-convertOnSet) config to `false`.
	 * 
	 * **Note:** convertOnSet `false` only prevents the convert / calculate call when the
	 * set `fieldName` param matches the field's [`name`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-name).  See
	 * [convertOnSet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html#cfg-convertOnSet) for additional details.
	 * 
	 * ### Dependencies
	 * 
	 * When a field's [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-convert) method processes values from the record
	 * (vs. just the field's value), it is best to also provide a `depends` config as shown
	 * above. Fields that provide a [`calculate`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-calculate) method must follow the
	 ...
	 * with [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-convert) methods that use the provided record that do _not_
	 * specify a [`depends`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-depends) config are processed as a group after all other
	 ...
	 * 
	 * By default, only [`date`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Date.html) fields have a `serialize` method.
	 ...
	 * ## Validation
	 * 
	 * Custom field types can override the [`validate`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-validate) method or
	 * provide a set of [`validators`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-validators).
	 * 
	...
	class Field extends Ext.Base {
		/** 
		 * This property is `true` if this field has a [`calculate`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-calculate)
		 * method or a [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-convert) method that operates on the entire
		 * record as opposed to just the data value. This property is determined from the
		 * `length` of the [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-convert) function which means this is
		 * _not_ calculated:
		 * 
		 *     convert: function (value) {
		 *         return ...
		 ...
		 *     }
		 * 
		 * **NOTE:** It is recommended for such fields to use [`calculate`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-calculate)
		 * or explicitly specify the fields used by [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-convert) using
		 * [`depends`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-depends).
		 * @property
		 * @public (property)
		 * @readonly
		 * @default false
		...
		/** 
		 * The class (derived from [Ext.data.Model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html)) that defined this field.
		 * 
		...
		/** 
		 * This property is set to `true` if this is an [id](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html#cfg-idProperty)
		 * field.
		 * @property
		 * @public (property)
		 * @readonly
		...
		/** 
		 * The position of this field in the [Ext.data.Model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html) in which it was defined.
		 * @property
		 * @public (property)
		 * @type {number}
		 */
		 ...
		 * a [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-convert) config.
		 * 
		 ...
		 * [fields](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html#cfg-fields) array.
	...
	class Number extends Ext.data.field.Integer {
		 ...
		 * A function which converts the value provided by the Reader into the value that will
		 * be stored in the record. This method can be overridden by a derived class or set as
		 * a [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Integer.html#cfg-convert) config.
		 * 
		 * If configured as `null`, then no conversion will be applied to the raw data property
		 * when this Field is read. This will increase performance. but you must ensure that
		 * the data is of the correct type and does not _need_ converting.
...
declare namespace Ext.data.field.Boolean {
	 ...
	 * [Ext.data.field.Boolean](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Boolean.html)
	 */
...
declare namespace Ext.data.field.Integer {
	 ...
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.data.field.Integer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Integer.html)
	 */
...
declare namespace Ext.data.field.Number {
	 ...
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.data.field.Number](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Number.html)
	 */
...
declare namespace Ext.data.field.String {
	 ...
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.data.field.String](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.String.html)
	 */
...
declare namespace Ext.data.field.Boolean {
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * Used for validating a [model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html). Defaults to true. An empty value here will cause
		 * [Ext.data.Model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html).[isValid](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html#method-isValid) to evaluate to false.
		 * @configuration
		 * @optional
		 * @default true
		 * @type {boolean}
		...
		allowBlank?: boolean;
		/** 
		 * Use when converting received data into a [&lt;code&gt;int&lt;/code&gt;](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Integer.html),
		 * [&lt;code&gt;float&lt;/code&gt;](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Number.html), [&lt;code&gt;bool&lt;/code&gt;](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Boolean.html)
		 * or [&lt;code&gt;string&lt;/code&gt;](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.String.html) type. If the value cannot be
		 ...
		 * - for `bool` - `false`.
		 * 
		 * Note that when parsing of [&lt;code&gt;date&lt;/code&gt;](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Date.html) type fails, the value will
		 ...
		 * 
		 * **Note:** The use of calculate and [convert](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-convert) are exclusive.  The
		...
		/** 
		 * If specified this config overrides the [`convert`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#method-convert) method. See
		 * also [`calculate`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-calculate) for simple field calculations.
		 * 
		 * **Note:** The use of [calculate](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-calculate) and convert are exclusive.  The calculate
		 ...
		 * [`Ext.data.Model.idProperty`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html#cfg-idProperty) but the [`Ext.data.Model.versionProperty`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html#cfg-versionProperty)
		 ...
		 * and the property referenced by the [`mapping`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-mapping)
		...
		defaultValue?: object;
		/** 
		 * The field name or names within the [Model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html) on which the value
		 ...
		 * 
		 * Whenever any of the named fields are set using the [set](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html#method-set)
		 * method, this fields will have its `convert` method called passing the
		 * [record](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html) so that the dependent value can be calculated from
		...
		/** 
		 * (Optional) A path expression for use by the [Ext.data.reader.Reader](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.reader.Reader.html) implementation that is creating the
		 * [Model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html) to extract the Field value from the data object. If the path expression is the same
		 ...
		 * item's [rootProperty](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.reader.Json.html#cfg-rootProperty) Array. Defaults to the field name. If a function is passed,
		 ...
		 * 
		 * The mapping is an [Ext.DomQuery](https://docs.sencha.com/extjs/6.2.0/classic/Ext.dom.Query.html) path to the data item relative to the DOM element that represents the
		 * [record](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.reader.Xml.html#cfg-record). Defaults to the field name. If a function is passed, a single argument
		 ...
		 * </ul>
		 * 
		 * If a more complex value extraction strategy is required, then configure the Field with a [convert](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-convert)
		 ...
		 * [Ext.grid.property.HeaderContainer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.property.HeaderContainer.html).
		 * 
		...
		name?: string;
		/** 
		 * False to exclude this field from the [Ext.data.Model.modified](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html#property-modified) fields in a
		 * record. This will also exclude the field from being written using a
		 * [Ext.data.writer.Writer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.writer.Writer.html). This option is useful when fields are used to keep
		 ...
		 * 
		 * For further documentation, see [Ext.data.schema.Reference](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.schema.Reference.html).
		 * @configuration
		 * @optional
		 * @type {string|object}
		 */
		 ...
		 * 
		 * Predefined functions are provided in [Ext.data.SortTypes](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.SortTypes.html). A custom sort example:
		 * 
		 ...
		 * [Ext.data.SortTypes](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.SortTypes.html).
		 * @configuration
		 * @optional
		 ...
		 * that a `unique` field cannot also be [nullable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Field.html#cfg-allowBlank).
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
		...
		unique?: boolean;
		/** 
		 * An array of [validators](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.validator.Validator.html) for this field. These
...
declare namespace Ext.data.field.Date {
	...
	interface Cfg extends Ext.base.Configs {
		...
		critical?: boolean;
		/** 
		 * Serves as a default for the [dateReadFormat](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Date.html#cfg-dateReadFormat) and [dateWriteFormat](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Date.html#cfg-dateWriteFormat) config options. This
		 * will be used in place of those other configurations if not specified.
		 * 
		 * A format string for the [Ext.Date.parse](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Date.html#method-parse) function, or "timestamp" if the value provided by
		 * the Reader is a UNIX timestamp, or "time" if the value provided by the Reader is a javascript millisecond
		 * timestamp. See [Ext.Date](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Date.html).
		 * 
		 * It is quite important to note that while this config is optional, it will default to using the base
		 * JavaScript Date object's `parse` function if not specified, rather than [Ext.Date.parse](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Date.html#method-parse).
		 * This can cause unexpected issues, especially when converting between timezones, or when converting dates that
		 * do not have a timezone specified. The behavior of the native [`Date.parse`](https://docs.sencha.com/extjs/6.2.0/classic/Date.html#static-method-parse) is implementation-specific, and
		...
		dateFormat?: string;
		/** 
		 * Used when converting received data into a Date when the [type](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Date.html#property-type) is specified as `"date"`.
		 * This configuration takes precedence over [dateFormat](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Date.html#cfg-dateFormat).
		 * See [dateFormat](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Date.html#cfg-dateFormat) for more information.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		...
		/** 
		 * Provides a custom format when serializing dates with a [Ext.data.writer.Writer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.writer.Writer.html).
		 * If this is not specified, the [dateFormat](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.field.Date.html#cfg-dateFormat) will be used. If no `dateFormat`
		 * is specified, 'timestamp' format is used.
		 * 
		 * See the [Ext.data.writer.Writer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.writer.Writer.html) docs for more information on writing dates.
		 * 
		 * **Note** It is not possible to use the standard date serialization pathway or [native browser JSON production](https://docs.sencha.com/extjs/6.2.0/classic/Ext.html#property-USE_NATIVE_JSON)
		 * to use a [JsonWriter](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.writer.Json.html) to send Microsoft formated
		 * "JSON" dates.
		 * 
		 * To use a [JsonWriter](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.writer.Json.html) to write dates in a JSON packet in
		 ...
		 *     }
		 * 
		 * Then override the [`Ext.JSON`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.JSON.html) date serialize function:
		 * 
		 ...
		 * is specified, will use value of Ext.Date.useStrict to determine how to
		 * process dates.
		 * @configuration
		 * @optional
		 * @type {boolean}

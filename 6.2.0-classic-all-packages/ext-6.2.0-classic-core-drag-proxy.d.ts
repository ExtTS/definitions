declare namespace Ext.drag.proxy {
	/** 
	 * [Ext.drag.proxy.None](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.None.html)
	 * A base class for drag proxies that are shown to represent the
	 * dragged item during a drag.
	 * 
	 * Default implementations are:
	 * 
	 * - [Ext.drag.proxy.Original](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Original.html): Moves the original element.
	 * - [Ext.drag.proxy.Placeholder](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Placeholder.html): Creates a new element each drag.
	 * 
	...
	class None extends Ext.Base {
		 ...
		 * @property
		 * @public (property)
		 * @default {aliasPrefix: 'drag.proxy.', type: 'dragproxy'}
		 * @type {object}
		 */
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.drag.proxy.None.Statics}
		 */
		self?: Ext.drag.proxy.None.Statics | Ext.Base.Statics;
		/** 
		 * @property
		 * @private (property)
		 * @default 'factoryable'
		 ...
		 * @returns {Ext.drag.proxy.None|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.drag.proxy.None;
		 ...
		 * @returns {Ext.drag.proxy.None|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.drag.proxy.None;
		 ...
		 * @returns {Ext.drag.proxy.None|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.drag.proxy.None;
		 ...
		 * @returns {Ext.drag.proxy.None|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.drag.proxy.None;
		...
		/** 
		 * Returns the value of [source](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.None.html#cfg-source).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		 ...
		 * @returns {Ext.drag.proxy.None|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.drag.proxy.None;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Sets the value of [source](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.None.html#cfg-source).
		 * @method
		 * @public (method)
		 * @param   {object} source The new value.
		 * @returns {void}          
		 */
		 ...
		 */
		getElement? (info: Ext.drag.Info): Ext.dom.Element;
		/** 
		 ...
		 * @returns {void}               
		 */
		update? (info: Ext.drag.Info): void;
		/** 
		 ...
		 * @returns {number[]}           The adjusted position.
		 */
		adjustCursorOffset? (info: Ext.drag.Info, pos: number[]): number[];
		/** 
		 ...
		 * @returns {Ext.drag.proxy.None|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.drag.proxy.None;
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.drag.proxy.None.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.drag.proxy.None.Statics;
		 ...
		 * @returns {Ext.drag.proxy.None|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.drag.proxy.None;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * [Ext.drag.proxy.Original](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Original.html)
	 * A drag proxy that uses the [Ext.drag.Source.element](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.Source.html#cfg-element).
	 */
	class Original extends Ext.drag.proxy.None {
		/** 
		 * Get the reference to the current class from which this object was instantiated. Unlike [statics](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#method-statics),
		 * `this.self` is scope-dependent and it's meant to be used for dynamic inheritance. See [statics](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#method-statics)
		 * for a detailed comparison
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.drag.proxy.Original.Statics}
		 */
		self?: Ext.drag.proxy.Original.Statics | Ext.drag.proxy.None.Statics | Ext.Base.Statics;
		/** 
		 * @property
		 * @private (property)
		 * @type {object}
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.drag.proxy.Original|Ext.drag.proxy.None|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.drag.proxy.Original;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.drag.proxy.None;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                               members
		 * @returns {Ext.drag.proxy.Original|Ext.drag.proxy.None|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.drag.proxy.Original;
		static addStatics? (members: object): typeof Ext.drag.proxy.None;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.drag.proxy.Original|Ext.drag.proxy.None|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.drag.proxy.Original;
		static addMember? (name: object, member: object): typeof Ext.drag.proxy.None;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.drag.proxy.Original|Ext.drag.proxy.None|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.drag.proxy.Original;
		static onExtended? (fn: object, scope: object): typeof Ext.drag.proxy.None;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 ...
		 * @returns {Ext.drag.proxy.Original|Ext.drag.proxy.None|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.drag.proxy.Original;
		setConfig? (name: string | object, value?: object): Ext.drag.proxy.None;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Sets the value of [source](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.None.html#cfg-source).
		 ...
		 * @returns {Ext.dom.Element}      The element.
		 */
		getElement? (info: object): Ext.dom.Element;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.drag.proxy.None.getElement](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.None.html#method-getElement).
		 * Get the proxy element for the drag source. This is called as
		 * the drag starts. This element may be cached on the instance and
		 * reused.
		 * @method
		 ...
		 * @returns {Ext.drag.proxy.Original|Ext.drag.proxy.None|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.drag.proxy.Original;
		initConfig? (config: object): Ext.drag.proxy.None;
		initConfig? (config: object): Ext.Base;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.drag.proxy.Original.Statics|Ext.drag.proxy.None.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.drag.proxy.Original.Statics;
		statics? (): Ext.drag.proxy.None.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 * This method applies a versioned, deprecation declaration to this class. This
		 ...
		 * @returns {Ext.drag.proxy.Original|Ext.drag.proxy.None|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.drag.proxy.Original;
		unlink? (names: string[]): Ext.drag.proxy.None;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * [Ext.drag.proxy.Placeholder](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Placeholder.html)
	 * A drag proxy that creates a new element to follow the cursor.
	 */
	class Placeholder extends Ext.drag.proxy.None {
		/** 
		 * Get the reference to the current class from which this object was instantiated. Unlike [statics](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#method-statics),
		 * `this.self` is scope-dependent and it's meant to be used for dynamic inheritance. See [statics](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#method-statics)
		 * for a detailed comparison
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.drag.proxy.Placeholder.Statics}
		 */
		self?: Ext.drag.proxy.Placeholder.Statics | Ext.drag.proxy.None.Statics | Ext.Base.Statics;
		/** 
		 * @property
		 * @private (property)
		 * @type {object}
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.drag.proxy.Placeholder|Ext.drag.proxy.None|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.drag.proxy.Placeholder;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.drag.proxy.None;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                                  members
		 * @returns {Ext.drag.proxy.Placeholder|Ext.drag.proxy.None|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.drag.proxy.Placeholder;
		static addStatics? (members: object): typeof Ext.drag.proxy.None;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.drag.proxy.Placeholder|Ext.drag.proxy.None|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.drag.proxy.Placeholder;
		static addMember? (name: object, member: object): typeof Ext.drag.proxy.None;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.drag.proxy.Placeholder|Ext.drag.proxy.None|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.drag.proxy.Placeholder;
		static onExtended? (fn: object, scope: object): typeof Ext.drag.proxy.None;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 ...
		 * 
		 * To prevent potential memory leaks, all object references will be nulled
		 * at the end of destruction sequence, unless [clearPropertiesOnDestroy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Placeholder.html#property-clearPropertiesOnDestroy)
		 * is set to `false`.
		 * @method
		 * @public (method)
		 * @returns {void}  
		...
		destroy? (): void;
		/** 
		 * Returns the value of [cls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Placeholder.html#cfg-cls).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		getConfig? (name?: string, peek?: boolean): object;
		/** 
		 * Returns the value of [cursorOffset](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Placeholder.html#cfg-cursorOffset).
		 * @method
		 * @public (method)
		 * @returns {number[]}  
		 */
		...
		getElement? (info: Ext.drag.Info): Ext.dom.Element;
		/** 
		 * Returns the value of [html](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Placeholder.html#cfg-html).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		getInitialConfig? (name?: string): object | any;
		/** 
		 * Returns the value of [invalidCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Placeholder.html#cfg-invalidCls).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		getSource? (): object;
		/** 
		 * Returns the value of [validCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Placeholder.html#cfg-validCls).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		getValidCls? (): string;
		/** 
		 * Sets the value of [cls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Placeholder.html#cfg-cls).
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.drag.proxy.Placeholder|Ext.drag.proxy.None|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.drag.proxy.Placeholder;
		setConfig? (name: string | object, value?: object): Ext.drag.proxy.None;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Sets the value of [cursorOffset](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Placeholder.html#cfg-cursorOffset).
		 * @method
		 * @public (method)
		 * @param   {number[]} cursorOffset The new value.
		 * @returns {void}                  
		 */
		setCursorOffset? (cursorOffset: number[]): void;
		/** 
		 * Sets the value of [html](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Placeholder.html#cfg-html).
		 * @method
		 * @public (method)
		 * @param   {string} html The new value.
		 * @returns {void}        
		 */
		setHtml? (html: string): void;
		/** 
		 * Sets the value of [invalidCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Placeholder.html#cfg-invalidCls).
		 * @method
		 * @public (method)
		...
		setSource? (source: object): void;
		/** 
		 * Sets the value of [validCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Placeholder.html#cfg-validCls).
		 * @method
		 * @public (method)
		 * @param   {string} validCls The new value.
		 * @returns {void}            
		 */
		setValidCls? (validCls: string): void;
		/** 
		 * Called when the target changes for the active drag. This may
		 * mean the target is now `null`.
		 * @method
		 ...
		 * @returns {Ext.drag.proxy.Placeholder|Ext.drag.proxy.None|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.drag.proxy.Placeholder;
		initConfig? (config: object): Ext.drag.proxy.None;
		initConfig? (config: object): Ext.Base;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.drag.proxy.Placeholder.Statics|Ext.drag.proxy.None.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.drag.proxy.Placeholder.Statics;
		statics? (): Ext.drag.proxy.None.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 * This method applies a versioned, deprecation declaration to this class. This
		 ...
		 * @returns {Ext.drag.proxy.Placeholder|Ext.drag.proxy.None|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.drag.proxy.Placeholder;
		unlink? (names: string[]): Ext.drag.proxy.None;
		unlink? (names: string[]): Ext.Base;
	}
}
declare namespace Ext.drag.proxy.None {
	/** 
	 * @definitions
	 ...
	 * for cursor tracking only.
	 */
	interface Def extends Ext.drag.proxy.None {
		/** 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.drag.proxy.None.Cfg}
		 */
		config?: Ext.drag.proxy.None.Cfg;
		/** 
		 ...
		 * @type {Ext.drag.proxy.None.Statics}
		 */
		statics?: (() => Ext.drag.proxy.None.Statics | Ext.Base.Statics) | Ext.drag.proxy.None.Statics | any;
	}
}
declare namespace Ext.drag.proxy.Original {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.drag.proxy.Original](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Original.html)
	 * A drag proxy that uses the [Ext.drag.Source.element](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.Source.html#cfg-element).
	 */
	interface Def extends Ext.drag.proxy.Original {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.drag.proxy.Original.Cfg}
		 */
		config?: Ext.drag.proxy.Original.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * @type {Ext.drag.proxy.Original.Statics}
		 */
		statics?: (() => Ext.drag.proxy.Original.Statics | Ext.drag.proxy.None.Statics | Ext.Base.Statics) | Ext.drag.proxy.Original.Statics | any;
	}
}
declare namespace Ext.drag.proxy.Placeholder {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.drag.proxy.Placeholder](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.proxy.Placeholder.html)
	 * A drag proxy that creates a new element to follow the cursor.
	 */
	interface Def extends Ext.drag.proxy.Placeholder {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.drag.proxy.Placeholder.Cfg}
		 */
		config?: Ext.drag.proxy.Placeholder.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * @type {Ext.drag.proxy.Placeholder.Statics}
		 */
		statics?: (() => Ext.drag.proxy.Placeholder.Statics | Ext.drag.proxy.None.Statics | Ext.Base.Statics) | Ext.drag.proxy.Placeholder.Statics | any;
	}
}
declare namespace Ext.drag.proxy.None {
	/** 
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.drag.proxy.None|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.drag.proxy.None;
		 ...
		 * @returns {Ext.drag.proxy.None|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.drag.proxy.None;
		 ...
		 * @returns {Ext.drag.proxy.None|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.drag.proxy.None;
		 ...
		 * @returns {Ext.drag.proxy.None|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.drag.proxy.None;
...
declare namespace Ext.drag.proxy.Original {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.drag.proxy.Original|Ext.drag.proxy.None|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.drag.proxy.Original;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.drag.proxy.None;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @returns {Ext.drag.proxy.Original|Ext.drag.proxy.None|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.drag.proxy.Original;
		addStatics? (members: object): typeof Ext.drag.proxy.None;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.drag.proxy.Original|Ext.drag.proxy.None|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.drag.proxy.Original;
		addMember? (name: object, member: object): typeof Ext.drag.proxy.None;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.drag.proxy.Original|Ext.drag.proxy.None|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.drag.proxy.Original;
		onExtended? (fn: object, scope: object): typeof Ext.drag.proxy.None;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.drag.proxy.Placeholder {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.drag.proxy.Placeholder|Ext.drag.proxy.None|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.drag.proxy.Placeholder;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.drag.proxy.None;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @returns {Ext.drag.proxy.Placeholder|Ext.drag.proxy.None|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.drag.proxy.Placeholder;
		addStatics? (members: object): typeof Ext.drag.proxy.None;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.drag.proxy.Placeholder|Ext.drag.proxy.None|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.drag.proxy.Placeholder;
		addMember? (name: object, member: object): typeof Ext.drag.proxy.None;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.drag.proxy.Placeholder|Ext.drag.proxy.None|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.drag.proxy.Placeholder;
		onExtended? (fn: object, scope: object): typeof Ext.drag.proxy.None;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.drag.proxy.None {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                      config
		 * @returns {Ext.drag.proxy.None.Statics}        this
		 */
		initConfig? (config: object): Ext.drag.proxy.None.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.drag.proxy.None.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.drag.proxy.None.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.drag.proxy.None.Statics}  
		 */
		statics? (): Ext.drag.proxy.None.Statics;
	}
}
declare namespace Ext.drag.proxy.Original {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                          config
		 * @returns {Ext.drag.proxy.Original.Statics}        this
		 */
		initConfig? (config: object): Ext.drag.proxy.Original.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.drag.proxy.Original.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.drag.proxy.Original.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.drag.proxy.Original.Statics}  
		 */
		statics? (): Ext.drag.proxy.Original.Statics;
	}
}
declare namespace Ext.drag.proxy.Placeholder {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * invalid [target](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.Target.html).
		 * @configuration
		 * @optional
		 * @default ''
		 * @type {string}
		 ...
		 * valid [target](https://docs.sencha.com/extjs/6.2.0/classic/Ext.drag.Target.html).
		 * @configuration
		 * @optional
		 * @default ''
		 * @type {string}
		 ...
		 * @chainable
		 * @param   {object}                             config
		 * @returns {Ext.drag.proxy.Placeholder.Statics}        this
		 */
		initConfig? (config: object): Ext.drag.proxy.Placeholder.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.drag.proxy.Placeholder.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.drag.proxy.Placeholder.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.drag.proxy.Placeholder.Statics}  
		 */
		statics? (): Ext.drag.proxy.Placeholder.Statics;
	}
}

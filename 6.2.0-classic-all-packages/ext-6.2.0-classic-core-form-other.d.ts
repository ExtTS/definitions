declare namespace Ext.form.action {
	/** 
	 * [Ext.form.action.Action](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html)
	 * The subclasses of this class provide actions to perform upon [Form](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html)s.
	 * 
	 * Instances of this class are only created by a [Form](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html) when the Form needs to perform an action
	 * such as submit or load. The Configuration options listed for this class are set through the Form's action methods:
	 * [submit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#method-submit), [load](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#method-load) and [doAction](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#method-doAction)
	 * 
	 * The instance of Action which performed the action is passed to the success and failure callbacks of the Form's action
	 * methods ([submit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#method-submit), [load](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#method-load) and
	 * [doAction](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#method-doAction)), and to the [actioncomplete](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#event-actioncomplete) and
	 * [actionfailed](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#event-actionfailed) event handlers.
	 */
	class Action extends Ext.Base {
		 ...
		 * side validation is performed unless [Ext.form.action.Submit.clientValidation](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Submit.html#cfg-clientValidation) is explicitly set to
		 * false.
		 * @property
		 * @public (property)
		 * @static
		 ...
		 * server. The [response](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#property-response) may be examined to provide further information.
		 * @property
		 * @public (property)
		 * @static
		 * @readonly
		...
		/** 
		 * Failure type returned when server side processing fails and the [result](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#property-result)'s `success` property is set to
		 * false.
		 * 
		 * In the case of a form submission, field-specific error messages may be returned in the [result](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#property-result)'s
		 * errors property.
		 * @property
		 * @public (property)
		 * @static
		 ...
		 * [CLIENT_INVALID](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#static-property-CLIENT_INVALID), [SERVER_INVALID](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#static-property-SERVER_INVALID), [CONNECT_FAILURE](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#static-property-CONNECT_FAILURE), or [LOAD_FAILURE](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#static-property-LOAD_FAILURE).
		 * 
		 * Usage:
		 * 
		 ...
		 * [handleResponse](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#method-handleResponse) to build the result object.
		 * @method
		 * @private (method)
	...
	/** 
	 * [Ext.form.action.DirectLoad](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.DirectLoad.html)
	 ...
	 * See [Ext.direct.Manager](https://docs.sencha.com/extjs/6.2.0/classic/Ext.direct.Manager.html) for more information.
	 * 
	 * For corresponding submit action, see [Ext.form.action.DirectSubmit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.DirectSubmit.html).
	 */
	...
	/** 
	 * [Ext.form.action.DirectSubmit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.DirectSubmit.html)
	 ...
	 * See [Ext.direct.Manager](https://docs.sencha.com/extjs/6.2.0/classic/Ext.direct.Manager.html) for more information.
	 * 
	 * For corresponding load action, see [Ext.form.action.DirectLoad](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.DirectLoad.html).
	 */
	class DirectSubmit extends Ext.form.action.Submit {
		 ...
		 * submitted (everything returned by [getParams](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Submit.html#method-getParams).
		 * 
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.form.action.Action.getParams](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#method-getParams).
		 * Get the set of parameters specified in the BasicForm's baseParams and/or the params option.
		 * Items in params override items of the same name in baseParams.
		 * @method
		 * @private (method)
	...
	/** 
	 * [Ext.form.action.Load](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Load.html)
	 * A class which handles loading of data from a server into the Fields of an [Ext.form.Basic](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html).
	 * 
	 * Instances of this class are only created by a [Form](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html) when [load](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#method-load)ing.
	 * 
	 ...
	 * the Field's [setValue](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.field.Field.html#method-setValue) method.
	 * 
	 * ## JSON Packets
	 * 
	 ...
	 *    }
	 * 
	 * Other data may be placed into the response for processing the [Form](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html)'s callback or event handler
	 * methods. The object decoded from this JSON is available in the [result](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#property-result) property.
	 */
	...
	/** 
	 * [Ext.form.action.StandardSubmit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.StandardSubmit.html)
	 * A class which handles submission of data from [Form](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html)s using a standard `&lt;form&gt;` element submit.
	 ...
	 * be called.
	 * 
	 * Instances of this class are only created by a [Form](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html) when
	 * [submit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#method-submit)ting, when the form's [Ext.form.Basic.standardSubmit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#cfg-standardSubmit) config option is true.
	 */
	class StandardSubmit extends Ext.form.action.Submit {
		 ...
		 * field value returned by [Ext.form.Basic.getValues](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#method-getValues), plus any configured [params](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.StandardSubmit.html#cfg-params) or
		 * [baseParams](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#cfg-baseParams).
		 * @method
		 * @private (method)
		 * @returns {void}  
		 */
	...
	/** 
	 * [Ext.form.action.Submit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Submit.html)
	 * A class which handles submission of data from [Form](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html)s and processes the returned response.
	 * 
	 * Instances of this class are only created by a [Form](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html) when
	 * [submit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#method-submit)ting.
	 * 
	 * # Response Packet Criteria
	 * 
	 ...
	 *    }
	 * 
	 * Other data may be placed into the response for processing by the [Ext.form.Basic](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html)'s callback or event handler
	 * methods. The object decoded from this JSON is available in the [result](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#property-result) property.
	 * 
	 * Alternatively, if an [errorReader](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#cfg-errorReader) is specified as an
	 * [XmlReader](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.reader.Xml.html):
	 * 
	 ...
	 *    &lt;/message&gt;
	 * 
	 * Other elements may be placed into the response XML for processing by the [Ext.form.Basic](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html)'s callback or event
	 * handler methods. The XML document is available in the [errorReader](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#cfg-errorReader)'s
	 * [xmlData](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.reader.Xml.html#property-xmlData) property.
	 */
...
declare namespace Ext.form.trigger {
	/** 
	 * A Text Field Trigger that contains a [Component](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html) or [Widget](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Widget.html).
	 * @private (class)
	 */
	class Component extends Ext.form.trigger.Trigger {}
	/** 
	 * [Ext.form.trigger.Spinner](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Spinner.html)
	...
	class Spinner extends Ext.form.trigger.Trigger {
		 ...
		 * Useful for creating more complex triggers such as [Ext.form.trigger.Spinner](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Spinner.html).
		 * @property
		 * @protected (property)
		 ...
		 * 
		 * To prevent potential memory leaks, all object references will be nulled
		 * at the end of destruction sequence, unless [clearPropertiesOnDestroy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Spinner.html#property-clearPropertiesOnDestroy)
		 * is set to `false`.
		 * @method
		 * @public (method)
		 * @returns {void}  
		...
		callSuper? (args: any[] | IArguments): object;
		/** 
		 * Allows addition of data to the render data object for the [bodyTpl](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Spinner.html#property-bodyTpl).
		 * @method
		 * @protected (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the element that should receive the "state" classes - [focusCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Spinner.html#property-focusCls),
		 * [overCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Spinner.html#property-overCls), and [clickCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Spinner.html#property-clickCls).
		 * @method
		 * @protected (method)
		 * @returns {void}  
		 */
		 ...
		 * @returns {void}     
		 */
		onClickRepeaterMouseUp? (e: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} e
	...
	/** 
	 * [Ext.form.trigger.Trigger](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Trigger.html)
	 * Base class for [Text Field triggers](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.field.Text.html#cfg-triggers)
	 */
	class Trigger extends Ext.Base {
		 ...
		 * 
		 * To prevent potential memory leaks, all object references will be nulled
		 * at the end of destruction sequence, unless [clearPropertiesOnDestroy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Trigger.html#property-clearPropertiesOnDestroy)
		 * is set to `false`.
		 * @method
		 * @public (method)
		 * @returns {void}  
		...
		callSuper? (args: any[] | IArguments): object;
		/** 
		 * Allows addition of data to the render data object for the [bodyTpl](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Trigger.html#property-bodyTpl).
		 * @method
		 * @protected (method)
		 * @returns {object}  
		 */
		getBodyRenderData? (): object;
		/** 
		 * Returns the element that should receive the "state" classes - [focusCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Trigger.html#property-focusCls),
		 * [overCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Trigger.html#property-overCls), and [clickCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Trigger.html#property-clickCls).
		 * @method
		 * @protected (method)
		 * @returns {void}  
		 */
...
declare namespace Ext.form.action.DirectAction {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.form.action.DirectAction](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.DirectAction.html)
	 * A mixin that contains methods specific to Ext Direct actions shared
	 * by DirectLoad and DirectSubmit.
	 */
	interface Statics extends Ext.base.Statics {
...
declare namespace Ext.form.trigger.Component {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.form.trigger.Component](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Component.html)
	 * A Text Field Trigger that contains a [Component](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html) or [Widget](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Widget.html).
	 */
	interface Statics extends Ext.base.Statics {
		/** 
...
declare namespace Ext.form.action.Action {
	...
	interface Cfg extends Ext.base.Configs {
		...
		/** 
		 * The [BasicForm](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html) instance that is invoking this Action. Required.
		 * @configuration
		 * @optional
		 * @type {Ext.form.Basic}
		 */
		 ...
		 * See [Ext.data.proxy.Ajax.headers](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Ajax.html#cfg-headers).
		 * 
		 ...
		 * Defaults to the [BasicForm's method](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#cfg-method), or 'POST' if not specified.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		method?: string;
		/** 
		 * Extra parameter values to pass. These are added to the Form's [Ext.form.Basic.baseParams](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#cfg-baseParams) and passed to the
		 * specified URL along with the Form's input fields.
		 * 
		 * Parameters are encoded as standard HTTP parameters using [Ext.Object.toQueryString](https://docs.sencha.com/extjs/6.2.0/classic/Ext.html#method-urlEncode).
		 * @configuration
		 * @optional
		 * @type {object|string}
		 */
		...
		/** 
		 * When set to **true**, causes the Form to be [reset](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#method-reset) on Action success. If specified,
		 * this happens before the [success](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#cfg-success) callback is called and before the Form's
		 * [actioncomplete](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#event-actioncomplete) event fires.
		 * @configuration
		 * @optional
		 * @type {boolean}
		 */
		reset?: boolean;
		/** 
		 * The scope in which to call the configured [success](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#cfg-success) and [failure](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#cfg-failure) callback functions
		...
		/** 
		 * The number of seconds to wait for a server response before failing with the [failureType](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#property-failureType) as
		 * [CONNECT_FAILURE](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#static-property-CONNECT_FAILURE). If not specified, defaults to the configured
		 * [timeout](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#cfg-timeout) of the [form](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#cfg-form).
		 * @configuration
		 * @optional
		 * @type {number}
		 */
		timeout?: number;
		/** 
		 * The URL that the Action is to invoke. Will default to the [url](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#cfg-url) configured on the
		 * [form](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.action.Action.html#cfg-form).
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		url?: string;
		/** 
		 * The message to be displayed by a call to [Ext.window.MessageBox.wait](https://docs.sencha.com/extjs/6.2.0/classic/Ext.window.MessageBox.html#method-wait) during the time the action is being
		 * processed.
		 * @configuration
		 * @optional
		 * @type {string}
		...
		waitMsg?: string;
		/** 
		 * The title to be displayed by a call to [Ext.window.MessageBox.wait](https://docs.sencha.com/extjs/6.2.0/classic/Ext.window.MessageBox.html#method-wait) during the time the action is being
		 * processed.
		 * @configuration
		 * @optional
		 * @type {string}
...
declare namespace Ext.form.action.DirectSubmit {
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * Determines whether a Form's fields are validated in a final call to [isValid](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.Basic.html#method-isValid) prior
...
declare namespace Ext.form.trigger.Component {
	...
	interface Cfg extends Ext.base.Configs {
		...
		extraCls?: string;
		/** 
		 * If `true`, the field will be focused upon
		...
		hidden?: boolean;
		/** 
		 * Set 'false' to prevent trigger from being hidden even though the related field is set [readOnly](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.field.Text.html#cfg-readOnly)
		 * @configuration
		 * @optional
		 * @default true
		 * @type {boolean}
		...
		/** 
		 * `true` to attach a [click repeater](https://docs.sencha.com/extjs/6.2.0/classic/Ext.util.ClickRepeater.html) to the trigger
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
		...
		repeatClick?: boolean;
		/** 
		 * Execution context for the [handler](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.trigger.Trigger.html#cfg-handler) function.
		 * @configuration
		 * @optional
		 * @type {object}
		 */
		scope?: object;
		/** 
		 * The triggers tooltip text. This text is available when using [`Ext.QuickTips`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.tip.QuickTipManager.html).
		 * @configuration
		 * @optional
		 * @type {string}
		 */

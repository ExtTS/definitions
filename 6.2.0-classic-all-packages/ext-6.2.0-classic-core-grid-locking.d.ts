declare namespace Ext.grid.locking {
	 ...
	 * automatically inject the [Ext.grid.locking.Lockable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.Lockable.html) mixin in when one of the
	 ...
	 * 
	 * By default the two grids, "locked" and "normal" will be arranged using an [hbox](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.container.HBox.html)
	 * layout. If the lockable grid is configured with [`split:true`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.Lockable.html#cfg-split), a vertical splitter
...
declare namespace Ext.grid.locking.HeaderContainer {
	 ...
	 * [Ext.grid.locking.HeaderContainer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.HeaderContainer.html)
	 * Private class which acts as a HeaderContainer for the Lockable which aggregates all columns
	 * from both sides of the Lockable. It is never rendered, it's just used to interrogate the
	 * column collection.
	 */
...
declare namespace Ext.grid.locking.Lockable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.grid.locking.Lockable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.Lockable.html)
	 * Lockable is a private mixin which injects lockable behavior into any
	 * TablePanel subclass such as GridPanel or TreePanel. TablePanel will
	 * automatically inject the [Ext.grid.locking.Lockable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.Lockable.html) mixin in when one of the
	 * these conditions are met:
...
declare namespace Ext.grid.locking.RowSynchronizer {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.grid.locking.RowSynchronizer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.RowSynchronizer.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
...
declare namespace Ext.grid.locking.View {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.grid.locking.View](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.View.html)
	 * This class is used internally to provide a single interface when using
	 * a locking grid. Internally, the locking grid creates two separate grids,
	 * so this class is used to map calls appropriately.
	 */
...
declare namespace Ext.grid.locking.HeaderContainer.methodParams.addListener {
	 ...
	 * [Ext.grid.locking.HeaderContainer.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.HeaderContainer.html#method-addListener)
...
declare namespace Ext.grid.locking.HeaderContainer.methodParams.forceComponentLayout {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.locking.HeaderContainer.forceComponentLayout](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.HeaderContainer.html#method-forceComponentLayout)
...
declare namespace Ext.grid.locking.HeaderContainer.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.locking.HeaderContainer.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.HeaderContainer.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.grid.locking.HeaderContainer.methodParams.onFocusEnter {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.locking.HeaderContainer.onFocusEnter](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.HeaderContainer.html#method-onFocusEnter)
	 */
...
declare namespace Ext.grid.locking.HeaderContainer.methodParams.onFocusLeave {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.locking.HeaderContainer.onFocusLeave](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.HeaderContainer.html#method-onFocusLeave)
	 */
...
declare namespace Ext.grid.locking.HeaderContainer.methodParams.remove {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.locking.HeaderContainer.remove](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.HeaderContainer.html#method-remove)
...
declare namespace Ext.grid.locking.HeaderContainer.methodParams.updateLayout {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.locking.HeaderContainer.updateLayout](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.HeaderContainer.html#method-updateLayout)
	 * An object with layout options.
	 */
	interface Options extends Ext.base.Params {
		/** 
...
declare namespace Ext.grid.locking.View.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.locking.View.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.View.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.grid.locking.View.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.locking.View.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.View.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.grid.locking.View.methodParams.onFocusEnter {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.locking.View.onFocusEnter](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.View.html#method-onFocusEnter)
	 */
	interface E extends Ext.base.Params {
		/** 
		 * The underlying DOM event.
...
declare namespace Ext.grid.locking.View.methodParams.onFocusLeave {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.locking.View.onFocusLeave](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.locking.View.html#method-onFocusLeave)
	 */
	interface E extends Ext.event.Event {
		/** 
		 * The underlying DOM event.
...
declare namespace Ext.grid.locking.Lockable {
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * By default, a lockable grid uses an [HBox](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.container.HBox.html) layout to arrange
		...
		/** 
		 * Configure as `true` to place a resizing [splitter](https://docs.sencha.com/extjs/6.2.0/classic/Ext.resizer.Splitter.html) between the locked

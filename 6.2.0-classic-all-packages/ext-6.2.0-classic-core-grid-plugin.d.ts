declare namespace Ext.grid.plugin {
	 ...
	 * 
	 * This class monitors scrolling of the [TableView](https://docs.sencha.com/extjs/6.2.0/classic/Ext.view.Table.html) within a [GridPanel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.Panel.html) to render a small section of
	 * the dataset.
	 * @private (class)
	 */
	class BufferedRenderer extends Ext.AbstractPlugin {}
	/** 
	 * [Ext.grid.plugin.CellEditing](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.CellEditing.html)
	 * The [Ext.grid.plugin.CellEditing](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.CellEditing.html) plugin injects editing at a cell level for a Grid. Only a single
	 * cell will be editable at a time. The field that will be used for the editor is defined at the
	 * [editor](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.column.Column.html#cfg-editor). The editor can be a field instance or a field configuration.
	 * 
	 ...
	 * to edit a date, it would be useful to specify [Ext.form.field.Date](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.field.Date.html) as the editor.
	 * 
	 * If the `editor` config on a column contains a `field` property, then the `editor` config is used to create
	 * the wrapping Ext.grid.CellEditorCellEditor, and the `field` property is used to create the editing
	 * input field.
	 * 
	 * ## Example
	 * 
	 ...
	 * we also specify a [field](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.column.Column.html#cfg-field) on two of our columns. For the
	 ...
	 * [selModel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.Panel.html#cfg-selModel), and created an instance of the CellEditing plugin,
	...
	class CellEditing extends Ext.grid.plugin.Editing {
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.grid.plugin.Editing.cancelEdit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Editing.html#method-cancelEdit).
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.grid.plugin.Editing.completeEdit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Editing.html#method-completeEdit).
		 * Completes the edit if there is an active edit in progress.
		 * @method
		 * @public (method)
		 * @returns {void}  
		 ...
		 */
		activateCell? (position: Ext.grid.CellContext, skipBeforeCheck: boolean, doFocus: boolean): boolean;
		/** 
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.grid.plugin.Editing.onReconfigure](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Editing.html#method-onReconfigure).
		 * Fires after the grid is reconfigured
		 * @method
		 * @protected (method)
		 * @returns {void}  
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.plugin.Abstract.resolveListenerScope](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.Abstract.html#method-resolveListenerScope).
		 * @method
		 * @private (method)
		 ...
		 * @returns {boolean}                       `true` if this Actionable has successfully resumed.
		 */
		resume? (position: Ext.grid.CellContext): boolean;
		/** 
	...
	/** 
	 * [Ext.grid.plugin.Clipboard](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Clipboard.html)
	 * This [grid](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.Panel.html) plugin adds clipboard support to a grid.
	 * 
	 * _Note that the grid must use the [spreadsheet selection model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html) to utilize this plugin._
	 * 
	 * This class supports the following [`formats`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.AbstractClipboard.html#cfg-formats)
	 * for grid data:
	 * 
	 * - `cell` - Complete field data that can be matched to other grids using the same
	 *   [model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html) regardless of column order.
	 ...
	 * 
	 * The `cell` format is not valid for the [`system`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.AbstractClipboard.html#cfg-system)
	 * clipboard format.
	 */
	class Clipboard extends Ext.plugin.AbstractClipboard {
		...
		getInitialConfig? (name?: string): object | any;
		/** 
		 * Returns the value of [memory](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.AbstractClipboard.html#cfg-memory).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [source](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.AbstractClipboard.html#cfg-source).
		 * @method
		 * @public (method)
		 * @returns {string|string[]}  
		 */
		...
		/** 
		 * Returns the value of [system](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.AbstractClipboard.html#cfg-system).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.plugin.AbstractClipboard.getTarget](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.AbstractClipboard.html#method-getTarget).
		 * Returns the element target to listen to copy/paste.
		 * @method
		 * @public (method)
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.plugin.AbstractClipboard.getTextData](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.AbstractClipboard.html#method-getTextData).
		 * This method returns the selected data in text format.
		 * @method
		 * @public (method)
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.plugin.AbstractClipboard.putTextData](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.AbstractClipboard.html#method-putTextData).
		 * This method pastes the given text data.
		 * @method
		 * @public (method)
		...
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Sets the value of [memory](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.AbstractClipboard.html#cfg-memory).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [source](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.AbstractClipboard.html#cfg-source).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [system](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.AbstractClipboard.html#cfg-system).
		 * @method
		 * @public (method)
		...
		callSuper? (args: any[] | IArguments): object;
		/** 
		 * Returns the value of [formats](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.AbstractClipboard.html#cfg-formats).
		 * @method
		 * @protected (method)
		 * @returns {object}  
		 */
		...
		initConfig? (config: object): Ext.Base;
		/** 
		 * Sets the value of [formats](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.AbstractClipboard.html#cfg-formats).
		 * @method
		 * @protected (method)
	...
	/** 
	 * [Ext.grid.plugin.DragDrop](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html)
	 * This plugin provides drag and drop functionality for a [GridView](https://docs.sencha.com/extjs/6.2.0/classic/Ext.view.Table.html).
	 * 
	 * A specialized instance of [DragZone](https://docs.sencha.com/extjs/6.2.0/classic/Ext.dd.DragZone.html) and [DropZone](https://docs.sencha.com/extjs/6.2.0/classic/Ext.dd.DropZone.html) are attached to the grid view.  The DropZone will participate in drops
	 * from DragZones having the same [ddGroup](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#cfg-ddGroup) including drops from within the same
	 * grid.
	 * 
	 ...
	 *   The value of [copy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#cfg-copy).  Or `true` if
	 *   [allowCopy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#cfg-allowCopy) is true **and** the control key was pressed as the drag operation
	 *   began.
	 * - **view:** [GridView](https://docs.sencha.com/extjs/6.2.0/classic/Ext.view.Table.html)
	 ...
	 * grid view as well as its owning Grid: [`beforedrop`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#event-beforedrop) and [`drop`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#event-drop).
	 * 
	...
	class DragDrop extends Ext.plugin.Abstract {
		...
		/** 
		 * An [DropZone](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.ViewDropZone.html) which handles mouseover and dropping records in any grid which shares the same [dropGroup](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#cfg-dropGroup).
		 * @property
		 * @public (property)
	...
	/** 
	 * [Ext.grid.plugin.Editing](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Editing.html)
	 * This class provides an abstract grid editing plugin on selected [columns](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.column.Column.html).
	 * The editable columns are specified by providing an [editor](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.column.Column.html#cfg-editor)
	 * in the [column configuration](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.column.Column.html).
	 * 
	 * **Note:** This class should not be used directly. See [Ext.grid.plugin.CellEditing](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.CellEditing.html) and
	 * [Ext.grid.plugin.RowEditing](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowEditing.html).
	 */
	...
	/** 
	 * [Ext.grid.plugin.HeaderResizer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.HeaderResizer.html)
	...
	class HeaderResizer extends Ext.plugin.Abstract {
		...
		getConfig? (name?: string, peek?: boolean): object;
		/** 
		 * Returns the value of [dynamic](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.HeaderResizer.html#cfg-dynamic).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Sets the value of [dynamic](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.HeaderResizer.html#cfg-dynamic).
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.grid.plugin.RowEditing](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowEditing.html)
	 * The [Ext.grid.plugin.RowEditing](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowEditing.html) plugin injects editing at a row level for a Grid. When editing begins,
	 ...
	 * [editRenderer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.column.Column.html#cfg-editRenderer) configuration on the column.
	 * 
	 * The editor may be shared for each column in the grid, or a different one may be specified for each column.
	 * An appropriate field type should be chosen to match the data structure that it will be editing. For example,
	 * to edit a date, it would be useful to specify [Ext.form.field.Date](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.field.Date.html) as the editor.
	...
	class RowEditing extends Ext.grid.plugin.Editing {
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.grid.plugin.Editing.onColumnMove](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Editing.html#method-onColumnMove).
		 * Template method which may be implemented in subclasses (RowEditing and CellEditing)
		 * @method
		 * @private (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.grid.plugin.RowExpander](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowExpander.html)
	 * Plugin (ptype = 'rowexpander') that adds the ability to have a Column in a grid which enables
	 * a second row body which expands/contracts.  The expand/contract behavior is configurable to react
	 * on clicking of the column, double click of the row, and/or hitting enter while a row is selected.
	 * 
	 * **Note:** The [rowexpander](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowExpander.html) plugin and the rowbody
	...
	class RowExpander extends Ext.plugin.Abstract {
		 ...
		 * @type {string}
		 */
		lockableScope?: string;
		/** 
		 * @property
		 * @private (property)
		 * @default Ext.baseCSSPrefix + 'grid-row-body-hidden'
		 * @type {string}
		 */
		rowBodyHiddenCls?: string;
		/** 
		 * @property
		 * @private (property)
		 * @default '.' + Ext.baseCSSPrefix + 'grid-rowbody-tr'
		 * @type {string}
		 */
		rowBodyTrSelector?: string;
		/** 
		 * @property
		 * @private (property)
		 * @default Ext.baseCSSPrefix + 'grid-row-collapsed'
		 * @type {string}
		 */
		rowCollapsedCls?: string;
		/** 
		 * Add methods / properties to the prototype of this class.
		 * 
		 *    Ext.define('My.awesome.Cat', {
		 ...
		 * @method
		 * @private (method)
		 * @param   {object} expanderGrid
		 * @returns {void}                
		 */
		addExpander? (expanderGrid: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} grid
		 ...
		 * @returns {void}            
		 */
		onColumnLock? (lockable: object, column: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} lockable
		 ...
		 * @returns {void}            
		 */
		onColumnUnlock? (lockable: object, column: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} view
		 ...
		 * @returns {void}          
		 */
		onDblClick? (view: object, record: object, row: object, rowIdx: object, e: object): void;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {void}              
		 */
		onItemAdd? (newRecords: object, startIndex: object, newItems: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} view
		 ...
		 * @returns {void}          
		 */
		onKeyDown? (view: object, record: object, row: object, rowIdx: object, e: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} lockable
		 * @param   {object} lockedHeaders
		 * @param   {object} normalHeaders
		 * @returns {void}                 
		 */
		onLockableProcessColumns? (lockable: object, lockedHeaders: object, normalHeaders: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} defaultScope
		 ...
		 * @method
		 * @private (method)
		 * @param   {object} lockedItem
		 * @param   {object} normalItem
		 * @returns {void}              
		 */
		syncRowHeights? (lockedItem: object, normalItem: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} rowIdx
		 ...
		 * @returns {void}          
		 */
		toggleRow? (rowIdx: object, record: object): void;
		/** 
		 * Destroys a given set of [`linked`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#method-link) objects. This is only needed if
		 * the linked object is being destroyed before this instance.
		 * @method
	...
	/** 
	 * [Ext.grid.plugin.RowWidget](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowWidget.html)
	 ...
	 * 
	 * The expansion row may contain a [widget](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowWidget.html#cfg-widget) which is primed with the record of the corresponding grid row.
	 * The widget's defaultBindProperty property is set to the record.
	 */
	class RowWidget extends Ext.grid.plugin.RowExpander {
		/** 
		 * Get the reference to the current class from which this object was instantiated. Unlike [statics](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#method-statics),
		 * `this.self` is scope-dependent and it's meant to be used for dynamic inheritance. See [statics](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#method-statics)
		 * for a detailed comparison
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.grid.plugin.RowWidget.Statics}
		 */
		self?: Ext.grid.plugin.RowWidget.Statics | Ext.grid.plugin.RowExpander.Statics | Ext.plugin.Abstract.Statics | Ext.Base.Statics;
		/** 
		 * @property
		 * @private (property)
		 * @type {object}
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.grid.plugin.RowWidget|Ext.grid.plugin.RowExpander|Ext.plugin.Abstract|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.plugin.RowWidget;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.plugin.RowExpander;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.plugin.Abstract;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 ...
		 * @chainable
		 * @param   {object}                                                                             members
		 * @returns {Ext.grid.plugin.RowWidget|Ext.grid.plugin.RowExpander|Ext.plugin.Abstract|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.grid.plugin.RowWidget;
		static addStatics? (members: object): typeof Ext.grid.plugin.RowExpander;
		static addStatics? (members: object): typeof Ext.plugin.Abstract;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.grid.plugin.RowWidget|Ext.grid.plugin.RowExpander|Ext.plugin.Abstract|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.grid.plugin.RowWidget;
		static addMember? (name: object, member: object): typeof Ext.grid.plugin.RowExpander;
		static addMember? (name: object, member: object): typeof Ext.plugin.Abstract;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.grid.plugin.RowWidget|Ext.grid.plugin.RowExpander|Ext.plugin.Abstract|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.grid.plugin.RowWidget;
		static onExtended? (fn: object, scope: object): typeof Ext.grid.plugin.RowExpander;
		static onExtended? (fn: object, scope: object): typeof Ext.plugin.Abstract;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 ...
		 * at the end of destruction sequence, unless [clearPropertiesOnDestroy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowWidget.html#property-clearPropertiesOnDestroy)
		 * is set to `false`.
		 * @method
		 * @public (method)
		 * @returns {void}  
		...
		getConfig? (name?: string, peek?: boolean): object;
		/** 
		 * Returns the value of [defaultWidgetUI](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowWidget.html#cfg-defaultWidgetUI).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getDefaultWidgetUI? (): object;
		/** 
		 ...
		 * 
		 * Note that if the record is not currently in the rendered block, _or_, it has never been expanded
		 * then there will not be a widget associated with that `record/view` context.
		 * @method
		 * @public (method)
		 * @param   {any} view   The view for which to return the widget
		 * @param   {any} record The record for which to return the widget
		 * @returns {any}        
		 */
		getWidget? (view: any, record: any): any;
		/** 
		 * The init method is invoked to formally associate the host component and the plugin.
		 * 
		 * Subclasses should perform initialization and set up any requires links between the
		 ...
		 * @returns {void}        
		 */
		setCmp? (grid: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.plugin.Abstract.setCmp](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.Abstract.html#method-setCmp).
		 * Sets the host component to which this plugin is attached. For a plugin to be
		 * removable without being destroyed, this method should be provided and be prepared
		 * to receive `null` for the component.
		 * @method
		 ...
		 * @returns {Ext.grid.plugin.RowWidget|Ext.grid.plugin.RowExpander|Ext.plugin.Abstract|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.grid.plugin.RowWidget;
		setConfig? (name: string | object, value?: object): Ext.grid.plugin.RowExpander;
		setConfig? (name: string | object, value?: object): Ext.plugin.Abstract;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Sets the value of [defaultWidgetUI](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowWidget.html#cfg-defaultWidgetUI).
		 * @method
		 * @public (method)
		 * @param   {object} defaultWidgetUI The new value.
		 * @returns {void}                   
		 */
		setDefaultWidgetUI? (defaultWidgetUI: object): void;
		/** 
		 * Call the original method that was previously overridden with [override](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#static-method-override)
		 * 
		 *    Ext.define('My.Cat', {
		 ...
		 * @returns {Ext.grid.plugin.RowWidget|Ext.grid.plugin.RowExpander|Ext.plugin.Abstract|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.grid.plugin.RowWidget;
		initConfig? (config: object): Ext.grid.plugin.RowExpander;
		initConfig? (config: object): Ext.plugin.Abstract;
		initConfig? (config: object): Ext.Base;
		/** 
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.grid.plugin.RowWidget.Statics|Ext.grid.plugin.RowExpander.Statics|Ext.plugin.Abstract.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.grid.plugin.RowWidget.Statics;
		statics? (): Ext.grid.plugin.RowExpander.Statics;
		statics? (): Ext.plugin.Abstract.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 ...
		 * @returns {Ext.grid.plugin.RowWidget|Ext.grid.plugin.RowExpander|Ext.plugin.Abstract|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.grid.plugin.RowWidget;
		unlink? (names: string[]): Ext.grid.plugin.RowExpander;
		unlink? (names: string[]): Ext.plugin.Abstract;
		unlink? (names: string[]): Ext.Base;
	}
...
declare namespace Ext.grid.plugin.RowWidget {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.grid.plugin.RowWidget](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowWidget.html)
	 ...
	 * The widget's defaultBindProperty property is set to the record.
	 */
	interface Def extends Ext.grid.plugin.RowWidget {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.grid.plugin.RowWidget.Cfg}
		 */
		config?: Ext.grid.plugin.RowWidget.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * @type {Ext.grid.plugin.RowWidget.Statics}
		 */
		statics?: (() => Ext.grid.plugin.RowWidget.Statics | Ext.grid.plugin.RowExpander.Statics | Ext.plugin.Abstract.Statics | Ext.Base.Statics) | Ext.grid.plugin.RowWidget.Statics | any;
	}
}
declare namespace Ext.grid.plugin.BufferedRenderer {
	 ...
	 * [Ext.grid.plugin.BufferedRenderer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.BufferedRenderer.html)
	 * Implements buffered rendering of a grid, allowing users to scroll
	 * through thousands of records without the performance penalties of
	 * rendering all the records into the DOM at once.
	 * 
...
declare namespace Ext.grid.plugin.HeaderReorderer {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.grid.plugin.HeaderReorderer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.HeaderReorderer.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
...
declare namespace Ext.grid.plugin.RowWidget {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.grid.plugin.RowWidget|Ext.grid.plugin.RowExpander|Ext.plugin.Abstract|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.plugin.RowWidget;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.plugin.RowExpander;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.plugin.Abstract;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.grid.plugin.RowWidget|Ext.grid.plugin.RowExpander|Ext.plugin.Abstract|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.grid.plugin.RowWidget;
		addStatics? (members: object): typeof Ext.grid.plugin.RowExpander;
		addStatics? (members: object): typeof Ext.plugin.Abstract;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.grid.plugin.RowWidget|Ext.grid.plugin.RowExpander|Ext.plugin.Abstract|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.grid.plugin.RowWidget;
		addMember? (name: object, member: object): typeof Ext.grid.plugin.RowExpander;
		addMember? (name: object, member: object): typeof Ext.plugin.Abstract;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.grid.plugin.RowWidget|Ext.grid.plugin.RowExpander|Ext.plugin.Abstract|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.grid.plugin.RowWidget;
		onExtended? (fn: object, scope: object): typeof Ext.grid.plugin.RowExpander;
		onExtended? (fn: object, scope: object): typeof Ext.plugin.Abstract;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
...
declare namespace Ext.grid.plugin.BufferedRenderer.methodParams.scrollTo {
	 ...
	 * [Ext.grid.plugin.BufferedRenderer.scrollTo](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.BufferedRenderer.html#method-scrollTo)
...
declare namespace Ext.grid.plugin.CellEditing.eventsParams.beforeedit {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.CellEditing.beforeedit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.CellEditing.html#event-beforeedit)
	...
	interface Context extends Ext.base.Params {
		...
		row?: HTMLElement;
		/** 
		 * The [Ext.grid.column.Column](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.column.Column.html) Column} being edited.
		 * @configuration
		 * @optional
...
declare namespace Ext.grid.plugin.CellEditing.eventsParams.canceledit {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.CellEditing.canceledit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.CellEditing.html#event-canceledit)
...
declare namespace Ext.grid.plugin.CellEditing.eventsParams.edit {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.CellEditing.edit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.CellEditing.html#event-edit)
...
declare namespace Ext.grid.plugin.CellEditing.eventsParams.validateedit {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.CellEditing.validateedit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.CellEditing.html#event-validateedit)
	 * An editing context with the following properties:
	 */
	interface Context extends Ext.base.Params {
		/** 
		 ...
		 * The
		 * 
		 *                                   Ext.grid.column.Column Column} being
		 *                                   edited.
		 * 
		 * @configuration
		 * @optional
...
declare namespace Ext.grid.plugin.CellEditing.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.CellEditing.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.CellEditing.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.grid.plugin.CellEditing.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.CellEditing.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.CellEditing.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.grid.plugin.DragDrop.eventsParams.beforedrop {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.DragDrop.beforedrop](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#event-beforedrop)
	...
	interface Data extends Ext.base.Params {
		/** 
		 * The value of [copy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#cfg-copy).  Or `true` if
		 * [allowCopy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#cfg-allowCopy) is true **and** the control key was pressed as the drag
		 * operation began.
		 * @configuration
		 * @optional
		 * @type {boolean}
...
declare namespace Ext.grid.plugin.DragDrop.eventsParams.drop {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.DragDrop.drop](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#event-drop)
	 * The data object gathered at mousedown time by the
	 * cooperating [DragZone](https://docs.sencha.com/extjs/6.2.0/classic/Ext.dd.DragZone.html)'s [getDragData](https://docs.sencha.com/extjs/6.2.0/classic/Ext.dd.DragZone.html#method-getDragData) method.  It contains the following properties:
	 */
	interface Data extends Ext.base.Params {
...
declare namespace Ext.grid.plugin.Editing.eventsParams.beforeedit {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.Editing.beforeedit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Editing.html#event-beforeedit)
	...
	interface Context extends Ext.base.Params {
		...
		cancel?: boolean;
		/** 
		 * Alias for value (only when using [CellEditing](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.CellEditing.html)).
		 * @configuration
		 * @optional
		 * @type {any}
		 */
...
declare namespace Ext.grid.plugin.Editing.eventsParams.canceledit {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.Editing.canceledit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Editing.html#event-canceledit)
	 * The editing context with the following properties:
	 */
	interface Context extends Ext.base.Params {
		/** 
...
declare namespace Ext.grid.plugin.Editing.eventsParams.edit {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.Editing.edit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Editing.html#event-edit)
	 * The editing context with the following properties:
	 */
	interface Context extends Ext.base.Params {
		/** 
...
declare namespace Ext.grid.plugin.Editing.eventsParams.validateedit {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.Editing.validateedit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Editing.html#event-validateedit)
	 * The editing context with the following properties:
	 */
	interface Context extends Ext.base.Params {
		/** 
...
declare namespace Ext.grid.plugin.Editing.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.Editing.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Editing.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.grid.plugin.Editing.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.Editing.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Editing.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.grid.plugin.RowEditing.eventsParams.beforeedit {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.RowEditing.beforeedit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowEditing.html#event-beforeedit)
	 * The editing context with the following properties:
	 */
	interface Context extends Ext.base.Params {
		/** 
...
declare namespace Ext.grid.plugin.RowEditing.eventsParams.canceledit {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.RowEditing.canceledit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowEditing.html#event-canceledit)
	 * The editing context with the following properties:
	 */
	interface Context extends Ext.base.Params {
		/** 
...
declare namespace Ext.grid.plugin.RowEditing.eventsParams.edit {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.RowEditing.edit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowEditing.html#event-edit)
	 * The editing context with the following properties:
	 */
	interface Context extends Ext.base.Params {
		/** 
...
declare namespace Ext.grid.plugin.RowEditing.eventsParams.validateedit {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.RowEditing.validateedit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowEditing.html#event-validateedit)
	 * The editing context with the following properties:
	 */
	interface Context extends Ext.base.Params {
		/** 
...
declare namespace Ext.grid.plugin.RowEditing.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.RowEditing.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowEditing.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.grid.plugin.RowEditing.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.plugin.RowEditing.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowEditing.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.grid.plugin.BufferedRenderer {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * **outside the [numFromEdge](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.BufferedRenderer.html#cfg-numFromEdge)** buffer as scrolling proceeds.
		 * @configuration
		 * @optional
		 * @default 20
		 * @type {number}
		...
		pluginId?: string;
		/** 
		 * This is the time in milliseconds to buffer load requests when the store is a [buffered store](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.BufferedStore.html)
		 ...
		 * [`numFromEdge`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.BufferedRenderer.html#cfg-numFromEdge) rows of the grid viewport, if the required rows are available in the Store,
...
declare namespace Ext.grid.plugin.CellEditing {
	...
	interface Cfg extends Ext.base.Configs {
		...
		pluginId?: string;
		/** 
		 * The event which triggers editing. Supersedes the [clicksToEdit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Editing.html#cfg-clicksToEdit) configuration. May be one of:
		 * 
		 * - cellclick
		 * - celldblclick
		 * - cellfocus
...
declare namespace Ext.grid.plugin.Clipboard {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * documentation for [`getTextData`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Clipboard.html#method-getTextData) and  [`putTextData`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Clipboard.html#method-putTextData).
		 * 
		 * The format name "system" is not allowed.
		 * @configuration
		 * @optional
		 * @default {cell: {get: 'getCells'}, html: {get: 'getCellData'}, raw: {get: 'getCellData', put: 'putCellData'}}
		 * @type {object}
		 */
		formats?: object;
		/** 
...
declare namespace Ext.grid.plugin.DragDrop {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * unique stores.
		 * 
		 * See [copy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#cfg-copy) to enable the copying of all dragged records.
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
		 ...
		 * unique stores.
		 * 
		 * See [allowCopy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#cfg-allowCopy) to allow only control-drag operations to copy records.
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
		...
		ddGroup?: string;
		/** 
		 * The [ddGroup](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#cfg-ddGroup) to which the DragZone will belong.
		 * 
		 * This defines which other DropZones the DragZone will interact with. Drag/DropZones only interact with other
		 * Drag/DropZones which are members of the same [ddGroup](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#cfg-ddGroup).
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		...
		dragText?: string;
		/** 
		 * A config object to apply to the creation of the [DragZone](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#property-dragZone) which handles for drag start gestures.
		 * 
		...
		dragZone?: object;
		/** 
		 * The [ddGroup](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#cfg-ddGroup) to which the DropZone will belong.
		 * 
		...
		dropGroup?: string;
		/** 
		 * A config object to apply to the creation of the [DropZone](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.DragDrop.html#property-dropZone) which handles mouseover and drop gestures.
		 * 
...
declare namespace Ext.grid.plugin.RowEditing {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * Note that this option is mutually exclusive with [autoUpdate](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowEditing.html#cfg-autoUpdate).
		 * @configuration
		 * @optional
		 * @default true
		 * @type {boolean}
		 ...
		 * the pending changes.
		 * Note that if this is set to `true`, [autoCancel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowEditing.html#cfg-autoCancel) will be set to `false`.
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
		 ...
		 * This will default to the same value as [clicksToEdit](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.Editing.html#cfg-clicksToEdit).
		 * @configuration
		 * @optional
		 * @type {number}
		 */
		...
		default?: string;
		/** 
		 * True to show a [tooltip](https://docs.sencha.com/extjs/6.2.0/classic/Ext.tip.ToolTip.html) that summarizes all validation errors present
		 ...
		 * This label can be a [Ext.String.format](https://docs.sencha.com/extjs/6.2.0/classic/Ext.String.html#method-format) template, with the only parameter
		 * being the row number. Note that row numbers start at base [formAriaLabelRowBase](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowEditing.html#cfg-formAriaLabelRowBase).
		 * @configuration
		 * @optional
...
declare namespace Ext.grid.plugin.RowExpander {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * See [lockedTpl](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowExpander.html#cfg-lockedTpl)
		 * @configuration
		 * @optional
		 * @type {Ext.XTemplate}
		 */
...
declare namespace Ext.grid.plugin.RowWidget {
	...
	interface Cfg extends Ext.base.Configs {
		...
		columnWidth?: number;
		/** 
		 * A map of xtype to [Ext.Component.ui](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html#cfg-ui) names to use when using Components in the expansion row.
		 * @configuration
		 * @optional
		 * @default {}
		 * @type {object}
		...
		lockedTpl?: Ext.XTemplate;
		/** 
		 * A config object containing an [xtype](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html#cfg-xtype).
		 * 
		 * This is used to create the widgets or components which are rendered into the expansion row _on the locked side of a lockable grid_.
		 * @configuration
		 * @optional
		 * @type {object}
		 */
		 ...
		 * 
		 * The associated grid row's record is used to update the widget/component's [defaultBindProperty](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html#property-defaultBindProperty).
		 * 
		 * Note that if this plugin is applied to a lockable grid, the widget applies to the normal (unlocked) side.
		 * See [lockedWidget](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.plugin.RowWidget.html#cfg-lockedWidget)
		 * @configuration
		 * @optional
		 * @type {object}
		 */
		 ...
		 * @chainable
		 * @param   {object}                            config
		 * @returns {Ext.grid.plugin.RowWidget.Statics}        this
		 */
		initConfig? (config: object): Ext.grid.plugin.RowWidget.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.grid.plugin.RowWidget.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.grid.plugin.RowWidget.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.grid.plugin.RowWidget.Statics}  
		 */
		statics? (): Ext.grid.plugin.RowWidget.Statics;
	}
}
...
declare namespace Ext.grid.plugin.DragDrop {
	...
	interface Events extends Ext.base.Events {
		/** 
		 * **This event is fired through the [GridView](https://docs.sencha.com/extjs/6.2.0/classic/Ext.view.Table.html) and its owning
		 * [Grid](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.Panel.html). You can add listeners to the grid or grid [view config](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.Panel.html#cfg-viewConfig) object**
		 * 
		 ...
		 * The [grid view](https://docs.sencha.com/extjs/6.2.0/classic/Ext.view.Table.html) node **if any** over
		 ...
		 * @event
		 * @param   {HTMLElement}                                            node
		 * The [GridView](https://docs.sencha.com/extjs/6.2.0/classic/Ext.view.Table.html) node **if any** over
		 * which the cursor was positioned.

declare namespace Ext.grid.selection {
	/** 
	 * [Ext.grid.selection.Cells](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Cells.html)
	 ...
	 */
	class Cells extends Ext.grid.selection.Selection {
		/** 
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.grid.selection.Cells.Statics}
		 */
		self?: Ext.grid.selection.Cells.Statics | Ext.grid.selection.Selection.Statics | Ext.Base.Statics;
		/** 
		 * ---
		 * @property
		 * @private (property)
		 ...
		 * @returns {Ext.grid.selection.Cells|Ext.grid.selection.Selection|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Cells;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Selection;
		 ...
		 * @returns {Ext.grid.selection.Cells|Ext.grid.selection.Selection|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.grid.selection.Cells;
		static addStatics? (members: object): typeof Ext.grid.selection.Selection;
		 ...
		 * @returns {Ext.grid.selection.Cells|Ext.grid.selection.Selection|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.grid.selection.Cells;
		static addMember? (name: object, member: object): typeof Ext.grid.selection.Selection;
		 ...
		 * @returns {Ext.grid.selection.Cells|Ext.grid.selection.Selection|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.grid.selection.Cells;
		static onExtended? (fn: object, scope: object): typeof Ext.grid.selection.Selection;
		...
		/** 
		 * Returns `true` if the passed [cell context](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.CellContext.html) is selected.
		 * @method
		 * @public (method)
		 * @param   {Ext.grid.CellContext} cellContext The cell context to test.
		 * @returns {boolean}                          `true` if the passed [cell context](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.CellContext.html) is selected.
		 */
		 ...
		 * @returns {void}         
		 */
		eachCell? (fn: object, scope: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.grid.selection.Selection.eachCell](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Selection.html#method-eachCell).
		 * Calls the passed function for each selected cell from top left to bottom right
		 * iterating over columns within each row.
		 * @method
		 * @public (method)
		 * @param   {Function}             fn
		 * The function to call. If this returns `false`, the iteration is
		 ...
		 * @param   {object}               [scope]
		 * The context (`this` reference) in which `fn` is executed.
		 * Defaults to this Selection object.
		 * @returns {void}                                  
		 */
		eachCell? (fn: ((context?: Ext.grid.CellContext, columnIndex?: number, rowIndex?: number) => void) | ExtGlobalFunction, scope?: object): void;
		/** 
		 ...
		 * @returns {void}         
		 */
		eachColumn? (fn: object, scope: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.grid.selection.Selection.eachColumn](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Selection.html#method-eachColumn).
		 * Calls the passed function for each selected column from left to right.
		 * @method
		 * @public (method)
		 * @param   {Function}               fn
		 ...
		 * @param   {number}                 [fn.columnIndex]
		 * The index of the current column. _Note that in a
		 * locked grid, this is relative to the outermost grid encompassing both sides_.
		 * @param   {void}                   fn.returns
		 * @param   {object}                 [scope]
		 * The context (`this` reference) in which `fn` is executed.
		 * Defaults to this Selection object.
		 * @returns {void}                                    
		 */
		eachColumn? (fn: ((column?: Ext.grid.column.Column, columnIndex?: number) => void) | ExtGlobalFunction, scope?: object): void;
		/** 
		 * Calls the passed function for each selected [record](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html).
		 * @method
		 * @public (method)
		 * @param   {object} fn
		 * @param   {object} scope
		 * @returns {void}         
		 */
		eachRow? (fn: object, scope: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.grid.selection.Selection.eachRow](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Selection.html#method-eachRow).
		 * Calls the passed function for each selected [record](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html).
		 * @method
		 * @public (method)
		 * @param   {Function}       fn
		 ...
		 * @returns {void}                       
		 */
		eachRow? (fn: ((record?: Ext.data.Model) => void) | ExtGlobalFunction, scope?: object): void;
		/** 
		 ...
		 * @returns {Ext.grid.selection.Cells|Ext.grid.selection.Selection|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.grid.selection.Cells;
		setConfig? (name: string | object, value?: object): Ext.grid.selection.Selection;
		 ...
		 * @returns {Ext.grid.selection.Cells|Ext.grid.selection.Selection|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.grid.selection.Cells;
		initConfig? (config: object): Ext.grid.selection.Selection;
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.grid.selection.Cells.Statics|Ext.grid.selection.Selection.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.grid.selection.Cells.Statics;
		statics? (): Ext.grid.selection.Selection.Statics;
		 ...
		 * @returns {Ext.grid.selection.Cells|Ext.grid.selection.Selection|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.grid.selection.Cells;
		unlink? (names: string[]): Ext.grid.selection.Selection;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * [Ext.grid.selection.Columns](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Columns.html)
	 * A class which encapsulates a range of columns defining a selection in a grid.
	 */
	class Columns extends Ext.grid.selection.Selection {
		/** 
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.grid.selection.Columns.Statics}
		 */
		self?: Ext.grid.selection.Columns.Statics | Ext.grid.selection.Selection.Statics | Ext.Base.Statics;
		/** 
		 * ---
		 * @property
		 * @private (property)
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.grid.selection.Columns|Ext.grid.selection.Selection|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Columns;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Selection;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                                           members
		 * @returns {Ext.grid.selection.Columns|Ext.grid.selection.Selection|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.grid.selection.Columns;
		static addStatics? (members: object): typeof Ext.grid.selection.Selection;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.grid.selection.Columns|Ext.grid.selection.Selection|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.grid.selection.Columns;
		static addMember? (name: object, member: object): typeof Ext.grid.selection.Selection;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.grid.selection.Columns|Ext.grid.selection.Selection|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.grid.selection.Columns;
		static onExtended? (fn: object, scope: object): typeof Ext.grid.selection.Selection;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		...
		clone? (): Ext.grid.selection.Selection;
		/** 
		 * Returns `true` if the passed [column](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.column.Column.html) is selected.
		 * @method
		 * @public (method)
		 * @param   {Ext.grid.column.Column} column The column to test.
		 * @returns {boolean}                       `true` if the passed [column](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.column.Column.html) is selected.
		 */
		 ...
		 * @returns {Ext.grid.selection.Columns|Ext.grid.selection.Selection|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.grid.selection.Columns;
		setConfig? (name: string | object, value?: object): Ext.grid.selection.Selection;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Call the original method that was previously overridden with [override](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#static-method-override)
		 ...
		 * @returns {Ext.grid.selection.Columns|Ext.grid.selection.Selection|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.grid.selection.Columns;
		initConfig? (config: object): Ext.grid.selection.Selection;
		initConfig? (config: object): Ext.Base;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.grid.selection.Columns.Statics|Ext.grid.selection.Selection.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.grid.selection.Columns.Statics;
		statics? (): Ext.grid.selection.Selection.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 * This method applies a versioned, deprecation declaration to this class. This
		 ...
		 * @returns {Ext.grid.selection.Columns|Ext.grid.selection.Selection|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.grid.selection.Columns;
		unlink? (names: string[]): Ext.grid.selection.Selection;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * [Ext.grid.selection.Replicator](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Replicator.html)
	 * A plugin for use in grids which use the [spreadsheet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html) selection model,
	 * with [extensible](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#cfg-extensible) configured as `true` or `"y"`, meaning that
	 ...
	 * 
	 * If just _one_ row is selected, the values in that row are replicated unchanged into the extension area.
	 * 
	 ...
	 */
	class Replicator extends Ext.plugin.Abstract {
		/** 
		 * An array of the columns encompassed by the selection block. This is gathered before [replicateSelection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Replicator.html#method-replicateSelection)
		 * is called, so is available to subclasses which implement their own [replicateSelection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Replicator.html#method-replicateSelection) method.
		 * @property
		 * @public (property)
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.grid.selection.Replicator.Statics}
		 */
		self?: Ext.grid.selection.Replicator.Statics | Ext.plugin.Abstract.Statics | Ext.Base.Statics;
		/** 
		 * Add methods / properties to the prototype of this class.
		 * 
		 *    Ext.define('My.awesome.Cat', {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.grid.selection.Replicator|Ext.plugin.Abstract|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Replicator;
		 ...
		 * @chainable
		 * @param   {object}                                                     members
		 * @returns {Ext.grid.selection.Replicator|Ext.plugin.Abstract|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.grid.selection.Replicator;
		 ...
		 * @returns {Ext.grid.selection.Replicator|Ext.plugin.Abstract|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.grid.selection.Replicator;
		 ...
		 * @returns {Ext.grid.selection.Replicator|Ext.plugin.Abstract|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.grid.selection.Replicator;
		...
		/** 
		 * A utility method, which, when passed a record, uses the [columns](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Replicator.html#property-columns) property to extract the values
		 * of that record which are encompassed by the selection.
		 * 
		 * Note that columns with no [dataIndex](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.column.Column.html#cfg-dataIndex) cannot yield a value.
		 * @method
		 * @public (method)
		 * @param   {Ext.data.Model} record The record from which to read values.
		 * @returns {any[]}                 The values of the fields used by the selected column range for the passed record.
		 */
		getColumnValues? (record: Ext.data.Model): any[];
		/** 
		 * Returns a specified config property value. If the name parameter is not passed,
		 * all current configuration options will be returned as key value pairs.
		 * @method
		...
		/** 
		 * This is the method which is called when the [spreadsheet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html) selection model's
		 ...
		 * @param   {object|Ext.grid.selection.Replicator.methodParams.replicateSelection.Extension} extension An object describing the type and size of extension.
		 * @returns {void}                                                                                     
		 */
		replicateSelection? (ownerGrid: Ext.panel.Table, sel: Ext.grid.selection.Selection, extension: object | Ext.grid.selection.Replicator.methodParams.replicateSelection.Extension): void;
		/** 
		 ...
		 * @returns {Ext.grid.selection.Replicator|Ext.plugin.Abstract|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.grid.selection.Replicator;
		 ...
		 * @returns {Ext.grid.selection.Replicator|Ext.plugin.Abstract|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.grid.selection.Replicator;
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.grid.selection.Replicator.Statics|Ext.plugin.Abstract.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.grid.selection.Replicator.Statics;
		 ...
		 * @returns {Ext.grid.selection.Replicator|Ext.plugin.Abstract|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.grid.selection.Replicator;
		unlink? (names: string[]): Ext.plugin.Abstract;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * [Ext.grid.selection.Rows](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Rows.html)
	 * A class which encapsulates a range of rows defining a selection in a grid.
	 */
	class Rows extends Ext.grid.selection.Selection {
		/** 
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.grid.selection.Rows.Statics}
		 */
		self?: Ext.grid.selection.Rows.Statics | Ext.grid.selection.Selection.Statics | Ext.Base.Statics;
		/** 
		 * ---
		 * @property
		 * @private (property)
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.grid.selection.Rows|Ext.grid.selection.Selection|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Rows;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Selection;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                                        members
		 * @returns {Ext.grid.selection.Rows|Ext.grid.selection.Selection|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.grid.selection.Rows;
		static addStatics? (members: object): typeof Ext.grid.selection.Selection;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.grid.selection.Rows|Ext.grid.selection.Selection|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.grid.selection.Rows;
		static addMember? (name: object, member: object): typeof Ext.grid.selection.Selection;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.grid.selection.Rows|Ext.grid.selection.Selection|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.grid.selection.Rows;
		static onExtended? (fn: object, scope: object): typeof Ext.grid.selection.Selection;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 ...
		 * 
		 * Internally this method increments a counter that is decremented by [`endUpdate`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Rows.html#method-endUpdate). It
		...
		clone? (): Ext.grid.selection.Selection;
		/** 
		 * Returns `true` if the passed [record](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html) is selected.
		 * @method
		 * @public (method)
		 * @param   {Ext.data.Model} record The record to test.
		 * @returns {boolean}               `true` if the passed [record](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html) is selected.
		 */
		 ...
		 * 
		 * To prevent potential memory leaks, all object references will be nulled
		 * at the end of destruction sequence, unless [clearPropertiesOnDestroy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Rows.html#property-clearPropertiesOnDestroy)
		 * is set to `false`.
		 * @method
		 * @public (method)
		 * @returns {void}  
		 ...
		 * see [`beginUpdate`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Rows.html#method-beginUpdate).
		 * @method
		 * @public (method)
		 * @returns {void}  
		 */
		 ...
		 * @returns {Ext.grid.selection.Rows|Ext.grid.selection.Selection|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.grid.selection.Rows;
		setConfig? (name: string | object, value?: object): Ext.grid.selection.Selection;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Call the original method that was previously overridden with [override](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#static-method-override)
		 ...
		 * @returns {Ext.grid.selection.Rows|Ext.grid.selection.Selection|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.grid.selection.Rows;
		initConfig? (config: object): Ext.grid.selection.Selection;
		initConfig? (config: object): Ext.Base;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.grid.selection.Rows.Statics|Ext.grid.selection.Selection.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.grid.selection.Rows.Statics;
		statics? (): Ext.grid.selection.Selection.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 * This method applies a versioned, deprecation declaration to this class. This
		 ...
		 * @returns {Ext.grid.selection.Rows|Ext.grid.selection.Selection|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.grid.selection.Rows;
		unlink? (names: string[]): Ext.grid.selection.Selection;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * [Ext.grid.selection.Selection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Selection.html)
	 * Base class for selections which may be of three subtypes:
	 * 
	 * - [Cells](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Cells.html) A rectangular range of cells defined by a start
	 *   record/column and an end record/column.
	 * - [Rows](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Rows.html) An array of records.
	 * - [Columns](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Columns.html) An array of columns in which all records
	 *   are included.
	 */
	class Selection extends Ext.Base {
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.grid.selection.Selection.Statics}
		 */
		self?: Ext.grid.selection.Selection.Statics | Ext.Base.Statics;
		/** 
		 * Add methods / properties to the prototype of this class.
		 * 
		 *    Ext.define('My.awesome.Cat', {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.grid.selection.Selection|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Selection;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 ...
		 * @chainable
		 * @param   {object}                                members
		 * @returns {Ext.grid.selection.Selection|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.grid.selection.Selection;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.grid.selection.Selection.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.grid.selection.Selection.Statics;
		statics? (): Ext.Base.Statics;
		/** 
	...
	/** 
	 * [Ext.grid.selection.SpreadsheetModel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html)
	 * A selection model for [grids](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.Panel.html) which allows you to select data in
	 ...
	 *    });
	 * 
	 * # Using [Ext.data.BufferedStore](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.BufferedStore.html)s
	 * 
	 * It is very important to remember that a [Ext.data.BufferedStore](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.BufferedStore.html) does _not_ contain the
	 ...
	 * 
	 * _But records which have not been read into the cache will obviously not be available
	 * when interrogating selected records. As you scroll through the dataset, and more
	 * pages are read from the server, they will become available to add to the selection._
	 */
	class SpreadsheetModel extends Ext.selection.Model {
		/** 
		 * Get the reference to the current class from which this object was instantiated. Unlike [statics](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#method-statics),
		 * `this.self` is scope-dependent and it's meant to be used for dynamic inheritance. See [statics](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#method-statics)
		 * for a detailed comparison
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.grid.selection.SpreadsheetModel.Statics}
		 */
		self?: Ext.grid.selection.SpreadsheetModel.Statics | Ext.selection.Model.Statics | Ext.mixin.Observable.Statics | Ext.Base.Statics;
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.grid.selection.SpreadsheetModel|Ext.selection.Model|Ext.mixin.Observable|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.SpreadsheetModel;
		 ...
		 * @chainable
		 * @param   {object}                                                                                members
		 * @returns {Ext.grid.selection.SpreadsheetModel|Ext.selection.Model|Ext.mixin.Observable|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.grid.selection.SpreadsheetModel;
		 ...
		 * @returns {Ext.grid.selection.SpreadsheetModel|Ext.selection.Model|Ext.mixin.Observable|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.grid.selection.SpreadsheetModel;
		 ...
		 * @returns {Ext.grid.selection.SpreadsheetModel|Ext.selection.Model|Ext.mixin.Observable|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.grid.selection.SpreadsheetModel;
		 ...
		 * @returns {void}                 
		 */
		deselect? (records: object, suppressEvent: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.selection.Model.deselect](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#method-deselect).
		 * Deselects a record instance by record instance or index.
		 * @method
		 * @public (method)
		 ...
		 * Pass `true` to prevent firing the
		 * [`selectionchange`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#event-selectionchange) event.
		 * @returns {void}                    
		 */
		...
		/** 
		 * Deselects a range of rows if the selection model [is not locked](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#method-isLocked).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [cellSelect](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#cfg-cellSelect).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [columnSelect](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#cfg-columnSelect).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		 ...
		 * 
		 * To interrogate the selection use [getSelected](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#method-getSelected) which will return an instance of one
		...
		getCount? (): number;
		/** 
		 * Returns the value of [dragSelect](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#cfg-dragSelect).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [extensible](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#cfg-extensible).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		getInitialConfig? (name?: string): object | any;
		/** 
		 * Returns the value of [rowSelect](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#cfg-rowSelect).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		 ...
		 * @returns {void}  
		 */
		isRangeSelected? (): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.selection.Model.isRangeSelected](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#method-isRangeSelected).
		 ...
		 * @returns {boolean}        
		 */
		isSelected? (record: object): boolean;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.selection.Model.isSelected](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#method-isSelected).
		 * Returns true if the specified row is selected.
		 * @method
		 * @public (method)
		 ...
		 * @returns {void}                 
		 */
		select? (records: object, keepExisting: object, suppressEvent: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.selection.Model.select](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#method-select).
		 * Selects a record instance by record instance or index.
		 * @method
		 * @public (method)
		 * @param   {Ext.data.Model[]|number} records         An array of records or an index
		 ...
		 * @method
		 * @public (method)
		 * @param   {object}  rangeStart
		 * {[Ext.grid.CellContext](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.CellContext.html)/Number[]} Range starting position. Can be either Cell context or a `[rowIndex, columnIndex]` numeric array.
		 * 
		 * Note that when a numeric array is used in a locking grid, the column indices are relative to the outermost grid, encompassing locked _and_ normal sides.
		 * @param   {object}  rangeEnd
		 * {[Ext.grid.CellContext](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.CellContext.html)/Number[]} Range end position. Can be either Cell context or a `[rowIndex, columnIndex]` numeric array.
		 * 
		 * Note that when a numeric array is used in a locking grid, the column indices are relative to the outermost grid, encompassing locked _and_ normal sides.
		 * @param   {boolean} [suppressEvent]
		 * Pass `true` to prevent firing the
		 ...
		 * @returns {void}                    
		 */
		selectCells? (rangeStart: object, rangeEnd: object, suppressEvent?: boolean): void;
		/** 
		 * Selects a column.
		 * @method
		 * @public (method)
		 * @param   {Ext.grid.column.Column} column          Column to select.
		 * @param   {boolean}                [keepSelection] Pass `true` to keep previous selection.
		 * @param   {boolean}                [suppressEvent]
		 * Pass `true` to prevent firing the
		 * [`selectionchange`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#event-selectionchange) event.
		 * @returns {void}                                   
		...
		/** 
		 * Selects a range of rows if the selection model [is not locked](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#method-isLocked).
		 ...
		 * @method
		 * @public (method)
		 * @param   {object}  rows            {[Ext.data.Model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html)[]} Records to select.
		 * @param   {boolean} [keepSelection] Pass `true` to keep previous selection.
		 * @param   {boolean} [suppressEvent]
		 * Pass `true` to prevent firing the
		 * [`selectionchange`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#event-selectionchange) event.
		 * @returns {void}                    
		 */
		selectRows? (rows: object, keepSelection?: boolean, suppressEvent?: boolean): void;
		/** 
		 * Sets the value of [cellSelect](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#cfg-cellSelect).
		 * @method
		 * @public (method)
		 * @param   {boolean} cellSelect The new value.
		 * @returns {void}               
		 */
		setCellSelect? (cellSelect: boolean): void;
		/** 
		 * Sets the value of [columnSelect](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#cfg-columnSelect).
		 * @method
		 * @public (method)
		 * @param   {boolean} columnSelect The new value.
		 * @returns {void}                 
		 */
		 ...
		 * @returns {Ext.grid.selection.SpreadsheetModel|Ext.selection.Model|Ext.mixin.Observable|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.grid.selection.SpreadsheetModel;
		...
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Sets the value of [dragSelect](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#cfg-dragSelect).
		 * @method
		 * @public (method)
		 * @param   {boolean} dragSelect The new value.
		 * @returns {void}               
		 */
		setDragSelect? (dragSelect: boolean): void;
		/** 
		 * Sets the value of [extensible](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#cfg-extensible).
		 * @method
		 * @public (method)
		 * @param   {string} extensible The new value.
		 * @returns {void}              
		 */
		setExtensible? (extensible: string): void;
		/** 
		...
		/** 
		 * Sets the value of [rowSelect](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#cfg-rowSelect).
		 * @method
		 * @public (method)
		 * @param   {boolean} rowSelect The new value.
		 * @returns {void}              
		 */
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.selection.Model.bindComponent](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#method-bindComponent).
		 * @method
		 * @public (method)
		 * @returns {void}  
		 */
		 ...
		 * @returns {Ext.grid.selection.SpreadsheetModel|Ext.selection.Model|Ext.mixin.Observable|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.grid.selection.SpreadsheetModel;
		 ...
		 * @returns {void}            
		 */
		onBindStore? (store: object, oldStore: object, initial: object): void;
		/** 
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.grid.selection.SpreadsheetModel.Statics|Ext.selection.Model.Statics|Ext.mixin.Observable.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.grid.selection.SpreadsheetModel.Statics;
		...
		getCurrentConfig? (): void;
		/** 
		 * Called by [Ext.panel.Table.updateBindSelection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.panel.Table.html#method-updateBindSelection) when publishing the `selection` property.
		 * It should yield the last record selected.
		 * @method
		 * @private (method)
		 * @returns {Ext.data.Model} 
		 * The last record selected. This is only available if the current selection type is cells or rows.
		 * In the case of multiple selection, the _last_ record added to the selection is returned.
		 */
		...
		/** 
		 * Returns the value of [store](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#cfg-store).
		 * @method
		 * @private (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.selection.Model.onHeaderClick](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#method-onHeaderClick).
		 * Called by the owning grid's [header container](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.header.Container.html)
		...
		/** 
		 * Sets the value of [store](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#cfg-store).
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.grid.selection.SpreadsheetModel|Ext.selection.Model|Ext.mixin.Observable|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.grid.selection.SpreadsheetModel;
		unlink? (names: string[]): Ext.selection.Model;
		unlink? (names: string[]): Ext.mixin.Observable;
		unlink? (names: string[]): Ext.Base;
		/** 
		 * Called when the store is refreshed.
		 * Selected records which are no longer present in the store are removed if [pruneRemoved](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#cfg-pruneRemoved) is `true`.
		 * 
		 ...
		 * @returns {void}                                      
		 */
		updateSelectedInstances? (selected: Ext.util.Collection | Ext.util.Bag): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} store
...
declare namespace Ext.grid.selection.Cells {
	/** 
	 * @definitions
	 ...
	 * order is traditional `x, y` order, that is column index followed by row index.
	 */
	interface Def extends Ext.grid.selection.Cells {
		/** 
		 ...
		 * @type {Ext.grid.selection.Cells.Statics}
		 */
		statics?: (() => Ext.grid.selection.Cells.Statics | Ext.grid.selection.Selection.Statics | Ext.Base.Statics) | Ext.grid.selection.Cells.Statics | any;
	}
}
declare namespace Ext.grid.selection.Columns {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.grid.selection.Columns](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Columns.html)
	 * A class which encapsulates a range of columns defining a selection in a grid.
	 */
	interface Def extends Ext.grid.selection.Columns {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @type {Ext.grid.selection.Columns.Statics}
		 */
		statics?: (() => Ext.grid.selection.Columns.Statics | Ext.grid.selection.Selection.Statics | Ext.Base.Statics) | Ext.grid.selection.Columns.Statics | any;
	}
}
declare namespace Ext.grid.selection.Replicator {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.grid.selection.Replicator](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Replicator.html)
	 ...
	 * difference, and that difference is used to calculate the sequence of values all the way into the extension area.
	 */
	interface Def extends Ext.grid.selection.Replicator {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.grid.selection.Replicator.Cfg}
		 */
		config?: Ext.grid.selection.Replicator.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * @type {Ext.grid.selection.Replicator.Statics}
		 */
		statics?: (() => Ext.grid.selection.Replicator.Statics | Ext.plugin.Abstract.Statics | Ext.Base.Statics) | Ext.grid.selection.Replicator.Statics | any;
	}
}
declare namespace Ext.grid.selection.Rows {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.grid.selection.Rows](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Rows.html)
	 * A class which encapsulates a range of rows defining a selection in a grid.
	 */
	interface Def extends Ext.grid.selection.Rows {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @type {Ext.grid.selection.Rows.Statics}
		 */
		statics?: (() => Ext.grid.selection.Rows.Statics | Ext.grid.selection.Selection.Statics | Ext.Base.Statics) | Ext.grid.selection.Rows.Statics | any;
	}
}
declare namespace Ext.grid.selection.Selection {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.grid.selection.Selection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Selection.html)
	 ...
	 *   are included.
	 */
	interface Def extends Ext.grid.selection.Selection {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @type {Ext.grid.selection.Selection.Statics}
		 */
		statics?: (() => Ext.grid.selection.Selection.Statics | Ext.Base.Statics) | Ext.grid.selection.Selection.Statics | any;
	}
}
declare namespace Ext.grid.selection.SpreadsheetModel {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.grid.selection.SpreadsheetModel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html)
	 ...
	 * pages are read from the server, they will become available to add to the selection._
	 */
	interface Def extends Ext.grid.selection.SpreadsheetModel {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.grid.selection.SpreadsheetModel.Cfg}
		 */
		config?: Ext.grid.selection.SpreadsheetModel.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * @type {Ext.grid.selection.SpreadsheetModel.Statics}
		 */
		statics?: (() => Ext.grid.selection.SpreadsheetModel.Statics | Ext.selection.Model.Statics | Ext.mixin.Observable.Statics | Ext.Base.Statics) | Ext.grid.selection.SpreadsheetModel.Statics | any;
	}
}
declare namespace Ext.grid.selection.Cells {
	/** 
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.grid.selection.Cells|Ext.grid.selection.Selection|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Cells;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Selection;
		 ...
		 * @returns {Ext.grid.selection.Cells|Ext.grid.selection.Selection|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.grid.selection.Cells;
		addStatics? (members: object): typeof Ext.grid.selection.Selection;
		 ...
		 * @returns {Ext.grid.selection.Cells|Ext.grid.selection.Selection|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.grid.selection.Cells;
		addMember? (name: object, member: object): typeof Ext.grid.selection.Selection;
		 ...
		 * @returns {Ext.grid.selection.Cells|Ext.grid.selection.Selection|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.grid.selection.Cells;
		onExtended? (fn: object, scope: object): typeof Ext.grid.selection.Selection;
...
declare namespace Ext.grid.selection.Columns {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.grid.selection.Columns|Ext.grid.selection.Selection|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Columns;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Selection;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @returns {Ext.grid.selection.Columns|Ext.grid.selection.Selection|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.grid.selection.Columns;
		addStatics? (members: object): typeof Ext.grid.selection.Selection;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.grid.selection.Columns|Ext.grid.selection.Selection|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.grid.selection.Columns;
		addMember? (name: object, member: object): typeof Ext.grid.selection.Selection;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.grid.selection.Columns|Ext.grid.selection.Selection|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.grid.selection.Columns;
		onExtended? (fn: object, scope: object): typeof Ext.grid.selection.Selection;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.grid.selection.Replicator {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.grid.selection.Replicator|Ext.plugin.Abstract|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Replicator;
		 ...
		 * @returns {Ext.grid.selection.Replicator|Ext.plugin.Abstract|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.grid.selection.Replicator;
		 ...
		 * @returns {Ext.grid.selection.Replicator|Ext.plugin.Abstract|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.grid.selection.Replicator;
		 ...
		 * @returns {Ext.grid.selection.Replicator|Ext.plugin.Abstract|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.grid.selection.Replicator;
...
declare namespace Ext.grid.selection.Rows {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.grid.selection.Rows|Ext.grid.selection.Selection|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Rows;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.Selection;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @returns {Ext.grid.selection.Rows|Ext.grid.selection.Selection|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.grid.selection.Rows;
		addStatics? (members: object): typeof Ext.grid.selection.Selection;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.grid.selection.Rows|Ext.grid.selection.Selection|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.grid.selection.Rows;
		addMember? (name: object, member: object): typeof Ext.grid.selection.Selection;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.grid.selection.Rows|Ext.grid.selection.Selection|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.grid.selection.Rows;
		onExtended? (fn: object, scope: object): typeof Ext.grid.selection.Selection;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.grid.selection.SpreadsheetModel {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.grid.selection.SpreadsheetModel|Ext.selection.Model|Ext.mixin.Observable|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.grid.selection.SpreadsheetModel;
		 ...
		 * @returns {Ext.grid.selection.SpreadsheetModel|Ext.selection.Model|Ext.mixin.Observable|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.grid.selection.SpreadsheetModel;
		 ...
		 * @returns {Ext.grid.selection.SpreadsheetModel|Ext.selection.Model|Ext.mixin.Observable|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.grid.selection.SpreadsheetModel;
		 ...
		 * @returns {Ext.grid.selection.SpreadsheetModel|Ext.selection.Model|Ext.mixin.Observable|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.grid.selection.SpreadsheetModel;
...
declare namespace Ext.grid.selection.Replicator.methodParams.replicateSelection {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.selection.Replicator.replicateSelection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Replicator.html#method-replicateSelection)
	 * An object describing the type and size of extension.
	 */
	interface Extension extends Ext.base.Params {
		/** 
		 * `"rows"` or `"columns"`
		 * @configuration
		 * @optional
...
declare namespace Ext.grid.selection.SpreadsheetModel.methodParams.addListener {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.selection.SpreadsheetModel.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#method-addListener)
...
declare namespace Ext.grid.selection.SpreadsheetModel.methodParams.extendSelection {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.selection.SpreadsheetModel.extendSelection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#method-extendSelection)
	 * An object describing the type and size of extension.
	 */
	interface Extension extends Ext.base.Params {
		/** 
...
declare namespace Ext.grid.selection.SpreadsheetModel.methodParams.on {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.grid.selection.SpreadsheetModel.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.grid.selection.Replicator {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                                config
		 * @returns {Ext.grid.selection.Replicator.Statics}        this
		 */
		initConfig? (config: object): Ext.grid.selection.Replicator.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.grid.selection.Replicator.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.grid.selection.Replicator.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.grid.selection.Replicator.Statics}  
		 */
		statics? (): Ext.grid.selection.Replicator.Statics;
	}
}
declare namespace Ext.grid.selection.SpreadsheetModel {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * Only applicable when the [mode](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#cfg-mode) is 'SINGLE'.
		 * @configuration
		 * @optional
		 * @type {boolean}
		 */
		 ...
		 * 
		 * if [showHeaderCheckbox](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#cfg-showHeaderCheckbox) is `true`, the text is shown _above_ the checkbox.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		checkColumnHeaderText?: string;
		/** 
		 ...
		 * new column at position specified by [checkboxColumnIndex](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#cfg-checkboxColumnIndex).
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
		...
		dragSelect?: boolean;
		/** 
		 * This configures whether this selection model is to implement a mouse based dragging gesture to extend a _contiguou_s selection.
		 * 
		 ...
		 * 
		 * Upon the end of the drag, the [beforeselectionextend](https://docs.sencha.com/extjs/6.2.0/classic/Ext.panel.Table.html#event-beforeselectionextend) event will be fired though the
		 ...
		 * 
		 * - **"SINGLE"** - Only allows selecting one item at a time.  Use [allowDeselect](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#cfg-allowDeselect) to allow
		 *   deselecting that item.  Also see [toggleOnClick](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#cfg-toggleOnClick). This is the default.
		 ...
		 * {[Ext.util.Collection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.util.Collection.html)} instead of {[Ext.util.Bag](https://docs.sencha.com/extjs/6.2.0/classic/Ext.util.Bag.html)} to maintain insertion order.
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
		 ...
		 * 
		 * **Important:** When using [paging](https://docs.sencha.com/extjs/6.2.0/classic/Ext.toolbar.Paging.html) or a [Ext.data.BufferedStore](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.BufferedStore.html),
		 * records which are cached in the Store's [data collection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Store.html#property-data) may be removed from the Store when pages change,
		 ...
		 * you MUST ensure that the Model definition's [idProperty](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Model.html#cfg-idProperty) references a unique
		 ...
		 * 
		 * _Note_: This feature will add the row number as the first column.
		 * @configuration
		 * @optional
		 * @default true
		 * @type {boolean}
		...
		rowSelect?: boolean;
		/** 
		 * Pass an instance of one of the subclasses of [Ext.grid.selection.Selection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Selection.html).
		 * @configuration
		 * @optional
		 ...
		 * when [checkboxSelect](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.SpreadsheetModel.html#cfg-checkboxSelect) is set.
		 * @configuration
		 * @optional
		 * @default true
		 * @type {boolean}
		...
		/** 
		 * The [store](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Store.html) in which this selection model represents the selected subset.
		 * @configuration
		 * @optional
		 * @type {object}
		 */
		 ...
		 * Only applicable when the [mode](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#cfg-mode) is 'SINGLE'.
		 * Only applicable when the [allowDeselect](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#cfg-allowDeselect) is 'true'.
		 * @configuration
		 * @optional
		 * @default true
		 * @type {boolean}
		 ...
		 * @chainable
		 * @param   {object}                                      config
		 * @returns {Ext.grid.selection.SpreadsheetModel.Statics}        this
		 */
		initConfig? (config: object): Ext.grid.selection.SpreadsheetModel.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.grid.selection.SpreadsheetModel.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.grid.selection.SpreadsheetModel.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.grid.selection.SpreadsheetModel.Statics}  
		 */
		statics? (): Ext.grid.selection.SpreadsheetModel.Statics;
	}
	/** 
	...
	interface Events extends Ext.base.Events {
		...
		/** 
		 * Fired _by the grid_ after the selection changes. Return `false` to veto the selection extension.
		 * 
		 ...
		 * @param   {Ext.grid.selection.Selection} selection
		 * A subclass of
		 * [Ext.grid.selection.Selection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.selection.Selection.html) describing the new selection.
		 * @param   {object}                       eOpts     The options object passed to [Ext.util.Observable.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.util.Observable.html#method-addListener).
		 * @returns {void}                         
		 */
		selectionchange? (grid: Ext.grid.Panel, selection: Ext.grid.selection.Selection, eOpts: object): void;
	}
}

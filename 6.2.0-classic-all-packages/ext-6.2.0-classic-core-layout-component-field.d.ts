declare namespace Ext.layout.component.field {
	 ...
	 * @private (class)
	 */
	class FieldContainer extends Ext.layout.component.Auto {}
	/** 
	 * Layout class for [Ext.form.field.HtmlEditor](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.field.HtmlEditor.html) fields. Sizes textarea and iframe elements.
	 * @private (class)
	 */
	class HtmlEditor extends Ext.layout.component.field.FieldContainer {}
}
declare namespace Ext.layout.component.field.FieldContainer {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.component.field.FieldContainer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.field.FieldContainer.html)
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.layout.component.field.FieldContainer|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.field.FieldContainer;
		 ...
		 * @returns {Ext.layout.component.field.FieldContainer|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.layout.component.field.FieldContainer;
		 ...
		 * @returns {Ext.layout.component.field.FieldContainer|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.layout.component.field.FieldContainer;
		 ...
		 * @returns {Ext.layout.component.field.FieldContainer|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.field.FieldContainer;
...
declare namespace Ext.layout.component.field.HtmlEditor {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.component.field.HtmlEditor](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.field.HtmlEditor.html)
	 * Layout class for [Ext.form.field.HtmlEditor](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.field.HtmlEditor.html) fields. Sizes textarea and iframe elements.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.layout.component.field.HtmlEditor|Ext.layout.component.field.FieldContainer|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.field.HtmlEditor;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.field.FieldContainer;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Auto;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Component;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.Layout;
		 ...
		 * @chainable
		 * @param   {object}                                                                                                                                                              members
		 * @returns {Ext.layout.component.field.HtmlEditor|Ext.layout.component.field.FieldContainer|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.layout.component.field.HtmlEditor;
		addStatics? (members: object): typeof Ext.layout.component.field.FieldContainer;
		addStatics? (members: object): typeof Ext.layout.component.Auto;
		addStatics? (members: object): typeof Ext.layout.component.Component;
		addStatics? (members: object): typeof Ext.layout.Layout;
		 ...
		 * @returns {Ext.layout.component.field.HtmlEditor|Ext.layout.component.field.FieldContainer|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.layout.component.field.HtmlEditor;
		addMember? (name: object, member: object): typeof Ext.layout.component.field.FieldContainer;
		addMember? (name: object, member: object): typeof Ext.layout.component.Auto;
		addMember? (name: object, member: object): typeof Ext.layout.component.Component;
		addMember? (name: object, member: object): typeof Ext.layout.Layout;
		 ...
		 * @returns {Ext.layout.component.field.HtmlEditor|Ext.layout.component.field.FieldContainer|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.field.HtmlEditor;
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.field.FieldContainer;
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Auto;
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Component;
		onExtended? (fn: object, scope: object): typeof Ext.layout.Layout;
...
declare namespace Ext.layout.component.field.FieldContainer {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                                            config
		 * @returns {Ext.layout.component.field.FieldContainer.Statics}        this
		 */
		initConfig? (config: object): Ext.layout.component.field.FieldContainer.Statics;
		/** 
		 ...
		 * @returns {Ext.layout.component.field.FieldContainer.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.layout.component.field.FieldContainer.Statics;
		/** 
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.layout.component.field.FieldContainer.Statics}  
		 */
		statics? (): Ext.layout.component.field.FieldContainer.Statics;
	}
}
declare namespace Ext.layout.component.field.HtmlEditor {
	/** 
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                                        config
		 * @returns {Ext.layout.component.field.HtmlEditor.Statics}        this
		 */
		initConfig? (config: object): Ext.layout.component.field.HtmlEditor.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.layout.component.field.HtmlEditor.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.layout.component.field.HtmlEditor.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.layout.component.field.HtmlEditor.Statics}  
		 */
		statics? (): Ext.layout.component.field.HtmlEditor.Statics;
	}
}

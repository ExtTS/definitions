declare namespace Ext.layout.component {
	/** 
	 * [Ext.layout.component.Auto](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.Auto.html)
	 * The class is the default component layout for [Ext.Component](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html) when no explicit
	 * [`componentLayout`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html#cfg-componentLayout) is configured.
	 * 
	 ...
	 * [size model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html#method-getSizeModel).
	 * 
	 * ## configured / calculated
	 * 
	 * In either of these size models, the dimension of the outer element is of a known size.
	 * The size is found in the `ownerContext` (the [Ext.layout.ContextItem](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.ContextItem.html) for the owner
	 ...
	 * 
	 * - [`Ext.layout.component.Component.measureContentWidth`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.Component.html#method-measureContentWidth)
	 * - `publishOwnerWidth`
	 *   <ul>
	 *   <li>`calculateOwnerWidthFromContentWidth`
	 ...
	 * 
	 * - [`Ext.layout.component.Component.measureOwnerWidth`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.Component.html#method-measureOwnerWidth)
	 * - `publishInnerWidth`
	 */
	class Auto extends Ext.layout.component.Component {
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.layout.component.Auto.Statics}
		 */
		self?: Ext.layout.component.Auto.Statics | Ext.layout.component.Component.Statics | Ext.layout.Layout.Statics | Ext.Base.Statics;
		/** 
		 ...
		 * @type {boolean}
		 */
		waitForOuterHeightInDom?: boolean;
		/** 
		 * @property
		 * @private (property)
		 * @default false
		 * @type {boolean}
		 */
		waitForOuterWidthInDom?: boolean;
		/** 
		 ...
		 * @returns {Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Auto;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Component;
		 ...
		 * @returns {Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.layout.component.Auto;
		static addStatics? (members: object): typeof Ext.layout.component.Component;
		 ...
		 * @returns {Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.layout.component.Auto;
		static addMember? (name: object, member: object): typeof Ext.layout.component.Component;
		 ...
		 * @returns {Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.layout.component.Auto;
		static onExtended? (fn: object, scope: object): typeof Ext.layout.component.Component;
		 ...
		 * @param   {object} firstCycle
		 * @returns {void}                
		 */
		beginLayoutCycle? (ownerContext: object, firstCycle: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.layout.Layout.beginLayoutCycle](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.Layout.html#method-beginLayoutCycle).
		 * Called before any calculation cycles to reset DOM values and prepare for calculation.
		 * 
		 * This is a write phase and DOM reads should be strictly avoided when overridding
		 * this method.
		 ...
		 * least once and may be called repeatedly if the [done](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.Auto.html#property-done) property is cleared
		 * before return to indicate that this layout is not yet done. The [done](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.Auto.html#property-done) property
		 ...
		 * @returns {void}                
		 */
		calculate? (ownerContext: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.layout.Layout.calculate](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.Layout.html#method-calculate).
		 * Called to perform the calculations for this layout. This method will be called at
		 ...
		 * @returns {void}                
		 */
		finishedLayout? (ownerContext: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.layout.Layout.finishedLayout](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.Layout.html#method-finishedLayout).
		 * This method is called after all layouts are complete and their calculations flushed
		 * to the DOM. No further layouts will be run and this method is only called once per
		 * layout run. The base component layout caches `lastComponentSize`.
		 * 
		 ...
		 * called once per layout run. It is the bookend to [beginLayout](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.Component.html#method-beginLayout).
		 * 
		 * This is a write phase and DOM reads should be avoided if possible when overridding
		 ...
		 * a read is necessary, consider implementing a [finalizeLayout](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.Component.html#method-finalizeLayout) method to do the
		 * required reads.
		 * 
		 * This method need not be implemented by derived classes and, in fact, should only be
		 * implemented when needed.
		 ...
		 * @returns {void}                
		 */
		notifyOwner? (ownerContext: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.layout.Layout.notifyOwner](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.Layout.html#method-notifyOwner).
		 * This method (if implemented) is called after all layouts are finished, and all have
		 * a `lastComponentSize` cached. No further layouts will be run and this method is only
		 ...
		 * @returns {Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.layout.component.Auto;
		setConfig? (name: string | object, value?: object): Ext.layout.component.Component;
		 ...
		 * @returns {Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.layout.component.Auto;
		initConfig? (config: object): Ext.layout.component.Component;
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.layout.component.Auto.Statics|Ext.layout.component.Component.Statics|Ext.layout.Layout.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.layout.component.Auto.Statics;
		statics? (): Ext.layout.component.Component.Statics;
		 ...
		 * @returns {void}                
		 */
		cacheTargetInfo? (ownerContext: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} ownerContext
		 ...
		 * @returns {void}                 
		 */
		calculateOwnerHeightFromContentHeight? (ownerContext: object, contentHeight: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} ownerContext
		 ...
		 * @returns {void}                
		 */
		calculateOwnerWidthFromContentWidth? (ownerContext: object, contentWidth: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
		 ...
		 * @returns {void}                
		 */
		measureAutoDimensions? (ownerContext: object, dimensions: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} ownerContext
		 * @returns {void}                
		 */
		measureContentHeight? (ownerContext: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} ownerContext
		 * @returns {void}                
		 */
		measureContentWidth? (ownerContext: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} ownerContext
		 * @returns {void}                
		 */
		measureOwnerHeight? (ownerContext: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} ownerContext
		 * @returns {void}                
		 */
		measureOwnerWidth? (ownerContext: object): void;
		/** 
		 ...
		 * @returns {void}                 
		 */
		publishOwnerHeight? (ownerContext: object, contentHeight: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} ownerContext
		 ...
		 * @returns {void}                
		 */
		publishOwnerWidth? (ownerContext: object, contentWidth: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
		 ...
		 * @returns {Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.layout.component.Auto;
		unlink? (names: string[]): Ext.layout.component.Component;
	...
	/** 
	 * Component layout for [Ext.view.BoundList](https://docs.sencha.com/extjs/6.2.0/classic/Ext.view.BoundList.html).
	 * @private (class)
	 */
	class BoundList extends Ext.layout.component.Auto {}
	/** 
	 * This class is intended to be extended or created via the [layout](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html#cfg-componentLayout)
	 * configuration property.  See [Ext.Component.componentLayout](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html#cfg-componentLayout) for additional details.
	 * @private (class)
	 */
	...
	/** 
	 * Component layout for [Ext.form.FieldSet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.FieldSet.html) components
	 * @private (class)
	 */
	...
	class AbstractDock extends Ext.layout.component.Dock {}
}
declare namespace Ext.layout.component.Auto {
	/** 
	 * @definitions
	 ...
	 * - `publishInnerWidth`
	 */
	interface Def extends Ext.layout.component.Auto {
		/** 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.layout.component.Auto.Cfg}
		 */
		config?: Ext.layout.component.Auto.Cfg;
		/** 
		 ...
		 * @type {Ext.layout.component.Auto.Statics}
		 */
		statics?: (() => Ext.layout.component.Auto.Statics | Ext.layout.component.Component.Statics | Ext.layout.Layout.Statics | Ext.Base.Statics) | Ext.layout.component.Auto.Statics | any;
	}
	/** 
	 * @statics
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Auto;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Component;
		 ...
		 * @returns {Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.layout.component.Auto;
		addStatics? (members: object): typeof Ext.layout.component.Component;
		 ...
		 * @returns {Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.layout.component.Auto;
		addMember? (name: object, member: object): typeof Ext.layout.component.Component;
		 ...
		 * @returns {Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Auto;
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Component;
...
declare namespace Ext.layout.component.Body {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.component.Body](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.Body.html)
	 * Component layout for components which maintain an inner body element which must be resized to synchronize with the
	 * Component size.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.layout.component.Body|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Body;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Auto;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Component;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.Layout;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		 ...
		 * @chainable
		 * @param   {object}                                                                                                        members
		 * @returns {Ext.layout.component.Body|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.layout.component.Body;
		addStatics? (members: object): typeof Ext.layout.component.Auto;
		addStatics? (members: object): typeof Ext.layout.component.Component;
		addStatics? (members: object): typeof Ext.layout.Layout;
		addStatics? (members: object): typeof Ext.Base;
		 ...
		 * @returns {Ext.layout.component.Body|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.layout.component.Body;
		addMember? (name: object, member: object): typeof Ext.layout.component.Auto;
		addMember? (name: object, member: object): typeof Ext.layout.component.Component;
		addMember? (name: object, member: object): typeof Ext.layout.Layout;
		addMember? (name: object, member: object): typeof Ext.Base;
		 ...
		 * @returns {Ext.layout.component.Body|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Body;
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Auto;
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Component;
		onExtended? (fn: object, scope: object): typeof Ext.layout.Layout;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
...
declare namespace Ext.layout.component.BoundList {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.component.BoundList](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.BoundList.html)
	 * Component layout for [Ext.view.BoundList](https://docs.sencha.com/extjs/6.2.0/classic/Ext.view.BoundList.html).
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.layout.component.BoundList|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.BoundList;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Auto;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Component;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.Layout;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		 ...
		 * @chainable
		 * @param   {object}                                                                                                             members
		 * @returns {Ext.layout.component.BoundList|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.layout.component.BoundList;
		addStatics? (members: object): typeof Ext.layout.component.Auto;
		addStatics? (members: object): typeof Ext.layout.component.Component;
		addStatics? (members: object): typeof Ext.layout.Layout;
		addStatics? (members: object): typeof Ext.Base;
		 ...
		 * @returns {Ext.layout.component.BoundList|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.layout.component.BoundList;
		addMember? (name: object, member: object): typeof Ext.layout.component.Auto;
		addMember? (name: object, member: object): typeof Ext.layout.component.Component;
		addMember? (name: object, member: object): typeof Ext.layout.Layout;
		addMember? (name: object, member: object): typeof Ext.Base;
		 ...
		 * @returns {Ext.layout.component.BoundList|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.BoundList;
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Auto;
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Component;
		onExtended? (fn: object, scope: object): typeof Ext.layout.Layout;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
...
declare namespace Ext.layout.component.Component {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.component.Component](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.Component.html)
	 * This class is intended to be extended or created via the [layout](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html#cfg-componentLayout)
	 * configuration property.  See [Ext.Component.componentLayout](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html#cfg-componentLayout) for additional details.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Component;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.Layout;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		 ...
		 * @chainable
		 * @param   {object}                                                    members
		 * @returns {Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.layout.component.Component;
		addStatics? (members: object): typeof Ext.layout.Layout;
		addStatics? (members: object): typeof Ext.Base;
...
declare namespace Ext.layout.component.Dock {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.component.Dock](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.Dock.html)
	 * This ComponentLayout handles docking for Panels. It takes care of panels that are
	 * part of a ContainerLayout that sets this Panel's size and Panels that are part of
	 * an AutoContainerLayout in which this panel get his height based of the CSS or
	 * its content.
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.layout.component.Dock|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Dock;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Component;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.Layout;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 ...
		 * @chainable
		 * @param   {object}                                                                              members
		 * @returns {Ext.layout.component.Dock|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.layout.component.Dock;
		addStatics? (members: object): typeof Ext.layout.component.Component;
		addStatics? (members: object): typeof Ext.layout.Layout;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.layout.component.Dock|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.layout.component.Dock;
		addMember? (name: object, member: object): typeof Ext.layout.component.Component;
		addMember? (name: object, member: object): typeof Ext.layout.Layout;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 ...
		 * @returns {Ext.layout.component.Dock|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Dock;
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Component;
		onExtended? (fn: object, scope: object): typeof Ext.layout.Layout;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
...
declare namespace Ext.layout.component.FieldSet {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.component.FieldSet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.FieldSet.html)
	 * Component layout for [Ext.form.FieldSet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.form.FieldSet.html) components
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.layout.component.FieldSet|Ext.layout.component.Body|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.FieldSet;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Body;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Auto;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Component;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.Layout;
		 ...
		 * @chainable
		 * @param   {object}                                                                                                                                      members
		 * @returns {Ext.layout.component.FieldSet|Ext.layout.component.Body|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.layout.component.FieldSet;
		addStatics? (members: object): typeof Ext.layout.component.Body;
		addStatics? (members: object): typeof Ext.layout.component.Auto;
		addStatics? (members: object): typeof Ext.layout.component.Component;
		addStatics? (members: object): typeof Ext.layout.Layout;
		 ...
		 * @returns {Ext.layout.component.FieldSet|Ext.layout.component.Body|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.layout.component.FieldSet;
		addMember? (name: object, member: object): typeof Ext.layout.component.Body;
		addMember? (name: object, member: object): typeof Ext.layout.component.Auto;
		addMember? (name: object, member: object): typeof Ext.layout.component.Component;
		addMember? (name: object, member: object): typeof Ext.layout.Layout;
		 ...
		 * @returns {Ext.layout.component.FieldSet|Ext.layout.component.Body|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.FieldSet;
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Body;
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Auto;
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Component;
		onExtended? (fn: object, scope: object): typeof Ext.layout.Layout;
...
declare namespace Ext.layout.component.ProgressBar {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.component.ProgressBar](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.component.ProgressBar.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.layout.component.ProgressBar|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.ProgressBar;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Auto;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.component.Component;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.layout.Layout;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		 ...
		 * @chainable
		 * @param   {object}                                                                                                               members
		 * @returns {Ext.layout.component.ProgressBar|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.layout.component.ProgressBar;
		addStatics? (members: object): typeof Ext.layout.component.Auto;
		addStatics? (members: object): typeof Ext.layout.component.Component;
		addStatics? (members: object): typeof Ext.layout.Layout;
		addStatics? (members: object): typeof Ext.Base;
		 ...
		 * @returns {Ext.layout.component.ProgressBar|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.layout.component.ProgressBar;
		addMember? (name: object, member: object): typeof Ext.layout.component.Auto;
		addMember? (name: object, member: object): typeof Ext.layout.component.Component;
		addMember? (name: object, member: object): typeof Ext.layout.Layout;
		addMember? (name: object, member: object): typeof Ext.Base;
		 ...
		 * @returns {Ext.layout.component.ProgressBar|Ext.layout.component.Auto|Ext.layout.component.Component|Ext.layout.Layout|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.ProgressBar;
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Auto;
		onExtended? (fn: object, scope: object): typeof Ext.layout.component.Component;
		onExtended? (fn: object, scope: object): typeof Ext.layout.Layout;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
...
declare namespace Ext.layout.component.Auto {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                            config
		 * @returns {Ext.layout.component.Auto.Statics}        this
		 */
		initConfig? (config: object): Ext.layout.component.Auto.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.layout.component.Auto.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.layout.component.Auto.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.layout.component.Auto.Statics}  
		 */
		statics? (): Ext.layout.component.Auto.Statics;
	}
}
declare namespace Ext.layout.component.Body {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                            config
		 * @returns {Ext.layout.component.Body.Statics}        this
		 */
		initConfig? (config: object): Ext.layout.component.Body.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.layout.component.Body.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.layout.component.Body.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.layout.component.Body.Statics}  
		 */
		statics? (): Ext.layout.component.Body.Statics;
	}
}
declare namespace Ext.layout.component.BoundList {
	/** 
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                                 config
		 * @returns {Ext.layout.component.BoundList.Statics}        this
		 */
		initConfig? (config: object): Ext.layout.component.BoundList.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.layout.component.BoundList.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.layout.component.BoundList.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.layout.component.BoundList.Statics}  
		 */
		statics? (): Ext.layout.component.BoundList.Statics;
	}
}
declare namespace Ext.layout.component.Component {
	/** 
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                                 config
		 * @returns {Ext.layout.component.Component.Statics}        this
		 */
		initConfig? (config: object): Ext.layout.component.Component.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.layout.component.Component.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.layout.component.Component.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.layout.component.Component.Statics}  
		 */
		statics? (): Ext.layout.component.Component.Statics;
	}
}
declare namespace Ext.layout.component.Dock {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                            config
		 * @returns {Ext.layout.component.Dock.Statics}        this
		 */
		initConfig? (config: object): Ext.layout.component.Dock.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.layout.component.Dock.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.layout.component.Dock.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.layout.component.Dock.Statics}  
		 */
		statics? (): Ext.layout.component.Dock.Statics;
	}
}
declare namespace Ext.layout.component.FieldSet {
	/** 
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                                config
		 * @returns {Ext.layout.component.FieldSet.Statics}        this
		 */
		initConfig? (config: object): Ext.layout.component.FieldSet.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.layout.component.FieldSet.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.layout.component.FieldSet.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.layout.component.FieldSet.Statics}  
		 */
		statics? (): Ext.layout.component.FieldSet.Statics;
	}
}
declare namespace Ext.layout.component.ProgressBar {
	/** 
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                                   config
		 * @returns {Ext.layout.component.ProgressBar.Statics}        this
		 */
		initConfig? (config: object): Ext.layout.component.ProgressBar.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.layout.component.ProgressBar.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.layout.component.ProgressBar.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.layout.component.ProgressBar.Statics}  
		 */
		statics? (): Ext.layout.component.ProgressBar.Statics;
	}
}

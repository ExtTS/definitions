...
declare namespace Ext.layout.container.boxOverflow.Menu {
	 ...
	 * [Ext.layout.container.boxOverflow.Menu](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.container.boxOverflow.Menu.html)
	 */
...
declare namespace Ext.layout.container.boxOverflow.None {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.container.boxOverflow.None](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.container.boxOverflow.None.html)
	 * Base class for Box Layout overflow handlers. These specialized classes are invoked when a Box Layout
	 * (either an HBox or a VBox) has child items that are either too wide (for HBox) or too tall (for VBox)
	 * for its container.
	 */
...
declare namespace Ext.layout.container.boxOverflow.Scroller {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.layout.container.boxOverflow.Scroller](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.container.boxOverflow.Scroller.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
...
declare namespace Ext.layout.container.boxOverflow.Scroller.methodParams.addListener {
	 ...
	 * [Ext.layout.container.boxOverflow.Scroller.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.container.boxOverflow.Scroller.html#method-addListener)
...
declare namespace Ext.layout.container.boxOverflow.Scroller.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.layout.container.boxOverflow.Scroller.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.layout.container.boxOverflow.Scroller.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.

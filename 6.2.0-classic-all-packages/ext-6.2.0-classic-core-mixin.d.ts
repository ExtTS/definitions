declare namespace Ext.mixin {
	...
	/** 
	 * A mixin that gives [Ext.Component](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html) and [Ext.Widget](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Widget.html) the ability to process the "delegate"
	 * event option.
	 * @private (class)
	 */
	...
	/** 
	 * [Ext.mixin.Dirty](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Dirty.html)
	 * This mixin provides a `dirty` config that tracks the modified state of an object. If
	 * the class using this mixin is [observable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Observable.html), changes to the
	...
	class Dirty extends Ext.Base {
		...
		/** 
		 * Returns the value of [dirty](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Dirty.html#cfg-dirty).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Sets the value of [dirty](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Dirty.html#cfg-dirty).
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.mixin.Factoryable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Factoryable.html)
	 * This mixin automates use of [`Ext.Factory`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Factory.html). When mixed in to a class, the `alias` of the
	 * class is retrieved and combined with an optional `factoryConfig` property on that class
	 * to produce the configuration to pass to [`Ext.Factory`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Factory.html).
	 * 
	 * The factory method created by [`Ext.Factory`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Factory.html) is also added as a static method to the
	 * target class.
	 * 
	 ...
	 * 
	 * Alternatively the produced factory is available as a static method of [`Ext.Factory`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Factory.html).
	 */
	...
	/** 
	 * [Ext.mixin.Keyboard](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Keyboard.html)
	 * A mixin for components that need to interact with the keyboard. The primary config
	 * for this class is the [`keyMap`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Keyboard.html#cfg-keyMap) config. This config is an object
	 * with key names as its properties and with values that describe how the key event
	 * should be handled.
	 * 
	 * Key names may key name as documented in [`Ext.event.Event`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.event.Event.html), numbers (which are treated
	 * as `keyCode` values), single characters (for those that are not defined in
	 * [`Ext.event.Event`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.event.Event.html)) or `charCode` values prefixed by '#' (e.g., "#65" for `charCode=65`).
	 * 
	...
	/** 
	 * [Ext.mixin.Mashup](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Mashup.html)
	 * This mixin allows users to easily require external scripts in their classes. This load
	 * process delays application launch ([`Ext.onReady`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.html#method-onReady)) until all such scripts are loaded
	...
	/** 
	 * [Ext.mixin.Observable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Observable.html)
	 ...
	 * [initConfig](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Observable.html#method-initConfig), so it does not need to be called a second time.
	 * 
	 * For example:
	 * 
	 *    Ext.define('Employee', {
	...
	class Observable extends Ext.Base {
		 ...
		 * add. See [addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.util.Observable.html#method-addListener).
		 * @returns {void}               
		 */
	...
	/** 
	 * [Ext.mixin.Pluggable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Pluggable.html)
	 ...
	 * 
	 * While [`Ext.Component`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html) in the Classic Toolkit supports `plugins`, it does not use this
	...
	/** 
	 * A mixin for providing query related methods for [Ext.ComponentQuery](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ComponentQuery.html) for classes that
	 * implement getRefItems.
	 * @private (class)
	 */
	class Queryable extends Ext.Base {}
	/** 
	 * [Ext.mixin.Responsive](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Responsive.html)
	 ...
	 *     });
	 * 
	 * To use responsiveConfig the class must be defined using the [Ext.mixin.Responsive](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Responsive.html) mixin.
	 * 
	 ...
	 *     });
	 * 
	 * _Note:_ There is the exception of [`Ext.container.Viewport`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.container.Viewport.html) or other classes using [`Ext.plugin.Viewport`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.Viewport.html).
	 *  In those cases, the viewport plugin inherits from [`Ext.plugin.Responsive`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.plugin.Responsive.html).
	 * 
	 * For details see [`responsiveConfig`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Responsive.html#cfg-responsiveConfig).
	 */
	 ...
	 * [dataview](https://docs.sencha.com/extjs/6.2.0/classic/Ext.view.View.html) and all subclasses.
	 * @private (class)
	 */
...
declare namespace Ext.mixin.Templatable {
	 ...
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.mixin.Templatable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Templatable.html)
	 */
...
declare namespace Ext.mixin.Accessible {
	 ...
	 * [Ext.mixin.Accessible](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Accessible.html)
	 * This mixin defines certain config options, properties, and APIs to be used
	 * by Components that implement accessible traits according to WAI-ARIA 1.0 specification.
	 */
...
declare namespace Ext.mixin.Bindable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Bindable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Bindable.html)
	 * This class is intended as a mixin for classes that want to provide a "bind" config that
	 * connects to a `ViewModel`.
	 */
	interface Statics extends Ext.base.Statics {
...
declare namespace Ext.mixin.ComponentDelegation {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.ComponentDelegation](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.ComponentDelegation.html)
	 * A mixin that gives [Ext.Component](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html) and [Ext.Widget](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Widget.html) the ability to process the "delegate"
	 * event option.
	 */
	interface Statics extends Ext.base.Statics {
...
declare namespace Ext.mixin.ConfigState {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.ConfigState](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.ConfigState.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
...
declare namespace Ext.mixin.Container {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Container](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Container.html)
	 * Common methods for both classic &amp; modern containers
	 */
	interface Statics extends Ext.base.Statics {
		/** 
...
declare namespace Ext.mixin.Hookable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Hookable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Hookable.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
...
declare namespace Ext.mixin.Identifiable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Identifiable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Identifiable.html)
	 * An Identifiable mixin.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
...
declare namespace Ext.mixin.Inheritable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Inheritable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Inheritable.html)
	 * A mixin that provides the functionality for inheritable configs. This allows linking
	 * components and containers via a prototype-chained object for accessing inherited
	 * values.
	 * 
...
declare namespace Ext.mixin.Queryable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Queryable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Queryable.html)
	 * A mixin for providing query related methods for [Ext.ComponentQuery](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ComponentQuery.html) for classes that
	 * implement getRefItems.
	 */
	interface Statics extends Ext.base.Statics {
...
declare namespace Ext.mixin.Selectable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Selectable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Selectable.html)
	 * Tracks what records are currently selected in a databound widget. This class is mixed in to
	 * [dataview](https://docs.sencha.com/extjs/6.2.0/classic/Ext.view.View.html) and all subclasses.
	 */
	interface Statics extends Ext.base.Statics {
...
declare namespace Ext.mixin.StyleCacher {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.StyleCacher](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.StyleCacher.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
...
declare namespace Ext.mixin.Traversable {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Traversable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Traversable.html)
	 * A Traversable mixin.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
...
declare namespace Ext.mixin.Observable.methodParams.addListener {
	 ...
	 * [Ext.mixin.Observable.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Observable.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.mixin.Observable.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.mixin.Observable.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Observable.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.mixin.Responsive {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 *   (see [`Ext.platformTags`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.html#property-platformTags)). The properties of this
		 ...
		 *   [`responsiveFormulas`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Responsive.html#cfg-responsiveFormulas) overlaps and hides any of these properties).
...
declare namespace Ext.mixin.Dirty {
	...
	interface Events extends Ext.base.Events {
		/** 
		 * Fires when a change in the object's [dirty](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Dirty.html#cfg-dirty) state is detected.
		 * 
		 * **Note:** In order for this event to fire, the class that mixes in this mixin
		 * must be [`Observable`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.mixin.Observable.html).
		 * @event

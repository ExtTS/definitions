declare namespace Ext.env {
	 ...
	 * Access the global instance stored in [Ext.browser](https://docs.sencha.com/extjs/6.2.0/classic/Ext.browser.html) instead.
	 * @private (class)
	 */
	class Browser {}
	/** 
	 ...
	 * 
	 * Should not be manually instantiated unless for unit-testing.
	 * Access the global instance stored in [Ext.os](https://docs.sencha.com/extjs/6.2.0/classic/Ext.os.html) instead.
	 * @private (class)
	 */
	class OS {}
	/** 
	 * This class manages ready detection and handling. Direct use of this class is not
	 * recommended. Instead use [`Ext.onReady`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.html#method-onReady):
	 * 
	 ...
	 * that is required, the [`Ext.onDocumentReady`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.html#method-onDocumentReady) method can be called to register a callback
	 ...
	 * This is easy to understand, at least in part because historically [`Ext.onReady`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.html#method-onReady) only
	 * waited for DOM ready.
	 * 
	 * With the introduction of [`Ext.Loader`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Loader.html), however, it became common for DOM ready to occur
	 ...
	 * this, the [`Ext.onReady`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.html#method-onReady) mechanism was extended to wait for both DOM ready _and_ all of
	 * the required classes to be loaded.
	 * 
	 * When the framework enters or leaves a state where it is not ready (for example, the
	 * first dynamic load is requested or last load completes), [`Ext.env.Ready`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.env.Ready.html) is informed.
	 * For example:
	 * 
	 *     Ext.env.Ready.block();
	 *    
	 ...
	 * - [Ext.dom.Element](https://docs.sencha.com/extjs/6.2.0/classic/Ext.dom.Element.html): `1500`
	 * @private (class)
...
declare namespace Ext.event {
	/** 
	 * [Ext.event.Event](https://docs.sencha.com/extjs/6.2.0/classic/Ext.event.Event.html)
	 * Just as [Ext.dom.Element](https://docs.sencha.com/extjs/6.2.0/classic/Ext.dom.Element.html) wraps around a native DOM node, [Ext.event.Event](https://docs.sencha.com/extjs/6.2.0/classic/Ext.event.Event.html) wraps the browser's native
	 ...
	 * 
	 * For a full list of default recognizers, and more information, please view the [Ext.event.gesture.Recognizer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.event.gesture.Recognizer.html) documentation.
	 * 
	...
	class Event extends Ext.Base {
		...
		/** 
		 * Indicates whether or not [preventDefault()](https://docs.sencha.com/extjs/6.2.0/classic/Ext.event.Event.html#method-preventDefault) was called on the event.
		 * @property
		 * @public (property)
		 * @default false
		 * @type {boolean}
		 ...
		 *             use [currentTarget](https://docs.sencha.com/extjs/6.2.0/classic/Ext.event.Event.html#property-currentTarget) instead.
		 * @type {HTMLElement}
		 */
		 ...
		 * cross browser normalized x-coordinate use [getX](https://docs.sencha.com/extjs/6.2.0/classic/Ext.event.Event.html#method-getX)
		 * @property
		 * @public (property)
		 * @type {number}
		 */
		 ...
		 * cross browser normalized y-coordinate use [getY](https://docs.sencha.com/extjs/6.2.0/classic/Ext.event.Event.html#method-getY)
		 * @property
		 * @public (property)
		 * @type {number}
		 */
		 ...
		 * ancestor of the target. See [Ext.dom.Query](https://docs.sencha.com/extjs/6.2.0/classic/Ext.dom.Query.html) for information about simple
		 * selectors.
		 ...
		 * `true` to return a [Ext.Element](https://docs.sencha.com/extjs/6.2.0/classic/Ext.dom.Element.html) object instead of DOM
		 * node.
		 * @returns {HTMLElement}                   
		 */
		 ...
		 * @param   {boolean}     [returnEl]
		 * `true` to return a [Ext.Element](https://docs.sencha.com/extjs/6.2.0/classic/Ext.dom.Element.html) object instead
		 * of DOM node.
		 * @returns {HTMLElement}            
		 */
		 ...
		 * [getWheelDeltas](https://docs.sencha.com/extjs/6.2.0/classic/Ext.event.Event.html#method-getWheelDeltas) instead.
		 * @method
		 * @public (method)
		...
		startDrag? (): void;
		/** 
		 * Stop the event ([`preventDefault`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.event.Event.html#method-preventDefault) and [`stopPropagation`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.event.Event.html#method-stopPropagation)).
		 * @method
		 * @public (method)
		 * @chainable
		 * @returns {Ext.event.Event}  this
		 ...
		 * @method
		 * @public (method)
		 * @param   {string|HTMLElement|Ext.dom.Element} el        The id, DOM element or [Ext.Element](https://docs.sencha.com/extjs/6.2.0/classic/Ext.dom.Element.html) to check
...
declare namespace Ext.perf.Accumulator {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.perf.Accumulator](https://docs.sencha.com/extjs/6.2.0/classic/Ext.perf.Accumulator.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
...
declare namespace Ext.perf.Monitor {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.perf.Monitor](https://docs.sencha.com/extjs/6.2.0/classic/Ext.perf.Monitor.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
...
declare namespace Ext.env.Ready.methodParams.makeListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.env.Ready.makeListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.env.Ready.html#method-makeListener)
...
declare namespace Ext.env.Ready.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.env.Ready.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.env.Ready.html#method-on)
	 * An object with extra options.
	 */
	interface Options extends Ext.base.Params {
		/** 

declare namespace Ext.scroll {
	/** 
	 * [Ext.scroll.Scroller](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html)
	 * [Ext.scroll.Scroller](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html) allows any element to have scrollable content, both on desktop and
	...
	class Scroller extends Ext.Evented {
		 ...
		 * at the end of destruction sequence, unless [clearPropertiesOnDestroy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#property-clearPropertiesOnDestroy)
		 * is set to `false`.
		 * @method
		 * @public (method)
		 * @returns {void}  
		...
		/** 
		 * Gets the `clientWidth` and `clientHeight` of the [element](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#cfg-element) for this scroller.
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [direction](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#cfg-direction).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [element](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#cfg-element).
		 * @method
		 * @public (method)
		 ...
		 * [Ext.scroll.Scroller](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html), and Ext.scroll.View has been removed.  Component's
		 * getScrollable() method now returns a [Ext.scroll.Scroller](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html).  This method is
		...
		getSize? (): object;
		/** 
		 * Returns the value of [spacerXY](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#cfg-spacerXY).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getSpacerXY? (): object;
		/** 
		 * Returns the value of [x](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#cfg-x).
		 * @method
		 * @public (method)
		...
		getX? (): boolean | string;
		/** 
		 * Returns the value of [y](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#cfg-y).
		 * @method
		 * @public (method)
		 * @returns {boolean|string}  
		 */
		 ...
		 * The dom node, [Ext.dom.Element](https://docs.sencha.com/extjs/6.2.0/classic/Ext.dom.Element.html), or
		 ...
		 * are deferred until the next [idle](https://docs.sencha.com/extjs/6.2.0/classic/Ext.GlobalEvents.html#event-idle) event to
		...
		/** 
		 * Sets the value of [direction](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#cfg-direction).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [element](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#cfg-element).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [spacerXY](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#cfg-spacerXY).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [x](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#cfg-x).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [y](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#cfg-y).
		 * @method
		 * @public (method)
...
declare namespace Ext.scroll.Scroller.methodParams.addListener {
	 ...
	 * [Ext.scroll.Scroller.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#method-addListener)
...
declare namespace Ext.scroll.Scroller.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.scroll.Scroller.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.scroll.Scroller {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * configured automatically by an [Ext.Component](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html) based on its inherited
		 * [rtl](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Component.html#cfg-rtl) state
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
		 ...
		 *   scrolling is only enabled when the [element](https://docs.sencha.com/extjs/6.2.0/classic/Ext.scroll.Scroller.html#cfg-element) has overflowing content.

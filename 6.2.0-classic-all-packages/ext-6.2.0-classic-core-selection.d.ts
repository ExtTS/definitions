declare namespace Ext.selection {
	/** 
	 * [Ext.selection.CellModel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.CellModel.html)
	 * A selection model for [grid panels](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.Panel.html) which allows selection of a single cell at a time.
	 * 
	...
	class CellModel extends Ext.selection.DataViewModel {
		 ...
		 * @param   {object}                                                 keepExisting  (private)
		 * @param   {object}                                                 suppressEvent (private)
		 * @returns {void}                                                                 
		 */
		select? (pos: object | Ext.selection.CellModel.methodParams.select.Pos, keepExisting: object, suppressEvent: object): void;
		/** 
		...
		/** 
		 * Returns the value of [selected](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#cfg-selected).
		 * @method
		 * @private (method)
		 * @returns {object}  
		 */
		getSelected? (): object;
		/** 
		 * Sets the value of [selected](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#cfg-selected).
		 * @method
		 * @private (method)
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.selection.Model.onUpdate](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#method-onUpdate).
		 * Called when the contents of the node are updated, perform any processing here.
		 * @method
		 * @private (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.selection.DataViewModel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.DataViewModel.html)
	 * The DataViewModel selection model implements item-based selection for [Ext.view.View](https://docs.sencha.com/extjs/6.2.0/classic/Ext.view.View.html).
	...
	/** 
	 * [Ext.selection.CheckboxModel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.CheckboxModel.html)
	 ...
	 * and according to the [injectCheckbox](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.CheckboxModel.html#cfg-injectCheckbox) configuration.
	 */
	class CheckboxModel extends Ext.selection.RowModel {
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.selection.Model.beforeViewRender](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#method-beforeViewRender).
		 * Allows multiple views to be controlled by one selection model.
		 * Called by AbstractView's beforeRender method.
		 * @method
		 * @protected (method)
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.selection.RowModel.vetoSelection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.RowModel.html#method-vetoSelection).
		 * Checks whether a selection should proceed based on the ignoreRightMouseSelection
		 * option.
		 * @method
		 * @private (method)
	...
	/** 
	 * [Ext.selection.Model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html)
	 ...
	 * [Grid](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.Panel.html) and [Tree](https://docs.sencha.com/extjs/6.2.0/classic/Ext.tree.Panel.html) should subclass [Ext.selection.Model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html)
	...
	class Model extends Ext.mixin.Observable {
		...
		/** 
		 * `true` in this class to identify an object as an instantiated [selection model](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html), or subclass thereof.
		 * @property
		 * @public (property)
		 * @default true
		 * @type {boolean}
		 ...
		 * @private (property)
		 * @readonly
		 * @type {Ext.util.Bag|Ext.util.Collection}
		 */
		readonly selected?: Ext.util.Bag | Ext.util.Collection;
		/** 
		 * @property
		 * @private (property)
		 * @default 0
	...
	/** 
	 * [Ext.selection.RowModel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.RowModel.html)
	 * RowModel Selection Model implements row based navigation for
	 * [grid panels](https://docs.sencha.com/extjs/6.2.0/classic/Ext.grid.Panel.html) via user input. RowModel is the default grid selection
	 ...
	 * 
	 * - [mode](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.RowModel.html#cfg-mode) - Specifies whether user may select multiple rows or single rows
	 * - [allowDeselect](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.RowModel.html#cfg-allowDeselect) - Specifies whether user may deselect records when in SINGLE mode
	 * - [ignoreRightMouseSelection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.RowModel.html#cfg-ignoreRightMouseSelection) - Specifies whether user may ignore right clicks
	...
	/** 
	 * [Ext.selection.TreeModel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.TreeModel.html)
	 * This selection model is created by default for [Ext.tree.Panel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.tree.Panel.html).
	 * 
...
declare namespace Ext.selection.CellModel.methodParams.addListener {
	 ...
	 * [Ext.selection.CellModel.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.CellModel.html#method-addListener)
...
declare namespace Ext.selection.CellModel.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.selection.CellModel.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.CellModel.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.selection.CellModel.methodParams.select {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.selection.CellModel.select](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.CellModel.html#method-select)
...
declare namespace Ext.selection.DataViewModel.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.selection.DataViewModel.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.DataViewModel.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.selection.DataViewModel.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.selection.DataViewModel.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.DataViewModel.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.selection.CheckboxModel.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.selection.CheckboxModel.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.CheckboxModel.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.selection.CheckboxModel.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.selection.CheckboxModel.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.CheckboxModel.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.selection.Model.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.selection.Model.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.selection.Model.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.selection.Model.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.Model.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.selection.RowModel.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.selection.RowModel.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.RowModel.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.selection.RowModel.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.selection.RowModel.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.RowModel.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.selection.TreeModel.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.selection.TreeModel.addListener](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.TreeModel.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.selection.TreeModel.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.selection.TreeModel.on](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.TreeModel.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.selection.CellModel {
	...
	interface Cfg extends Ext.base.Configs {
		...
		/** 
		 * The Ext.util.Bag/Ext.util.Collection to use as the collection of selected records.
		 * @configuration
		 * @optional
		 * @default {}
		 * @type {object}
...
declare namespace Ext.selection.CheckboxModel {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * [showHeaderCheckbox](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.CheckboxModel.html#cfg-showHeaderCheckbox) is shown, and all rows are selected.
		 * @configuration
		 * @optional
		 * @default "Press Space to deselect all rows"
		 * @type {string}
		 */
		headerDeselectText?: string;
		/** 
		 * ARIA description text to announce for the check column's header when it is focused,
		 * [showHeaderCheckbox](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.CheckboxModel.html#cfg-showHeaderCheckbox) is shown, and not all rows are selected.
		 * @configuration
		 * @optional
		 ...
		 * 
		 * if [showHeaderCheckbox](https://docs.sencha.com/extjs/6.2.0/classic/Ext.selection.CheckboxModel.html#cfg-showHeaderCheckbox) is `true`, the text is shown _above_ the checkbox.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		 ...
		 * When the store is a [BufferedStore](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.BufferedStore.html), this configuration will

declare namespace Ext.google.data {
	/** 
	 * [Ext.google.data.AbstractProxy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.google.data.AbstractProxy.html)
	...
	class AbstractProxy extends Ext.data.proxy.Server {
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.proxy.Server.buildUrl](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Server.html#method-buildUrl).
		 * Generates a url based on a given [Ext.data.Request](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.Request.html) object. By default, ServerProxy's buildUrl will add the
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.proxy.Server.doRequest](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Server.html#method-doRequest).
		 * In ServerProxy subclasses, the [create](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Server.html#method-create), [read](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Server.html#method-read), [update](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Server.html#method-update) and [erase](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Server.html#method-erase) methods all
		 * pass through to doRequest. Each ServerProxy subclass must implement the doRequest method - see [Ext.data.proxy.JsonP](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.JsonP.html) and [Ext.data.proxy.Ajax](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Ajax.html) for examples. This method carries the same signature as
		 * each of the methods that delegate to it.
		 * @method
		 * @public (method)
		 * @param   {Ext.data.operation.Operation} operation The [Ext.data.operation.Operation](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.operation.Operation.html) object
	...
	/** 
	 * [Ext.google.data.CalendarsProxy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.google.data.CalendarsProxy.html)
	...
	/** 
	 * [Ext.google.data.EventsProxy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.google.data.EventsProxy.html)
...
declare namespace Ext.google.ux {
	/** 
	 * [Ext.google.ux.Client](https://docs.sencha.com/extjs/6.2.0/classic/Ext.google.ux.Client.html)

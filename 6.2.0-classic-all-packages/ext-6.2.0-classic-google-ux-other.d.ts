declare namespace Ext.ux.dashboard {
	/** 
	 * [Ext.ux.dashboard.GoogleRssPart](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.dashboard.GoogleRssPart.html)
	 * This `part` implements a Google RSS Feed for use in a `Dashboard`.
	 */
	class GoogleRssPart extends Ext.dashboard.Part {
		/** 
		 * Returns the value of [suggestedFeed](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.dashboard.GoogleRssPart.html#cfg-suggestedFeed).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Sets the value of [suggestedFeed](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.dashboard.GoogleRssPart.html#cfg-suggestedFeed).
		 * @method
		 * @public (method)
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.dashboard.Part.displayForm](https://docs.sencha.com/extjs/6.2.0/classic/Ext.dashboard.Part.html#method-displayForm).
		 * This method should display an appropriate edit form (probably a modal [`Ext.Window`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.window.Window.html)
		 * or [`Ext.Msg.prompt`](https://docs.sencha.com/extjs/6.2.0/classic/Ext.MessageBox.html#method-prompt)) to get or edit configuration for an instance of this part.
		 * 
	...
	/** 
	 * [Ext.ux.dashboard.GoogleRssView](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.dashboard.GoogleRssView.html)
...
declare namespace Ext.ux.google {
	/** 
	 * [Ext.ux.google.Api](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.google.Api.html)
	...
	/** 
	 * [Ext.ux.google.Feeds](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.google.Feeds.html)

declare namespace Ext.data.proxy {
	/** 
	 * [Ext.data.proxy.Sql](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Sql.html)
	...
	class Sql extends Ext.data.proxy.Client {
		...
		privates?: object;
		/** 
		 * Returns the value of [database](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Sql.html#cfg-database).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Returns the value of [table](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Sql.html#cfg-table).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		getTable? (): string;
		/** 
		 * Sets the value of [database](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Sql.html#cfg-database).
		 * @method
		 * @public (method)
		 * @param   {string} database The new value.
		 * @returns {void}            
		 */
		setDatabase? (database: string): void;
		/** 
		 * Sets the value of [table](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Sql.html#cfg-table).
		 * @method
		 * @public (method)
		 * @param   {string} table The new value.
		 * @returns {void}         
		 */
		 ...
		 * @returns {void}             
		 */
		create? (operation: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.proxy.Proxy.create](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Proxy.html#method-create).
		 ...
		 * @returns {void}             
		 */
		erase? (operation: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.proxy.Proxy.erase](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Proxy.html#method-erase).
		 ...
		 * @returns {void}             
		 */
		read? (operation: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.proxy.Proxy.read](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Proxy.html#method-read).
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.proxy.Proxy.update](https://docs.sencha.com/extjs/6.2.0/classic/Ext.data.proxy.Proxy.html#method-update).
	...
	class SQL extends Ext.data.proxy.Sql {}
}
declare namespace Ext.data.proxy.Sql {
	/** 
	 * @definitions
	 ...
	 * 
	 */
	interface Def extends Ext.data.proxy.Sql {
		/** 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.data.proxy.Sql.Cfg}
		 */
		config?: Ext.data.proxy.Sql.Cfg;
		/** 
		 ...
		 * @returns {Ext.data.proxy.Client.Statics|Ext.data.proxy.Proxy.Statics|Ext.Base.Statics}  
		 * @type {object}
		 */
		statics?: (() => Ext.data.proxy.Client.Statics | Ext.data.proxy.Proxy.Statics | Ext.Base.Statics) | object | any;
	}
	/** 
	 * @configurations

declare namespace Ext.ux.ajax {
	/** 
	 * [Ext.ux.ajax.DataSimlet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.DataSimlet.html)
	 * This base class is used to handle data preparation (e.g., sorting, filtering and
	 * group summary).
	 */
	class DataSimlet extends Ext.Base {}
	/** 
	 * [Ext.ux.ajax.JsonSimlet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.JsonSimlet.html)
	 * JSON Simlet.
	 */
	class JsonSimlet extends Ext.ux.ajax.DataSimlet {
		 ...
		 * @returns {void}       
		 */
		doPost? (ctx: object): void;
	}
	/** 
	 * [Ext.ux.ajax.PivotSimlet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.PivotSimlet.html)
	 * Pivot Simlet does remote pivot calculations.
	 * Filtering the pivot results doesn't work.
	 */
	class PivotSimlet extends Ext.ux.ajax.JsonSimlet {
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} ctx
	...
	/** 
	 * [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.Simlet.html)
	 * This is a base class for more advanced "simlets" (simulated servers). A simlet is asked
	 * to provide a response given a [Ext.ux.ajax.SimXhr](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.SimXhr.html) instance.
	 */
	...
	/** 
	 * [Ext.ux.ajax.SimManager](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.SimManager.html)
	 ...
	 * 
	 * The requires hooks are inserted when either the [init](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.SimManager.html#method-init) method is called or the
	 * first [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.Simlet.html) is registered. For example:
	 * 
	 ...
	 *     }
	 * 
	 * As many URL's as desired can be registered and associated with a [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.Simlet.html). To make
	...
	interface SimManager extends Ext.Base {
		...
		/** 
		 * Registeres one or more [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.Simlet.html) instances.
		 * @method
		 * @public (method)
		 * @param   {any[]|object} simlet
		 * Either a [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.Simlet.html) instance or config, an Array
		 * of such elements or an Object keyed by URL with values that are [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.Simlet.html)
	...
	/** 
	 * [Ext.ux.ajax.SimXhr](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.SimXhr.html)
	 * Simulates an XMLHttpRequest object's methods and properties but is backed by a
	 * [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.Simlet.html) instance that provides the data.
	 */
	...
	/** 
	 * [Ext.ux.ajax.XmlSimlet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.XmlSimlet.html)
...
declare namespace Ext.ux.ajax.PivotSimlet {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.ajax.PivotSimlet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.PivotSimlet.html)
	 ...
	 * Filtering the pivot results doesn't work.
	 */
	interface Def extends Ext.ux.ajax.PivotSimlet {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.ajax.Simlet {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 */
		responseHeaders?: ExtGlobalFunction | object;
		/** 
		 * @configuration
		 * @optional
		 * @type {ExtGlobalFunction|string}
		 */
		responseText?: ExtGlobalFunction | string;
		/** 
		 * @configuration
		 * @optional
		 * @type {ExtGlobalFunction|string}
		 */
		responseXML?: ExtGlobalFunction | string;
		/** 
		 * @configuration
		 * @optional
		 * @default 200
		 * @type {ExtGlobalFunction|number}
		 */
		status?: ExtGlobalFunction | number;
		/** 
		 * @configuration
		 * @optional
		 * @default 'OK'
		 * @type {ExtGlobalFunction|string}
		 */
		statusText?: ExtGlobalFunction | string;
		/** 
...
declare namespace Ext.ux.ajax.SimManager {
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * The [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.Simlet.html) instance to use for non-matching URL's. By default, this will
		...
		/** 
		 * The default `type` to apply to generic [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ajax.Simlet.html) configuration objects. The
		 * default is 'basic'.
		 * @configuration
		 * @optional
		 * @default 'basic'

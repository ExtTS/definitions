declare namespace Ext.ux.desktop {
	/** 
	 * [Ext.ux.desktop.App](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.App.html)
	 * Ext JS Library
	 * Copyright(c) 2006-2014 Sencha Inc.
	 * licensing@sencha.com
	 * http://www.sencha.com/license
	 */
	class App extends Ext.Base {
		/** 
		 * @method
		 * @public (method)
		 * @param   {object} config
		 ...
		 * @returns {void}  
		 */
		getTaskbarConfig? (): void;
	}
	/** 
	 * [Ext.ux.desktop.Desktop](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.Desktop.html)
	 * This class manages the wallpaper, shortcuts and taskbar.
	 */
	class Desktop extends Ext.panel.Panel {
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.ux.desktop.ShortcutModel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.ShortcutModel.html)
	 * This model defines the minimal set of fields for desktop shortcuts.
	 */
	class ShortcutModel extends Ext.data.Model {
		/** 
		 * @property
		 * @private (property)
		 * @type {object}                 In current class.
		 * @type {Ext.data.field.Field[]} In parent class `Ext.data.Model`.
		 * @type {any}                    TS compatibility for types in parent class: `Ext.data.Model`.
		 */
		fields?: object | /* @compatible Ext.data.Model.fields[Ext.data.field.Field[]] */ any;
	}
	/** 
	 * [Ext.ux.desktop.StartMenu](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.StartMenu.html)
	 * Ext JS Library
	 * Copyright(c) 2006-2014 Sencha Inc.
	 * licensing@sencha.com
	 * http://www.sencha.com/license
	 */
	class StartMenu extends Ext.menu.Menu {
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
	...
	class TaskBar extends Ext.toolbar.Toolbar {
		/** 
	...
	/** 
	 * [Ext.ux.desktop.TrayClock](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.TrayClock.html)
	 * This class displays a clock on the toolbar.
	 */
	class TrayClock extends Ext.toolbar.TextItem {
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.ux.desktop.Video](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.Video.html)
	 ...
	 * [http://developer.mozilla.org/En/HTML/Element/Video](http://developer.mozilla.org/En/HTML/Element/Video)
	 */
	class Video extends Ext.panel.Panel {
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.ux.desktop.Wallpaper](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.Wallpaper.html)
	 * This component renders an image that stretches to fill the component.
	 */
	class Wallpaper extends Ext.Component {
		/** 
		 * @method
		 * @private (method)
		 * @returns {void|object}  
...
declare namespace Ext.ux.desktop.App {
	/** 
	 * @definitions
	 ...
	 * http://www.sencha.com/license
	 */
	interface Def extends Ext.ux.desktop.App {
		/** 
...
declare namespace Ext.ux.desktop.Desktop {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.desktop.Desktop](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.Desktop.html)
	 * This class manages the wallpaper, shortcuts and taskbar.
	 */
	interface Def extends Ext.ux.desktop.Desktop {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.desktop.Desktop.Cfg}
		 */
		config?: Ext.ux.desktop.Desktop.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.ux.desktop.ShortcutModel {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.desktop.ShortcutModel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.ShortcutModel.html)
	 * This model defines the minimal set of fields for desktop shortcuts.
	 */
	interface Def extends Ext.ux.desktop.ShortcutModel {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.desktop.StartMenu {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.desktop.StartMenu](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.StartMenu.html)
	 ...
	 * http://www.sencha.com/license
	 */
	interface Def extends Ext.ux.desktop.StartMenu {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * 
		 * @protected (method+configuration)
		 * @returns {Ext.menu.Menu.Statics|Ext.panel.Panel.Statics|Ext.container.Container.Statics|Ext.Component.Statics|Ext.Base.Statics}  
		 * @type {object}
		 */
		statics?: (() => Ext.menu.Menu.Statics | Ext.panel.Panel.Statics | Ext.container.Container.Statics | Ext.Component.Statics | Ext.Base.Statics) | object | any;
	}
}
declare namespace Ext.ux.desktop.TaskBar {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.desktop.TaskBar](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.TaskBar.html)
	 */
	interface Def extends Ext.ux.desktop.TaskBar {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.desktop.TaskBar.Cfg}
		 */
		config?: Ext.ux.desktop.TaskBar.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.ux.desktop.TrayClock {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.desktop.TrayClock](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.TrayClock.html)
	 * This class displays a clock on the toolbar.
	 */
	interface Def extends Ext.ux.desktop.TrayClock {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * 
		 * @protected (method+configuration)
		 * @returns {Ext.toolbar.TextItem.Statics|Ext.toolbar.Item.Statics|Ext.Component.Statics|Ext.Base.Statics}  
		 * @type {object}
		 */
		statics?: (() => Ext.toolbar.TextItem.Statics | Ext.toolbar.Item.Statics | Ext.Component.Statics | Ext.Base.Statics) | object | any;
	}
}
declare namespace Ext.ux.desktop.Video {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.desktop.Video](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.Video.html)
	 ...
	 * [http://developer.mozilla.org/En/HTML/Element/Video](http://developer.mozilla.org/En/HTML/Element/Video)
	 */
	interface Def extends Ext.ux.desktop.Video {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.desktop.Wallpaper {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.desktop.Wallpaper](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.Wallpaper.html)
	 * This component renders an image that stretches to fill the component.
	 */
	interface Def extends Ext.ux.desktop.Wallpaper {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.desktop.Desktop {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * If the [shortcutTpl](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.Desktop.html#cfg-shortcutTpl) is modified, this will probably need to be modified as
		 * well.
		 * @configuration
		 * @optional
		 * @default 'div.ux-desktop-shortcut'
		 * @type {string}
		 */
		shortcutItemSelector?: string;
		/** 
		 * This XTemplate is used to render items in the DataView. If this is changed, the
		 * [shortcutItemSelector](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.Desktop.html#cfg-shortcutItemSelector) will probably also need to changed.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		shortcutTpl?: string;
		/** 
		 * The items to add to the DataView. This can be a Store or a
		 * simple array. Items should minimally provide the fields in the
		 * [Shortcut](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.desktop.ShortcutModel.html).
		 * @configuration
		 * @optional
		 * @type {any[]|Ext.data.Store}
		 */
		shortcuts?: any[] | Ext.data.Store;
		/** 

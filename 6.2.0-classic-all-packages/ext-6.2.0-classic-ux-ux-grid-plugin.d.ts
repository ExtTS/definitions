declare namespace Ext.ux.grid.plugin {
	/** 
	 * [Ext.ux.grid.plugin.AutoSelector](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.grid.plugin.AutoSelector.html)
	 ...
	 */
	class AutoSelector extends Ext.plugin.Abstract {
		/** 
		 * Returns the value of [store](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.grid.plugin.AutoSelector.html#cfg-store).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getStore? (): object;
		/** 
		 * Sets the value of [store](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.grid.plugin.AutoSelector.html#cfg-store).
		 * @method
		 * @public (method)
...
declare namespace Ext.ux.grid.plugin.AutoSelector {
	/** 
	 * @definitions
	 ...
	 * only exception is, of course, when there are no records in the store.
	 */
	interface Def extends Ext.ux.grid.plugin.AutoSelector {
		/** 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.grid.plugin.AutoSelector.Cfg}
		 */
		config?: Ext.ux.grid.plugin.AutoSelector.Cfg;
		/** 

declare namespace Ext.ux.statusbar {
	/** 
	 * [Ext.ux.statusbar.StatusBar](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html)
	 ...
	 * status text and icon.  You can also indicate that something is processing using the [showBusy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-showBusy) method.
	 * 
	...
	class StatusBar extends Ext.toolbar.Toolbar {
		/** 
		 * Clears the status [text](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-text) and [iconCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-iconCls). Also supports clearing via an optional fade out animation.
		 * @method
		 * @public (method)
		 * @chainable
		...
		getText? (): string;
		/** 
		 * Convenience method for setting the status icon directly.  For more flexible options see [setStatus](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-setStatus).
		 * See [iconCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-iconCls) for complete details about customizing the icon.
		 * @method
		 * @public (method)
		 * @chainable
		...
		/** 
		 * Sets the status [text](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-text) and/or [iconCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-iconCls). Also supports automatically clearing the
		...
		/** 
		 * Convenience method for setting the status text directly.  For more flexible options see [setStatus](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-setStatus).
		 * @method
		 * @public (method)
		 * @chainable
		 ...
		 * A config object in the same format supported by [setStatus](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-setStatus), or a
		 * string to use as the status text (in which case all other options for setStatus will be defaulted).  Use the
		 * `text` and/or `iconCls` properties on the config to override the default [busyText](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-busyText)
		 * and [busyIconCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-busyIconCls) settings. If the config argument is not specified, [busyText](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-busyText) and
		 * [busyIconCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-busyIconCls) will be used in conjunction with all of the default options for [setStatus](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-setStatus).
		 * @returns {Ext.ux.statusbar.StatusBar}          this
		 */
	...
	/** 
	 * [Ext.ux.statusbar.ValidationStatus](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.ValidationStatus.html)
	 * A [Ext.ux.statusbar.StatusBar](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html) plugin that provides automatic error
...
declare namespace Ext.ux.statusbar.StatusBar.methodParams.clearStatus {
	 ...
	 * [Ext.ux.statusbar.StatusBar.clearStatus](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-clearStatus)
	 * A config object containing any or all of the following properties.  If this
	 * object is not specified the status will be cleared using the defaults below:
	 */
	interface Config extends Ext.base.Params {
		...
		anim?: boolean;
		/** 
		 * True to reset the text and icon using [defaultText](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-defaultText) and
		 * [defaultIconCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-defaultIconCls) (defaults to false which sets the text to '' and removes any existing icon class).
		 * @configuration
		 * @optional
		 * @type {boolean}
		 */
...
declare namespace Ext.ux.statusbar.StatusBar.methodParams.setStatus {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.ux.statusbar.StatusBar.setStatus](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-setStatus)
	 * A config object specifying what status to set, or a string assumed
	 * to be the status text (and all other options are defaulted as explained below). A config
	 * object containing any or all of the following properties can be passed:
	 */
	interface Config extends Ext.base.Params {
		 ...
		 * [iconCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-iconCls) for details). If not specified, any current iconCls will remain unchanged.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
...
declare namespace Ext.ux.statusbar.StatusBar {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * [setStatus](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-setStatus) before automatically clearing the status text and icon.
		 * Note that this only applies when passing the `clear` argument to [setStatus](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-setStatus)
		 * since that is the only way to defer clearing the status.  This can
		 * be overridden by specifying a different `wait` value in [setStatus](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-setStatus).
		 * Calls to [clearStatus](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-clearStatus) always clear the status bar immediately and ignore this value.
		 * @configuration
		 * @optional
		 * @default 5000
		 * @type {number}
		...
		autoClear?: number;
		/** 
		 * The default [iconCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-iconCls) applied when calling [showBusy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-showBusy).
		 * It can be overridden at any time by passing the `iconCls` argument into [showBusy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-showBusy).
		 * @configuration
		 * @optional
		...
		busyIconCls?: string;
		/** 
		 * The default [text](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-text) applied when calling [showBusy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-showBusy).
		 * It can be overridden at any time by passing the `text` argument into [showBusy](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#method-showBusy).
		 * @configuration
		 * @optional
		 * @default 'Loading...'
		 * @type {string}
		...
		cls?: string;
		/** 
		 * The default [iconCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-iconCls) value (see the iconCls docs for additional details about customizing the icon).
		...
		/** 
		 * The default [text](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-text) value.  This will be used anytime the status bar is cleared with the
		 ...
		 * If not specified, the value set for [defaultText](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-defaultText) will be used.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
...
declare namespace Ext.ux.statusbar.ValidationStatus {
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * The [iconCls](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-iconCls) value to be applied
		...
		errorListCls?: string;
		/** 
		 * The [text](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-text) value to display when
		...
		hideText?: string;
		/** 
		 * The [text](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.statusbar.StatusBar.html#cfg-text) value to be applied when

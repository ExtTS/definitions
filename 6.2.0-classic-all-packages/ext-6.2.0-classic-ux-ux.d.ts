declare namespace Ext.ux {
	/** 
	 * [Ext.ux.BoxReorderer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.BoxReorderer.html)
	 * Base class from [Ext.ux.TabReorderer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TabReorderer.html).
	 */
	class BoxReorderer extends Ext.plugin.Abstract {
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @private (method)
		 * @param   {number} newIndex The initial drop index.
		 * @returns {number}          The index of the reorderable component.
		 */
		findReorderable? (newIndex: number): number;
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} e
		 * @returns {void}     
		 */
		getDragCmp? (e: object): void;
		/** 
		 * Calculate drop index based upon the dragEl's position.
		 * @method
		 * @private (method)
		 * @param   {object} pointerPos
		 * @returns {void}              
		 */
		getNewIndex? (pointerPos: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.ux.CellDragDrop](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.CellDragDrop.html)
	 ...
	 * 
	 */
	class CellDragDrop extends Ext.plugin.Abstract {
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.ux.DataTip](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.DataTip.html)
	 * This plugin implements automatic tooltip generation for an arbitrary number of child nodes _within_ a Component.
	 * 
	 ...
	 * it automatically selects a delegate so that it appears when the mouse enters a sub-element.
	 * 
	 * When applied to a GridPanel, this ToolTip appears when over a row, and the Record's data is applied
	 * using this object's tpl template.
	 * 
	 * When applied to a DataView, this ToolTip appears when over a view node, and the Record's data is applied
	 * using this object's tpl template.
	 * 
	 * When applied to a TreePanel, this ToolTip appears when over a tree node, and the Node's Ext.data.Model record data is applied
	 * using this object's tpl template.
	 * 
	 * When applied to a FormPanel, this ToolTip appears when over a Field, and the Field's `tooltip` property is used is applied
	 * using this object's tpl template, or if it is a string, used as HTML content. If there is no `tooltip` property,
	 * the field itself is used as the template's data object.
	 * 
	 * If more complex logic is needed to determine content, then the beforeshow event may be used.
	 * This class also publishes a **`beforeshowtip`** event through its host Component. The _host Component_ fires the
	 * **`beforeshowtip`** event.
	 */
	class DataTip extends Ext.tip.ToolTip {}
}
declare namespace Ext.ux.DataView {
	/** 
	 * [Ext.ux.DataView.Animated](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.DataView.Animated.html)
	 * Transition plugin for DataViews
	 */
	class Animated extends Ext.Base {
		/** 
		 ...
		 * @property
		 * @public (property)
		 * @default {duration: 750, idProperty: 'id'}
		 * @type {object}
		 */
		defaults?: object;
		/** 
		 ...
		 * @returns {void}                 
		 */
		cacheStoreData? (store: Ext.data.Store): void;
		/** 
		 ...
		 * @returns {object}               Object of records not already present in the dataview in format {id: record}
		 */
		getAdded? (store: Ext.data.Store): object;
		/** 
		 * Returns all records that were already in the DataView
		 * @method
		 * @public (method)
		 * @returns {object}  All existing records
		 */
		getExisting? (): object;
		/** 
		 ...
		 * @method
		 * @public (method)
		 * @returns {number}  The number of existing items
		 */
		 ...
		 * @public (method)
		 * @param   {Ext.data.Store} store The updated store instance
		 * @returns {object}               Object of records that are still present from last time in format {id: record}
		 */
		getRemaining? (store: Ext.data.Store): object;
		/** 
		 * Returns all records that are present in the DataView but not the new store
		 * @method
		 * @public (method)
		 * @param   {Ext.data.Store} store The updated store instance
		 * @returns {any[]}                Array of records that used to be present
		 */
		getRemoved? (store: Ext.data.Store): any[];
		/** 
		 ...
		 * @returns {void}                   
		 */
		init? (dataview: Ext.view.View): void;
	}
	/** 
	 * [Ext.ux.DataView.Draggable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.DataView.Draggable.html)
	...
	class Draggable extends Ext.Base {
		 ...
		 * @method
		 * @public (method)
		 * @param   {any[]}       records The set of records that is currently selected in the parent DataView
		 * @returns {HTMLElement}         The Ghost DataView's encapsulating HTMLElement.
		 */
		prepareGhost? (records: any[]): HTMLElement;
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
	...
	class DragSelector extends Ext.Base {
		/** 
		 ...
		 * @returns {void}            
		 */
		init? (dataview: object): void;
	}
	class LabelEditor extends Ext.Editor {
	}
}
declare namespace Ext.ux {
	/** 
	 * [Ext.ux.DataViewTransition](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.DataViewTransition.html)
	 * Transition plugin for DataViews
	 */
	...
	/** 
	 * [Ext.ux.Explorer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Explorer.html)
	 ...
	 * of a given node.
	 */
	class Explorer extends Ext.panel.Panel {
		/** 
		 * @property
		 * @private (property)
		 * @type {object}
		 ...
		 * @returns {void}              
		 */
		_onBreadcrumbSelectionChange? (breadcrumb: object, selection: object): void;
		/** 
		 * Returns the value of [breadcrumb](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Explorer.html#cfg-breadcrumb).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the value of [contentView](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Explorer.html#cfg-contentView).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getContentView? (): object;
		/** 
		 * Returns the value of [selection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Explorer.html#cfg-selection).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [store](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Explorer.html#cfg-store).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [tree](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Explorer.html#cfg-tree).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getTree? (): object;
		/** 
		 * Sets the value of [breadcrumb](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Explorer.html#cfg-breadcrumb).
		 * @method
		 * @public (method)
		 * @param   {object} breadcrumb The new value.
		 * @returns {void}              
		 */
		setBreadcrumb? (breadcrumb: object): void;
		/** 
		 * Sets the value of [contentView](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Explorer.html#cfg-contentView).
		 * @method
		 * @public (method)
		 * @param   {object} contentView The new value.
		 * @returns {void}               
		 */
		setContentView? (contentView: object): void;
		/** 
		 * Sets the value of [selection](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Explorer.html#cfg-selection).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [store](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Explorer.html#cfg-store).
		 * @method
		 * @public (method)
		 * @param   {Ext.data.TreeStore} store The new value.
		 * @returns {void}                     
		 */
		setStore? (store: Ext.data.TreeStore): void;
		/** 
		 * Sets the value of [tree](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Explorer.html#cfg-tree).
		 * @method
		 * @public (method)
		 * @param   {object} tree The new value.
		 * @returns {void}        
		 */
	...
	/** 
	 * [Ext.ux.FieldReplicator](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.FieldReplicator.html)
	 ...
	 * 
	 */
	class FieldReplicator extends Ext.Base {
	}
	/** 
	 * [Ext.ux.Gauge](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html)
	...
	class Gauge extends Ext.Gadget {
		...
		template?: any[];
		/** 
		 * Returns the value of [angleOffset](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-angleOffset).
		 * @method
		 * @public (method)
		 * @returns {number}  
		 */
		...
		/** 
		 * Returns the value of [animation](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-animation).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [clockwise](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-clockwise).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [maxValue](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-maxValue).
		 * @method
		 * @public (method)
		 * @returns {number}  
		 */
		getMaxValue? (): number;
		/** 
		 * Returns the value of [minValue](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-minValue).
		 * @method
		 * @public (method)
		 * @returns {number}  
		 */
		getMinValue? (): number;
		/** 
		 * Returns the value of [padding](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-padding).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [textAlign](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-textAlign).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		getTextAlign? (): string;
		/** 
		 * Returns the value of [textTpl](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-textTpl).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [trackLength](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-trackLength).
		 * @method
		 * @public (method)
		 * @returns {number}  
		 */
		...
		/** 
		 * Returns the value of [trackStart](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-trackStart).
		 * @method
		 * @public (method)
		 * @returns {number}  
		 */
		...
		/** 
		 * Returns the value of [trackStyle](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-trackStyle).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the value of [valueStyle](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-valueStyle).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Sets the value of [angleOffset](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-angleOffset).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [animation](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-animation).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [clockwise](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-clockwise).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [maxValue](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-maxValue).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [minValue](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-minValue).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [padding](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-padding).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [textAlign](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-textAlign).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [textTpl](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-textTpl).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [trackLength](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-trackLength).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [trackStart](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-trackStart).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [trackStyle](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-trackStyle).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [valueStyle](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-valueStyle).
		 * @method
		 * @public (method)
		...
		/** 
		 * Stops the current value or [angleOffset](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-angleOffset) animation.
		 * @method
		 * @public (method)
		 * @returns {void}  
		 */
	...
	/** 
	 * [Ext.ux.GMapPanel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.GMapPanel.html)
	 ...
	 * 
	 */
	class GMapPanel extends Ext.panel.Panel {
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} w
		 ...
		 * @returns {void}     
		 */
		afterComponentLayout? (w: object, h: object): void;
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.container.Container.afterComponentLayout](https://docs.sencha.com/extjs/6.2.0/classic/Ext.container.Container.html#method-afterComponentLayout).
	...
	/** 
	 * [Ext.ux.GroupTabPanel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.GroupTabPanel.html)
	 * A TabPanel with grouping support.
	 */
	class GroupTabPanel extends Ext.Container {
		/** 
		 * Returns the root group item that is currently active inside this GroupTabPanel.
		 * @method
		 * @public (method)
		 * @returns {Ext.Component|number}  The currently active root group item
		 */
		getActiveGroup? (): Ext.Component | number;
		/** 
		 * Returns the item that is currently active inside this GroupTabPanel.
		 * @method
		 * @public (method)
		 * @returns {Ext.Component|number}  The currently active item
		 */
		getActiveTab? (): Ext.Component | number;
		/** 
		 ...
		 * @returns {void}              
		 */
		setActiveGroup? (cmp: Ext.Component): void;
		/** 
		 ...
		 * @returns {void}              
		 */
		setActiveTab? (cmp: Ext.Component): void;
	}
	/** 
	 * [Ext.ux.GroupTabRenderer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.GroupTabRenderer.html)
	 * Allows GroupTab to render a table structure.
	 */
	class GroupTabRenderer extends Ext.plugin.Abstract {
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} grid
	...
	/** 
	 * [Ext.ux.IFrame](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.IFrame.html)
	 * Barebones iframe implementation.
	 */
	class IFrame extends Ext.Component {
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.ux.LiveSearchGridPanel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.LiveSearchGridPanel.html)
	 * A GridPanel class with live search support.
	 */
	class LiveSearchGridPanel extends Ext.grid.Panel {
		/** 
		 * @property
		 * @private (property)
		 * @type {object}
	...
	/** 
	 * [Ext.ux.PreviewPlugin](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.PreviewPlugin.html)
	 ...
	 */
	class PreviewPlugin extends Ext.plugin.Abstract {
		/** 
	...
	/** 
	 * [Ext.ux.ProgressBarPager](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ProgressBarPager.html)
	 * Plugin for displaying a progressbar inside of a paging toolbar
	 * instead of plain text.
	 */
	class ProgressBarPager extends Ext.Base {
		/** 
	...
	/** 
	 * [Ext.ux.RowExpander](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.RowExpander.html)
	 * @deprecated
	 */
	class RowExpander extends Ext.grid.plugin.RowExpander {}
	/** 
	 * [Ext.ux.SlidingPager](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.SlidingPager.html)
	 * Plugin for PagingToolbar which replaces the textfield input with a slider
	 */
	class SlidingPager extends Ext.Base {
		/** 
	...
	/** 
	 * [Ext.ux.Spotlight](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Spotlight.html)
	 * UX used to provide a spotlight around a specified component/element.
	 */
	class Spotlight extends Ext.Base {
		/** 
		 * @method
		 * @public (method)
		 * @param   {object} config
		 ...
		 * @returns {void}            
		 */
		applyBounds? (animate: boolean, reverse: boolean): void;
		/** 
		 ...
		 * @returns {void}            
		 */
		hide? (callback: object, scope: object): void;
		/** 
		 * Show the spotlight
		 * @method
		 * @public (method)
		 ...
		 * @returns {void}            
		 */
		show? (el: object, callback: object, scope: object): void;
		/** 
	...
	/** 
	 * [Ext.ux.TabCloseMenu](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TabCloseMenu.html)
	 * Plugin for adding a close context menu to tabs. Note that the menu respects
	 * the closable configuration on the tab. As such, commands like remove others
	 * and remove all will not remove items that are not closable.
	 */
	class TabCloseMenu extends Ext.plugin.Abstract {
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.ux.TabReorderer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TabReorderer.html)
	 * This plugin allow you to reorder tabs of a TabPanel.
	 */
	class TabReorderer extends Ext.ux.BoxReorderer {
		/** 
		 * @method
		 * @private (method)
		 * @param   {object} tabPanel
	...
	/** 
	 * [Ext.ux.TabScrollerMenu](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TabScrollerMenu.html)
	 * Plugin for adding a tab menu to a TabBar is the Tabs overflow.
	 */
	class TabScrollerMenu extends Ext.Base {
		/** 
		 ...
		 * @method
		 * @public (method)
		 * @returns {number}  this.maxText The current max text length.
		 */
		getMaxText? (): number;
		/** 
		 ...
		 * @method
		 * @public (method)
		 * @returns {string}  this.menuPrefixText The current menu prefix text.
		 */
		getMenuPrefixText? (): string;
		/** 
		 * Returns an the current page size (this.pageSize);
		 * @method
		 * @public (method)
		 * @returns {number}  this.pageSize The current page size.
		 */
		getPageSize? (): number;
		/** 
		 ...
		 * @returns {void}     
		 */
		setMenuPrefixText? (t: string): void;
		/** 
	...
	/** 
	 * [Ext.ux.ToolbarDroppable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ToolbarDroppable.html)
	 ...
	 */
	class ToolbarDroppable extends Ext.Base {
		/** 
		 ...
		 * @returns {void}           
		 */
		addDDGroup? (ddGroup: string): void;
		/** 
		 ...
		 * @returns {number}            The index at which to insert the new button
		 */
		calculateEntryIndex? (e: Ext.event.Event): number;
		/** 
		 ...
		 * @returns {any}         An item that can be added to a toolbar
		 */
		createItem? (data: object): any;
		/** 
		 ...
		 * @returns {void}                        
		 */
		init? (toolbar: Ext.toolbar.Toolbar): void;
		/** 
		 ...
		 * @returns {void}              
		 */
		notifyDrop? (dragSource: object, event: object, data: object): void;
		/** 
		 ...
		 * @param   {object} event
		 * @param   {object} data
		 * @returns {string}            The CSS class to add
		 */
		notifyOver? (dragSource: object, event: object, data: object): string;
	}
	/** 
	 * [Ext.ux.TreePicker](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TreePicker.html)
	 * A Picker field that contains a tree panel on its popup, enabling selection of tree nodes.
	 */
	class TreePicker extends Ext.form.field.Picker {
		/** 
		...
		createPicker? (): void;
		/** 
		 * Returns the value of [columns](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TreePicker.html#cfg-columns).
		 * @method
		 * @public (method)
		 * @returns {any[]}  
		 */
		getColumns? (): any[];
		/** 
		 * Returns the value of [displayField](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TreePicker.html#cfg-displayField).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Returns the value of [maxPickerHeight](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TreePicker.html#cfg-maxPickerHeight).
		 * @method
		 * @public (method)
		 * @returns {number}  
		 */
		getMaxPickerHeight? (): number;
		/** 
		 * Returns the value of [minPickerHeight](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TreePicker.html#cfg-minPickerHeight).
		 * @method
		 * @public (method)
		 * @returns {number}  
		 */
		getMinPickerHeight? (): number;
		/** 
		 * Returns the value of [selectOnTab](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TreePicker.html#cfg-selectOnTab).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		getSelectOnTab? (): boolean;
		/** 
		 * Returns the value of [store](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TreePicker.html#cfg-store).
		 * @method
		 * @public (method)
		 * @returns {Ext.data.TreeStore}  
		 */
		 ...
		 * @returns {void}  
		 */
		repaintPickerView? (): void;
		/** 
		 * Sets the value of [columns](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TreePicker.html#cfg-columns).
		 * @method
		 * @public (method)
		 * @param   {any[]} columns The new value.
		 * @returns {void}          
		 */
		setColumns? (columns: any[]): void;
		/** 
		 * Sets the value of [displayField](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TreePicker.html#cfg-displayField).
		 * @method
		 * @public (method)
		 * @param   {string} displayField The new value.
		 * @returns {void}                
		 */
		setDisplayField? (displayField: string): void;
		/** 
		 * Sets the value of [maxPickerHeight](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TreePicker.html#cfg-maxPickerHeight).
		 * @method
		 * @public (method)
		 * @param   {number} maxPickerHeight The new value.
		 * @returns {void}                   
		 */
		setMaxPickerHeight? (maxPickerHeight: number): void;
		/** 
		 * Sets the value of [minPickerHeight](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TreePicker.html#cfg-minPickerHeight).
		 * @method
		 * @public (method)
		 * @param   {number} minPickerHeight The new value.
		 * @returns {void}                   
		 */
		setMinPickerHeight? (minPickerHeight: number): void;
		/** 
		 * Sets the value of [selectOnTab](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TreePicker.html#cfg-selectOnTab).
		 * @method
		 * @public (method)
		 * @param   {boolean} selectOnTab The new value.
		 * @returns {void}                
		 */
		setSelectOnTab? (selectOnTab: boolean): void;
		/** 
		 * Sets the value of [store](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TreePicker.html#cfg-store).
		 * @method
		 * @public (method)
		 * @param   {Ext.data.TreeStore} store The new value.
		 * @returns {void}                     
		 ...
		 * @chainable
		 * @param   {any}               value
		 * @returns {Ext.ux.TreePicker}       this
		 */
		setValue? (value: any): Ext.ux.TreePicker;
		/** 
		 ...
		 * @public (method)
		 * @param   {object}                                 value
		 * @returns {Ext.ux.TreePicker|Ext.form.field.Field}       this
		 */
...
declare namespace Ext.ux.BoxReorderer {
	/** 
	 * @definitions
	 ...
	 * Base class from [Ext.ux.TabReorderer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TabReorderer.html).
	 */
	interface Def extends Ext.ux.BoxReorderer {
		/** 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.BoxReorderer.Cfg}
		 */
		config?: Ext.ux.BoxReorderer.Cfg;
		/** 
...
declare namespace Ext.ux.CellDragDrop {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.CellDragDrop](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.CellDragDrop.html)
	 ...
	 * 
	 */
	interface Def extends Ext.ux.CellDragDrop {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.CellDragDrop.Cfg}
		 */
		config?: Ext.ux.CellDragDrop.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.ux.DataTip {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.DataTip](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.DataTip.html)
	 ...
	 * **`beforeshowtip`** event.
	 */
	interface Def extends Ext.ux.DataTip {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * 
		 * @protected (method+configuration)
		 * @returns {Ext.tip.ToolTip.Statics|Ext.tip.Tip.Statics|Ext.panel.Panel.Statics|Ext.container.Container.Statics|Ext.Component.Statics|Ext.Base.Statics}  
		 * @type {object}
		 */
		statics?: (() => Ext.tip.ToolTip.Statics | Ext.tip.Tip.Statics | Ext.panel.Panel.Statics | Ext.container.Container.Statics | Ext.Component.Statics | Ext.Base.Statics) | object | any;
	}
}
declare namespace Ext.ux.DataView.Animated {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.DataView.Animated](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.DataView.Animated.html)
	 * Transition plugin for DataViews
	 */
	interface Def extends Ext.ux.DataView.Animated {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.DataView.Draggable {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.DataView.Draggable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.DataView.Draggable.html)
	 ...
	 * 
	 */
	interface Def extends Ext.ux.DataView.Draggable {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.DataView.Draggable.Cfg}
		 */
		config?: Ext.ux.DataView.Draggable.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.ux.DataView.DragSelector {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.DataView.DragSelector](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.DataView.DragSelector.html)
	 */
	interface Def extends Ext.ux.DataView.DragSelector {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.DataView.LabelEditor {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.DataView.LabelEditor](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.DataView.LabelEditor.html)
	 */
	interface Def extends Ext.ux.DataView.LabelEditor {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * 
		 * @protected (method+configuration)
		 * @returns {Ext.Editor.Statics|Ext.container.Container.Statics|Ext.Component.Statics|Ext.Base.Statics}  
		 * @type {object}
		 */
		statics?: (() => Ext.Editor.Statics | Ext.container.Container.Statics | Ext.Component.Statics | Ext.Base.Statics) | object | any;
	}
}
declare namespace Ext.ux.DataViewTransition {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.DataViewTransition](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.DataViewTransition.html)
	 * Transition plugin for DataViews
	 */
	interface Def extends Ext.ux.DataViewTransition {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.Explorer {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.Explorer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Explorer.html)
	 ...
	 * of a given node.
	 */
	interface Def extends Ext.ux.Explorer {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.Explorer.Cfg}
		 */
		config?: Ext.ux.Explorer.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.ux.FieldReplicator {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.FieldReplicator](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.FieldReplicator.html)
	 ...
	 * 
	 */
	interface Def extends Ext.ux.FieldReplicator {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.GMapPanel {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.GMapPanel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.GMapPanel.html)
	 ...
	 * 
	 */
	interface Def extends Ext.ux.GMapPanel {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.GroupTabPanel {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.GroupTabPanel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.GroupTabPanel.html)
	 * A TabPanel with grouping support.
	 */
	interface Def extends Ext.ux.GroupTabPanel {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.GroupTabRenderer {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.GroupTabRenderer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.GroupTabRenderer.html)
	 * Allows GroupTab to render a table structure.
	 */
	interface Def extends Ext.ux.GroupTabRenderer {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.IFrame {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.IFrame](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.IFrame.html)
	 * Barebones iframe implementation.
	 */
	interface Def extends Ext.ux.IFrame {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.LiveSearchGridPanel {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.LiveSearchGridPanel](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.LiveSearchGridPanel.html)
	 * A GridPanel class with live search support.
	 */
	interface Def extends Ext.ux.LiveSearchGridPanel {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.LiveSearchGridPanel.Cfg}
		 */
		config?: Ext.ux.LiveSearchGridPanel.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.ux.PreviewPlugin {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.PreviewPlugin](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.PreviewPlugin.html)
	 ...
	 * another instance of the same plugin.
	 */
	interface Def extends Ext.ux.PreviewPlugin {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.PreviewPlugin.Cfg}
		 */
		config?: Ext.ux.PreviewPlugin.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.ux.ProgressBarPager {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.ProgressBarPager](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ProgressBarPager.html)
	 ...
	 * instead of plain text.
	 */
	interface Def extends Ext.ux.ProgressBarPager {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.ProgressBarPager.Cfg}
		 */
		config?: Ext.ux.ProgressBarPager.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.ux.RowExpander {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.RowExpander](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.RowExpander.html)
	 */
	interface Def extends Ext.ux.RowExpander {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.SlidingPager {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.SlidingPager](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.SlidingPager.html)
	 * Plugin for PagingToolbar which replaces the textfield input with a slider
	 */
	interface Def extends Ext.ux.SlidingPager {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.Spotlight {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.Spotlight](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Spotlight.html)
	 * UX used to provide a spotlight around a specified component/element.
	 */
	interface Def extends Ext.ux.Spotlight {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.Spotlight.Cfg}
		 */
		config?: Ext.ux.Spotlight.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.ux.TabCloseMenu {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.TabCloseMenu](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TabCloseMenu.html)
	 ...
	 * and remove all will not remove items that are not closable.
	 */
	interface Def extends Ext.ux.TabCloseMenu {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.TabCloseMenu.Cfg}
		 */
		config?: Ext.ux.TabCloseMenu.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.ux.TabReorderer {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.TabReorderer](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TabReorderer.html)
	 * This plugin allow you to reorder tabs of a TabPanel.
	 */
	interface Def extends Ext.ux.TabReorderer {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.TabReorderer.Cfg}
		 */
		config?: Ext.ux.TabReorderer.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.ux.TabScrollerMenu {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.TabScrollerMenu](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TabScrollerMenu.html)
	 * Plugin for adding a tab menu to a TabBar is the Tabs overflow.
	 */
	interface Def extends Ext.ux.TabScrollerMenu {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.TabScrollerMenu.Cfg}
		 */
		config?: Ext.ux.TabScrollerMenu.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.ux.ToolbarDroppable {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.ToolbarDroppable](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.ToolbarDroppable.html)
	 ...
	 * the item has been created.
	 */
	interface Def extends Ext.ux.ToolbarDroppable {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
...
declare namespace Ext.ux.TreePicker {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.TreePicker](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.TreePicker.html)
	 * A Picker field that contains a tree panel on its popup, enabling selection of tree nodes.
	 */
	interface Def extends Ext.ux.TreePicker {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.TreePicker.Cfg}
		 */
		config?: Ext.ux.TreePicker.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
...
declare namespace Ext.ux.CellDragDrop {
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * If `true`, then use the value of [emptyText](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.CellDragDrop.html#cfg-emptyText) to replace the drag record's value after a node drop.
		 ...
		 * @type {boolean}
		 */
		dropBackgroundColor?: boolean;
		/** 
		 * If [applyEmptyText](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.CellDragDrop.html#cfg-applyEmptyText) is `true`, then this value as the drag record's value after a node drop.
		 * 
...
declare namespace Ext.ux.DataView.Draggable {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @configuration
		 * @optional
		 * @default 'x-dataview-draggable-ghost'
		 * @type {string}
		 */
		ghostCls?: string;
		/** 
		 ...
		 * @configuration
		 * @optional
		 * @default ['<tpl for=".">', '{title}', '</tpl>']
		 * @type {Ext.XTemplate|any[]}
		 */
		ghostTpl?: Ext.XTemplate | any[];
		/** 
		 * Call the original method that was previously overridden with [override](https://docs.sencha.com/extjs/6.2.0/classic/Ext.Base.html#static-method-override)
		 * 
		 *    Ext.define('My.Cat', {
...
declare namespace Ext.ux.Explorer {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @configuration
		 * @optional
		 * @default {dock: 'top', xtype: 'breadcrumb', reference: 'breadcrumb'}
		 * @type {object}
		 */
		breadcrumb?: object;
		/** 
		 ...
		 * @configuration
		 * @optional
		 * @default {xtype: 'dataview', reference: 'contentView', region: 'center', cls: Ext.baseCSSPrefix + 'explorer-view', itemSelector: '.' + Ext.baseCSSPrefix + 'explorer-item', tpl: '<tpl for=".">' + '<div class="' + Ext.baseCSSPrefix + 'explorer-item">' + '<div class="{iconCls}">' + '<div class="' + Ext.baseCSSPrefix + 'explorer-node-icon' + '{[values.leaf ? " ' + Ext.baseCSSPrefix + 'explorer-leaf-icon' + '" : ""]}' + '">' + '</div>' + '<div class="' + Ext.baseCSSPrefix + 'explorer-item-text">{text}</div>' + '</div>' + '</div>' + '</tpl>'}
		 * @type {object}
		 */
		contentView?: object;
		/** 
		 ...
		 * @configuration
		 * @optional
		 * @default {xtype: 'treepanel', reference: 'tree', region: 'west', width: 200}
		 * @type {object}
		 */
		tree?: object;
		/** 
...
declare namespace Ext.ux.Gauge {
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * The angle at which the [minValue](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-minValue) starts in case of a circular gauge.
		 * @configuration
		 * @optional
		 * @default 0
		 * @type {number}
		 ...
		 * - `minValue` - The value of the [minValue](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-minValue) config.
		 * - `maxValue` - The value of the [maxValue](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-maxValue) config.
		 * - `delta` - The delta between the [minValue](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-minValue) and [maxValue](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-maxValue).
		 * @configuration
		 * @optional
		...
		/** 
		 * The angle in the (0, 360] interval to add to the [trackStart](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.Gauge.html#cfg-trackStart) angle
...
declare namespace Ext.ux.ProgressBarPager {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @configuration
		 * @optional
		 * @default {duration: 1000, easing: 'bounceOut'}
		 * @type {object}
		 */
		defaultAnimCfg?: object;
		/** 
...
declare namespace Ext.ux.TabCloseMenu {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @configuration
		 * @optional
		 * @default 'Close Other Tabs'
		 * @type {string}
		 */
		closeOthersTabsText?: string;
		/** 
...
declare namespace Ext.ux.BoxReorderer {
	...
	interface Events extends Ext.base.Events {
		 ...
		 * @event
		 * @param   {Ext.ux.BoxReorderer}     _this
		 ...
		 * @returns {void}                    
		 */
		ChangeIndex? (_this: Ext.ux.BoxReorderer, container: Ext.container.Container, dragCmp: Ext.Component, startIdx: number, idx: number, eOpts: object): void;
		/** 
		 ...
		 * @returns {void}                    
		 */
		Drag? (_this: Ext.ux.BoxReorderer, container: Ext.container.Container, dragCmp: Ext.Component, startIdx: number, idx: number, eOpts: object): void;
		/** 
		 ...
		 * @returns {void}                    
		 */
		Drop? (_this: Ext.ux.BoxReorderer, container: Ext.container.Container, dragCmp: Ext.Component, startIdx: number, idx: number, eOpts: object): void;
		/** 
		 ...
		 * @returns {void}                    
		 */
		StartDrag? (_this: Ext.ux.BoxReorderer, container: Ext.container.Container, dragCmp: Ext.Component, idx: number, eOpts: object): void;
	}
}
declare namespace Ext.ux.GroupTabPanel {
	/** 
	...
	interface Events extends Ext.base.Events {
		/** 
		 * Fires before a group change (activated by [setActiveGroup](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.GroupTabPanel.html#method-setActiveGroup)). Return false in any listener to cancel
		 * the groupchange
		 * @event
		 ...
		 * @returns {void}                 
		 */
		beforegroupchange? (grouptabPanel: Ext.ux.GroupTabPanel, newGroup: Ext.Component, oldGroup: Ext.Component, eOpts: object): void;
		/** 
		 * Fires before a tab change (activated by [setActiveTab](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.GroupTabPanel.html#method-setActiveTab)). Return false in any listener to cancel
		 * the tabchange
		 * @event
		 * @param   {Ext.ux.GroupTabPanel} grouptabPanel The GroupTabPanel
		 ...
		 * @returns {void}                 
		 */
		beforetabchange? (grouptabPanel: Ext.ux.GroupTabPanel, newCard: Ext.Component, oldCard: Ext.Component, eOpts: object): void;
		/** 
		 * Fires when a new group has been activated (activated by [setActiveGroup](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.GroupTabPanel.html#method-setActiveGroup)).
		 * @event
		 * @param   {Ext.ux.GroupTabPanel} grouptabPanel The GroupTabPanel
		 ...
		 * @returns {void}                 
		 */
		groupchange? (grouptabPanel: Ext.ux.GroupTabPanel, newGroup: Ext.Component, oldGroup: Ext.Component, eOpts: object): void;
		/** 
		 * Fires when a new tab has been activated (activated by [setActiveTab](https://docs.sencha.com/extjs/6.2.0/classic/Ext.ux.GroupTabPanel.html#method-setActiveTab)).
		 * @event
		 * @param   {Ext.ux.GroupTabPanel} grouptabPanel The GroupTabPanel
		 ...
		 * @returns {void}                 
		 */
		tabchange? (grouptabPanel: Ext.ux.GroupTabPanel, newCard: Ext.Component, oldCard: Ext.Component, eOpts: object): void;
	}
}
declare namespace Ext.ux.TabReorderer {
	/** 
...
declare namespace Ext.ux.TreePicker {
	...
	interface Events extends Ext.base.Events {
		 ...
		 * @returns {void}              
		 */
		select? (picker: Ext.ux.TreePicker, record: Ext.data.Model, eOpts: object): void;
	}
}

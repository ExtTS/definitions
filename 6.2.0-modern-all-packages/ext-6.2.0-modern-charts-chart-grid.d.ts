declare namespace Ext.chart.grid {
	/** 
	 * [Ext.chart.grid.CircularGrid](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.grid.CircularGrid.html)
	...
	class CircularGrid extends Ext.draw.sprite.Circle {
		 ...
		 * The given sprite must be an instance of the [Ext.draw.sprite.Path](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.sprite.Path.html) class
		 * or its subclass.
		 * @method
		 * @public (method)
		 * @param   {object} path
		 ...
		 * @returns {Ext.chart.grid.CircularGrid|Ext.draw.sprite.Circle|Ext.draw.sprite.Path|Ext.draw.sprite.Sprite}           This sprite.
		 */
		setTransform? (matrix: Ext.draw.Matrix | number[], isSplit?: boolean): Ext.chart.grid.CircularGrid;
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.draw.sprite.Path.updatePath](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.sprite.Path.html#method-updatePath).
		 * Update the path.
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.chart.grid.HorizontalGrid](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.grid.HorizontalGrid.html)
	...
	class HorizontalGrid extends Ext.draw.sprite.Sprite {
		 ...
		 * @returns {Ext.chart.grid.HorizontalGrid|Ext.draw.sprite.Sprite}           This sprite.
		 */
		setTransform? (matrix: Ext.draw.Matrix | number[], isSplit?: boolean): Ext.chart.grid.HorizontalGrid;
		setTransform? (matrix: Ext.draw.Matrix | number[], isSplit?: boolean): Ext.draw.sprite.Sprite;
		/** 
		 * Show the sprite.
		 * @method
	...
	/** 
	 * [Ext.chart.grid.HorizontalGrid3D](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.grid.HorizontalGrid3D.html)
	...
	class HorizontalGrid3D extends Ext.chart.grid.HorizontalGrid {
		 ...
		 * @returns {Ext.chart.grid.HorizontalGrid3D|Ext.chart.grid.HorizontalGrid|Ext.draw.sprite.Sprite}           This sprite.
		 */
		setTransform? (matrix: Ext.draw.Matrix | number[], isSplit?: boolean): Ext.chart.grid.HorizontalGrid3D;
		setTransform? (matrix: Ext.draw.Matrix | number[], isSplit?: boolean): Ext.chart.grid.HorizontalGrid;
		setTransform? (matrix: Ext.draw.Matrix | number[], isSplit?: boolean): Ext.draw.sprite.Sprite;
		/** 
		 * Show the sprite.
	...
	/** 
	 * [Ext.chart.grid.RadialGrid](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.grid.RadialGrid.html)
	...
	class RadialGrid extends Ext.draw.sprite.Path {
		 ...
		 * @returns {Ext.chart.grid.RadialGrid|Ext.draw.sprite.Path|Ext.draw.sprite.Sprite}           This sprite.
		 */
		setTransform? (matrix: Ext.draw.Matrix | number[], isSplit?: boolean): Ext.chart.grid.RadialGrid;
		setTransform? (matrix: Ext.draw.Matrix | number[], isSplit?: boolean): Ext.draw.sprite.Path;
		setTransform? (matrix: Ext.draw.Matrix | number[], isSplit?: boolean): Ext.draw.sprite.Sprite;
		/** 
		 * Show the sprite.
	...
	/** 
	 * [Ext.chart.grid.VerticalGrid](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.grid.VerticalGrid.html)
	...
	class VerticalGrid extends Ext.draw.sprite.Sprite {
		 ...
		 * @returns {Ext.chart.grid.VerticalGrid|Ext.draw.sprite.Sprite}           This sprite.
		 */
		setTransform? (matrix: Ext.draw.Matrix | number[], isSplit?: boolean): Ext.chart.grid.VerticalGrid;
		setTransform? (matrix: Ext.draw.Matrix | number[], isSplit?: boolean): Ext.draw.sprite.Sprite;
		/** 
		 * Show the sprite.
		 * @method
	...
	/** 
	 * [Ext.chart.grid.VerticalGrid3D](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.grid.VerticalGrid3D.html)
	...
	class VerticalGrid3D extends Ext.chart.grid.VerticalGrid {
		 ...
		 * @returns {Ext.chart.grid.VerticalGrid3D|Ext.chart.grid.VerticalGrid|Ext.draw.sprite.Sprite}           This sprite.
		 */
		setTransform? (matrix: Ext.draw.Matrix | number[], isSplit?: boolean): Ext.chart.grid.VerticalGrid3D;
		setTransform? (matrix: Ext.draw.Matrix | number[], isSplit?: boolean): Ext.chart.grid.VerticalGrid;
		setTransform? (matrix: Ext.draw.Matrix | number[], isSplit?: boolean): Ext.draw.sprite.Sprite;
		/** 
		 * Show the sprite.

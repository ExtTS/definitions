declare namespace Ext.chart.interactions {
	/** 
	 * [Ext.chart.interactions.Abstract](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Abstract.html)
	...
	class Abstract extends Ext.Base {
		...
		/** 
		 * Returns the value of [chart](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Abstract.html#cfg-chart).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [enabled](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Abstract.html#cfg-enabled).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		getEnabled? (): boolean;
		/** 
		 * Sets the value of [chart](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Abstract.html#cfg-chart).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [enabled](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Abstract.html#cfg-enabled).
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.chart.interactions.Crosshair](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Crosshair.html)
	...
	class Crosshair extends Ext.chart.interactions.Abstract {
		...
		constructor (config: object);
		/** 
		 * Returns the value of [axes](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Crosshair.html#cfg-axes).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		getEnabled? (): boolean;
		/** 
		 * Returns the value of [gesture](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Crosshair.html#cfg-gesture).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		getGesture? (): string;
		/** 
		 * Returns the value of [lines](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Crosshair.html#cfg-lines).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getLines? (): object;
		/** 
		 * Sets the value of [axes](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Crosshair.html#cfg-axes).
		 * @method
		 * @public (method)
		...
		setEnabled? (enabled: boolean): void;
		/** 
		 * Sets the value of [gesture](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Crosshair.html#cfg-gesture).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [lines](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Crosshair.html#cfg-lines).
		 * @method
		 * @public (method)
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.chart.interactions.Abstract.onGesture](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Abstract.html#method-onGesture).
		 * Placeholder method.
		 * @method
		 * @protected (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.chart.interactions.CrossZoom](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.CrossZoom.html)
	...
	class CrossZoom extends Ext.chart.interactions.Abstract {
		/** 
		 * Returns the value of [axes](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.CrossZoom.html#cfg-axes).
		 * @method
		 * @public (method)
		 * @returns {object|any[]}  
		 */
		...
		getEnabled? (): boolean;
		/** 
		 * Returns the value of [gestures](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.CrossZoom.html#cfg-gestures).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getGestures? (): object;
		/** 
		 * Returns the value of [undoButton](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.CrossZoom.html#cfg-undoButton).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Sets the value of [axes](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.CrossZoom.html#cfg-axes).
		 * @method
		 * @public (method)
		...
		setEnabled? (enabled: boolean): void;
		/** 
		 * Sets the value of [gestures](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.CrossZoom.html#cfg-gestures).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [undoButton](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.CrossZoom.html#cfg-undoButton).
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.chart.interactions.ItemEdit](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemEdit.html)
	 ...
	 * ['itemhighlight'](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemHighlight.html) interaction,
	...
	class ItemEdit extends Ext.chart.interactions.ItemHighlight {
		...
		getChart? (): Ext.chart.AbstractChart;
		/** 
		 * Returns the value of [cursors](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemEdit.html#cfg-cursors).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		getEnabled? (): boolean;
		/** 
		 * Returns the value of [gestures](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemEdit.html#cfg-gestures).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getGestures? (): object;
		/** 
		 * Returns the value of [renderer](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemEdit.html#cfg-renderer).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [sticky](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemHighlight.html#cfg-sticky).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		getSticky? (): boolean;
		/** 
		 * Returns the value of [style](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemEdit.html#cfg-style).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getStyle? (): object;
		/** 
		 * Returns the value of [tooltip](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemEdit.html#cfg-tooltip).
		 * @method
		 * @public (method)
		...
		setChart? (chart: Ext.chart.AbstractChart): void;
		/** 
		 * Sets the value of [cursors](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemEdit.html#cfg-cursors).
		 * @method
		 * @public (method)
		...
		setEnabled? (enabled: boolean): void;
		/** 
		 * Sets the value of [gestures](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemEdit.html#cfg-gestures).
		 * @method
		 * @public (method)
		 * @param   {object} gestures The new value.
		 * @returns {void}            
		...
		setGestures? (gestures: object): void;
		/** 
		 * Sets the value of [renderer](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemEdit.html#cfg-renderer).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [sticky](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemHighlight.html#cfg-sticky).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [style](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemEdit.html#cfg-style).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [tooltip](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemEdit.html#cfg-tooltip).
		 * @method
		 * @public (method)
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.chart.interactions.ItemHighlight.showTooltip](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemHighlight.html#method-showTooltip).
		 * @method
		 * @private (method)
		 * @param   {object} e
		 * @param   {object} item
	...
	/** 
	 * [Ext.chart.interactions.ItemHighlight](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemHighlight.html)
	...
	class ItemHighlight extends Ext.chart.interactions.Abstract {
		...
		getEnabled? (): boolean;
		/** 
		 * Returns the value of [gestures](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemHighlight.html#cfg-gestures).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		setEnabled? (enabled: boolean): void;
		/** 
		 * Sets the value of [gestures](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemHighlight.html#cfg-gestures).
		 * @method
		 * @public (method)
		 * @param   {object} gestures The new value.
		 * @returns {void}            
	...
	/** 
	 * [Ext.chart.interactions.ItemInfo](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemInfo.html)
	 ...
	 * [interactions](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.AbstractChart.html#cfg-interactions) config with the `iteminfo` type:
	 * 
	...
	class ItemInfo extends Ext.chart.interactions.Abstract {
		...
		getEnabled? (): boolean;
		/** 
		 * Returns the value of [gestures](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemInfo.html#cfg-gestures).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getGestures? (): object;
		/** 
		 * Returns the value of [panel](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemInfo.html#cfg-panel).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		setEnabled? (enabled: boolean): void;
		/** 
		 * Sets the value of [gestures](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemInfo.html#cfg-gestures).
		 * @method
		 * @public (method)
		 * @param   {object} gestures The new value.
		 * @returns {void}            
		...
		setGestures? (gestures: object): void;
		/** 
		 * Sets the value of [panel](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.ItemInfo.html#cfg-panel).
		 * @method
		 * @public (method)
		 * @param   {object} panel The new value.
		 * @returns {void}         
		 */
		setPanel? (panel: object): void;
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.chart.interactions.PanZoom](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html)
	 ...
	 * [modeToggleButton](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-modeToggleButton) provides a button to indicate and toggle between two modes.
	 * 
	 *    Ext.create({
	 ...
	 * will be made navigable via the `axes` config. See the [axes](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-axes) config documentation
	...
	class PanZoom extends Ext.chart.interactions.Abstract {
		...
		constructor (config: object);
		/** 
		 * Returns the value of [axes](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-axes).
		 * @method
		 * @public (method)
		 * @returns {object|any[]}  
		 */
		...
		getEnabled? (): boolean;
		/** 
		 * Returns the value of [hideLabelInGesture](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-hideLabelInGesture).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [maxZoom](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-maxZoom).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getMaxZoom? (): object;
		/** 
		 * Returns the value of [minZoom](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-minZoom).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getMinZoom? (): object;
		/** 
		 * Returns the value of [modeToggleButton](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-modeToggleButton).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the value of [showOverflowArrows](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-showOverflowArrows).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [zoomOnPan](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-zoomOnPan).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		getZoomOnPan? (): boolean;
		/** 
		 * Sets the value of [axes](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-axes).
		 * @method
		 * @public (method)
		 * @param   {object|any[]} axes The new value.
		 * @returns {void}              
		...
		setEnabled? (enabled: boolean): void;
		/** 
		 * Sets the value of [hideLabelInGesture](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-hideLabelInGesture).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [maxZoom](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-maxZoom).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [minZoom](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-minZoom).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [modeToggleButton](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-modeToggleButton).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [showOverflowArrows](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-showOverflowArrows).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [zoomOnPan](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-zoomOnPan).
		 * @method
		 * @public (method)
		 * @param   {boolean} zoomOnPan The new value.
		 * @returns {void}              
		 */
		setZoomOnPan? (zoomOnPan: boolean): void;
		/** 
		 * Sets the value of [zoomOnPanGesture](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-zoomOnPanGesture).
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.chart.interactions.Rotate](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Rotate.html)
	...
	class Rotate extends Ext.chart.interactions.Abstract {
		...
		getEnabled? (): boolean;
		/** 
		 * Returns the value of [gestures](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Rotate.html#cfg-gestures).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		setEnabled? (enabled: boolean): void;
		/** 
		 * Sets the value of [gestures](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Rotate.html#cfg-gestures).
		 * @method
		 * @public (method)
		 * @param   {object} gestures The new value.
		 * @returns {void}            
		...
		/** 
		 * Returns the value of [gesture](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Rotate.html#cfg-gesture).
		 * @method
		 * @private (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Returns the value of [rotation](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Rotate.html#cfg-rotation).
		 * @method
		 * @private (method)
		 * @returns {number}  
		 */
		...
		removeChartListener? (chart: object): void;
		/** 
		 * Sets the value of [gesture](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Rotate.html#cfg-gesture).
		 * @method
		 * @private (method)
		 * @param   {string} gesture The new value.
		 * @returns {void}           
		...
		setGesture? (gesture: string): void;
		/** 
		 * Sets the value of [rotation](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.Rotate.html#cfg-rotation).
		 * @method
		 * @private (method)
	...
	/** 
	 * [Ext.chart.interactions.RotatePie3D](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.RotatePie3D.html)
...
declare namespace Ext.chart.interactions.Crosshair {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * to the [position](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.axis.Axis.html#cfg-position) must be provided.
		 * 
		 *    {
		 *        type: 'crosshair',
		 *        axes: {
		 ...
		 * 
		 * - `label` will use values from the [label](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.axis.Axis.html#cfg-label) config.
...
declare namespace Ext.chart.interactions.CrossZoom {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * <li>
		 * 
		 * An Object whose keys correspond to the [position](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.axis.Axis.html#cfg-position) of each
		 ...
		 *  <li>
		 *  
		 *  An Array of strings, each one corresponding to the [position](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.axis.Axis.html#cfg-position)
...
declare namespace Ext.chart.interactions.PanZoom {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * <li>
		 * 
		 * An Object with keys corresponding to the [position](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.axis.Axis.html#cfg-position) of each
		 * axis that should be made navigable. Each key's value can either be an Object with further
		 * configuration options for each axis or simply `true` for a default set of options.
		 * 
		 *    {
		 ...
		 * @configuration
		 * @optional
		 * @default {xtype: 'segmentedbutton', width: 200, defaults: {ui: 'default-toolbar'}, cls: Ext.baseCSSPrefix + 'panzoom-toggle', items: [{text: 'Pan', value: 'pan'}, {text: 'Zoom', value: 'zoom'}]}
		 * @type {object}
		 */
		modeToggleButton?: object;
		/** 
		 * A set of optional overrides for the overflow arrow sprites' options. Only relevant when
		 * [showOverflowArrows](https://docs.sencha.com/extjs/6.2.0/modern/Ext.chart.interactions.PanZoom.html#cfg-showOverflowArrows) is `true`.
		 * @configuration
		 * @optional
		 * @type {object}
		 */

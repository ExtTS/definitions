declare namespace Ext.draw {
	/** 
	 * [Ext.draw.Animator](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Animator.html)
	...
	/** 
	 * [Ext.draw.Container](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Container.html)
	 * The container that holds and manages instances of the [Ext.draw.Surface](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html)
	 * in which [sprites](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.sprite.Sprite.html) are rendered.  Draw containers are
	 ...
	 * sprite.  The _type_ of the sprite is [circle](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.sprite.Circle.html), so if you
	 * run this code you'll see a green circle.
	 * 
	 * You can attach sprite event listeners to the draw container with the help of the
	 * [Ext.draw.plugin.SpriteEvents](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.plugin.SpriteEvents.html) plugin.
	 * 
	 * For more information on sprites, the core elements added to a draw container's
	 * surface, refer to the [Ext.draw.sprite.Sprite](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.sprite.Sprite.html) documentation.
	 * 
	 * For more information on surfaces, the interface owned by the draw container used to
	 * manage all sprites, see the [Ext.draw.Surface](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html) documentation.
	 */
	class Container extends Ext.draw.ContainerBase {
		/** 
		 * The default URL used by [download](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Container.html#method-download).
		 * @property
		 * @public (property)
		 ...
		 * the [preview](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Container.html#method-preview) method instead. This method doesn't work in IE8.
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [resizeHandler](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Container.html#cfg-resizeHandler).
		 * @method
		 * @public (method)
		 * @returns {Function}  
		 */
	...
	/** 
	 * [Ext.draw.Draw](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Draw.html)
	 ...
	 * 
	 * When [get](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.LimitedCache.html#method-get) is called, the container will try to find the object in the list.
	 * If failed it will call the [feeder](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.LimitedCache.html#cfg-feeder) to create that object. If there are too many
	...
	/** 
	 * [Ext.draw.Matrix](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Matrix.html)
	 * Ext.draw.Matix is a utility class used to calculate
	 * [affine transformation](http://en.wikipedia.org/wiki/Affine_transformation) matrix.<br/>
	 * The matrix class is used to apply transformations to existing
	 * [sprites](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.sprite.Sprite.html) using a number of convenience transform
	 * methods.
	 * 
	 * Transformations configured directly on a sprite are processed in the following order:
	 * scaling, rotation, and translation.  The matrix class offers additional flexibility.<br/>
	 ...
	 * 
	 * To demonstrate, we'll start with a simple [rect](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.sprite.Rect.html) sprite
	 ...
	 *    });
	 * 
	 * Next, we'll use the [rotate](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Matrix.html#method-rotate) and [translate](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Matrix.html#method-translate) methods from our matrix
	 ...
	 * 
	 * 1. [Ext.draw.Matrix](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Matrix.html) is not read only
	...
	class Matrix extends Ext.Base {
		 ...
		 * Use [getXX](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Matrix.html#method-getXX) instead.
		 * @property
		 * @public (property)
		 * @type {number}
		 */
	...
	/** 
	 * [Ext.draw.Path](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Path.html)
	 ...
	 * 
	 * **From override Ext.draw.overrides.hittest.Path:** Adds hit testing and path intersection points methods to the [Ext.draw.Path](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Path.html).
	 * Included by the [Ext.draw.PathUtil](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.PathUtil.html).
	 */
	...
	/** 
	 * Singleton that provides methods used by the [Ext.draw.Path](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Path.html)
	 * for hit testing and finding path intersection points.
	 * @private (class)
	 */
	class PathUtil extends Ext.Base {}
	/** 
	 * [Ext.draw.Point](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Point.html)
	 * A helper class to facilitate common operations on points and vectors.
	 */
	class Point extends Ext.Base {
		/** 
		 * Creates a flyweight [Ext.draw.Point](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Point.html) instance.
		 * Takes the same parameters as the [constructor](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Point.html#method-constructor).
		 ...
		 */
		static fly? (point: number | number[] | object | Ext.draw.Point): Ext.draw.Point;
		/** 
		 * Creates a point.
		 * 
		 ...
		 */
		constructor (x: number | number[] | object | Ext.draw.Point, y: number | number[] | object | Ext.draw.Point);
		/** 
		 ...
		 * @returns {Ext.draw.Point}                          
		 */
		add? (x: number | number[] | object | Ext.draw.Point, y: number | number[] | object | Ext.draw.Point): Ext.draw.Point;
		/** 
		 ...
		 * @returns {number}                                  
		 */
		dot? (x: number | number[] | object | Ext.draw.Point, y: number | number[] | object | Ext.draw.Point): number;
		/** 
		 ...
		 * @returns {boolean}                                 
		 */
		equals? (x: number | number[] | object | Ext.draw.Point, y: number | number[] | object | Ext.draw.Point): boolean;
		/** 
		 ...
		 * @method
		 * @public (method)
		 * @param   {number}         [factor] Multiplication factor. Defaults to 1.
		 * @returns {Ext.draw.Point}          
		 */
		 ...
		 * @returns {void}                                    
		 */
		set? (x: number | number[] | object | Ext.draw.Point, y: number | number[] | object | Ext.draw.Point): void;
		/** 
		 ...
		 * @returns {Ext.draw.Point}                          
		 */
		sub? (x: number | number[] | object | Ext.draw.Point, y: number | number[] | object | Ext.draw.Point): Ext.draw.Point;
		/** 
	...
	/** 
	 * [Ext.draw.SegmentTree](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.SegmentTree.html)
	...
	class SegmentTree extends Ext.Base {
		...
		/** 
		 * Returns the value of [strategy](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.SegmentTree.html#cfg-strategy).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Sets the value of [strategy](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.SegmentTree.html#cfg-strategy).
		 * @method
		 * @public (method)
	...
	/** 
	 * [Ext.draw.Surface](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html)
	 * A surface is an interface to render [sprites](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.sprite.Sprite.html) inside a
	 * [draw container](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Container.html).  The surface API has methods to render
	 ...
	 * 
	 * One of the more useful methods is the [add](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#method-add) method used to add sprites to the
	 * surface:
	 * 
	 ...
	 * until you call the surface's [renderFrame](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#method-renderFrame)
	 * method.  This must be done after adding, removing, or modifying sprites in order to
	 * see the changes on-screen.
	 * 
	 * **From override Ext.draw.overrides.hittest.Surface:** Adds hit testing methods to the [Ext.draw.Surface](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html).
	 * Included by the [Ext.draw.plugin.SpriteEvents](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.plugin.SpriteEvents.html).
	 */
	class Surface extends Ext.draw.SurfaceBase {
		 ...
		 * See [Ext.draw.sprite.Sprite](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.sprite.Sprite.html) for the configuration object to be passed into this method.
		 * 
		 * For example:
		 * 
		...
		/** 
		 * Returns the value of [background](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#cfg-background).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the value of [dirty](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#cfg-dirty).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		getDirty? (): boolean;
		/** 
		 * Returns the value of [flipRtlText](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#cfg-flipRtlText).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [items](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#cfg-items).
		 * @method
		 * @public (method)
		 * @returns {any[]}  
		 */
		getItems? (): any[];
		/** 
		 * Returns the value of [rect](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#cfg-rect).
		 * @method
		 * @public (method)
		 * @returns {any[]}  
		 */
		 ...
		 * converts event's page coordinates to surface coordinates before calling [hitTest](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#method-hitTest).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [background](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#cfg-background).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [dirty](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#cfg-dirty).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [flipRtlText](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#cfg-flipRtlText).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [items](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#cfg-items).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [rect](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#cfg-rect).
		 * @method
		 * @public (method)
	 ...
	 * @private (class)
	 */
	class SurfaceBase extends Ext.Widget {}
	/** 
	 * [Ext.draw.TextMeasurer](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.TextMeasurer.html)
	...
	/** 
	 * [Ext.draw.TimingFunctions](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.TimingFunctions.html)
...
declare namespace Ext.draw.Point {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.draw.Point}                              
		 */
		fly? (point: number | number[] | object | Ext.draw.Point): Ext.draw.Point;
	}
}
declare namespace Ext.draw.Container.methodParams.download {
	 ...
	 * [Ext.draw.Container.download](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Container.html#method-download)
...
declare namespace Ext.draw.Surface.methodParams.flatten {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.draw.Surface.flatten](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#method-flatten)
...
declare namespace Ext.draw.Surface.methodReturns {
	 ...
	 * [Ext.draw.Surface.getBBox](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Surface.html#method-getBBox)
	 */
...
declare namespace Ext.draw.Container {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * 
		 * **Note:** since resize events trigger [renderFrame](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.Container.html#method-renderFrame) calls automatically,
...
declare namespace Ext.draw.LimitedCache {
	 ...
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.draw.LimitedCache](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.LimitedCache.html)
	 * Limited cache is a size limited cache container that stores limited number of objects.
	 * 
	 * When [get](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.LimitedCache.html#method-get) is called, the container will try to find the object in the list.
	 * If failed it will call the [feeder](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.LimitedCache.html#cfg-feeder) to create that object. If there are too many
	...
	interface Cfg extends Ext.base.Configs {
		...
		limit?: number;
		/** 
		 * The scope for [feeder](https://docs.sencha.com/extjs/6.2.0/modern/Ext.draw.LimitedCache.html#cfg-feeder)
		 * @configuration
		 * @optional
		 * @type {object}
		 */

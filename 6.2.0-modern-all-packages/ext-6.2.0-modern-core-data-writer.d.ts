declare namespace Ext.data.writer {
	/** 
	 * [Ext.data.writer.Json](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html)
	 * This class is used to write [Ext.data.Model](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html) data to the server in a JSON format.
	 * The [allowSingle](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-allowSingle) configuration can be set to false to force the records to always
	...
	class Json extends Ext.data.writer.Writer {
		...
		destroy? (): void;
		/** 
		 * Returns the value of [allDataOptions](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-allDataOptions).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the value of [allowSingle](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-allowSingle).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [clientIdProperty](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-clientIdProperty).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Returns the value of [dateFormat](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-dateFormat).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Returns the value of [encode](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-encode).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		getEncode? (): boolean;
		/** 
		 * Returns the value of [expandData](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-expandData).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [nameProperty](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-nameProperty).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Returns the value of [partialDataOptions](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-partialDataOptions).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		...
		/** 
		 * Returns the value of [rootProperty](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-rootProperty).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Returns the value of [transform](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-transform).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [writeAllFields](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-writeAllFields).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Returns the value of [writeRecordId](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-writeRecordId).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		...
		/** 
		 * Sets the value of [allDataOptions](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-allDataOptions).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [allowSingle](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-allowSingle).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [clientIdProperty](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-clientIdProperty).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [dateFormat](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-dateFormat).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [encode](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-encode).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [expandData](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-expandData).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [nameProperty](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-nameProperty).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [partialDataOptions](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-partialDataOptions).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [rootProperty](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-rootProperty).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [transform](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-transform).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [writeAllFields](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-writeAllFields).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [writeRecordId](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-writeRecordId).
		 * @method
		 * @public (method)
		...
		/** 
		 * Prepares a Proxy's [Ext.data.Request](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Request.html) object.
		 * @method
		 * @public (method)
		 ...
		 * writer must support converting the flat [Ext.data.Model](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html) structure back into the original nested data
		 ...
		 *    }
		 * 
		 * This behavior is governed by the [expandData](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-expandData) config. By default, this option is `false` for
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.writer.Writer.writeRecords](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#method-writeRecords).
		 * Write the record data to the request in the appropriate format.
		 * @method
		 * @protected (method)
	...
	/** 
	 * [Ext.data.writer.Writer](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html)
	 * Base Writer class used by most subclasses of [Ext.data.proxy.Server](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.Server.html). This class
	 * is responsible for taking a set of [Ext.data.operation.Operation](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.operation.Operation.html) objects and a
	 * [Ext.data.Request](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Request.html) object and modifying that request based on the Operations.
	 * 
	 * For example a [Ext.data.writer.Json](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html) would format the Operations and their
	 * [Ext.data.Model](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html) instances based on the config options passed to the JsonWriter's
	 * constructor.
	 * 
	 * Writers are not needed for any kind of local storage - whether via a
	 * [Web Storage proxy](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.WebStorage.html) (see
	 * [localStorage](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.LocalStorage.html) and
	 * [sessionStorage](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.SessionStorage.html))
	 * or just in memory via a [MemoryProxy](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.Memory.html).
	 * 
	 * # Dates
	 * 
	 * Before sending dates to the server, they can be formatted using an [Ext.Date](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Date.html)
	 ...
	 * 
	 * - [Writer.dateFormat](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-dateFormat) The writer `dateFormat` will always have the
	 *   highest precedence.
	 * - [Ext.data.field.Date.dateWriteFormat](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.field.Date.html#cfg-dateWriteFormat) The `dateWriteFormat` given to the field
	 *   instance. This is handled by [Ext.data.field.Date.serialize](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.field.Date.html#method-serialize).
	 * - [Field.dateFormat](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.field.Date.html#cfg-dateFormat) This is handled by the field's
	 *   `serialize` method.
	 * - [Field.dateReadFormat](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.field.Date.html#cfg-dateReadFormat) Also handled by the
	...
	/** 
	 * [Ext.data.writer.Xml](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Xml.html)
	 * This class is used to write [Ext.data.Model](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html) data to the server in an XML format.
	 * The [documentRoot](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Xml.html#cfg-documentRoot) property is used to specify the root element in the XML document.
	 * The [record](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Xml.html#cfg-record) option is used to specify the element name for each record that will make up the XML document.
	 */
	class Xml extends Ext.data.writer.Writer {
		...
		getDateFormat? (): string;
		/** 
		 * Returns the value of [defaultDocumentRoot](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Xml.html#cfg-defaultDocumentRoot).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Returns the value of [documentRoot](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Xml.html#cfg-documentRoot).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Returns the value of [header](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Xml.html#cfg-header).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		getPartialDataOptions? (): object;
		/** 
		 * Returns the value of [record](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Xml.html#cfg-record).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		setDateFormat? (dateFormat: string): void;
		/** 
		 * Sets the value of [defaultDocumentRoot](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Xml.html#cfg-defaultDocumentRoot).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [documentRoot](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Xml.html#cfg-documentRoot).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [header](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Xml.html#cfg-header).
		 * @method
		 * @public (method)
		...
		setPartialDataOptions? (partialDataOptions: object): void;
		/** 
		 * Sets the value of [record](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Xml.html#cfg-record).
		 * @method
		 * @public (method)
...
declare namespace Ext.data.writer.Json {
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * This object contains the options passed to [`Ext.data.Model.getData`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html#method-getData) when
		 * writing [`Ext.data.Model.phantom`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html#property-phantom) records or when `writeAllFields` is set
		 * to `true`.
		 * 
		...
		allowSingle?: boolean;
		/** 
		 * When specified this property causes the [`Ext.data.Model.idProperty`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html#cfg-idProperty) of
		 ...
		 * You can use [`Ext.data.Model.identifier`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html#cfg-identifier) to produce identifiers that
		 ...
		 *     }
		 * 
		 * While this config provides the behavior of [`Ext.data.Model.clientIdProperty`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html#cfg-clientIdProperty)
		 * from previous releases, this property is not as useful as a suitable
		 * [`Ext.data.Model.identifier`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html#cfg-identifier) due to id's appearing in foreign-key fields
		 * and in [`Ext.data.Model.manyToMany`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html#cfg-manyToMany) associations.
		 * 
		 * See [`Ext.data.Model.identifier`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html#cfg-identifier) for more on id generation.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		...
		dateFormat?: string;
		/** 
		 * Configure `true` to send record data (all record fields if [writeAllFields](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-writeAllFields) is `true`)
		 * as a JSON encoded HTTP parameter named by the [rootProperty](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-rootProperty) configuration.
		 * 
		 * The encode option should only be set to true when a [rootProperty](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-rootProperty) is defined, because the values will be
		...
		encode?: boolean;
		/** 
		 * By default, when dot-delimited field [mappings](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-nameProperty) are
		 ...
		 * by [getExpandedData](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#method-getExpandedData), which can optionally be overridden to apply more customized logic.
		 * @configuration
		 * @optional
		 * @default false
		 * @type {boolean}
		...
		/** 
		 * This object contains the options passed to [`Ext.data.Model.getData`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html#method-getData) when
		 * writing non [`Ext.data.Model.phantom`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html#property-phantom) records or when `writeAllFields` is
		 * set to `false`.
		 * 
		 * _NOTE:_ The `serialize` option cannot be used here.
		 * @configuration
		 ...
		 * [encode](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Json.html#cfg-encode) option is `true`.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		rootProperty?: string;
		/** 
		 * If a transform function is set, it will be invoked just before [writeRecords](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#method-writeRecords)
		 * executes. It is passed the unserialized data object and the [request](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Request.html)
		 ...
		 * that any fields that have [`Ext.data.field.Field.persist`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.field.Field.html#cfg-persist) set to `false`
		 * will still be ignored while those with [`Ext.data.field.Field.critical`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.field.Field.html#cfg-critical)
		 ...
		 * `true` when writing [`Ext.data.Model.phantom`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html#property-phantom) records.
		 * 
		 ...
		 * [`Ext.data.Model.phantom`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.Model.html#property-phantom) state.
		 * 
		 ...
		 * and so would not be sent to the server unless [writeAllFields](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Writer.html#cfg-writeAllFields) was
		 * explicitly enabled.
		 * 
...
declare namespace Ext.data.writer.Xml {
	...
	interface Cfg extends Ext.base.Configs {
		...
		dateFormat?: string;
		/** 
		 * The root to be used if [documentRoot](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Xml.html#cfg-documentRoot) is empty and a root is required
		 ...
		 * 
		 * If the [record](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.writer.Xml.html#cfg-record) mapping includes a root element name, eg: "SystemInfo>Operation", and
		 ...
		 * the owning [Proxy](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.Proxy.html)'s [Reader](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.reader.Xml.html)'s
		 * [Ext.data.reader.Xml.record](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.reader.Xml.html#cfg-record) setting, or `'record'`.
		 * @configuration
		 * @optional
		 * @default 'record'
		 * @type {string}

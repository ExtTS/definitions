declare namespace Ext.mixin {
	 ...
	 * @private (class)
	 */
	class Accessible extends Ext.Mixin {}
	/** 
	...
	/** 
	 * A mixin that gives [Ext.Component](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Component.html) and [Ext.Widget](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Widget.html) the ability to process the "delegate"
	 * event option.
	 * @private (class)
	 */
	class ComponentDelegation extends Ext.Mixin {}
	/** 
	 * @private (class)
	 */
	class ConfigState extends Ext.Mixin {}
	/** 
	 * Common methods for both classic &amp; modern containers
	 * @private (class)
	 */
	class Container extends Ext.Mixin {}
	/** 
	 * [Ext.mixin.Dirty](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Dirty.html)
	 * This mixin provides a `dirty` config that tracks the modified state of an object. If
	 * the class using this mixin is [observable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Observable.html), changes to the
	 * `dirty` config will fire the `dirtychange` event.
	 */
	class Dirty extends Ext.Base {
		/** 
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.mixin.Dirty.Statics}
		 */
		self?: Ext.mixin.Dirty.Statics | Ext.Base.Statics;
		/** 
		 ...
		 * @returns {Ext.mixin.Dirty|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Dirty;
		 ...
		 * @returns {Ext.mixin.Dirty|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.mixin.Dirty;
		 ...
		 * @returns {Ext.mixin.Dirty|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.mixin.Dirty;
		 ...
		 * @returns {Ext.mixin.Dirty|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.mixin.Dirty;
		 ...
		 * @returns {Ext.mixin.Dirty|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Dirty;
		 ...
		 * @returns {Ext.mixin.Dirty|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.mixin.Dirty;
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Dirty.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.mixin.Dirty.Statics;
		 ...
		 * @returns {Ext.mixin.Dirty|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.mixin.Dirty;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * [Ext.mixin.Factoryable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Factoryable.html)
	 * This mixin automates use of [`Ext.Factory`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Factory.html). When mixed in to a class, the `alias` of the
	 * class is retrieved and combined with an optional `factoryConfig` property on that class
	 * to produce the configuration to pass to [`Ext.Factory`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Factory.html).
	 * 
	 * The factory method created by [`Ext.Factory`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Factory.html) is also added as a static method to the
	 * target class.
	 * 
	 ...
	 * 
	 * Alternatively the produced factory is available as a static method of [`Ext.Factory`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Factory.html).
	 */
	class Factoryable extends Ext.Base {
		/** 
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.mixin.Factoryable.Statics}
		 */
		self?: Ext.mixin.Factoryable.Statics | Ext.Base.Statics;
		/** 
		 * Add methods / properties to the prototype of this class.
		 * 
		 *    Ext.define('My.awesome.Cat', {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Factoryable|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Factoryable;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @chainable
		 * @param   {object}                         members
		 * @returns {Ext.mixin.Factoryable|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.mixin.Factoryable;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.mixin.Factoryable|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.mixin.Factoryable;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Factoryable|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.mixin.Factoryable;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.mixin.Factoryable|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Factoryable;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Call the original method that was previously overridden with [override](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#static-method-override)
		 * 
		 ...
		 * @returns {Ext.mixin.Factoryable|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.mixin.Factoryable;
		initConfig? (config: object): Ext.Base;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Factoryable.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.mixin.Factoryable.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 * This method applies a versioned, deprecation declaration to this class. This
		 * is typically called by the `deprecated` config.
		 ...
		 * @returns {Ext.mixin.Factoryable|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.mixin.Factoryable;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * @private (class)
	 */
	class Hookable extends Ext.Mixin {}
	/** 
	 * An Identifiable mixin.
	 * @private (class)
	 */
	class Identifiable extends Ext.Base {}
	/** 
	 ...
	 * @private (class)
	 */
	class Inheritable extends Ext.Mixin {}
	/** 
	 * [Ext.mixin.Keyboard](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Keyboard.html)
	 * A mixin for components that need to interact with the keyboard. The primary config
	 * for this class is the [`keyMap`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Keyboard.html#cfg-keyMap) config. This config is an object
	 * with key names as its properties and with values that describe how the key event
	 * should be handled.
	 * 
	 * Key names may key name as documented in [`Ext.event.Event`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.event.Event.html), numbers (which are treated
	 * as `keyCode` values), single characters (for those that are not defined in
	 * [`Ext.event.Event`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.event.Event.html)) or `charCode` values prefixed by '#' (e.g., "#65" for `charCode=65`).
	 * 
	 ...
	 * interpreted.
	 */
	class Keyboard extends Ext.Base {
		/** 
		 * Get the reference to the current class from which this object was instantiated. Unlike [statics](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#method-statics),
		 * `this.self` is scope-dependent and it's meant to be used for dynamic inheritance. See [statics](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#method-statics)
		 * for a detailed comparison
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.mixin.Keyboard.Statics}
		 */
		self?: Ext.mixin.Keyboard.Statics | Ext.Base.Statics;
		/** 
		 * Add methods / properties to the prototype of this class.
		 * 
		 *    Ext.define('My.awesome.Cat', {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Keyboard|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Keyboard;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @chainable
		 * @param   {object}                      members
		 * @returns {Ext.mixin.Keyboard|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.mixin.Keyboard;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.mixin.Keyboard|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.mixin.Keyboard;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Keyboard|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.mixin.Keyboard;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.mixin.Keyboard|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Keyboard;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Call the original method that was previously overridden with [override](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#static-method-override)
		 * 
		 ...
		 * @returns {Ext.mixin.Keyboard|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.mixin.Keyboard;
		initConfig? (config: object): Ext.Base;
		/** 
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Keyboard.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.mixin.Keyboard.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 * This method applies a versioned, deprecation declaration to this class. This
		 * is typically called by the `deprecated` config.
		 ...
		 * @returns {Ext.mixin.Keyboard|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.mixin.Keyboard;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * [Ext.mixin.Mashup](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Mashup.html)
	 * This mixin allows users to easily require external scripts in their classes. This load
	 * process delays application launch ([`Ext.onReady`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.html#method-onReady)) until all such scripts are loaded
	...
	class Mashup extends Ext.Base {
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.mixin.Mashup.Statics}
		 */
		self?: Ext.mixin.Mashup.Statics | Ext.Base.Statics;
		/** 
		 * Add methods / properties to the prototype of this class.
		 * 
		 *    Ext.define('My.awesome.Cat', {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Mashup|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Mashup;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @chainable
		 * @param   {object}                    members
		 * @returns {Ext.mixin.Mashup|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.mixin.Mashup;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.mixin.Mashup|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.mixin.Mashup;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Mashup|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.mixin.Mashup;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.mixin.Mashup|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Mashup;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Call the original method that was previously overridden with [override](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#static-method-override)
		 * 
		 ...
		 * @returns {Ext.mixin.Mashup|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.mixin.Mashup;
		initConfig? (config: object): Ext.Base;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Mashup.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.mixin.Mashup.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 * This method applies a versioned, deprecation declaration to this class. This
		 * is typically called by the `deprecated` config.
		 ...
		 * @returns {Ext.mixin.Mashup|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.mixin.Mashup;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * [Ext.mixin.Observable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Observable.html)
	 ...
	 * 
	 * _Note_: This mixin requires the constructor to be called, which is typically done
	 * during the construction of your object. The Observable constructor will call
	 * [initConfig](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Observable.html#method-initConfig), so it does not need to be called a second time.
	 * 
	 * For example:
	 * 
	 *    Ext.define('Employee', {
	...
	class Observable extends Ext.Base {
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.mixin.Observable.Statics}
		 */
		self?: Ext.mixin.Observable.Statics | Ext.Base.Statics;
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Observable|Ext.Base}            
		 */
		 ...
		 * @chainable
		 * @param   {object}                        members
		 * @returns {Ext.mixin.Observable|Ext.Base}         this
		 */
		 ...
		 * @returns {void}                        
		 */
		static capture? (o: Ext.util.Observable, fn: ExtGlobalFunction, scope?: object): void;
		/** 
		 * Create a new instance of this Class.
		 * 
		 *    Ext.define('My.cool.Class', {
		 ...
		 * add. See [addListener](https://docs.sencha.com/extjs/6.2.0/modern/Ext.util.Observable.html#method-addListener).
		 * @returns {void}               
		 */
		static observe? (c: ExtGlobalFunction, listeners: object): void;
		/** 
		 * Override members of this class. Overridden methods can be invoked via
		 * [callParent](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#method-callParent).
		 * 
		 ...
		 * @param   {object|Ext.mixin.Observable.methodParams.addListener.Options} [options]
		 ...
		 * 
		 */
		addListener? (eventName: string | object, fn?: ExtGlobalFunction | string, scope?: object, options?: object | Ext.mixin.Observable.methodParams.addListener.Options, order?: string): object;
		/** 
		 ...
		 * The scope (`this` reference) in which the handler function is
		 * executed. **If omitted, defaults to the object which fired the event.**
		 * @param   {object|Ext.mixin.Observable.methodParams.on.Options} [options]
		 * An object containing handler configuration.
		 * 
		 * **Note:** The options object will also be passed as the last argument to every
		 * event handler.
		 ...
		 * 
		 */
		on? (eventName: string | object, fn?: ExtGlobalFunction | string, scope?: object, options?: object | Ext.mixin.Observable.methodParams.on.Options, order?: string): object;
		/** 
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Observable.Statics|Ext.Base.Statics}  
		 */
	...
	/** 
	 * [Ext.mixin.Pluggable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Pluggable.html)
	 ...
	 * 
	 * While [`Ext.Component`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Component.html) in the Classic Toolkit supports `plugins`, it does not use this
	 ...
	 */
	class Pluggable extends Ext.Base {
		/** 
		 * Get the reference to the current class from which this object was instantiated. Unlike [statics](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#method-statics),
		 * `this.self` is scope-dependent and it's meant to be used for dynamic inheritance. See [statics](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#method-statics)
		 * for a detailed comparison
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.mixin.Pluggable.Statics}
		 */
		self?: Ext.mixin.Pluggable.Statics | Ext.Base.Statics;
		/** 
		 * Add methods / properties to the prototype of this class.
		 * 
		 *    Ext.define('My.awesome.Cat', {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Pluggable|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Pluggable;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @chainable
		 * @param   {object}                       members
		 * @returns {Ext.mixin.Pluggable|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.mixin.Pluggable;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.mixin.Pluggable|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.mixin.Pluggable;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Pluggable|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.mixin.Pluggable;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.mixin.Pluggable|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Pluggable;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Call the original method that was previously overridden with [override](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#static-method-override)
		 * 
		 ...
		 * @returns {Ext.mixin.Pluggable|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.mixin.Pluggable;
		initConfig? (config: object): Ext.Base;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Pluggable.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.mixin.Pluggable.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 * This method applies a versioned, deprecation declaration to this class. This
		 * is typically called by the `deprecated` config.
		 ...
		 * @returns {Ext.mixin.Pluggable|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.mixin.Pluggable;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * A Traversable mixin.
	 * @private (class)
	 */
	class Progressable extends Ext.Mixin {}
	/** 
	 * A mixin for providing query related methods for [Ext.ComponentQuery](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ComponentQuery.html) for classes that
	 * implement getRefItems.
	 * @private (class)
	 */
	class Queryable extends Ext.Base {}
	/** 
	 * [Ext.mixin.Responsive](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Responsive.html)
	 ...
	 *     });
	 * 
	 * To use responsiveConfig the class must be defined using the [Ext.mixin.Responsive](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Responsive.html) mixin.
	 * 
	 ...
	 *  In those cases, the viewport plugin inherits from [`Ext.plugin.Responsive`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.plugin.Responsive.html).
	 * 
	 * For details see [`responsiveConfig`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Responsive.html#cfg-responsiveConfig).
	 */
	class Responsive extends Ext.Base {
		/** 
		 * Get the reference to the current class from which this object was instantiated. Unlike [statics](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#method-statics),
		 * `this.self` is scope-dependent and it's meant to be used for dynamic inheritance. See [statics](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#method-statics)
		 * for a detailed comparison
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.mixin.Responsive.Statics}
		 */
		self?: Ext.mixin.Responsive.Statics | Ext.Base.Statics;
		/** 
		 * Add methods / properties to the prototype of this class.
		 * 
		 *    Ext.define('My.awesome.Cat', {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Responsive|Ext.Base}            
		 */
		 ...
		 * @chainable
		 * @param   {object}                        members
		 * @returns {Ext.mixin.Responsive|Ext.Base}         this
		 */
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Responsive.Statics|Ext.Base.Statics}  
		 */
	 ...
	 * @private (class)
	 */
	class Selectable extends Ext.Mixin {}
	/** 
	 * @private (class)
	 */
	class StyleCacher extends Ext.Mixin {}
	class Templatable extends Ext.Mixin {
		/** 
		 * Get the reference to the current class from which this object was instantiated. Unlike [statics](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#method-statics),
		 * `this.self` is scope-dependent and it's meant to be used for dynamic inheritance. See [statics](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#method-statics)
		 * for a detailed comparison
		 ...
		 * @protected (property)
		 * @default Ext.Base
		 * @type {Ext.mixin.Templatable.Statics}
		 */
		self?: Ext.mixin.Templatable.Statics | Ext.Mixin.Statics | Ext.Base.Statics;
		/** 
		 * Add methods / properties to the prototype of this class.
		 * 
		 *    Ext.define('My.awesome.Cat', {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Templatable|Ext.Mixin|Ext.Base}            
		 */
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Templatable;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Mixin;
		static addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @chainable
		 * @param   {object}                                   members
		 * @returns {Ext.mixin.Templatable|Ext.Mixin|Ext.Base}         this
		 */
		static addStatics? (members: object): typeof Ext.mixin.Templatable;
		static addStatics? (members: object): typeof Ext.Mixin;
		static addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.mixin.Templatable|Ext.Mixin|Ext.Base}        
		 */
		static addMember? (name: object, member: object): typeof Ext.mixin.Templatable;
		static addMember? (name: object, member: object): typeof Ext.Mixin;
		static addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Templatable|Ext.Mixin|Ext.Base}       
		 */
		static onExtended? (fn: object, scope: object): typeof Ext.mixin.Templatable;
		static onExtended? (fn: object, scope: object): typeof Ext.Mixin;
		static onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
		 ...
		 * @returns {Ext.mixin.Templatable|Ext.Mixin|Ext.Base}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Templatable;
		setConfig? (name: string | object, value?: object): Ext.Mixin;
		setConfig? (name: string | object, value?: object): Ext.Base;
		/** 
		 * Call the original method that was previously overridden with [override](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#static-method-override)
		 * 
		 ...
		 * @returns {Ext.mixin.Templatable|Ext.Mixin|Ext.Base}        this
		 */
		initConfig? (config: object): Ext.mixin.Templatable;
		initConfig? (config: object): Ext.Mixin;
		initConfig? (config: object): Ext.Base;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Templatable.Statics|Ext.Mixin.Statics|Ext.Base.Statics}  
		 */
		statics? (): Ext.mixin.Templatable.Statics;
		statics? (): Ext.Mixin.Statics;
		statics? (): Ext.Base.Statics;
		/** 
		 * This method applies a versioned, deprecation declaration to this class. This
		 * is typically called by the `deprecated` config.
		 ...
		 * @returns {Ext.mixin.Templatable|Ext.Mixin|Ext.Base}       this
		 */
		unlink? (names: string[]): Ext.mixin.Templatable;
		unlink? (names: string[]): Ext.Mixin;
		unlink? (names: string[]): Ext.Base;
	}
	/** 
	 * A Traversable mixin.
	 * @private (class)
	 */
	class Traversable extends Ext.Mixin {}
}
declare namespace Ext.mixin.Dirty {
	/** 
	 * @definitions
	 ...
	 * `dirty` config will fire the `dirtychange` event.
	 */
	interface Def extends Ext.mixin.Dirty {
		/** 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.mixin.Dirty.Cfg}
		 */
		config?: Ext.mixin.Dirty.Cfg;
		/** 
		 ...
		 * @type {Ext.mixin.Dirty.Statics}
		 */
		statics?: (() => Ext.mixin.Dirty.Statics | Ext.Base.Statics) | Ext.mixin.Dirty.Statics | any;
	}
}
declare namespace Ext.mixin.Factoryable {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.mixin.Factoryable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Factoryable.html)
	 ...
	 * Alternatively the produced factory is available as a static method of [`Ext.Factory`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Factory.html).
	 */
	interface Def extends Ext.mixin.Factoryable {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @type {Ext.mixin.Factoryable.Statics}
		 */
		statics?: (() => Ext.mixin.Factoryable.Statics | Ext.Base.Statics) | Ext.mixin.Factoryable.Statics | any;
	}
}
declare namespace Ext.mixin.Keyboard {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.mixin.Keyboard](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Keyboard.html)
	 ...
	 * interpreted.
	 */
	interface Def extends Ext.mixin.Keyboard {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.mixin.Keyboard.Cfg}
		 */
		config?: Ext.mixin.Keyboard.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * @type {Ext.mixin.Keyboard.Statics}
		 */
		statics?: (() => Ext.mixin.Keyboard.Statics | Ext.Base.Statics) | Ext.mixin.Keyboard.Statics | any;
	}
}
declare namespace Ext.mixin.Mashup {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.mixin.Mashup](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Mashup.html)
	 ...
	 * @cmd.optimizer.requires.async
	 */
	interface Def extends Ext.mixin.Mashup {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @type {Ext.mixin.Mashup.Statics}
		 */
		statics?: (() => Ext.mixin.Mashup.Statics | Ext.Base.Statics) | Ext.mixin.Mashup.Statics | any;
	}
}
declare namespace Ext.mixin.Observable {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.mixin.Observable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Observable.html)
	 ...
	 * 
	 */
	interface Def extends Ext.mixin.Observable {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.mixin.Observable.Cfg}
		 */
		config?: Ext.mixin.Observable.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * @type {Ext.mixin.Observable.Statics}
		 */
		statics?: (() => Ext.mixin.Observable.Statics | Ext.Base.Statics) | Ext.mixin.Observable.Statics | any;
	}
}
declare namespace Ext.mixin.Pluggable {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.mixin.Pluggable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Pluggable.html)
	 ...
	 * **Important:** To ensure plugins are destroyed, call `setPlugins(null)`.
	 */
	interface Def extends Ext.mixin.Pluggable {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.mixin.Pluggable.Cfg}
		 */
		config?: Ext.mixin.Pluggable.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * @type {Ext.mixin.Pluggable.Statics}
		 */
		statics?: (() => Ext.mixin.Pluggable.Statics | Ext.Base.Statics) | Ext.mixin.Pluggable.Statics | any;
	}
}
declare namespace Ext.mixin.Responsive {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.mixin.Responsive](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Responsive.html)
	 ...
	 * For details see [`responsiveConfig`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Responsive.html#cfg-responsiveConfig).
	 */
	interface Def extends Ext.mixin.Responsive {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.mixin.Responsive.Cfg}
		 */
		config?: Ext.mixin.Responsive.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * @type {Ext.mixin.Responsive.Statics}
		 */
		statics?: (() => Ext.mixin.Responsive.Statics | Ext.Base.Statics) | Ext.mixin.Responsive.Statics | any;
	}
}
declare namespace Ext.mixin.Templatable {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.mixin.Templatable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Templatable.html)
	 */
	interface Def extends Ext.mixin.Templatable {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @type {Ext.mixin.Templatable.Statics}
		 */
		statics?: (() => Ext.mixin.Templatable.Statics | Ext.Mixin.Statics | Ext.Base.Statics) | Ext.mixin.Templatable.Statics | any;
	}
}
declare namespace Ext.mixin.Accessible {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Accessible](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Accessible.html)
	 * This mixin defines certain config options, properties, and APIs to be used
	 * by Components that implement accessible traits according to WAI-ARIA 1.0 specification.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Accessible|Ext.Mixin|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Accessible;
		 ...
		 * @chainable
		 * @param   {object}                                  members
		 * @returns {Ext.mixin.Accessible|Ext.Mixin|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Accessible;
		 ...
		 * @returns {Ext.mixin.Accessible|Ext.Mixin|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Accessible;
		 ...
		 * @returns {Ext.mixin.Accessible|Ext.Mixin|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Accessible;
...
declare namespace Ext.mixin.Bindable {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Bindable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Bindable.html)
	 * This class is intended as a mixin for classes that want to provide a "bind" config that
	 * connects to a `ViewModel`.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Bindable|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Bindable;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @chainable
		 * @param   {object}                      members
		 * @returns {Ext.mixin.Bindable|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Bindable;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.mixin.Bindable|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Bindable;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Bindable|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Bindable;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.mixin.ComponentDelegation {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.ComponentDelegation](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.ComponentDelegation.html)
	 * A mixin that gives [Ext.Component](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Component.html) and [Ext.Widget](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Widget.html) the ability to process the "delegate"
	 * event option.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.ComponentDelegation|Ext.Mixin|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.ComponentDelegation;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Mixin;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                           members
		 * @returns {Ext.mixin.ComponentDelegation|Ext.Mixin|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.ComponentDelegation;
		addStatics? (members: object): typeof Ext.Mixin;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.mixin.ComponentDelegation|Ext.Mixin|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.ComponentDelegation;
		addMember? (name: object, member: object): typeof Ext.Mixin;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.mixin.ComponentDelegation|Ext.Mixin|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.ComponentDelegation;
		onExtended? (fn: object, scope: object): typeof Ext.Mixin;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.ConfigState {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.ConfigState](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.ConfigState.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.ConfigState|Ext.Mixin|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.ConfigState;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Mixin;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                   members
		 * @returns {Ext.mixin.ConfigState|Ext.Mixin|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.ConfigState;
		addStatics? (members: object): typeof Ext.Mixin;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.mixin.ConfigState|Ext.Mixin|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.ConfigState;
		addMember? (name: object, member: object): typeof Ext.Mixin;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.mixin.ConfigState|Ext.Mixin|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.ConfigState;
		onExtended? (fn: object, scope: object): typeof Ext.Mixin;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Container {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Container](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Container.html)
	 * Common methods for both classic &amp; modern containers
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Container|Ext.Mixin|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Container;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Mixin;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                 members
		 * @returns {Ext.mixin.Container|Ext.Mixin|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Container;
		addStatics? (members: object): typeof Ext.Mixin;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.mixin.Container|Ext.Mixin|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Container;
		addMember? (name: object, member: object): typeof Ext.Mixin;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.mixin.Container|Ext.Mixin|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Container;
		onExtended? (fn: object, scope: object): typeof Ext.Mixin;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Dirty {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.Dirty|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Dirty;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Dirty|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Dirty;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.mixin.Dirty|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Dirty;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Dirty|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Dirty;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.mixin.Factoryable {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.Factoryable|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Factoryable;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Factoryable|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Factoryable;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.mixin.Factoryable|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Factoryable;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Factoryable|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Factoryable;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.mixin.Hookable {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Hookable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Hookable.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Hookable|Ext.Mixin|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Hookable;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Mixin;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                members
		 * @returns {Ext.mixin.Hookable|Ext.Mixin|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Hookable;
		addStatics? (members: object): typeof Ext.Mixin;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.mixin.Hookable|Ext.Mixin|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Hookable;
		addMember? (name: object, member: object): typeof Ext.Mixin;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.mixin.Hookable|Ext.Mixin|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Hookable;
		onExtended? (fn: object, scope: object): typeof Ext.Mixin;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Identifiable {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Identifiable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Identifiable.html)
	 * An Identifiable mixin.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Identifiable|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Identifiable;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @chainable
		 * @param   {object}                          members
		 * @returns {Ext.mixin.Identifiable|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Identifiable;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.mixin.Identifiable|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Identifiable;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Identifiable|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Identifiable;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.mixin.Inheritable {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Inheritable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Inheritable.html)
	 * A mixin that provides the functionality for inheritable configs. This allows linking
	 * components and containers via a prototype-chained object for accessing inherited
	 * values.
	 * 
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Inheritable|Ext.Mixin|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Inheritable;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Mixin;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                   members
		 * @returns {Ext.mixin.Inheritable|Ext.Mixin|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Inheritable;
		addStatics? (members: object): typeof Ext.Mixin;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.mixin.Inheritable|Ext.Mixin|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Inheritable;
		addMember? (name: object, member: object): typeof Ext.Mixin;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.mixin.Inheritable|Ext.Mixin|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Inheritable;
		onExtended? (fn: object, scope: object): typeof Ext.Mixin;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Keyboard {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.Keyboard|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Keyboard;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Keyboard|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Keyboard;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.mixin.Keyboard|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Keyboard;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Keyboard|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Keyboard;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.mixin.Mashup {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.Mashup|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Mashup;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Mashup|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Mashup;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.mixin.Mashup|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Mashup;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Mashup|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Mashup;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.mixin.Observable {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {void}                        
		 */
		capture? (o: Ext.util.Observable, fn: ExtGlobalFunction, scope?: object): void;
		/** 
		 * Create a new instance of this Class.
		 * 
		 *    Ext.define('My.cool.Class', {
		 ...
		 * @returns {void}               
		 */
		observe? (c: ExtGlobalFunction, listeners: object): void;
		/** 
		 * Override members of this class. Overridden methods can be invoked via
		 * [callParent](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#method-callParent).
		 * 
...
declare namespace Ext.mixin.Pluggable {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.Pluggable|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Pluggable;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Pluggable|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Pluggable;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.mixin.Pluggable|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Pluggable;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Pluggable|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Pluggable;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.mixin.Progressable {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Progressable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Progressable.html)
	 * A Traversable mixin.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Progressable|Ext.Mixin|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Progressable;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Mixin;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                    members
		 * @returns {Ext.mixin.Progressable|Ext.Mixin|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Progressable;
		addStatics? (members: object): typeof Ext.Mixin;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.mixin.Progressable|Ext.Mixin|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Progressable;
		addMember? (name: object, member: object): typeof Ext.Mixin;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.mixin.Progressable|Ext.Mixin|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Progressable;
		onExtended? (fn: object, scope: object): typeof Ext.Mixin;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Queryable {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Queryable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Queryable.html)
	 * A mixin for providing query related methods for [Ext.ComponentQuery](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ComponentQuery.html) for classes that
	 * implement getRefItems.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Queryable|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Queryable;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 * 
		 ...
		 * @chainable
		 * @param   {object}                       members
		 * @returns {Ext.mixin.Queryable|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Queryable;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 * 
		 ...
		 * @returns {Ext.mixin.Queryable|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Queryable;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 * 
		 ...
		 * @returns {Ext.mixin.Queryable|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Queryable;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
		 * @private (method)
...
declare namespace Ext.mixin.Selectable {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Selectable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Selectable.html)
	 * Tracks what records are currently selected in a databound widget. This class is mixed in to
	 * dataview and all subclasses.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Selectable|Ext.Mixin|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Selectable;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Mixin;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                  members
		 * @returns {Ext.mixin.Selectable|Ext.Mixin|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Selectable;
		addStatics? (members: object): typeof Ext.Mixin;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.mixin.Selectable|Ext.Mixin|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Selectable;
		addMember? (name: object, member: object): typeof Ext.Mixin;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.mixin.Selectable|Ext.Mixin|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Selectable;
		onExtended? (fn: object, scope: object): typeof Ext.Mixin;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.StyleCacher {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.StyleCacher](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.StyleCacher.html)
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 * Add methods / properties to the prototype of this class.
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.StyleCacher|Ext.Mixin|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.StyleCacher;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Mixin;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                   members
		 * @returns {Ext.mixin.StyleCacher|Ext.Mixin|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.StyleCacher;
		addStatics? (members: object): typeof Ext.Mixin;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.mixin.StyleCacher|Ext.Mixin|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.StyleCacher;
		addMember? (name: object, member: object): typeof Ext.Mixin;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.mixin.StyleCacher|Ext.Mixin|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.StyleCacher;
		onExtended? (fn: object, scope: object): typeof Ext.Mixin;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Templatable {
	...
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.mixin.Templatable|Ext.Mixin|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Templatable;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Mixin;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @returns {Ext.mixin.Templatable|Ext.Mixin|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Templatable;
		addStatics? (members: object): typeof Ext.Mixin;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.mixin.Templatable|Ext.Mixin|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Templatable;
		addMember? (name: object, member: object): typeof Ext.Mixin;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.mixin.Templatable|Ext.Mixin|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Templatable;
		onExtended? (fn: object, scope: object): typeof Ext.Mixin;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Traversable {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.mixin.Traversable](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Traversable.html)
	 * A Traversable mixin.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.mixin.Traversable|Ext.Mixin|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.mixin.Traversable;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Mixin;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 * Add / override static properties of this class.
		 ...
		 * @chainable
		 * @param   {object}                                   members
		 * @returns {Ext.mixin.Traversable|Ext.Mixin|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.mixin.Traversable;
		addStatics? (members: object): typeof Ext.Mixin;
		addStatics? (members: object): typeof Ext.Base;
		/** 
		 * Create a new instance of this Class.
		 ...
		 * @returns {Ext.mixin.Traversable|Ext.Mixin|Ext.Base}        
		 */
		addMember? (name: object, member: object): typeof Ext.mixin.Traversable;
		addMember? (name: object, member: object): typeof Ext.Mixin;
		addMember? (name: object, member: object): typeof Ext.Base;
		/** 
		 * Borrow another class' members to the prototype of this class.
		 ...
		 * @returns {Ext.mixin.Traversable|Ext.Mixin|Ext.Base}       
		 */
		onExtended? (fn: object, scope: object): typeof Ext.mixin.Traversable;
		onExtended? (fn: object, scope: object): typeof Ext.Mixin;
		onExtended? (fn: object, scope: object): typeof Ext.Base;
		/** 
		 * @method
...
declare namespace Ext.mixin.Observable.methodParams.addListener {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.mixin.Observable.addListener](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Observable.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.mixin.Observable.methodParams.on {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.mixin.Observable.on](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Observable.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.mixin.Accessible {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * The selector works the same way as [ariaLabelledBy](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Accessible.html#cfg-ariaLabelledBy).
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		 ...
		 * [ariaLabelledBy](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Accessible.html#cfg-ariaLabelledBy) option instead, because screen readers prefer
		 * `aria-labelledby` attribute to `aria-label`. [ariaLabel](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Accessible.html#cfg-ariaLabel) and
		 * [ariaLabelledBy](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Accessible.html#cfg-ariaLabelledBy) config options are mutually exclusive.
		 * @configuration
		 * @optional
		 * @type {string}
		 */
		 ...
		 * 
		 * [ariaLabelledBy](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Accessible.html#cfg-ariaLabelledBy) and [ariaLabel](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Accessible.html#cfg-ariaLabel) config options are
		 ...
		 * @chainable
		 * @param   {object}                       config
		 * @returns {Ext.mixin.Accessible.Statics}        this
		 */
		initConfig? (config: object): Ext.mixin.Accessible.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.mixin.Accessible.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Accessible.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Accessible.Statics}  
		 */
		statics? (): Ext.mixin.Accessible.Statics;
	}
}
declare namespace Ext.mixin.Bindable {
	/** 
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                     config
		 * @returns {Ext.mixin.Bindable.Statics}        this
		 */
		initConfig? (config: object): Ext.mixin.Bindable.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.mixin.Bindable.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Bindable.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Bindable.Statics}  
		 */
		statics? (): Ext.mixin.Bindable.Statics;
	}
}
declare namespace Ext.mixin.Container {
	/** 
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                      config
		 * @returns {Ext.mixin.Container.Statics}        this
		 */
		initConfig? (config: object): Ext.mixin.Container.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.mixin.Container.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Container.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Container.Statics}  
		 */
		statics? (): Ext.mixin.Container.Statics;
	}
}
declare namespace Ext.mixin.Dirty {
	/** 
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                  config
		 * @returns {Ext.mixin.Dirty.Statics}        this
		 */
		initConfig? (config: object): Ext.mixin.Dirty.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.mixin.Dirty.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Dirty.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Dirty.Statics}  
		 */
		statics? (): Ext.mixin.Dirty.Statics;
	}
}
declare namespace Ext.mixin.Keyboard {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                     config
		 * @returns {Ext.mixin.Keyboard.Statics}        this
		 */
		initConfig? (config: object): Ext.mixin.Keyboard.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.mixin.Keyboard.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Keyboard.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Keyboard.Statics}  
		 */
		statics? (): Ext.mixin.Keyboard.Statics;
	}
}
declare namespace Ext.mixin.Observable {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                       config
		 * @returns {Ext.mixin.Observable.Statics}        this
		 */
		initConfig? (config: object): Ext.mixin.Observable.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.mixin.Observable.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Observable.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Observable.Statics}  
		 */
		statics? (): Ext.mixin.Observable.Statics;
	}
}
declare namespace Ext.mixin.Pluggable {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                      config
		 * @returns {Ext.mixin.Pluggable.Statics}        this
		 */
		initConfig? (config: object): Ext.mixin.Pluggable.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.mixin.Pluggable.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Pluggable.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Pluggable.Statics}  
		 */
		statics? (): Ext.mixin.Pluggable.Statics;
	}
}
declare namespace Ext.mixin.Progressable {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                         config
		 * @returns {Ext.mixin.Progressable.Statics}        this
		 */
		initConfig? (config: object): Ext.mixin.Progressable.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.mixin.Progressable.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Progressable.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Progressable.Statics}  
		 */
		statics? (): Ext.mixin.Progressable.Statics;
	}
}
declare namespace Ext.mixin.Responsive {
	/** 
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 *   (see [`Ext.platformTags`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.html#property-platformTags)). The properties of this
		 ...
		 *   [`responsiveFormulas`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.mixin.Responsive.html#cfg-responsiveFormulas) overlaps and hides any of these properties).
		 ...
		 * @chainable
		 * @param   {object}                       config
		 * @returns {Ext.mixin.Responsive.Statics}        this
		 */
		initConfig? (config: object): Ext.mixin.Responsive.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.mixin.Responsive.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Responsive.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Responsive.Statics}  
		 */
		statics? (): Ext.mixin.Responsive.Statics;
	}
}
declare namespace Ext.mixin.Selectable {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * @chainable
		 * @param   {object}                       config
		 * @returns {Ext.mixin.Selectable.Statics}        this
		 */
		initConfig? (config: object): Ext.mixin.Selectable.Statics;
		/** 
		 * Sets a single/multiple configuration options.
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.mixin.Selectable.Statics}         this
		 */
		setConfig? (name: string | object, value?: object): Ext.mixin.Selectable.Statics;
		/** 
		 * Get the reference to the class from which this object was instantiated. Note that unlike [self](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Base.html#property-self),
		 * `this.statics()` is scope-independent and it always returns the class from which it was called, regardless of what
		 * `this` points to during run-time
		 ...
		 * @method
		 * @protected (method)
		 * @returns {Ext.mixin.Selectable.Statics}  
		 */
		statics? (): Ext.mixin.Selectable.Statics;
	}
}
declare namespace Ext.mixin.Dirty {
	/** 

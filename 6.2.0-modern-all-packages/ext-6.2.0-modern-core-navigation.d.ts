declare namespace Ext.navigation {
	/** 
	 * This component is used in [Ext.navigation.View](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html) to control animations in the toolbar. You should never need to
	 * interact with the component directly, unless you are subclassing it.
	 * @private (class)
	 */
	class Bar extends Ext.TitleBar {}
	/** 
	 * [Ext.navigation.View](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html)
	 * NavigationView is basically a [Ext.Container](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Container.html) with a [card](https://docs.sencha.com/extjs/6.2.0/modern/Ext.layout.Card.html) layout, so only one view
	 ...
	 *    });
	 * 
	 * As you can see, it is as simple as calling the [push](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#method-push) method, with a new view (instance or object). Done.
	 * 
	 * You can also `pop` a view at any time. This will remove the top-most view from the NavigationView, and animate back
	 * to the previous view. You can do this using the [pop](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#method-pop) method (which requires no arguments).
	 * 
	 *    view.pop();
	 * 
	 * Applications that need compatibility with ##Older Android## devices will want to see the [layout](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#cfg-layout) config for details on
	...
	class View extends Ext.Container {
		...
		getData? (): object;
		/** 
		 * Returns the value of [defaultBackButtonText](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#cfg-defaultBackButtonText).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		getInnerItems? (): any[];
		/** 
		 * Returns the value of [items](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#cfg-items).
		 * @method
		 * @public (method)
		 * @returns {any[]|object}  
		 */
		getItems? (): any[] | object;
		/** 
		 * Returns the value of [layout](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#cfg-layout).
		 * @method
		 * @public (method)
		 * @returns {object|void}  
		 */
		...
		getModal? (): boolean;
		/** 
		 * Returns the value of [navigationBar](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#cfg-navigationBar).
		 * @method
		 * @public (method)
		...
		getUi? (): string | string[];
		/** 
		 * Returns the value of [useTitleForBackButtonText](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#cfg-useTitleForBackButtonText).
		 * @method
		 * @public (method)
		 * @returns {boolean}  
		 */
		 ...
		 */
		hide? (animation?: object | boolean): Ext.navigation.View;
		hide? (animation?: object | boolean): Ext.Container;
		hide? (animation?: object | boolean): Ext.Component;
		/** 
		 * @method
		 * @private (method)
		 * @returns {Ext.navigation.View|Ext.Container|Ext.Component|void}  
		 */
		hide? (): void;
		/** 
		 ...
		 * of this view. You can also pass a [Ext.ComponentQuery](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ComponentQuery.html) selector to target what inner item to pop to.
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [defaultBackButtonText](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#cfg-defaultBackButtonText).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [items](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#cfg-items).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [navigationBar](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#cfg-navigationBar).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [useTitleForBackButtonText](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#cfg-useTitleForBackButtonText).
		 * @method
		 * @public (method)
		 ...
		 * @returns {Ext.navigation.View}             
		 */
		show? (animation?: object | boolean): Ext.navigation.View;
...
declare namespace Ext.navigation.Bar {
	 ...
	 * [Ext.navigation.Bar](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.Bar.html)
	 * This component is used in [Ext.navigation.View](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html) to control animations in the toolbar. You should never need to
	 * interact with the component directly, unless you are subclassing it.
	 */
...
declare namespace Ext.navigation.Bar.methodParams.addListener {
	 ...
	 * [Ext.navigation.Bar.addListener](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.Bar.html#method-addListener)
...
declare namespace Ext.navigation.Bar.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.navigation.Bar.on](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.Bar.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.navigation.View.methodParams.addListener {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.navigation.View.addListener](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#method-addListener)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.navigation.View.methodParams.on {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.navigation.View.on](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#method-on)
	 * An object containing handler configuration.
	 * 
	 * **Note:** The options object will also be passed as the last argument to every
	 * event handler.
...
declare namespace Ext.navigation.Bar {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * Used as the prefix for [ui](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.Bar.html#cfg-ui)-specific class names.
		 * When set to `true` the [classCls](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.Bar.html#property-classCls) will be used as the baseCls
		 * @configuration
		 * @optional
		 ...
		 * and `border-style` via CSS rule or [style](https://docs.sencha.com/extjs/6.2.0/modern/Ext.TitleBar.html#cfg-style) configuration
		 * (if not already provide by the theme).
		 * 
		 * ## Using [style](https://docs.sencha.com/extjs/6.2.0/modern/Ext.TitleBar.html#cfg-style):
		 * 
		 *    Ext.Viewport.add({
		 *        centered: true,
		 *        width: 100,
		 ...
		 * addition to the [baseCls](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.Bar.html#cfg-baseCls). In many cases, this property will be specified
		 * by the derived widget class. See [userCls](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.Bar.html#cfg-userCls) for adding additional CSS
		 ...
		 * b) The [useTitleForBackButtonText](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.Bar.html#cfg-useTitleForBackButtonText) configuration is true.
		 * @configuration
		 * @optional
		 * @default 'Back'
		 * @type {string}
		...
		/** 
		 * Set to false if you always want to display the [defaultBackButtonText](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.Bar.html#cfg-defaultBackButtonText) as the text
...
declare namespace Ext.navigation.View {
	...
	interface Cfg extends Ext.base.Configs {
		...
		/** 
		 * The base CSS class to apply to this widget's element.
		 * Used as the prefix for [ui](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#cfg-ui)-specific class names.
		 * When set to `true` the [classCls](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#property-classCls) will be used as the baseCls
		 * @configuration
		 * @optional
		 ...
		 * - The [useTitleForBackButtonText](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#cfg-useTitleForBackButtonText) configuration is `true`.
		 * @configuration
		 * @optional
		 * @default 'Back'
		 * @type {string}
		 ...
		 *    });
		 * 
		 * If you want a title to be displayed in the [navigationBar](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#cfg-navigationBar), you must specify a `title` configuration in your
		 * view, like above.
		 * 
		 * **Note:** Only one view will be visible at a time. If you want to change to another view, use the [push](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#method-push) or
		 * [setActiveItem](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#method-setActiveItem) methods.
		 * @configuration
		 * @optional
		 * @type {any[]|object}
		 */
		...
		useBodyElement?: object;
		/** 
		 * Set to `false` if you always want to display the [defaultBackButtonText](https://docs.sencha.com/extjs/6.2.0/modern/Ext.navigation.View.html#cfg-defaultBackButtonText) as the text
		 * on the back button. `true` if you want to use the previous views title.
		 * @configuration
		 * @optional
		 * @default false

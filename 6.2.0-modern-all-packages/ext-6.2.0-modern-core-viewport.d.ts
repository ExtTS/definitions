declare namespace Ext.viewport {
	 ...
	 * 
	 * Please refer to the [Ext.Viewport](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Viewport.html) documentation about using the global instance.
	 * @private (class)
...
declare namespace Ext.viewport.Android {
	 ...
	 * [Ext.viewport.Android](https://docs.sencha.com/extjs/6.2.0/modern/Ext.viewport.Android.html)
	 * Android version of viewport.
	 */
	interface Statics extends Ext.base.Statics {
		 ...
		 * @returns {Ext.viewport.Android|Ext.viewport.Default|Ext.Base}            
		 */
		 ...
		 * @returns {Ext.viewport.Android|Ext.viewport.Default|Ext.Base}         this
		 */
...
declare namespace Ext.viewport.Default {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.viewport.Default](https://docs.sencha.com/extjs/6.2.0/modern/Ext.viewport.Default.html)
	 * Base class for iOS and Android viewports.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.viewport.Default|Ext.Base}            
		 */
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.viewport.Default;
		addMembers? (members: object, isStatic?: boolean, privacy?: boolean): typeof Ext.Base;
		/** 
		 ...
		 * @chainable
		 * @param   {object}                        members
		 * @returns {Ext.viewport.Default|Ext.Base}         this
		 */
		addStatics? (members: object): typeof Ext.viewport.Default;
		addStatics? (members: object): typeof Ext.Base;
		/** 
...
declare namespace Ext.viewport.Ios {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.viewport.Ios](https://docs.sencha.com/extjs/6.2.0/modern/Ext.viewport.Ios.html)
	 * iOS version of viewport.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.viewport.Ios|Ext.viewport.Default|Ext.Base}            
		 */
		 ...
		 * @chainable
		 * @param   {object}                                         members
		 * @returns {Ext.viewport.Ios|Ext.viewport.Default|Ext.Base}         this
		 */
...
declare namespace Ext.viewport.Viewport {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.viewport.Viewport](https://docs.sencha.com/extjs/6.2.0/modern/Ext.viewport.Viewport.html)
	 * This class acts as a factory for environment-specific viewport implementations.
	 * 
	 * Please refer to the [Ext.Viewport](https://docs.sencha.com/extjs/6.2.0/modern/Ext.Viewport.html) documentation about using the global instance.
	 */
...
declare namespace Ext.viewport.WindowsPhone {
	 ...
	 * @statics
	 * Class static members interface: 
	 * [Ext.viewport.WindowsPhone](https://docs.sencha.com/extjs/6.2.0/modern/Ext.viewport.WindowsPhone.html)
	 * Windows Phone version of Viewport.
	 */
	interface Statics extends Ext.base.Statics {
		/** 
		 ...
		 * Pass `true` if the members are private. This
		 * only has meaning in debug mode and only for methods.
		 * @returns {Ext.viewport.WindowsPhone|Ext.viewport.Default|Ext.Base}            
		 */
		 ...
		 * @chainable
		 * @param   {object}                                                  members
		 * @returns {Ext.viewport.WindowsPhone|Ext.viewport.Default|Ext.Base}         this
		 */
...
declare namespace Ext.viewport.Android.methodParams.setMenu {
	 ...
	 * [Ext.viewport.Android.setMenu](https://docs.sencha.com/extjs/6.2.0/modern/Ext.viewport.Android.html#method-setMenu)
	...
	interface Config extends Ext.base.Params {
		...
		cover?: boolean;
		/** 
		 * True to push the menu alongside the viewport
...
declare namespace Ext.viewport.Default.methodParams.setMenu {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.viewport.Default.setMenu](https://docs.sencha.com/extjs/6.2.0/modern/Ext.viewport.Default.html#method-setMenu)
	 * The configuration for the menu.
	 */
	interface Config extends Ext.base.Params {
		/** 
...
declare namespace Ext.viewport.Ios.methodParams.setMenu {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.viewport.Ios.setMenu](https://docs.sencha.com/extjs/6.2.0/modern/Ext.viewport.Ios.html#method-setMenu)
	 * The configuration for the menu.
	 */
	interface Config extends Ext.base.Params {
		/** 
...
declare namespace Ext.viewport.WindowsPhone.methodParams.setMenu {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.viewport.WindowsPhone.setMenu](https://docs.sencha.com/extjs/6.2.0/modern/Ext.viewport.WindowsPhone.html#method-setMenu)
	 * The configuration for the menu.
	 */
	interface Config extends Ext.base.Params {
		/** 

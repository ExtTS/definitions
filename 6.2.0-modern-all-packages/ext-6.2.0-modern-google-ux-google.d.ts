declare namespace Ext.ux.google {
	/** 
	 * [Ext.ux.google.Api](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.google.Api.html)
	...
	/** 
	 * [Ext.ux.google.Feeds](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.google.Feeds.html)
	...
	/** 
	 * [Ext.ux.google.Map](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.google.Map.html)
	...
	class Map extends Ext.Container {
		/** 
		 * Returns the value of [geo](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.google.Map.html#cfg-geo).
		 * @method
		 * @public (method)
		 * @returns {Ext.util.Geolocation}  
		 */
		getGeo? (): Ext.util.Geolocation;
		/** 
		 * Returns the value of [map](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.google.Map.html#cfg-map).
		 * @method
		 * @public (method)
		...
		/** 
		 * Returns the value of [mapListeners](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.google.Map.html#cfg-mapListeners).
		 * @method
		 * @public (method)
		 * @returns {object}  
		 */
		getMapListeners? (): object;
		/** 
		 * Returns the value of [useCurrentLocation](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.google.Map.html#cfg-useCurrentLocation).
		 * @method
		 * @public (method)
		 * @returns {boolean|Ext.util.Geolocation}  
		 */
		getUseCurrentLocation? (): boolean | Ext.util.Geolocation;
		/** 
		 * Sets the value of [geo](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.google.Map.html#cfg-geo).
		 * @method
		 * @public (method)
		 * @param   {Ext.util.Geolocation} geo The new value.
		 * @returns {void}                     
		 */
		setGeo? (geo: Ext.util.Geolocation): void;
		/** 
		 * Sets the value of [map](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.google.Map.html#cfg-map).
		 * @method
		 * @public (method)
		 * @param   {google.maps.Map} map The new value.
		 * @returns {void}                
		 */
		 ...
		 * @method
		 * @public (method)
		 * @param   {object|google.maps.LatLng} coordinates
		 * Object representing the desired Latitude and
		 * longitude upon which to center the map.
		 * @returns {void}                                  
		 */
		setMapCenter? (coordinates: object | google.maps.LatLng): void;
		/** 
		 * Sets the value of [mapListeners](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.google.Map.html#cfg-mapListeners).
		 * @method
		 * @public (method)
		 * @param   {object} mapListeners The new value.
		 * @returns {void}                
		 */
		setMapListeners? (mapListeners: object): void;
		/** 
		 * Sets the value of [mapOptions](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.google.Map.html#cfg-mapOptions).
		 * @method
		 * @public (method)
		 * @param   {object} mapOptions The new value.
		 * @returns {void}              
		 */
		setMapOptions? (mapOptions: object): void;
		/** 
		 * Sets the value of [useCurrentLocation](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.google.Map.html#cfg-useCurrentLocation).
		 * @method
		 * @public (method)
		 * @param   {boolean|Ext.util.Geolocation} useCurrentLocation The new value.
		 * @returns {void}                                            
		 */
		setUseCurrentLocation? (useCurrentLocation: boolean | Ext.util.Geolocation): void;
		/** 
		 * @method
		 * @private (method)
		 * @returns {void}  
...
declare namespace Ext {
	class Map extends Ext.ux.google.Map {}
}
...
declare namespace Ext.ux.google.Map {
	/** 
	 * @definitions
	 * Config interface to declare class: 
	 * [Ext.ux.google.Map](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.google.Map.html)
	 ...
	 * 
	 */
	interface Def extends Ext.ux.google.Map {
		/** 
		 * List of short aliases for class names. An alias consists of a namespace and a name
		 * concatenated by a period as &#60;namespace&#62;.&#60;name&#62;
		 * 
		 ...
		 * @property
		 * @protected (property)
		 * @type {Ext.ux.google.Map.Cfg}
		 */
		config?: Ext.ux.google.Map.Cfg;
		/** 
		 * The parent class that this class extends. For example:
		 * 
		 *    Ext.define('Person', {
		 ...
		 * 
		 * @protected (method+configuration)
		 * @returns {Ext.Container.Statics|Ext.Component.Statics|Ext.Widget.Statics|Ext.Evented.Statics|Ext.Base.Statics}  
		 * @type {object}
		 */
		statics?: (() => Ext.Container.Statics | Ext.Component.Statics | Ext.Widget.Statics | Ext.Evented.Statics | Ext.Base.Statics) | object | any;
	}
}
declare namespace Ext.ux.google.Api {
	/** 
...
declare namespace Ext.ux.google.Map {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * GeoLocation config to have more control over your GeoLocation options
		 * @configuration
		 * @optional
		 * @default false
	...
	interface Events extends Ext.base.Events {
		 ...
		 * @returns {void}               
		 */
		centerchange? (_this: Ext.ux.google.Map, map: google.maps.Map, center: google.maps.LatLng, eOpts: object): void;
		/** 
		 ...
		 * @returns {void}              
		 */
		maprender? (_this: Ext.ux.google.Map, map: google.maps.Map, eOpts: object): void;
		/** 
		 ...
		 * @returns {void}              
		 */
		typechange? (_this: Ext.ux.google.Map, map: google.maps.Map, mapType: number, eOpts: object): void;
		/** 
		 ...
		 * @returns {void}              
		 */
		zoomchange? (_this: Ext.ux.google.Map, map: google.maps.Map, zoomLevel: number, eOpts: object): void;
	}
}

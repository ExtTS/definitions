declare namespace Ext.data.proxy {
	/** 
	 * [Ext.data.proxy.Sql](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.Sql.html)
	...
	class Sql extends Ext.data.proxy.Client {
		...
		privates?: object;
		/** 
		 * Returns the value of [database](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.Sql.html#cfg-database).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		...
		/** 
		 * Returns the value of [table](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.Sql.html#cfg-table).
		 * @method
		 * @public (method)
		 * @returns {string}  
		 */
		getTable? (): string;
		/** 
		 * Sets the value of [database](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.Sql.html#cfg-database).
		 * @method
		 * @public (method)
		...
		/** 
		 * Sets the value of [table](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.Sql.html#cfg-table).
		 * @method
		 * @public (method)
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.proxy.Proxy.create](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.Proxy.html#method-create).
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.proxy.Proxy.erase](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.Proxy.html#method-erase).
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.proxy.Proxy.read](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.Proxy.html#method-read).
		...
		/** 
		 * @compatible DO NOT USE THIS METHOD VARIANT. It's only compatibility for class [Ext.data.proxy.Proxy.update](https://docs.sencha.com/extjs/6.2.0/modern/Ext.data.proxy.Proxy.html#method-update).

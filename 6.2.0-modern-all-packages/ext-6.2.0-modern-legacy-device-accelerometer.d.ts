declare namespace Ext.device.accelerometer {
	 ...
	 * @private (class)
	 */
	class Cordova extends Ext.device.accelerometer.Abstract {}
	/** 
	 * @private (class)
	 */
	class Simulator extends Ext.device.accelerometer.Abstract {}
	class PhoneGap extends Ext.device.accelerometer.Cordova {}
}
declare namespace Ext.device.accelerometer.Abstract {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.accelerometer.Abstract](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.accelerometer.Abstract.html)
	 */
...
declare namespace Ext.device.accelerometer.Cordova {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.accelerometer.Cordova](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.accelerometer.Cordova.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * The default frequency to get the current acceleration when using [Ext.device.Accelerometer.watchAcceleration](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.Accelerometer.html#method-watchAcceleration).
...
declare namespace Ext.device.accelerometer.Simulator {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.accelerometer.Simulator](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.accelerometer.Simulator.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * The default frequency to get the current acceleration when using [Ext.device.Accelerometer.watchAcceleration](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.Accelerometer.html#method-watchAcceleration).

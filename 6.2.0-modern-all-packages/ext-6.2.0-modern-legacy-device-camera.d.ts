declare namespace Ext.device.camera {
	 ...
	 * @private (class)
	 */
	class Cordova extends Ext.device.camera.Abstract {}
	/** 
	 * @private (class)
	 */
	class Simulator extends Ext.device.camera.Abstract {}
	class PhoneGap extends Ext.device.camera.Cordova {}
}
declare namespace Ext.device.camera.Abstract.methodParams.capture {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.device.camera.Abstract.capture](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.camera.Abstract.html#method-capture)
	...
	interface Options extends Ext.base.Params {
		 ...
		 * @configuration
		 * @optional
		 * @type {Function|Ext.device.camera.Abstract.methodParams.capture.Options.success}
		 */
...
declare namespace Ext.device.camera.Simulator {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.camera.Simulator](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.camera.Simulator.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * @configuration
		 * @optional
		 * @default [{success: 'http://www.sencha.com/img/sencha-large.png'}]
		 * @type {any[]}
		 */
		samples?: any[];
		/** 

declare namespace Ext.device.compass {
	 ...
	 * @private (class)
	 */
	class Cordova extends Ext.device.compass.Abstract {}
	/** 
	 * @private (class)
	 */
	class Simulator extends Ext.device.compass.Abstract {}
	class PhoneGap extends Ext.device.compass.Cordova {}
}
declare namespace Ext.device.compass.Abstract {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.compass.Abstract](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.compass.Abstract.html)
	 */
...
declare namespace Ext.device.compass.Cordova {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.compass.Cordova](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.compass.Cordova.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * The default frequency to get the current heading when using [Ext.device.Compass.watchHeading](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.Compass.html#method-watchHeading).
...
declare namespace Ext.device.compass.Simulator {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.compass.Simulator](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.compass.Simulator.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * The default frequency to get the current heading when using [Ext.device.Compass.watchHeading](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.Compass.html#method-watchHeading).

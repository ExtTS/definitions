declare namespace Ext.device.connection {
	 ...
	 * @private (class)
	 */
	class Cordova extends Ext.device.connection.Abstract {}
	/** 
	 * @private (class)
	 */
	class Simulator extends Ext.device.connection.Abstract {}
	class PhoneGap extends Ext.device.connection.Cordova {}
}
declare namespace Ext.device.connection.Abstract {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.connection.Abstract](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.connection.Abstract.html)
	 */
...
declare namespace Ext.device.connection.Cordova {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.connection.Cordova](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.connection.Cordova.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * @configuration
...
declare namespace Ext.device.connection.Simulator {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.connection.Simulator](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.connection.Simulator.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * @configuration

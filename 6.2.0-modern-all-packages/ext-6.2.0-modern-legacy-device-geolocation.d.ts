declare namespace Ext.device.geolocation {
	 ...
	 * @private (class)
	 */
	class Cordova extends Ext.device.geolocation.Abstract {}
	/** 
	 * @private (class)
	 */
	class Simulator extends Ext.device.geolocation.Abstract {}
	class PhoneGap extends Ext.device.geolocation.Cordova {}
}
declare namespace Ext.device.geolocation.Abstract.methodParams.getCurrentPosition {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.device.geolocation.Abstract.getCurrentPosition](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.geolocation.Abstract.html#method-getCurrentPosition)
	...
	interface Config extends Ext.base.Params {
		 ...
		 * @configuration
		 * @optional
		 * @type {Function|Ext.device.geolocation.Abstract.methodParams.getCurrentPosition.Config.success}
		 */
...
declare namespace Ext.device.geolocation.Abstract.methodParams.watchPosition {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.device.geolocation.Abstract.watchPosition](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.geolocation.Abstract.html#method-watchPosition)
	 * An object which contains the following config options:
	 */
	interface Config extends Ext.base.Params {
		/** 
...
declare namespace Ext.device.geolocation.Abstract {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.geolocation.Abstract](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.geolocation.Abstract.html)
	 */
...
declare namespace Ext.device.geolocation.Cordova {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.geolocation.Cordova](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.geolocation.Cordova.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * True to allow high accuracy when getting the current position.
...
declare namespace Ext.device.geolocation.Simulator {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.geolocation.Simulator](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.geolocation.Simulator.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * True to allow high accuracy when getting the current position.

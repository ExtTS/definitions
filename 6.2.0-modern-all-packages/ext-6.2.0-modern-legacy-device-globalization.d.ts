declare namespace Ext.device.globalization {
	 ...
	 * @private (class)
	 */
	class Cordova extends Ext.device.globalization.Abstract {}
	/** 
	 * @private (class)
	 */
	class Simulator extends Ext.device.globalization.Abstract {}
	class PhoneGap extends Ext.device.globalization.Cordova {}
}
declare namespace Ext.device.globalization.Abstract {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.globalization.Abstract](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.globalization.Abstract.html)
	 */
...
declare namespace Ext.device.globalization.Cordova {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.globalization.Cordova](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.globalization.Cordova.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * @configuration
...
declare namespace Ext.device.globalization.Simulator {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.globalization.Simulator](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.globalization.Simulator.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * @configuration

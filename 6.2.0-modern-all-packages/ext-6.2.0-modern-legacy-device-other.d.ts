declare namespace Ext.device.analytics {
	 ...
	 * @private (class)
	 */
	class Cordova extends Ext.device.analytics.Abstract {}
}
declare namespace Ext.device.browser {
	 ...
	 * @private (class)
	 */
	class Cordova extends Ext.device.browser.Abstract {}
	/** 
	 * @private (class)
	 */
	class Simulator extends Ext.Base {}
	/** 
	 * @private (class)
	 */
	class Window extends Ext.Evented {}
}
...
declare namespace Ext.device.communicator {
	 ...
	 * @private (class)
	 */
	class Android extends Ext.device.communicator.Default {}
	/** 
	 ...
	 * 
	 * As an example, to capture a photo from the device's camera, we use [`Ext.device.Camera.capture](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.Camera.html#method-capture)()` like:
	 * 
	 ...
	 * respectively) and maintained by [`Ext.device.Communicator`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.Communicator.html).
	 * 
	 ...
	 * 
	 * Note that [`Ext.device.Communicator`](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.Communicator.html) maintains the uniqueness of each function callback and
...
declare namespace Ext.device.contacts {
	 ...
	 * @private (class)
	 */
	class Cordova extends Ext.device.contacts.Abstract {}
}
declare namespace Ext.device.media {
	 ...
	 * @private (class)
	 */
	class Cordova extends Ext.device.media.Abstract {}
}
declare namespace Ext.device.notification {
	 ...
	 * @private (class)
	 */
	class Cordova extends Ext.device.notification.Abstract {}
	/** 
	 * @private (class)
	 */
	class Simulator extends Ext.device.notification.Abstract {}
}
declare namespace Ext.device.orientation {
	 ...
	 * @private (class)
	 */
	class HTML5 extends Ext.device.orientation.Abstract {}
}
declare namespace Ext.device.push {
	 ...
	 * @private (class)
	 */
	class Cordova extends Ext.device.push.Abstract {}
}
declare namespace Ext.device.splashscreen {
	 ...
	 * @private (class)
	 */
	class Cordova extends Ext.device.splashscreen.Abstract {}
	/** 
	 * @private (class)
	 */
	class Simulator extends Ext.device.splashscreen.Abstract {}
}
declare namespace Ext.device.capture {
	class Simulator extends Ext.device.capture.Abstract {}
}
declare namespace Ext.device.contacts {
	class PhoneGap extends Ext.device.contacts.Cordova {}
}
declare namespace Ext.device.media {
	class PhoneGap extends Ext.device.media.Cordova {}
}
declare namespace Ext.device.notification {
	class PhoneGap extends Ext.device.notification.Cordova {}
}
declare namespace Ext.device.splashscreen {
	class PhoneGap extends Ext.device.splashscreen.Cordova {}
}
declare namespace Ext.device.push.Cordova {
	/** 
	 * @statics
	 * Class static members interface: 
	 * [Ext.device.push.Cordova](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.push.Cordova.html)
	 * Interfaces with Cordova PushPlugin: https://github.com/phonegap-build/PushPlugin
	 */
	interface Statics extends Ext.base.Statics {
	}
}
declare namespace Ext.device.analytics.Abstract.methodParams.trackEvent {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.device.analytics.Abstract.trackEvent](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.analytics.Abstract.html#method-trackEvent)
	 */
...
declare namespace Ext.device.browser.Abstract.methodParams.open {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.device.browser.Abstract.open](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.browser.Abstract.html#method-open)
...
declare namespace Ext.device.capture.Abstract.methodParams.captureAudio {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.device.capture.Abstract.captureAudio](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.capture.Abstract.html#method-captureAudio)
	...
	interface Config extends Ext.base.Params {
		 ...
		 * @configuration
		 * @optional
		 * @type {Function|Ext.device.capture.Abstract.methodParams.captureAudio.Config.success}
		 */
...
declare namespace Ext.device.capture.Abstract.methodParams.captureVideo {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.device.capture.Abstract.captureVideo](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.capture.Abstract.html#method-captureVideo)
	 * The configuration object to be passed:
	 */
	interface Config extends Ext.base.Params {
		/** 
		 ...
		 * @configuration
		 * @optional
		 * @type {Function|Ext.device.capture.Abstract.methodParams.captureVideo.Config.success}
		 */
		success?: ((files?: any[]) => void) | ExtGlobalFunction;
		/** 
		 * Called if the capture is unsuccessful.
...
declare namespace Ext.device.notification.Abstract.methodParams.show {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.device.notification.Abstract.show](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.notification.Abstract.html#method-show)
	...
	interface Config extends Ext.base.Params {
		 ...
		 * @configuration
		 * @optional
		 * @type {Function|Ext.device.notification.Abstract.methodParams.show.Config.callback}
		 */
...
declare namespace Ext.device.orientation.Abstract.eventsParams.orientationchange {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.device.orientation.Abstract.orientationchange](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.orientation.Abstract.html#event-orientationchange)
	 * The event object
	 */
...
declare namespace Ext.device.orientation.HTML5.eventsParams.orientationchange {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.device.orientation.HTML5.orientationchange](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.orientation.HTML5.html#event-orientationchange)
	 * The event object
	 */
	interface Event extends Ext.base.Params {
		/** 
...
declare namespace Ext.device.push.Abstract.methodParams.register {
	/** 
	 * @params
	 * Config interface to call method: 
	 * [Ext.device.push.Abstract.register](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.push.Abstract.html#method-register)
	...
	interface Config extends Ext.base.Params {
		 ...
		 * @configuration
		 * @optional
		 * @type {Function|Ext.device.push.Abstract.methodParams.register.Config.success}
		 */
		 ...
		 * @configuration
		 * @optional
		 * @type {Function|Ext.device.push.Abstract.methodParams.register.Config.failure}
		 */
		 ...
		 * @configuration
		 * @optional
		 * @type {Function|Ext.device.push.Abstract.methodParams.register.Config.received}
		 */
		received?: ((notifications?: object) => void) | ExtGlobalFunction;
	}
}
declare namespace Ext.device.analytics.Abstract {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.analytics.Abstract](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.analytics.Abstract.html)
	 */
...
declare namespace Ext.device.analytics.Cordova {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.analytics.Cordova](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.analytics.Cordova.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * @configuration
...
declare namespace Ext.device.contacts.Abstract {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.contacts.Abstract](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.contacts.Abstract.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
...
declare namespace Ext.device.contacts.Cordova {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.contacts.Cordova](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.contacts.Cordova.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * True to include images when you get the contacts store. Please beware that this can be very slow.
...
declare namespace Ext.device.media.Abstract {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.media.Abstract](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.media.Abstract.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * @configuration
...
declare namespace Ext.device.media.Cordova {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.media.Cordova](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.media.Cordova.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * @configuration

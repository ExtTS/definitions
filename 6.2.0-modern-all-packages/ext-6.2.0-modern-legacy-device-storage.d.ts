declare namespace Ext.device.storage {
	 ...
	 * @private (class)
	 */
	class Cordova extends Ext.device.storage.HTML5.HTML5 {}
}
declare namespace Ext.device.storage.HTML5 {
	 ...
	 * @private (class)
	 */
	class SQLStatement extends Ext.Base {}
}
declare namespace Ext.device.storage {
	/** 
	 * @private (class)
	 */
	class Simulator extends Ext.device.storage.HTML5.HTML5 {}
	class PhoneGap extends Ext.device.storage.Cordova {}
}
declare namespace Ext.device.storage.Abstract {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.storage.Abstract](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.storage.Abstract.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * @configuration
		 * @optional
		 * @default 'Sencha Database'
		 * @type {string}
		 */
...
declare namespace Ext.device.storage.Cordova {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.storage.Cordova](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.storage.Cordova.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * @configuration
...
declare namespace Ext.device.storage.HTML5.HTML5 {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.storage.HTML5.HTML5](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.storage.HTML5.HTML5.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * @configuration
...
declare namespace Ext.device.storage.Simulator {
	/** 
	 * @configurations
	 * Config interface to create class: 
	 * [Ext.device.storage.Simulator](https://docs.sencha.com/extjs/6.2.0/modern/Ext.device.storage.Simulator.html)
	 */
	interface Cfg extends Ext.base.Configs {
		/** 
		 * @configuration

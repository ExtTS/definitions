declare namespace Ext.ux.ajax {
	/** 
	 * [Ext.ux.ajax.DataSimlet](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.DataSimlet.html)
	 * This base class is used to handle data preparation (e.g., sorting, filtering and
	 * group summary).
	 */
	class DataSimlet extends Ext.Base {}
	/** 
	 * [Ext.ux.ajax.JsonSimlet](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.JsonSimlet.html)
	 * JSON Simlet.
	 */
	...
	/** 
	 * [Ext.ux.ajax.PivotSimlet](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.PivotSimlet.html)
	...
	/** 
	 * [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.Simlet.html)
	 * This is a base class for more advanced "simlets" (simulated servers). A simlet is asked
	 * to provide a response given a [Ext.ux.ajax.SimXhr](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.SimXhr.html) instance.
	 */
	...
	/** 
	 * [Ext.ux.ajax.SimManager](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.SimManager.html)
	 ...
	 * 
	 * The requires hooks are inserted when either the [init](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.SimManager.html#method-init) method is called or the
	 * first [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.Simlet.html) is registered. For example:
	 * 
	 ...
	 *     }
	 * 
	 * As many URL's as desired can be registered and associated with a [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.Simlet.html). To make
	...
	interface SimManager extends Ext.Base {
		...
		/** 
		 * Registeres one or more [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.Simlet.html) instances.
		 * @method
		 * @public (method)
		 * @param   {any[]|object} simlet
		 * Either a [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.Simlet.html) instance or config, an Array
		 * of such elements or an Object keyed by URL with values that are [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.Simlet.html)
	...
	/** 
	 * [Ext.ux.ajax.SimXhr](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.SimXhr.html)
	 * Simulates an XMLHttpRequest object's methods and properties but is backed by a
	 * [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.Simlet.html) instance that provides the data.
	 */
	...
	/** 
	 * [Ext.ux.ajax.XmlSimlet](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.XmlSimlet.html)
...
declare namespace Ext.ux.event {
	/** 
	 * [Ext.ux.event.Driver](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Driver.html)
	 * This is the base class for [Ext.ux.event.Recorder](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Recorder.html) and [Ext.ux.event.Player](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Player.html).
	 */
	...
	/** 
	 * [Ext.ux.event.Maker](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Maker.html)
	 * Event maker.
	 */
	...
	/** 
	 * [Ext.ux.event.Player](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Player.html)
	 * This class manages the playback of an array of "event descriptors". For details on the
	 * contents of an "event descriptor", see [Ext.ux.event.Recorder](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Recorder.html). The events recorded by the
	 * [Ext.ux.event.Recorder](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Recorder.html) class are designed to serve as input for this class.
	 * 
	 * The simplest use of this class is to instantiate it with an [eventQueue](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Player.html#cfg-eventQueue) and call
	 * [start](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Player.html#method-start). Like so:
	 * 
	...
	class Player extends Ext.ux.event.Driver {
		 ...
		 * dequeue the event. Repeated calls return the same object (until [nextEvent](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Player.html#method-nextEvent)
		 * is called).
		 * @method
		 * @public (method)
		 * @returns {void}  
	...
	/** 
	 * [Ext.ux.event.Recorder](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Recorder.html)
	 * Event recorder.
	 */
...
declare namespace Ext.ux.event.Player.methodParams.injectKeyEvent {
	 ...
	 * [Ext.ux.event.Player.injectKeyEvent](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Player.html#method-injectKeyEvent)
...
declare namespace Ext.ux.event.Player.methodParams.injectMouseEvent {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.ux.event.Player.injectMouseEvent](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Player.html#method-injectMouseEvent)
	 * Object object containing all of the event injection
	 * options.
	 */
	interface Options extends Ext.base.Params {
...
declare namespace Ext.ux.event.Player.methodParams.injectUIEvent {
	 ...
	 * @params
	 * Config interface to call method: 
	 * [Ext.ux.event.Player.injectUIEvent](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Player.html#method-injectUIEvent)
	 */
	interface Options extends Ext.base.Params {
		/** 
		 * The type of event to fire. This can be any one of
...
declare namespace Ext.ux.ajax.SimManager {
	...
	interface Cfg extends Ext.base.Configs {
		/** 
		 * The [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.Simlet.html) instance to use for non-matching URL's. By default, this will
		...
		/** 
		 * The default `type` to apply to generic [Ext.ux.ajax.Simlet](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.ajax.Simlet.html) configuration objects. The
		 * default is 'basic'.
		 * @configuration
		 * @optional
		 * @default 'basic'
...
declare namespace Ext.ux.event.Player {
	...
	interface Cfg extends Ext.base.Configs {
		 ...
		 * the [start](https://docs.sencha.com/extjs/6.2.0/modern/Ext.ux.event.Player.html#method-start) method is called.
		 * @configuration
		 * @optional
		 * @type {any[]}
		 */
